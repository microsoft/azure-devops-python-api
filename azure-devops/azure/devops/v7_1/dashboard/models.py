...
class CopyDashboardResponse(Model):
    ...
    :type copied_dashboard: :class:`Dashboard <azure.devops.v7_1.dashboard.models.Dashboard>`
    :param copy_dashboard_options: Copy Dashboard options
    :type copy_dashboard_options: :class:`CopyDashboardOptions <azure.devops.v7_1.dashboard.models.CopyDashboardOptions>`
    """
...
class Dashboard(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_1.dashboard.models.ReferenceLinks>`
    ...
    :type id: str
    :param last_accessed_date: Dashboard Last Accessed Date.
    :type last_accessed_date: datetime
    :param modified_by: Id of the person who modified Dashboard.
    :type modified_by: str
    :param modified_date: Dashboard's last modified date.
    ...
    :type widgets: list of :class:`Widget <azure.devops.v7_1.dashboard.models.Widget>`
    """
    ...
    def __init__(self, _links=None, dashboard_scope=None, description=None, eTag=None, group_id=None, id=None, last_accessed_date=None, modified_by=None, modified_date=None, name=None, owner_id=None, position=None, refresh_interval=None, url=None, widgets=None):
...
class DashboardGroup(Model):
    ...
    :type dashboard_entries: list of :class:`DashboardGroupEntry <azure.devops.v7_1.dashboard.models.DashboardGroupEntry>`
...
class DashboardGroupEntry(Dashboard):
    ...
    def __init__(self, _links=None, dashboard_scope=None, description=None, eTag=None, group_id=None, id=None, last_accessed_date=None, modified_by=None, modified_date=None, name=None, owner_id=None, position=None, refresh_interval=None, url=None, widgets=None):
        super(DashboardGroupEntry, self).__init__(_links=_links, dashboard_scope=dashboard_scope, description=description, eTag=eTag, group_id=group_id, id=id, last_accessed_date=last_accessed_date, modified_by=modified_by, modified_date=modified_date, name=name, owner_id=owner_id, position=position, refresh_interval=refresh_interval, url=url, widgets=widgets)
...
class DashboardGroupEntryResponse(DashboardGroupEntry):
    ...
    def __init__(self, _links=None, dashboard_scope=None, description=None, eTag=None, group_id=None, id=None, last_accessed_date=None, modified_by=None, modified_date=None, name=None, owner_id=None, position=None, refresh_interval=None, url=None, widgets=None):
        super(DashboardGroupEntryResponse, self).__init__(_links=_links, dashboard_scope=dashboard_scope, description=description, eTag=eTag, group_id=group_id, id=id, last_accessed_date=last_accessed_date, modified_by=modified_by, modified_date=modified_date, name=name, owner_id=owner_id, position=position, refresh_interval=refresh_interval, url=url, widgets=widgets)
...
class DashboardResponse(DashboardGroupEntry):
    ...
    def __init__(self, _links=None, dashboard_scope=None, description=None, eTag=None, group_id=None, id=None, last_accessed_date=None, modified_by=None, modified_date=None, name=None, owner_id=None, position=None, refresh_interval=None, url=None, widgets=None):
        super(DashboardResponse, self).__init__(_links=_links, dashboard_scope=dashboard_scope, description=description, eTag=eTag, group_id=group_id, id=id, last_accessed_date=last_accessed_date, modified_by=modified_by, modified_date=modified_date, name=name, owner_id=owner_id, position=position, refresh_interval=refresh_interval, url=url, widgets=widgets)
...
class Widget(Model):
    ...
    :type allowed_sizes: list of :class:`WidgetSize <azure.devops.v7_1.dashboard.models.WidgetSize>`
    ...
    :type dashboard: :class:`Dashboard <azure.devops.v7_1.dashboard.models.Dashboard>`
    :param eTag:
    :type eTag: str
    :param id:
    :type id: str
    ...
    :type lightbox_options: :class:`LightboxOptions <azure.devops.v7_1.dashboard.models.LightboxOptions>`
    :param loading_image_url:
    :type loading_image_url: str
    :param name:
    :type name: str
    :param position:
    :type position: :class:`WidgetPosition <azure.devops.v7_1.dashboard.models.WidgetPosition>`
    :param settings:
    :type settings: str
    :param settings_version:
    :type settings_version: :class:`SemanticVersion <azure.devops.v7_1.dashboard.models.SemanticVersion>`
    :param size:
    :type size: :class:`WidgetSize <azure.devops.v7_1.dashboard.models.WidgetSize>`
    :param type_id:
    :type type_id: str
    :param url:
    :type url: str
...
class WidgetMetadataResponse(Model):
    ...
    :type widget_metadata: :class:`WidgetMetadata <azure.devops.v7_1.dashboard.models.WidgetMetadata>`
    """
...
class WidgetTypesResponse(Model):
    ...
    :type uri: str
    :param widget_types:
    :type widget_types: list of :class:`WidgetMetadata <azure.devops.v7_1.dashboard.models.WidgetMetadata>`
    """
