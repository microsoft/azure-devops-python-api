...
class ApprovalConfig(Model):
    ...
    :type approvers: list of :class:`IdentityRef <azure.devops.v7_1.microsoft._azure._pipelines._approval._web_api.models.IdentityRef>`
    :param blocked_approvers: Identities which are not allowed to approve.
    :type blocked_approvers: list of :class:`IdentityRef <azure.devops.v7_1.microsoft._azure._pipelines._approval._web_api.models.IdentityRef>`
...
class CheckConfigurationRef(Model):
    ...
    :type resource: :class:`Resource <azure.devops.v7_1.pipelines_checks.models.Resource>`
    :param type: Check configuration type
    :type type: :class:`CheckType <azure.devops.v7_1.pipelines_checks.models.CheckType>`
...
class CheckIssue(Model):
    ...
    def __init__(self, detailed_message=None, message=None, type=None):
...
class CheckSuiteRef(Model):
    ...
    :type context: :class:`object <azure.devops.v7_1.pipelines_checks.models.object>`
...
class CheckSuiteRequest(Model):
    ...
    :type id: str
    :param resources:
    :type resources: list of :class:`Resource <azure.devops.v7_1.pipelines_checks.models.Resource>`
    """
...
class TaskCheckConfig(Model):
    ...
    :type definition_ref: :class:`TaskCheckDefinitionReference <azure.devops.v7_1.microsoft._azure._pipelines._task_check._web_api.models.TaskCheckDefinitionReference>`
    :param display_name:
    :type display_name: str
    :param inputs:
    :type inputs: dict
...
class CheckConfiguration(CheckConfigurationRef):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_1.pipelines_checks.models.ReferenceLinks>`
    :param created_by: Identity of person who configured check.
    :type created_by: :class:`IdentityRef <azure.devops.v7_1.pipelines_checks.models.IdentityRef>`
    :param created_on: Time when check got configured.
    :type created_on: datetime
    :param issue: Issue connected to check configuration.
    :type issue: :class:`CheckIssue <azure.devops.v7_1.pipelines_checks.models.CheckIssue>`
    :param modified_by: Identity of person who modified the configured check.
    :type modified_by: :class:`IdentityRef <azure.devops.v7_1.pipelines_checks.models.IdentityRef>`
...
class CheckRun(CheckRunResult):
    ...
    :type check_configuration_ref: :class:`CheckConfigurationRef <azure.devops.v7_1.pipelines_checks.models.CheckConfigurationRef>`
    :param id:
    :type id: str
    """
...
class CheckSuite(CheckSuiteRef):
    ...
    :type check_runs: list of :class:`CheckRun <azure.devops.v7_1.pipelines_checks.models.CheckRun>`
