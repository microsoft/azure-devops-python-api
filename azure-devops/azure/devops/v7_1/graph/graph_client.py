...
class GraphClient(Client):
    ...
    def get_avatar(self, subject_descriptor, size=None, format=None):
        ...
        :param str size:
        :param str format:
        :rtype: :class:`<Avatar> <azure.devops.v7_1.graph.models.Avatar>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def set_avatar(self, avatar, subject_descriptor):
        """SetAvatar.
        [Preview API]
        :param :class:`<Avatar> <azure.devops.v7_1.graph.models.Avatar>` avatar:
        :param str subject_descriptor:
        """
        route_values = {}
        if subject_descriptor is not None:
    ...
    def get_descriptor(self, storage_key):
        ...
        :rtype: :class:`<GraphDescriptorResult> <azure.devops.v7_1.graph.models.GraphDescriptorResult>`
        """
        route_values = {}
    ...
    def create_group(self, creation_context, scope_descriptor=None, group_descriptors=None):
        ...
        :param :class:`<GraphGroupCreationContext> <azure.devops.v7_1.graph.models.GraphGroupCreationContext>` creation_context: The subset of the full graph group used to uniquely find the graph subject in an external provider.
        ...
        :rtype: :class:`<GraphGroup> <azure.devops.v7_1.graph.models.GraphGroup>`
        """
        query_parameters = {}
    ...
    def list_groups(self, scope_descriptor=None, subject_types=None, continuation_token=None):
        ...
        :rtype: :class:`<PagedGraphGroups> <azure.devops.v7_1.graph.models.PagedGraphGroups>`
        """
        query_parameters = {}
        if scope_descriptor is not None:
            query_parameters['scopeDescriptor'] = self._serialize.query('scope_descriptor', scope_descriptor, 'str')
    ...
    def update_group(self, group_descriptor, patch_document):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_1.graph.models.[JsonPatchOperation]>` patch_document: The JSON+Patch document containing the fields to alter.
        :rtype: :class:`<GraphGroup> <azure.devops.v7_1.graph.models.GraphGroup>`
        """
        route_values = {}
        if group_descriptor is not None:
    ...
    def add_membership(self, subject_descriptor, container_descriptor):
        ...
        :rtype: :class:`<GraphMembership> <azure.devops.v7_1.graph.models.GraphMembership>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def get_membership_state(self, subject_descriptor):
        ...
        :rtype: :class:`<GraphMembershipState> <azure.devops.v7_1.graph.models.GraphMembershipState>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def get_provider_info(self, user_descriptor):
        ...
        :rtype: :class:`<GraphProviderInfo> <azure.devops.v7_1.graph.models.GraphProviderInfo>`
        """
        route_values = {}
    ...
    def request_access(self, jsondocument):
        """RequestAccess.
        [Preview API]
        :param :class:`<object> <azure.devops.v7_1.graph.models.object>` jsondocument:
        """
    ...
    def create_service_principal(self, creation_context, group_descriptors=None):
        """CreateServicePrincipal.
        [Preview API] Materialize an existing AAD service principal into the ADO account.
        :param :class:`<GraphServicePrincipalCreationContext> <azure.devops.v7_1.graph.models.GraphServicePrincipalCreationContext>` creation_context: The subset of the full graph service principal used to uniquely find the graph subject in an external provider.
        :param [str] group_descriptors: A comma separated list of descriptors of groups you want the graph service principal to join
        :rtype: :class:`<GraphServicePrincipal> <azure.devops.v7_1.graph.models.GraphServicePrincipal>`
        """
        query_parameters = {}
        if group_descriptors is not None:
            group_descriptors = ",".join(group_descriptors)
            query_parameters['groupDescriptors'] = self._serialize.query('group_descriptors', group_descriptors, 'str')
        content = self._serialize.body(creation_context, 'GraphServicePrincipalCreationContext')
        response = self._send(http_method='POST',
                              location_id='e1dbb0ae-49cb-4532-95a1-86cd89cfcab4',
                              version='7.1-preview.1',
                              query_parameters=query_parameters,
                              content=content)
        return self._deserialize('GraphServicePrincipal', response)

    def delete_service_principal(self, service_principal_descriptor):
        """DeleteServicePrincipal.
        [Preview API] Disables a service principal.
        :param str service_principal_descriptor: The descriptor of the service principal to delete.
        """
        route_values = {}
        if service_principal_descriptor is not None:
            route_values['servicePrincipalDescriptor'] = self._serialize.url('service_principal_descriptor', service_principal_descriptor, 'str')
        self._send(http_method='DELETE',
                   location_id='e1dbb0ae-49cb-4532-95a1-86cd89cfcab4',
                   version='7.1-preview.1',
                   route_values=route_values)

    def get_service_principal(self, service_principal_descriptor):
        """GetServicePrincipal.
        [Preview API] Get a service principal by its descriptor.
        :param str service_principal_descriptor: The descriptor of the desired service principal.
        :rtype: :class:`<GraphServicePrincipal> <azure.devops.v7_1.graph.models.GraphServicePrincipal>`
        """
        route_values = {}
        if service_principal_descriptor is not None:
    ...
    def list_service_principals(self, continuation_token=None, scope_descriptor=None):
        """ListServicePrincipals.
        [Preview API] Get a list of all service principals in a given scope.
        :param str continuation_token: An opaque data blob that allows the next page of data to resume immediately after where the previous page ended. The only reliable way to know if there is more data left is the presence of a continuation token.
        :param str scope_descriptor: Specify a non-default scope (collection, project) to search for service principals.
        :rtype: :class:`<PagedGraphServicePrincipals> <azure.devops.v7_1.graph.models.PagedGraphServicePrincipals>`
        """
        query_parameters = {}
        if continuation_token is not None:
            query_parameters['continuationToken'] = self._serialize.query('continuation_token', continuation_token, 'str')
        ...
        response = self._send(http_method='GET',
                              ...
                              version='7.1-preview.1',
                              query_parameters=query_parameters)
        response_object = models.PagedGraphServicePrincipals()
        response_object.graph_service_principals = self._deserialize('[GraphServicePrincipal]', self._unwrap_collection(response))
        response_object.continuation_token = response.headers.get('X-MS-ContinuationToken')
        return response_object
    ...
    def get_storage_key(self, subject_descriptor):
        ...
        :param str subject_descriptor:
        :rtype: :class:`<GraphStorageKeyResult> <azure.devops.v7_1.graph.models.GraphStorageKeyResult>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def lookup_subjects(self, subject_lookup):
        ...
        :param :class:`<GraphSubjectLookup> <azure.devops.v7_1.graph.models.GraphSubjectLookup>` subject_lookup: A list of descriptors that specifies a subset of subjects to retrieve. Each descriptor uniquely identifies the subject across all instance scopes, but only at a single point in time.
        :rtype: {GraphSubject}
        """
    ...
    def create_user(self, creation_context, group_descriptors=None):
        ...
        :param :class:`<GraphUserCreationContext> <azure.devops.v7_1.graph.models.GraphUserCreationContext>` creation_context: The subset of the full graph user used to uniquely find the graph subject in an external provider.
        :param [str] group_descriptors: A comma separated list of descriptors of groups you want the graph user to join
        :rtype: :class:`<GraphUser> <azure.devops.v7_1.graph.models.GraphUser>`
        """
        query_parameters = {}
        if group_descriptors is not None:
            group_descriptors = ",".join(group_descriptors)
    ...
    def list_users(self, subject_types=None, continuation_token=None, scope_descriptor=None):
        ...
        :rtype: :class:`<PagedGraphUsers> <azure.devops.v7_1.graph.models.PagedGraphUsers>`
        """
        query_parameters = {}
        if subject_types is not None:
            subject_types = ",".join(subject_types)
    ...
    def update_user(self, update_context, user_descriptor):
        ...
        :param :class:`<GraphUserUpdateContext> <azure.devops.v7_1.graph.models.GraphUserUpdateContext>` update_context: The subset of the full graph user used to uniquely find the graph subject in an external provider.
