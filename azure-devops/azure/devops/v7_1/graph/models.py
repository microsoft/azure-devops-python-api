...
class GraphDescriptorResult(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_1.graph.models.ReferenceLinks>`
    :param value:
    :type value: :class:`str <azure.devops.v7_1.graph.models.str>`
    """
...
class GraphMembershipTraversal(Model):
    ...
    :type subject_descriptor: :class:`str <azure.devops.v7_1.graph.models.str>`
    ...
    :type traversed_subjects: list of :class:`str <azure.devops.v7_1.graph.models.str>`
    """
...
class GraphServicePrincipalCreationContext(Model):
    """
    ...
    :param storage_key: Optional: If provided, we will use this identifier for the storage key of the created service principal
    :type storage_key: str
    """
    ...
    def __init__(self, storage_key=None):
        super(GraphServicePrincipalCreationContext, self).__init__()
        self.storage_key = storage_key


class GraphServicePrincipalUpdateContext(Model):
    """
    ...
    :param storage_key: Storage key should not be specified in case of updating service principal
    :type storage_key: str
    """
    ...
    def __init__(self, storage_key=None):
        super(GraphServicePrincipalUpdateContext, self).__init__()
        self.storage_key = storage_key
...
class GraphSubjectLookup(Model):
    ...
    :param lookup_keys:
    :type lookup_keys: list of :class:`GraphSubjectLookupKey <azure.devops.v7_1.graph.models.GraphSubjectLookupKey>`
    """
...
class GraphSubjectLookupKey(Model):
    """
    :param descriptor:
    :type descriptor: :class:`str <azure.devops.v7_1.graph.models.str>`
    """
...
class GraphSubjectQuery(Model):
    ...
    :type scope_descriptor: :class:`str <azure.devops.v7_1.graph.models.str>`
...
class IdentityMapping(Model):
    """
    :param source:
    :type source: :class:`UserPrincipalName <azure.devops.v7_1.graph.models.UserPrincipalName>`
    :param target:
    :type target: :class:`UserPrincipalName <azure.devops.v7_1.graph.models.UserPrincipalName>`
    """

    _attribute_map = {
        'source': {'key': 'source', 'type': 'UserPrincipalName'},
        'target': {'key': 'target', 'type': 'UserPrincipalName'}
    }
...
class IdentityMappings(Model):
    """
    :param mappings:
    :type mappings: list of :class:`IdentityMapping <azure.devops.v7_1.graph.models.IdentityMapping>`
    """

    _attribute_map = {
        'mappings': {'key': 'mappings', 'type': '[IdentityMapping]'}
    }

    def __init__(self, mappings=None):
        super(IdentityMappings, self).__init__()
...
class MappingResult(Model):
    ...
    def __init__(self, code=None, error_message=None):
        super(MappingResult, self).__init__()
        self.code = code
...
class PagedGraphGroups(Model):
    ...
    :type graph_groups: list of :class:`GraphGroup <azure.devops.v7_1.graph.models.GraphGroup>`
    """
...
class PagedGraphMembers(Model):
    """
    :param continuation_token: This will be non-null if there is another page of data. There will never be more than one continuation token returned by a request.
    :type continuation_token: list of str
    :param graph_members: The enumerable list of members found within a page.
    :type graph_members: list of :class:`GraphMember <azure.devops.v7_1.graph.models.GraphMember>`
    """

    _attribute_map = {
        'continuation_token': {'key': 'continuationToken', 'type': '[str]'},
        'graph_members': {'key': 'graphMembers', 'type': '[GraphMember]'}
    }

    def __init__(self, continuation_token=None, graph_members=None):
        super(PagedGraphMembers, self).__init__()
        self.continuation_token = continuation_token
        self.graph_members = graph_members


class PagedGraphServicePrincipals(Model):
    """
    :param continuation_token: This will be non-null if there is another page of data. There will never be more than one continuation token returned by a request.
    :type continuation_token: list of str
    :param graph_service_principals: The enumerable list of service principals found within a page.
    :type graph_service_principals: list of :class:`GraphServicePrincipal <azure.devops.v7_1.graph.models.GraphServicePrincipal>`
    """

    _attribute_map = {
        'continuation_token': {'key': 'continuationToken', 'type': '[str]'},
        'graph_service_principals': {'key': 'graphServicePrincipals', 'type': '[GraphServicePrincipal]'}
    }

    def __init__(self, continuation_token=None, graph_service_principals=None):
        super(PagedGraphServicePrincipals, self).__init__()
        self.continuation_token = continuation_token
        self.graph_service_principals = graph_service_principals
...
class PagedGraphUsers(Model):
    ...
    :type graph_users: list of :class:`GraphUser <azure.devops.v7_1.graph.models.GraphUser>`
    """
...
class ResolveDisconnectedUsersResponse(Model):
    """
    :param code:
    :type code: str
    :param error_message:
    ...
    :type mapping_results: list of :class:`MappingResult <azure.devops.v7_1.graph.models.MappingResult>`
    """

    _attribute_map = {
        'code': {'key': 'code', 'type': 'str'},
        'error_message': {'key': 'errorMessage', 'type': 'str'},
        'mapping_results': {'key': 'mappingResults', 'type': '[MappingResult]'}
    }

    def __init__(self, code=None, error_message=None, mapping_results=None):
        super(ResolveDisconnectedUsersResponse, self).__init__()
        self.code = code
        self.error_message = error_message
        self.mapping_results = mapping_results


class UserPrincipalName(Model):
    """
    ...
    def __init__(self, principal_name=None):
        super(UserPrincipalName, self).__init__()
