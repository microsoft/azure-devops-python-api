...
class TestPlanClient(Client):
    ...
    def create_test_configuration(self, test_configuration_create_update_parameters, project):
        ...
        :param :class:`<TestConfigurationCreateUpdateParameters> <azure.devops.v7_1.test_plan.models.TestConfigurationCreateUpdateParameters>` test_configuration_create_update_parameters: TestConfigurationCreateUpdateParameters
        :param str project: Project ID or project name
        :rtype: :class:`<TestConfiguration> <azure.devops.v7_1.test_plan.models.TestConfiguration>`
        """
        route_values = {}
    ...
    def create_test_plan(self, test_plan_create_params, project):
        ...
        :param :class:`<TestPlanCreateParams> <azure.devops.v7_1.test_plan.models.TestPlanCreateParams>` test_plan_create_params: A testPlanCreateParams object.TestPlanCreateParams
        :param str project: Project ID or project name
        :rtype: :class:`<TestPlan> <azure.devops.v7_1.test_plan.models.TestPlan>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_test_plan(self, test_plan_update_params, project, plan_id):
        ...
        :param :class:`<TestPlanUpdateParams> <azure.devops.v7_1.test_plan.models.TestPlanUpdateParams>` test_plan_update_params: A testPlanUpdateParams object.TestPlanUpdateParams
        :param str project: Project ID or project name
    ...
    def create_test_suite(self, test_suite_create_params, project, plan_id):
        ...
        :param :class:`<TestSuiteCreateParams> <azure.devops.v7_1.test_plan.models.TestSuiteCreateParams>` test_suite_create_params: Parameters for suite creation
        :param str project: Project ID or project name
        :param int plan_id: ID of the test plan that contains the suites.
        :rtype: :class:`<TestSuite> <azure.devops.v7_1.test_plan.models.TestSuite>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_test_suite(self, test_suite_update_params, project, plan_id, suite_id):
        ...
        :param :class:`<TestSuiteUpdateParams> <azure.devops.v7_1.test_plan.models.TestSuiteUpdateParams>` test_suite_update_params: Parameters for suite updation
        :param str project: Project ID or project name
        :param int plan_id: ID of the test plan that contains the suites.
        :param int suite_id: ID of the parent suite.
        :rtype: :class:`<TestSuite> <azure.devops.v7_1.test_plan.models.TestSuite>`
    ...
    def get_test_case(self, project, plan_id, suite_id, test_case_id, wit_fields=None, return_identity_ref=None):
        """GetTestCase.
        ...
        :param str test_case_id: Test Case Id to be fetched.
        ...
        if suite_id is not None:
            route_values['suiteId'] = self._serialize.url('suite_id', suite_id, 'int')
        if test_case_id is not None:
            route_values['testCaseId'] = self._serialize.url('test_case_id', test_case_id, 'str')
        query_parameters = {}
    ...
    def get_test_case_list(self, project, plan_id, suite_id, test_ids=None, configuration_ids=None, wit_fields=None, continuation_token=None, return_identity_ref=None, expand=None, exclude_flags=None, is_recursive=None):
        """GetTestCaseList.
        ...
        :rtype: :class:`<[TestCase]> <azure.devops.v7_1.test_plan.models.[TestCase]>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def remove_test_cases_from_suite(self, project, plan_id, suite_id, test_case_ids):
        ...
        if test_case_ids is not None:
            query_parameters['testCaseIds'] = self._serialize.query('test_case_ids', test_case_ids, 'str')
        self._send(http_method='DELETE',
                   location_id='a9bd61ac-45cf-4d13-9441-43dcd01edf8d',
                   version='7.1-preview.3',
                   route_values=route_values,
    ...
    def remove_test_cases_list_from_suite(self, project, plan_id, suite_id, test_ids):
        ...
        :param int plan_id: ID of the test plan from which test cases are to be removed.
        :param int suite_id: ID of the test suite from which test cases are to be removed.
        :param str test_ids: Comma separated string of Test Case Ids to be removed.
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def clone_test_case(self, clone_request_body, project):
        """CloneTestCase.
        [Preview API]
        :param :class:`<CloneTestCaseParams> <azure.devops.v7_1.test_plan.models.CloneTestCaseParams>` clone_request_body:
        :param str project: Project ID or project name
        :rtype: :class:`<CloneTestCaseOperationInformation> <azure.devops.v7_1.test_plan.models.CloneTestCaseOperationInformation>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def clone_test_plan(self, clone_request_body, project, deep_clone=None):
        ...
        :param :class:`<CloneTestPlanParams> <azure.devops.v7_1.test_plan.models.CloneTestPlanParams>` clone_request_body: Plan Clone Request Body detail TestPlanCloneRequest
        :param str project: Project ID or project name
        :param bool deep_clone: Clones all the associated test cases as well
        :rtype: :class:`<CloneTestPlanOperationInformation> <azure.devops.v7_1.test_plan.models.CloneTestPlanOperationInformation>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_points(self, project, plan_id, suite_id, point_id, return_identity_ref=None, include_point_details=None):
        """GetPoints.
        ...
        :param str point_id: ID of test point to be fetched.
        ...
        if point_id is not None:
            query_parameters['pointId'] = self._serialize.query('point_id', point_id, 'str')
        if return_identity_ref is not None:
            query_parameters['returnIdentityRef'] = self._serialize.query('return_identity_ref', return_identity_ref, 'bool')
    ...
    def get_points_list(self, project, plan_id, suite_id, test_point_ids=None, test_case_id=None, continuation_token=None, return_identity_ref=None, include_point_details=None, is_recursive=None):
        ...
        :rtype: :class:`<[TestPoint]> <azure.devops.v7_1.test_plan.models.[TestPoint]>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def clone_test_suite(self, clone_request_body, project, deep_clone=None):
        ...
        :param :class:`<CloneTestSuiteParams> <azure.devops.v7_1.test_plan.models.CloneTestSuiteParams>` clone_request_body: Suite Clone Request Body detail TestSuiteCloneRequest
        :param str project: Project ID or project name
        :param bool deep_clone: Clones all the associated test cases as well
        :rtype: :class:`<CloneTestSuiteOperationInformation> <azure.devops.v7_1.test_plan.models.CloneTestSuiteOperationInformation>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_test_variable(self, test_variable_create_update_parameters, project):
        ...
        :param :class:`<TestVariableCreateUpdateParameters> <azure.devops.v7_1.test_plan.models.TestVariableCreateUpdateParameters>` test_variable_create_update_parameters: TestVariableCreateUpdateParameters
        :param str project: Project ID or project name
        :rtype: :class:`<TestVariable> <azure.devops.v7_1.test_plan.models.TestVariable>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
