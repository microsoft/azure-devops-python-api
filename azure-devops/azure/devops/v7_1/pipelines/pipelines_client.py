...
class PipelinesClient(Client):
    ...
    def get_artifact(self, project, pipeline_id, run_id, artifact_name, expand=None):
        ...
        :rtype: :class:`<Artifact> <azure.devops.v7_1.pipelines.models.Artifact>`
        """
        route_values = {}
    ...
    def get_log(self, project, pipeline_id, run_id, log_id, expand=None):
        ...
        :param str expand: Expand options. Default is None.
        :rtype: :class:`<Log> <azure.devops.v7_1.pipelines.models.Log>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def list_logs(self, project, pipeline_id, run_id, expand=None):
        ...
        :param int run_id: ID of the run of that pipeline.
        :param str expand: Expand options. Default is None.
        :rtype: :class:`<LogCollection> <azure.devops.v7_1.pipelines.models.LogCollection>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_pipeline(self, input_parameters, project):
        ...
        :param :class:`<CreatePipelineParameters> <azure.devops.v7_1.pipelines.models.CreatePipelineParameters>` input_parameters: Input parameters.
        :param str project: Project ID or project name
        :rtype: :class:`<Pipeline> <azure.devops.v7_1.pipelines.models.Pipeline>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def preview(self, run_parameters, project, pipeline_id, pipeline_version=None):
        ...
        :param :class:`<RunPipelineParameters> <azure.devops.v7_1.pipelines.models.RunPipelineParameters>` run_parameters: Optional additional parameters for this run.
        :param str project: Project ID or project name
        :param int pipeline_id: The pipeline ID.
        :param int pipeline_version: The pipeline version.
        :rtype: :class:`<PreviewRun> <azure.devops.v7_1.pipelines.models.PreviewRun>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_run(self, project, pipeline_id, run_id):
        ...
        :rtype: :class:`<Run> <azure.devops.v7_1.pipelines.models.Run>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
