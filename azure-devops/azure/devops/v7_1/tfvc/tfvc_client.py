...
class TfvcClient(Client):
    ...
    def get_branch(self, path, project=None, include_parent=None, include_children=None):
        ...
        :rtype: :class:`<TfvcBranch> <azure.devops.v7_1.tfvc.models.TfvcBranch>`
        """
        route_values = {}
    ...
    def get_changeset_changes(self, id=None, skip=None, top=None, continuation_token=None):
        ...
        :rtype: :class:`<[TfvcChange]> <azure.devops.v7_1.tfvc.models.[TfvcChange]>`
        """
        route_values = {}
        if id is not None:
    ...
    def create_changeset(self, changeset, project=None):
        ...
        :param :class:`<TfvcChangeset> <azure.devops.v7_1.tfvc.models.TfvcChangeset>` changeset:
        :param str project: Project ID or project name
        :rtype: :class:`<TfvcChangesetRef> <azure.devops.v7_1.tfvc.models.TfvcChangesetRef>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_changeset(self, id, project=None, max_change_count=None, include_details=None, include_work_items=None, max_comment_length=None, include_source_rename=None, skip=None, top=None, orderby=None, search_criteria=None):
        ...
        :param :class:`<TfvcChangesetSearchCriteria> <azure.devops.v7_1.tfvc.models.TfvcChangesetSearchCriteria>` search_criteria: Following criteria available (.itemPath, .version, .versionType, .versionOption, .author, .fromId, .toId, .fromDate, .toDate) Default: null
        :rtype: :class:`<TfvcChangeset> <azure.devops.v7_1.tfvc.models.TfvcChangeset>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_batched_changesets(self, changesets_request_data):
        ...
        :param :class:`<TfvcChangesetsRequestData> <azure.devops.v7_1.tfvc.models.TfvcChangesetsRequestData>` changesets_request_data: List of changeset IDs.
        :rtype: [TfvcChangesetRef]
        """
    ...
    def get_items_batch(self, item_request_data, project=None):
        ...
        :param :class:`<TfvcItemRequestData> <azure.devops.v7_1.tfvc.models.TfvcItemRequestData>` item_request_data:
        :param str project: Project ID or project name
        :rtype: [[TfvcItem]]
        """
        route_values = {}
    ...
    def get_item(self, path, project=None, file_name=None, download=None, scope_path=None, recursion_level=None, version_descriptor=None, include_content=None):
        ...
        :param :class:`<TfvcVersionDescriptor> <azure.devops.v7_1.tfvc.models.TfvcVersionDescriptor>` version_descriptor: Version descriptor.  Default is null.
        :param bool include_content: Set to true to include item content when requesting json.  Default is false.
        :rtype: :class:`<TfvcItem> <azure.devops.v7_1.tfvc.models.TfvcItem>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_items(self, project=None, scope_path=None, recursion_level=None, include_links=None, version_descriptor=None):
        ...
        :param :class:`<TfvcVersionDescriptor> <azure.devops.v7_1.tfvc.models.TfvcVersionDescriptor>` version_descriptor:
        :rtype: [TfvcItem]
        """
        route_values = {}
        if project is not None:
    ...
    def get_label(self, label_id, request_data, project=None):
        ...
        :param str label_id: Unique identifier of label
        :param :class:`<TfvcLabelRequestData> <azure.devops.v7_1.tfvc.models.TfvcLabelRequestData>` request_data: maxItemCount
        :param str project: Project ID or project name
        :rtype: :class:`<TfvcLabel> <azure.devops.v7_1.tfvc.models.TfvcLabel>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_labels(self, request_data, project=None, top=None, skip=None):
        ...
        :param :class:`<TfvcLabelRequestData> <azure.devops.v7_1.tfvc.models.TfvcLabelRequestData>` request_data: labelScope, name, owner, and itemLabelFilter
        :param str project: Project ID or project name
    ...
    def get_shelveset(self, shelveset_id, request_data=None):
        ...
        :param str shelveset_id: Shelveset's unique ID
        :param :class:`<TfvcShelvesetRequestData> <azure.devops.v7_1.tfvc.models.TfvcShelvesetRequestData>` request_data: includeDetails, includeWorkItems, maxChangeCount, and maxCommentLength
        :rtype: :class:`<TfvcShelveset> <azure.devops.v7_1.tfvc.models.TfvcShelveset>`
        """
        query_parameters = {}
        if shelveset_id is not None:
            query_parameters['shelvesetId'] = self._serialize.query('shelveset_id', shelveset_id, 'str')
    ...
    def get_shelvesets(self, request_data=None, top=None, skip=None):
        ...
        :param :class:`<TfvcShelvesetRequestData> <azure.devops.v7_1.tfvc.models.TfvcShelvesetRequestData>` request_data: name, owner, and maxCommentLength
