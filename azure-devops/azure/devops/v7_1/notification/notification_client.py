...
class NotificationClient(Client):
    ...
    def get_subscription_diagnostics(self, subscription_id):
        ...
        :rtype: :class:`<SubscriptionDiagnostics> <azure.devops.v7_1.notification.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def update_subscription_diagnostics(self, update_parameters, subscription_id):
        ...
        :param :class:`<UpdateSubscripitonDiagnosticsParameters> <azure.devops.v7_1.notification.models.UpdateSubscripitonDiagnosticsParameters>` update_parameters:
        :param str subscription_id: The id of the notifications subscription.
        :rtype: :class:`<SubscriptionDiagnostics> <azure.devops.v7_1.notification.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def get_event_type(self, event_type):
        ...
        :rtype: :class:`<NotificationEventType> <azure.devops.v7_1.notification.models.NotificationEventType>`
        """
        route_values = {}
    ...
    def get_settings(self):
        """GetSettings.
        [Preview API]
        :rtype: :class:`<NotificationAdminSettings> <azure.devops.v7_1.notification.models.NotificationAdminSettings>`
        """
        response = self._send(http_method='GET',
    ...
    def update_settings(self, update_parameters):
        """UpdateSettings.
        [Preview API]
        :param :class:`<NotificationAdminSettingsUpdateParameters> <azure.devops.v7_1.notification.models.NotificationAdminSettingsUpdateParameters>` update_parameters:
        :rtype: :class:`<NotificationAdminSettings> <azure.devops.v7_1.notification.models.NotificationAdminSettings>`
        """
    ...
    def get_subscriber(self, subscriber_id):
        ...
        :rtype: :class:`<NotificationSubscriber> <azure.devops.v7_1.notification.models.NotificationSubscriber>`
        """
        route_values = {}
    ...
    def update_subscriber(self, update_parameters, subscriber_id):
        ...
        :param :class:`<NotificationSubscriberUpdateParameters> <azure.devops.v7_1.notification.models.NotificationSubscriberUpdateParameters>` update_parameters:
        :param str subscriber_id: ID of the user or group.
        :rtype: :class:`<NotificationSubscriber> <azure.devops.v7_1.notification.models.NotificationSubscriber>`
        """
        route_values = {}
    ...
    def query_subscriptions(self, subscription_query):
        ...
        :param :class:`<SubscriptionQuery> <azure.devops.v7_1.notification.models.SubscriptionQuery>` subscription_query:
    ...
    def create_subscription(self, create_parameters):
        ...
        :param :class:`<NotificationSubscriptionCreateParameters> <azure.devops.v7_1.notification.models.NotificationSubscriptionCreateParameters>` create_parameters:
        :rtype: :class:`<NotificationSubscription> <azure.devops.v7_1.notification.models.NotificationSubscription>`
        """
    ...
    def update_subscription(self, update_parameters, subscription_id):
        ...
        :param :class:`<NotificationSubscriptionUpdateParameters> <azure.devops.v7_1.notification.models.NotificationSubscriptionUpdateParameters>` update_parameters:
        :param str subscription_id:
        :rtype: :class:`<NotificationSubscription> <azure.devops.v7_1.notification.models.NotificationSubscription>`
        """
        route_values = {}
    ...
    def update_subscription_user_settings(self, user_settings, subscription_id, user_id):
        ...
        :param :class:`<SubscriptionUserSettings> <azure.devops.v7_1.notification.models.SubscriptionUserSettings>` user_settings:
        :param str subscription_id:
        :param str user_id: ID of the user
        :rtype: :class:`<SubscriptionUserSettings> <azure.devops.v7_1.notification.models.SubscriptionUserSettings>`
        """
        route_values = {}
        if subscription_id is not None:
            route_values['subscriptionId'] = self._serialize.url('subscription_id', subscription_id, 'str')
