...
class WorkItemTrackingClient(Client):
    ...
    def query_work_items_for_artifact_uris(self, artifact_uri_query, project=None):
        ...
        :param :class:`<ArtifactUriQuery> <azure.devops.v7_1.work_item_tracking.models.ArtifactUriQuery>` artifact_uri_query: Defines a list of artifact URI for querying work items.
        :param str project: Project ID or project name
        :rtype: :class:`<ArtifactUriQueryResult> <azure.devops.v7_1.work_item_tracking.models.ArtifactUriQueryResult>`
        """
        route_values = {}
    ...
    def create_attachment(self, upload_stream, project=None, file_name=None, upload_type=None, area_path=None, **kwargs):
        ...
        :rtype: :class:`<AttachmentReference> <azure.devops.v7_1.work_item_tracking.models.AttachmentReference>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_or_update_classification_node(self, posted_node, project, structure_group, path=None):
        ...
        :param :class:`<WorkItemClassificationNode> <azure.devops.v7_1.work_item_tracking.models.WorkItemClassificationNode>` posted_node: Node to create or update.
        :param str project: Project ID or project name
        ...
        :rtype: :class:`<WorkItemClassificationNode> <azure.devops.v7_1.work_item_tracking.models.WorkItemClassificationNode>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def add_comment(self, request, project, work_item_id):
        ...
        :param :class:`<CommentCreate> <azure.devops.v7_1.work_item_tracking.models.CommentCreate>` request: Comment create request.
        :param str project: Project ID or project name
        :param int work_item_id: Id of a work item.
        :rtype: :class:`<Comment> <azure.devops.v7_1.work_item_tracking.models.Comment>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def add_work_item_comment(self, request, project, work_item_id, format):
        """AddWorkItemComment.
        [Preview API] Add a comment on a work item.
        :param :class:`<CommentCreate> <azure.devops.v7_1.work_item_tracking.models.CommentCreate>` request: Comment create request.
        :param str project: Project ID or project name
        :param int work_item_id: Id of a work item.
        :param str format: Format of a work item comment (Markdown or Html).
        :rtype: :class:`<Comment> <azure.devops.v7_1.work_item_tracking.models.Comment>`
        """
        route_values = {}
        if project is not None:
    ...
    def get_comments(self, project, work_item_id, top=None, continuation_token=None, include_deleted=None, expand=None, order=None):
        ...
        :rtype: :class:`<CommentList> <azure.devops.v7_1.work_item_tracking.models.CommentList>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_comment(self, request, project, work_item_id, comment_id):
        ...
        :param :class:`<CommentUpdate> <azure.devops.v7_1.work_item_tracking.models.CommentUpdate>` request: Comment update request.
        :param str project: Project ID or project name
        :param int work_item_id: Id of a work item.
        :param int comment_id:
        :rtype: :class:`<Comment> <azure.devops.v7_1.work_item_tracking.models.Comment>`
    ...
    def update_work_item_comment(self, request, project, work_item_id, comment_id, format):
    ...
    def create_comment_reaction(self, project, work_item_id, comment_id, reaction_type):
        ...
        :param int comment_id: Comment ID
        :param CommentReactionType reaction_type: Type of the reaction
        :rtype: :class:`<CommentReaction> <azure.devops.v7_1.work_item_tracking.models.CommentReaction>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_comment_version(self, project, work_item_id, comment_id, version):
        ...
        :param int comment_id:
        :param int version:
        :rtype: :class:`<CommentVersion> <azure.devops.v7_1.work_item_tracking.models.CommentVersion>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_work_item_field(self, work_item_field, project=None):
        """CreateWorkItemField.
        [Preview API] Create a new field.
        :param :class:`<WorkItemField2> <azure.devops.v7_1.work_item_tracking.models.WorkItemField2>` work_item_field: New field definition
        :param str project: Project ID or project name
        :rtype: :class:`<WorkItemField2> <azure.devops.v7_1.work_item_tracking.models.WorkItemField2>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
        content = self._serialize.body(work_item_field, 'WorkItemField2')
        response = self._send(http_method='POST',
                              location_id='b51fd764-e5c2-4b9b-aaf7-3395cf4bdd94',
                              version='7.1-preview.3',
                              route_values=route_values,
                              content=content)
        return self._deserialize('WorkItemField2', response)

    def delete_work_item_field(self, field_name_or_ref_name, project=None):
        """DeleteWorkItemField.
    ...
    def get_work_item_field(self, field_name_or_ref_name, project=None):
        """GetWorkItemField.
    ...
    def get_work_item_fields(self, project=None, expand=None):
        """GetWorkItemFields.
        ...
        response = self._send(http_method='GET',
                              ...
                              route_values=route_values,
                              query_parameters=query_parameters)
        return self._deserialize('[WorkItemField2]', self._unwrap_collection(response))

    def update_work_item_field(self, payload, field_name_or_ref_name, project=None):
        """UpdateWorkItemField.
        [Preview API] Update a field.
        :param :class:`<FieldUpdate> <azure.devops.v7_1.work_item_tracking.models.FieldUpdate>` payload: Payload contains desired value of the field's properties
        ...
        if field_name_or_ref_name is not None:
            route_values['fieldNameOrRefName'] = self._serialize.url('field_name_or_ref_name', field_name_or_ref_name, 'str')
        content = self._serialize.body(payload, 'FieldUpdate')
        response = self._send(http_method='PATCH',
                              location_id='b51fd764-e5c2-4b9b-aaf7-3395cf4bdd94',
                              version='7.1-preview.3',
                              route_values=route_values,
    ...
    def get_github_connection_repositories(self, project, connection_id):
        """GetGithubConnectionRepositories.
        [Preview API] Gets a list of repos within specified github connection.
        :param str project: Project ID or project name
        :param str connection_id:
        :rtype: [GitHubConnectionRepoModel]
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
        if connection_id is not None:
            route_values['connectionId'] = self._serialize.url('connection_id', connection_id, 'str')
        response = self._send(http_method='GET',
                              location_id='0b3a5212-f65b-2102-0d80-1dd77ce4c700',
                              version='7.1-preview.1',
                              route_values=route_values)
        return self._deserialize('[GitHubConnectionRepoModel]', self._unwrap_collection(response))

    def update_github_connection_repos(self, repos_operation_data, project, connection_id):
        """UpdateGithubConnectionRepos.
        [Preview API] Add/remove list of repos within specified github connection.
        :param :class:`<GitHubConnectionReposBatchRequest> <azure.devops.v7_1.work_item_tracking.models.GitHubConnectionReposBatchRequest>` repos_operation_data:
        :param str project: Project ID or project name
        :param str connection_id:
        :rtype: [GitHubConnectionRepoModel]
        """
        ...
        if connection_id is not None:
            route_values['connectionId'] = self._serialize.url('connection_id', connection_id, 'str')
        content = self._serialize.body(repos_operation_data, 'GitHubConnectionReposBatchRequest')
        response = self._send(http_method='POST',
                              location_id='15b19676-8d9e-e224-d795-ca4d1a18024d',
                              version='7.1-preview.1',
                              route_values=route_values,
                              content=content)
        return self._deserialize('[GitHubConnectionRepoModel]', self._unwrap_collection(response))

    def get_github_connections(self, project):
        """GetGithubConnections.
        [Preview API] Gets a list of github connections
        :param str project: Project ID or project name
        :rtype: [GitHubConnectionModel]
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
        response = self._send(http_method='GET',
                              location_id='0cf95f86-6ce1-f410-ccf6-3d8c92b3a1ef',
                              version='7.1-preview.1',
                              route_values=route_values)
        return self._deserialize('[GitHubConnectionModel]', self._unwrap_collection(response))
    ...
    def migrate_projects_process(self, new_process, project):
        ...
        :param :class:`<ProcessIdModel> <azure.devops.v7_1.work_item_tracking.models.ProcessIdModel>` new_process:
        :param str project: Project ID or project name
        :rtype: :class:`<ProcessMigrationResultModel> <azure.devops.v7_1.work_item_tracking.models.ProcessMigrationResultModel>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_query(self, posted_query, project, query, validate_wiql_only=None):
        ...
        :param :class:`<QueryHierarchyItem> <azure.devops.v7_1.work_item_tracking.models.QueryHierarchyItem>` posted_query: The query to create.
        :param str project: Project ID or project name
        ...
        :rtype: :class:`<QueryHierarchyItem> <azure.devops.v7_1.work_item_tracking.models.QueryHierarchyItem>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def search_queries(self, project, filter, top=None, expand=None, include_deleted=None):
        ...
        :param str expand:
        :param bool include_deleted: Include deleted queries and folders
        :rtype: :class:`<QueryHierarchyItemsResult> <azure.devops.v7_1.work_item_tracking.models.QueryHierarchyItemsResult>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_query(self, query_update, project, query, undelete_descendants=None):
        ...
        :param :class:`<QueryHierarchyItem> <azure.devops.v7_1.work_item_tracking.models.QueryHierarchyItem>` query_update: The query to update.
        :param str project: Project ID or project name
    ...
    def get_queries_batch(self, query_get_request, project):
        ...
        :param :class:`<QueryBatchGetRequest> <azure.devops.v7_1.work_item_tracking.models.QueryBatchGetRequest>` query_get_request:
        :param str project: Project ID or project name
        :rtype: [QueryHierarchyItem]
        """
        route_values = {}
    ...
    def get_deleted_work_item(self, id, project=None):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<WorkItemDelete> <azure.devops.v7_1.work_item_tracking.models.WorkItemDelete>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def restore_work_item(self, payload, id, project=None):
        ...
        :param :class:`<WorkItemDeleteUpdate> <azure.devops.v7_1.work_item_tracking.models.WorkItemDeleteUpdate>` payload: Paylod with instructions to update the IsDeleted flag to false
    ...
    def get_revision(self, id, revision_number, project=None, expand=None):
        ...
        :param str project: Project ID or project name
        :param str expand:
        :rtype: :class:`<WorkItem> <azure.devops.v7_1.work_item_tracking.models.WorkItem>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def send_mail(self, body, project=None):
        ...
        :param :class:`<SendMailBody> <azure.devops.v7_1.work_item_tracking.models.SendMailBody>` body:
        :param str project: Project ID or project name
        """
        route_values = {}
        if project is not None:
    ...
    def get_tag(self, project, tag_id_or_name):
        ...
        :param str project: Project ID or project name
        :param str tag_id_or_name:
        :rtype: :class:`<WorkItemTagDefinition> <azure.devops.v7_1.work_item_tracking.models.WorkItemTagDefinition>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_tag(self, tag_data, project, tag_id_or_name):
        """UpdateTag.
        [Preview API]
        :param :class:`<WorkItemTagDefinition> <azure.devops.v7_1.work_item_tracking.models.WorkItemTagDefinition>` tag_data:
        :param str project: Project ID or project name
        :param str tag_id_or_name:
        :rtype: :class:`<WorkItemTagDefinition> <azure.devops.v7_1.work_item_tracking.models.WorkItemTagDefinition>`
        """
    ...
    def create_template(self, template, team_context):
        ...
        :param :class:`<WorkItemTemplate> <azure.devops.v7_1.work_item_tracking.models.WorkItemTemplate>` template: Template contents
        :param :class:`<TeamContext> <azure.devops.v7_1.work_item_tracking.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<WorkItemTemplate> <azure.devops.v7_1.work_item_tracking.models.WorkItemTemplate>`
        """
        project = None
        team = None
    ...
    def replace_template(self, template_content, team_context, template_id):
        ...
        :param :class:`<WorkItemTemplate> <azure.devops.v7_1.work_item_tracking.models.WorkItemTemplate>` template_content: Template contents to replace with
        :param :class:`<TeamContext> <azure.devops.v7_1.work_item_tracking.models.TeamContext>` team_context: The team context for the operation
        :param str template_id: Template id
        :rtype: :class:`<WorkItemTemplate> <azure.devops.v7_1.work_item_tracking.models.WorkItemTemplate>`
        """
    ...
    def create_temp_query(self, posted_query, project):
        """CreateTempQuery.
        [Preview API] Creates a temporary query
        :param :class:`<TemporaryQueryRequestModel> <azure.devops.v7_1.work_item_tracking.models.TemporaryQueryRequestModel>` posted_query: The temporary query to create
        :param str project: Project ID or project name
        :rtype: :class:`<TemporaryQueryResponseModel> <azure.devops.v7_1.work_item_tracking.models.TemporaryQueryResponseModel>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
        content = self._serialize.body(posted_query, 'TemporaryQueryRequestModel')
        response = self._send(http_method='POST',
                              location_id='9f614388-a9f0-4952-ad6c-89756bd8e388',
                              version='7.1-preview.1',
                              route_values=route_values,
                              content=content)
        return self._deserialize('TemporaryQueryResponseModel', response)
    ...
    def get_update(self, id, update_number, project=None):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<WorkItemUpdate> <azure.devops.v7_1.work_item_tracking.models.WorkItemUpdate>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def query_by_wiql(self, wiql, team_context=None, time_precision=None, top=None):
        ...
        :param :class:`<Wiql> <azure.devops.v7_1.work_item_tracking.models.Wiql>` wiql: The query containing the WIQL.
        :param :class:`<TeamContext> <azure.devops.v7_1.work_item_tracking.models.TeamContext>` team_context: The team context for the operation
        :param bool time_precision: Whether or not to use time precision.
        :param int top: The max number of results to return.
        :rtype: :class:`<WorkItemQueryResult> <azure.devops.v7_1.work_item_tracking.models.WorkItemQueryResult>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def get_work_item_icon_json(self, icon, color=None, v=None):
        ...
        :rtype: :class:`<WorkItemIcon> <azure.devops.v7_1.work_item_tracking.models.WorkItemIcon>`
        """
        route_values = {}
        if icon is not None:
    ...
    def get_reporting_links_by_link_type(self, project=None, link_types=None, types=None, continuation_token=None, start_date_time=None):
        ...
        :rtype: :class:`<ReportingWorkItemLinksBatch> <azure.devops.v7_1.work_item_tracking.models.ReportingWorkItemLinksBatch>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_relation_type(self, relation):
        ...
        :rtype: :class:`<WorkItemRelationType> <azure.devops.v7_1.work_item_tracking.models.WorkItemRelationType>`
        """
        route_values = {}
    ...
    def read_reporting_revisions_get(self, project=None, fields=None, types=None, continuation_token=None, start_date_time=None, include_identity_ref=None, include_deleted=None, include_tag_ref=None, include_latest_only=None, expand=None, include_discussion_changes_only=None, max_page_size=None):
        ...
        :rtype: :class:`<ReportingWorkItemRevisionsBatch> <azure.devops.v7_1.work_item_tracking.models.ReportingWorkItemRevisionsBatch>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def read_reporting_revisions_post(self, filter, project=None, continuation_token=None, start_date_time=None, expand=None):
        ...
        :param :class:`<ReportingWorkItemRevisionsFilter> <azure.devops.v7_1.work_item_tracking.models.ReportingWorkItemRevisionsFilter>` filter: An object that contains request settings: field filter, type filter, identity format
        :param str project: Project ID or project name
        :param str continuation_token: Specifies the watermark to start the batch from. Omit this parameter to get the first batch of revisions.
        :param datetime start_date_time: Date/time to use as a starting point for revisions, all revisions will occur after this date/time. Cannot be used in conjunction with 'watermark' parameter.
        :param str expand:
    ...
    def create_work_item(self, document, project, type, validate_only=None, bypass_rules=None, suppress_notifications=None, expand=None):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_1.work_item_tracking.models.[JsonPatchOperation]>` document: The JSON Patch document representing the work item
        :param str project: Project ID or project name
    ...
    def update_work_item(self, document, id, project=None, validate_only=None, bypass_rules=None, suppress_notifications=None, expand=None):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_1.work_item_tracking.models.[JsonPatchOperation]>` document: The JSON Patch document representing the update
    ...
    def get_work_items_batch(self, work_item_get_request, project=None):
        ...
        :param :class:`<WorkItemBatchGetRequest> <azure.devops.v7_1.work_item_tracking.models.WorkItemBatchGetRequest>` work_item_get_request:
        :param str project: Project ID or project name
        :rtype: [WorkItem]
        """
        route_values = {}
    ...
    def delete_work_items(self, delete_request, project=None):
        """DeleteWorkItems.
        ...
        :param :class:`<WorkItemDeleteBatchRequest> <azure.devops.v7_1.work_item_tracking.models.WorkItemDeleteBatchRequest>` delete_request:
        :param str project: Project ID or project name
        :rtype: :class:`<WorkItemDeleteBatch> <azure.devops.v7_1.work_item_tracking.models.WorkItemDeleteBatch>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
        content = self._serialize.body(delete_request, 'WorkItemDeleteBatchRequest')
        response = self._send(http_method='POST',
                              location_id='8bc57545-27e5-420d-b709-f6e3ebcc1fc1',
                              version='7.1-preview.1',
                              route_values=route_values,
                              content=content)
        return self._deserialize('WorkItemDeleteBatch', response)
    ...
    def get_work_item_type_category(self, project, category):
        ...
        :rtype: :class:`<WorkItemTypeCategory> <azure.devops.v7_1.work_item_tracking.models.WorkItemTypeCategory>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_work_item_type(self, project, type):
        ...
        :rtype: :class:`<WorkItemType> <azure.devops.v7_1.work_item_tracking.models.WorkItemType>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_work_item_type_field_with_references(self, project, type, field, expand=None):
        ...
        :param str field:
        :param str expand: Expand level for the API response. Properties: to include allowedvalues, default value, isRequired etc. as a part of response; None: to skip these properties.
        :rtype: :class:`<WorkItemTypeFieldWithReferences> <azure.devops.v7_1.work_item_tracking.models.WorkItemTypeFieldWithReferences>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
