...
class CreatePipelineConnectionInputs(Model):
    ...
    :type project: :class:`TeamProject <azure.devops.v7_1.pipelines.models.TeamProject>`
...
class DetectedBuildFramework(Model):
    ...
    :type build_targets: list of :class:`DetectedBuildTarget <azure.devops.v7_1.pipelines.models.DetectedBuildTarget>`
...
class ResourceCreationParameter(Model):
    ...
    :type resource_to_create: :class:`object <azure.devops.v7_1.pipelines.models.object>`
    :param type:
    :type type: str
    """
...
class Operation(OperationReference):
    ...
    :param result_url: URL to the operation result.
    :type result_url: :class:`OperationResultReference <azure.devops.v7_1.microsoft._visual_studio._services._web_api.models.OperationResultReference>`
    """
...
class TeamProject(TeamProjectReference):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_1.microsoft._team_foundation._core._web_api.models.ReferenceLinks>`
    ...
    :type default_team: :class:`WebApiTeamRef <azure.devops.v7_1.microsoft._team_foundation._core._web_api.models.WebApiTeamRef>`
    """
