...
class BoardResult(Model):
    ...
    :type collection: :class:`Collection <azure.devops.v7_0.search.models.Collection>`
    :param project: Project details of the board document.
    :type project: :class:`Project <azure.devops.v7_0.search.models.Project>`
    :param team: Team details of the board document.
    :type team: :class:`Team <azure.devops.v7_0.search.models.Team>`
    """
...
class CodeResult(Model):
    ...
    :type repository: :class:`Repository <azure.devops.v7_0.search.models.Repository>`
    :param versions: Versions of the result file.
    :type versions: list of :class:`Version <azure.devops.v7_0.search.models.Version>`
    """
...
class CustomRepositoryStatusResponse(Model):
    ...
    :type indexed_top_level_folders: list of :class:`DepotInfo <azure.devops.v7_0.search.models.DepotInfo>`
...
class DepotInfo(Model):
    ...
    :type indexed_branches: list of :class:`BranchInfo <azure.devops.v7_0.search.models.BranchInfo>`
...
class PackageResult(Model):
    ...
    :type feeds: list of :class:`FeedInfo <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.FeedInfo>`
    :param hits: List of highlighted fields for the match.
    :type hits: list of :class:`PackageHit <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.PackageHit>`
...
class PackageSearchResponse(Model):
    ...
    :param content:
    :type content: :class:`PackageSearchResponseContent <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.PackageSearchResponseContent>`
    """
...
class PackageSearchResponseContent(EntitySearchResponse):
    ...
    :type results: list of :class:`PackageResult <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.PackageResult>`
    """
...
class SettingSearchResponse(EntitySearchResponse):
    ...
    :type results: list of :class:`SettingResult <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.SettingResult>`
    """
...
class TfvcRepositoryStatusResponse(Model):
    ...
    :type indexing_information: list of :class:`BranchInfo <azure.devops.v7_0.search.models.BranchInfo>`
    :param name: Repository Name.
    :type name: str
    """
...
class WikiResult(Model):
    ...
    :param collection: Collection of the result file.
    :type collection: :class:`Collection <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.Collection>`
    :param content_id: ContentId of the result file.
    :type content_id: str
    :param file_name: Name of the result file.
    :type file_name: str
    :param hits: Highlighted snippets of fields that match the search request. The list is sorted by relevance of the snippets.
    :type hits: list of :class:`WikiHit <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.WikiHit>`
    :param path: Path at which result file is present.
    :type path: str
    :param project: Project details of the wiki document.
    :type project: :class:`ProjectReference <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.ProjectReference>`
    :param wiki: Wiki information for the result.
    :type wiki: :class:`Wiki <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.Wiki>`
    """
...
class WikiSearchResponse(EntitySearchResponse):
    ...
    :type results: list of :class:`WikiResult <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.WikiResult>`
    """
...
class WorkItemResult(Model):
    ...
    :type fields: dict
    :param hits: Highlighted snippets of fields that match the search request. The list is sorted by relevance of the snippets.
    :type hits: list of :class:`WorkItemHit <azure.devops.v7_0.search.models.WorkItemHit>`
...
class WorkItemSearchResponse(EntitySearchResponse):
    ...
    :type results: list of :class:`WorkItemResult <azure.devops.v7_0.search.models.WorkItemResult>`
    """
...
class BoardSearchResponse(EntitySearchResponse):
    ...
    :type results: list of :class:`BoardResult <azure.devops.v7_0.search.models.BoardResult>`
    """
...
class CodeSearchResponse(EntitySearchResponse):
    ...
    :type results: list of :class:`CodeResult <azure.devops.v7_0.search.models.CodeResult>`
    """
...
class EntitySearchRequest(EntitySearchRequestBase):
    ...
    :type order_by: list of :class:`SortOption <azure.devops.v7_0.microsoft._visual_studio._services._search._shared._web_api.models.SortOption>`
...
class WorkItemSearchRequest(EntitySearchRequest):
    ...
    :type search_text: str
    :param order_by: Options for sorting search results. If set to null, the results will be returned sorted by relevance. If more than one sort option is provided, the results are sorted in the order specified in the OrderBy.
    :type order_by: list of :class:`SortOption <azure.devops.v7_0.search.models.SortOption>`
    :param skip: Number of results to be skipped.
    :type skip: int
    :param top: Number of results to be returned.
    :type top: int
