...
class TestResultsClient(Client):
    ...
    def update_test_results_meta_data(self, test_result_meta_data_update_input, project, test_case_reference_id):
        ...
        :param :class:`<TestResultMetaDataUpdateInput> <azure.devops.v7_0.test_results.models.TestResultMetaDataUpdateInput>` test_result_meta_data_update_input: TestResultMetaData update input TestResultMetaDataUpdateInput
        :param str project: Project ID or project name
        :param int test_case_reference_id: TestCaseReference Id of Test Result to be updated.
        :rtype: :class:`<TestResultMetaData> <azure.devops.v7_0.test_results.models.TestResultMetaData>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_test_result_logs(self, project, run_id, result_id, type, directory_path=None, file_name_prefix=None, fetch_meta_data=None, top=None, continuation_token=None):
        ...
        :rtype: :class:`<[TestLog]> <azure.devops.v7_0.test_results.models.[TestLog]>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_test_log_store_endpoint_details_for_result_log(self, project, run_id, result_id, type, file_path):
        ...
        :rtype: :class:`<TestLogStoreEndpointDetails> <azure.devops.v7_0.test_results.models.TestLogStoreEndpointDetails>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
