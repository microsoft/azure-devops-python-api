...
class AggregatedDataForResultTrend(Model):
    ...
    :type test_results_context: :class:`TestResultsContext <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultsContext>`
    :param total_tests:
...
class AggregatedResultsAnalysis(Model):
    ...
    :type previous_context: :class:`TestResultsContext <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultsContext>`
    :param results_by_outcome:
    :type results_by_outcome: dict
    :param results_difference:
    :type results_difference: :class:`AggregatedResultsDifference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.AggregatedResultsDifference>`
...
class BuildConfiguration(Model):
    ...
    :type project: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
...
class BuildCoverage(Model):
    ...
    :type configuration: :class:`BuildConfiguration <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.BuildConfiguration>`
    :param last_error: Last Error
    :type last_error: str
    :param modules: List of Modules
    :type modules: list of :class:`ModuleCoverage <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ModuleCoverage>`
    :param state: State
    :type state: str
    """
...
class CodeCoverageData(Model):
    ...
    :type coverage_stats: list of :class:`CodeCoverageStatistics <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.CodeCoverageStatistics>`
    """
...
class CodeCoverageSummary(Model):
    ...
    :type build: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param coverage_data: List of coverage data and details for the build
    :type coverage_data: list of :class:`CodeCoverageData <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.CodeCoverageData>`
    :param delta_build: Uri of build against which difference in coverage is computed
    :type delta_build: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
...
class FailingSince(Model):
    ...
    :type build: :class:`BuildReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.BuildReference>`
    :param date: Time since failing(UTC).
    :type date: datetime
    :param release: Release reference since failing.
    :type release: :class:`ReleaseReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ReleaseReference>`
    """
...
class FlakyDetection(Model):
    ...
    :type flaky_detection_pipelines: :class:`FlakyDetectionPipelines <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.FlakyDetectionPipelines>`
...
class FlakySettings(Model):
    ...
    :type flaky_detection: :class:`FlakyDetection <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.FlakyDetection>`
...
class FunctionCoverage(Model):
    ...
    :param statistics:
    :type statistics: :class:`CoverageStatistics <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.CoverageStatistics>`
    """
...
class GraphSubjectBase(Model):
    """
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ReferenceLinks>`
    :param descriptor:
    :type descriptor: str
    :param display_name:
...
class ModuleCoverage(Model):
    ...
    :type file_url: str
    :param functions:
    :type functions: list of :class:`FunctionCoverage <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.FunctionCoverage>`
    :param name:
    :type name: str
    :param signature:
    :type signature: str
...
class PipelineReference(Model):
    ...
    :type job_reference: :class:`JobReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.JobReference>`
    :param phase_reference: Reference of the phase.
    :type phase_reference: :class:`PhaseReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.PhaseReference>`
    ...
    :type stage_reference: :class:`StageReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.StageReference>`
    """
...
class PipelineTestMetrics(Model):
    ...
    :type current_context: :class:`PipelineReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.PipelineReference>`
    ...
    :type results_analysis: :class:`ResultsAnalysis <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ResultsAnalysis>`
    :param result_summary: This is the return value for metric ResultSummary Results summary based on results outcome.
    :type result_summary: :class:`ResultSummary <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ResultSummary>`
    :param run_summary: This is the return value for metric RunSummary Run summary.
    :type run_summary: :class:`RunSummary <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.RunSummary>`
    :param summary_at_child: Summary at child node.
    :type summary_at_child: list of :class:`PipelineTestMetrics <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.PipelineTestMetrics>`
    """
...
class ResultsAnalysis(Model):
    ...
    :type previous_context: :class:`PipelineReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.PipelineReference>`
    ...
    :type test_failures_analysis: :class:`TestResultFailuresAnalysis <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultFailuresAnalysis>`
    """
...
class RunCreateModel(Model):
    ...
    :type build_reference: :class:`BuildConfiguration <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.BuildConfiguration>`
    ...
    :type custom_test_fields: list of :class:`CustomTestField <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.CustomTestField>`
    :param dtl_aut_environment: An abstracted reference to DtlAutEnvironment.
    :type dtl_aut_environment: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param dtl_test_environment: An abstracted reference to DtlTestEnvironment.
    :type dtl_test_environment: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param due_date: Due date and time for test run.
    :type due_date: str
    :param environment_details:
    :type environment_details: :class:`DtlEnvironmentDetails <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.DtlEnvironmentDetails>`
    :param error_message: Error message associated with the run.
    :type error_message: str
    :param filter: Filter used for discovering the Run.
    :type filter: :class:`RunFilter <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.RunFilter>`
    ...
    :type owner: :class:`IdentityRef <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.IdentityRef>`
    ...
    :type pipeline_reference: :class:`PipelineReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.PipelineReference>`
    :param plan: An abstracted reference to the plan that it belongs.
    :type plan: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    ...
    :type release_reference: :class:`ReleaseReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ReleaseReference>`
    ...
    :type run_summary: list of :class:`RunSummaryModel <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.RunSummaryModel>`
    ...
    :type tags: list of :class:`TestTag <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestTag>`
    ...
    :type test_settings: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
...
class RunStatistic(Model):
    ...
    :type resolution_state: :class:`TestResolutionState <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResolutionState>`
...
class RunUpdateModel(Model):
    ...
    :type dtl_environment: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param dtl_environment_details:
    :type dtl_environment_details: :class:`DtlEnvironmentDetails <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.DtlEnvironmentDetails>`
    :param due_date: Due date and time for test run.
    :type due_date: str
    :param error_message: Error message associated with the run.
    :type error_message: str
    ...
    :type log_entries: list of :class:`TestMessageLogDetails <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestMessageLogDetails>`
    :param name: Name of the test run.
    :type name: str
    :param release_environment_uri: URI of release environment associated with the run.
    :type release_environment_uri: str
...
class TestCaseResult(Model):
    ...
    :type area: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param associated_bugs: Reference to bugs linked to test result.
    :type associated_bugs: list of :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    ...
    :type build_reference: :class:`BuildReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.BuildReference>`
    ...
    :type configuration: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param created_date: Timestamp when test result created(UTC).
    :type created_date: datetime
    :param custom_fields: Additional properties of test result.
    :type custom_fields: list of :class:`CustomTestField <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.CustomTestField>`
    ...
    :type failing_since: :class:`FailingSince <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.FailingSince>`
    ...
    :type iteration_details: list of :class:`TestIterationDetailsModel <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestIterationDetailsModel>`
    :param last_updated_by: Reference to identity last updated test result.
    :type last_updated_by: :class:`IdentityRef <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.IdentityRef>`
    ...
    :type release: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    ...
    :type run_by: :class:`IdentityRef <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.IdentityRef>`
    ...
    :type sub_results: list of :class:`TestSubResult <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestSubResult>`
    :param test_case: Reference to the test executed.
    :type test_case: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    ...
    :type test_plan: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param test_point: Reference to the test point executed.
    :type test_point: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param test_run: Reference to test run.
    :type test_run: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
    :param test_suite: Reference to test suite test case workitem is part of.
    :type test_suite: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
...
class TestFailureDetails(Model):
    ...
    :type count: int
    :param test_results:
    :type test_results: list of :class:`TestCaseResultIdentifier <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestCaseResultIdentifier>`
    """
...
class TestFailuresAnalysis(Model):
    ...
    :type existing_failures: :class:`TestFailureDetails <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestFailureDetails>`
    :param fixed_tests:
    :type fixed_tests: :class:`TestFailureDetails <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestFailureDetails>`
    :param new_failures:
    :type new_failures: :class:`TestFailureDetails <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestFailureDetails>`
    :param previous_context:
    :type previous_context: :class:`TestResultsContext <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultsContext>`
    """
...
class TestHistoryQuery(Model):
    ...
    :type results_for_group: list of :class:`TestResultHistoryForGroup <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultHistoryForGroup>`
...
class TestIterationDetailsModel(Model):
    ...
    :type action_results: list of :class:`TestActionResultModel <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestActionResultModel>`
    :param attachments: Reference to attachments in test iteration result.
    :type attachments: list of :class:`TestCaseResultAttachmentModel <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestCaseResultAttachmentModel>`
    ...
    :type parameters: list of :class:`TestResultParameterModel <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultParameterModel>`
...
class TestLog(Model):
    ...
    :type log_reference: :class:`TestLogReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestLogReference>`
...
class TestResultDocument(Model):
    ...
    :type operation_reference: :class:`TestOperationReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestOperationReference>`
    :param payload:
    :type payload: :class:`TestResultPayload <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultPayload>`
    """
...
class TestResultHistory(Model):
    ...
    :type results_for_group: list of :class:`TestResultHistoryDetailsForGroup <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultHistoryDetailsForGroup>`
    """
...
class TestResultHistoryDetailsForGroup(Model):
    ...
    :type group_by_value: object
    :param latest_result:
    :type latest_result: :class:`TestCaseResult <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestCaseResult>`
    """
...
class TestResultHistoryForGroup(Model):
    ...
    :type results: list of :class:`TestCaseResult <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestCaseResult>`
    """
...
class TestResultMetaData(Model):
    ...
    :type flaky_identifiers: list of :class:`TestFlakyIdentifier <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestFlakyIdentifier>`
...
class TestResultsDetails(Model):
    ...
    :type group_by_field: str
    :param results_for_group:
    :type results_for_group: list of :class:`TestResultsDetailsForGroup <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultsDetailsForGroup>`
    """
...
class TestResultsQuery(Model):
    ...
    :type results_filter: :class:`ResultsFilter <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ResultsFilter>`
    """
...
class TestResultsSettings(Model):
    ...
    :type flaky_settings: :class:`FlakySettings <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.FlakySettings>`
    :param new_test_result_logging_settings:
    :type new_test_result_logging_settings: :class:`NewTestResultLoggingSettings <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.NewTestResultLoggingSettings>`
    """
...
class TestResultSummary(Model):
    ...
    :type aggregated_results_analysis: :class:`AggregatedResultsAnalysis <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.AggregatedResultsAnalysis>`
    :param no_config_runs_count:
    :type no_config_runs_count: int
    :param team_project:
    :type team_project: :class:`TeamProjectReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TeamProjectReference>`
    :param test_failures:
    :type test_failures: :class:`TestFailuresAnalysis <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestFailuresAnalysis>`
    :param test_results_context:
    :type test_results_context: :class:`TestResultsContext <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestResultsContext>`
...
class TestRun(Model):
    ...
    :type build_configuration: :class:`BuildConfiguration <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.BuildConfiguration>`
    :param comment: Comments entered by those analyzing the run.
    :type comment: str
    :param completed_date: Completed date time of the run.
    :type completed_date: datetime
    ...
    :type dtl_environment_creation_details: :class:`DtlEnvironmentDetails <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.DtlEnvironmentDetails>`
    :param due_date: Due date and time for test run.
    ...
    :type run_statistics: list of :class:`RunStatistic <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.RunStatistic>`
    :param started_date: Start date time of the run.
    :type started_date: datetime
    ...
    :type test_environment: :class:`TestEnvironment <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestEnvironment>`
...
class TestRunStatistic(Model):
    ...
    :param run:
    :type run: :class:`ShallowReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.ShallowReference>`
...
class TestSubResult(Model):
    ...
    :type test_result: :class:`TestCaseResultIdentifier <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestCaseResultIdentifier>`
...
class TestSummaryForWorkItem(Model):
    """
    :param summary:
    :type summary: :class:`AggregatedDataForResultTrend <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.AggregatedDataForResultTrend>`
    :param work_item:
    :type work_item: :class:`WorkItemReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.WorkItemReference>`
    """
...
class TestToWorkItemLinks(Model):
    """
    :param test:
    :type test: :class:`TestMethod <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestMethod>`
    :param work_items:
    :type work_items: list of :class:`WorkItemReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.WorkItemReference>`
    """
...
class WorkItemToTestLinks(Model):
    ...
    :type executed_in: object
    :param tests:
    :type tests: list of :class:`TestMethod <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.TestMethod>`
    :param work_item:
    :type work_item: :class:`WorkItemReference <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.WorkItemReference>`
    """
...
class TestActionResultModel(TestResultModelBase):
    ...
    :type shared_step_model: :class:`SharedStepModel <azure.devops.v7_0.microsoft._team_foundation._test_management._web_api.models.SharedStepModel>`
    :param step_identifier: This is step Id of test case. For shared step, it is step Id of shared step in test case workitem; step Id in shared step. Example: TestCase workitem has two steps: 1) Normal step with Id = 1 2) Shared Step with Id = 2. Inside shared step: a) Normal Step with Id = 1 Value for StepIdentifier for First step: "1" Second step: "2;1"
    :type step_identifier: str
