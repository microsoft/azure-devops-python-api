...
class PipelinesChecksClient(Client):
    ...
    def add_check_configuration(self, configuration, project):
        ...
        :param :class:`<CheckConfiguration> <azure.devops.v7_0.pipelines_checks.models.CheckConfiguration>` configuration:
        :param str project: Project ID or project name
        :rtype: :class:`<CheckConfiguration> <azure.devops.v7_0.pipelines_checks.models.CheckConfiguration>`
        """
        route_values = {}
    ...
    def update_check_configuration(self, configuration, project, id):
        ...
        :param :class:`<CheckConfiguration> <azure.devops.v7_0.pipelines_checks.models.CheckConfiguration>` configuration: check configuration
        :param str project: Project ID or project name
        :param int id: check configuration id
        :rtype: :class:`<CheckConfiguration> <azure.devops.v7_0.pipelines_checks.models.CheckConfiguration>`
        """
    ...
    def evaluate_check_suite(self, request, project, expand=None):
        ...
        :param :class:`<CheckSuiteRequest> <azure.devops.v7_0.pipelines_checks.models.CheckSuiteRequest>` request:
        :param str project: Project ID or project name
        :param str expand:
        :rtype: :class:`<CheckSuite> <azure.devops.v7_0.pipelines_checks.models.CheckSuite>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
