...
class GitRepository(Model):
    """
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_0.microsoft._team_foundation._source_control._web_api.models.ReferenceLinks>`
    ...
    :type parent_repository: :class:`GitRepositoryRef <azure.devops.v7_0.microsoft._team_foundation._source_control._web_api.models.GitRepositoryRef>`
    :param project:
    :type project: :class:`TeamProjectReference <azure.devops.v7_0.microsoft._team_foundation._source_control._web_api.models.TeamProjectReference>`
    :param remote_url:
    :type remote_url: str
...
class GitRepositoryRef(Model):
    ...
    :type collection: :class:`TeamProjectCollectionReference <azure.devops.v7_0.microsoft._team_foundation._source_control._web_api.models.TeamProjectCollectionReference>`
    :param id:
    :type id: str
    :param is_fork: True if the repository was created as a fork
    :type is_fork: bool
...
class WikiAttachmentResponse(Model):
    ...
    :type attachment: :class:`WikiAttachment <azure.devops.v7_0.wiki.models.WikiAttachment>`
...
class WikiCreateParametersV2(WikiCreateBaseParameters):
    ...
    :type version: :class:`GitVersionDescriptor <azure.devops.v7_0.wiki.models.GitVersionDescriptor>`
    """
...
class WikiPageDetail(Model):
    ...
    :type view_stats: list of :class:`WikiPageStat <azure.devops.v7_0.wiki.models.WikiPageStat>`
    """
...
class WikiPageMoveResponse(Model):
    ...
    :type page_move: :class:`WikiPageMove <azure.devops.v7_0.wiki.models.WikiPageMove>`
    """
...
class WikiPageResponse(Model):
    ...
    :type page: :class:`WikiPage <azure.devops.v7_0.wiki.models.WikiPage>`
    """
...
class WikiUpdateParameters(Model):
    ...
    :type versions: list of :class:`GitVersionDescriptor <azure.devops.v7_0.wiki.models.GitVersionDescriptor>`
    """
...
class Comment(CommentResourceReference):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v7_0.microsoft._azure._dev_ops._comments._web_api.models.IdentityRef>`
    ...
    :type mentions: list of :class:`CommentMention <azure.devops.v7_0.microsoft._azure._dev_ops._comments._web_api.models.CommentMention>`
    :param modified_by: IdentityRef of the user who last modified the comment.
    :type modified_by: :class:`IdentityRef <azure.devops.v7_0.microsoft._azure._dev_ops._comments._web_api.models.IdentityRef>`
    ...
    :type reactions: list of :class:`CommentReaction <azure.devops.v7_0.microsoft._azure._dev_ops._comments._web_api.models.CommentReaction>`
    :param rendered_text: The rendered text of the comment
    :type rendered_text: str
    :param replies: Replies for this comment
    :type replies: :class:`CommentList <azure.devops.v7_0.microsoft._azure._dev_ops._comments._web_api.models.CommentList>`
...
class CommentList(CommentResourceReference):
    ...
    :type comments: list of :class:`Comment <azure.devops.v7_0.microsoft._azure._dev_ops._comments._web_api.models.Comment>`
...
class WikiPage(WikiPageCreateOrUpdateParameters):
    ...
    :type sub_pages: list of :class:`WikiPage <azure.devops.v7_0.wiki.models.WikiPage>`
