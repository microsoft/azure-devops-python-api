...
class UPackApiClient(Client):
    ...
    def update_package_versions(self, batch_request, feed_id, project=None):
        ...
        :param :class:`<UPackPackagesBatchRequest> <azure.devops.v7_0.upack_api.models.UPackPackagesBatchRequest>` batch_request: Information about the packages to update, the operation to perform, and its associated data.
    ...
    def update_recycle_bin_package_versions(self, batch_request, feed_id, project=None):
        ...
        :param :class:`<UPackPackagesBatchRequest> <azure.devops.v7_0.upack_api.models.UPackPackagesBatchRequest>` batch_request: Information about the packages to update, the operation to perform, and its associated data. <c>Operation</c> must be <c>PermanentDelete</c> or <c>RestoreToFeed</c>
    ...
    def get_package_version_metadata_from_recycle_bin(self, feed_id, package_name, package_version, project=None):
        ...
        :param str package_version: Version of the package.
        :param str project: Project ID or project name
        :rtype: :class:`<UPackPackageVersionDeletionState> <azure.devops.v7_0.upack_api.models.UPackPackageVersionDeletionState>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def restore_package_version_from_recycle_bin(self, package_version_details, feed_id, package_name, package_version, project=None):
        ...
        :param :class:`<UPackRecycleBinPackageVersionDetails> <azure.devops.v7_0.upack_api.models.UPackRecycleBinPackageVersionDetails>` package_version_details: Set the 'Deleted' property to 'false' to restore the package.
        :param str feed_id: Name or ID of the feed.
        :param str package_name: Name of the package.
        :param str package_version: Version of the package.
        :param str project: Project ID or project name
    ...
    def delete_package_version(self, feed_id, package_name, package_version, project=None):
        ...
        :param str package_version: Version of the package.
        :param str project: Project ID or project name
        :rtype: :class:`<Package> <azure.devops.v7_0.upack_api.models.Package>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_package_version(self, package_version_details, feed_id, package_name, package_version, project=None):
        ...
        :param :class:`<PackageVersionDetails> <azure.devops.v7_0.upack_api.models.PackageVersionDetails>` package_version_details:
        :param str feed_id: Name or ID of the feed.
        :param str package_name: Name of the package.
        :param str package_version: Version of the package.
        :param str project: Project ID or project name
