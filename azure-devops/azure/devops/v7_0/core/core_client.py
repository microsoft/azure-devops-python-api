...
class CoreClient(Client):
    ...
    def set_project_avatar(self, avatar_blob, project_id):
        ...
        :param :class:`<ProjectAvatar> <azure.devops.v7_0.core.models.ProjectAvatar>` avatar_blob: The avatar blob data object to upload.
        :param str project_id: The ID or name of the project.
        """
        route_values = {}
        if project_id is not None:
    ...
    def create_connected_service(self, connected_service_creation_data, project_id):
        ...
        [Preview API]
        :param :class:`<WebApiConnectedServiceDetails> <azure.devops.v7_0.core.models.WebApiConnectedServiceDetails>` connected_service_creation_data:
        :param str project_id:
        :rtype: :class:`<WebApiConnectedService> <azure.devops.v7_0.core.models.WebApiConnectedService>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def get_connected_service_details(self, project_id, name):
        ...
        :param str project_id:
        :param str name:
        :rtype: :class:`<WebApiConnectedServiceDetails> <azure.devops.v7_0.core.models.WebApiConnectedServiceDetails>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def get_process_by_id(self, process_id):
        ...
        :rtype: :class:`<Process> <azure.devops.v7_0.core.models.Process>`
        """
        route_values = {}
    ...
    def get_project_collection(self, collection_id):
        ...
        :rtype: :class:`<TeamProjectCollection> <azure.devops.v7_0.core.models.TeamProjectCollection>`
        """
        route_values = {}
    ...
    def get_project(self, project_id, include_capabilities=None, include_history=None):
        ...
        :rtype: :class:`<TeamProject> <azure.devops.v7_0.core.models.TeamProject>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def get_projects(self, state_filter=None, top=None, skip=None, continuation_token=None, get_default_team_image_url=None):
        ...
        :rtype: :class:`<[TeamProjectReference]> <azure.devops.v7_0.core.models.[TeamProjectReference]>`
        """
        query_parameters = {}
    ...
    def queue_create_project(self, project_to_create):
        ...
        :param :class:`<TeamProject> <azure.devops.v7_0.core.models.TeamProject>` project_to_create: The project to create.
        :rtype: :class:`<OperationReference> <azure.devops.v7_0.core.models.OperationReference>`
        """
    ...
    def update_project(self, project_update, project_id):
        ...
        :param :class:`<TeamProject> <azure.devops.v7_0.core.models.TeamProject>` project_update: The updates for the project. The state must be set to wellFormed to restore the project.
    ...
    def set_project_properties(self, project_id, patch_document):
        ...
        :param str project_id: The team project ID.
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_0.core.models.[JsonPatchOperation]>` patch_document: A JSON Patch document that represents an array of property operations. See RFC 6902 for more details on JSON Patch. The accepted operation verbs are Add and Remove, where Add is used for both creating and updating properties. The path consists of a forward slash and a property name.
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def create_or_update_proxy(self, proxy):
        """CreateOrUpdateProxy.
        [Preview API]
        :param :class:`<Proxy> <azure.devops.v7_0.core.models.Proxy>` proxy:
        :rtype: :class:`<Proxy> <azure.devops.v7_0.core.models.Proxy>`
        """
    ...
    def create_team(self, team, project_id):
        ...
        :param :class:`<WebApiTeam> <azure.devops.v7_0.core.models.WebApiTeam>` team: The team data used to create the team.
        :param str project_id: The name or ID (GUID) of the team project in which to create the team.
        :rtype: :class:`<WebApiTeam> <azure.devops.v7_0.core.models.WebApiTeam>`
        """
        route_values = {}
        if project_id is not None:
            route_values['projectId'] = self._serialize.url('project_id', project_id, 'str')
    ...
    def update_team(self, team_data, project_id, team_id):
        ...
        :param :class:`<WebApiTeam> <azure.devops.v7_0.core.models.WebApiTeam>` team_data:
