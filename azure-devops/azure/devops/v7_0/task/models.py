...
class PlanEnvironment(Model):
    """
    :param mask:
    :type mask: list of :class:`MaskHint <azure.devops.v7_0.task.models.MaskHint>`
    :param options:
    :type options: dict
    :param variables:
    :type variables: dict
...
class TaskAgentJob(Model):
    ...
    :param steps:
    :type steps: list of :class:`TaskAgentJobStep <azure.devops.v7_0.task.models.TaskAgentJobStep>`
    :param variables:
    :type variables: list of :class:`TaskAgentJobVariable <azure.devops.v7_0.task.models.TaskAgentJobVariable>`
    """
...
class TaskAgentJobStep(Model):
    ...
    :param task:
    :type task: :class:`TaskAgentJobTask <azure.devops.v7_0.task.models.TaskAgentJobTask>`
...
class TaskAttachment(Model):
    """
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_0.task.models.ReferenceLinks>`
    :param created_on:
...
class TaskOrchestrationPlanReference(Model):
    ...
    :param definition:
    :type definition: :class:`TaskOrchestrationOwner <azure.devops.v7_0.task.models.TaskOrchestrationOwner>`
    :param owner:
    :type owner: :class:`TaskOrchestrationOwner <azure.devops.v7_0.task.models.TaskOrchestrationOwner>`
    :param plan_group:
    :type plan_group: str
    :param plan_id:
    :type plan_id: str
...
class TaskOrchestrationQueuedPlanGroup(Model):
    ...
    :type plan_group: str
    :param plans:
    :type plans: list of :class:`TaskOrchestrationQueuedPlan <azure.devops.v7_0.task.models.TaskOrchestrationQueuedPlan>`
    :param project:
    :type project: :class:`ProjectReference <azure.devops.v7_0.task.models.ProjectReference>`
    :param queue_position:
    :type queue_position: int
    """
...
class TimelineRecord(Model):
    ...
    :type agent_specification: :class:`object <azure.devops.v7_0.task.models.object>`
    :param attempt:
    :type attempt: int
    :param current_operation:
    :type current_operation: str
    :param details:
    :type details: :class:`TimelineReference <azure.devops.v7_0.task.models.TimelineReference>`
    :param error_count:
    ...
    :type identifier: str
    :param issues:
    :type issues: list of :class:`Issue <azure.devops.v7_0.task.models.Issue>`
    :param last_modified:
    :type last_modified: datetime
    :param location:
    :type location: str
    :param log:
    :type log: :class:`TaskLogReference <azure.devops.v7_0.task.models.TaskLogReference>`
    :param name:
    :type name: str
    :param order:
    :type order: int
    ...
    :type previous_attempts: list of :class:`TimelineAttempt <azure.devops.v7_0.task.models.TimelineAttempt>`
    :param queue_id:
    :type queue_id: int
    :param ref_name:
    :type ref_name: str
    ...
    :type state: object
    :param task:
    :type task: :class:`TaskReference <azure.devops.v7_0.task.models.TaskReference>`
    :param type:
    :type type: str
    :param variables:
    :type variables: dict
...
class TaskOrchestrationContainer(TaskOrchestrationItem):
    ...
    :type data: dict
    :param children:
    :type children: list of :class:`TaskOrchestrationItem <azure.devops.v7_0.task.models.TaskOrchestrationItem>`
    :param max_concurrency:
    :type max_concurrency: int
    :param parallel:
    :type parallel: bool
    :param rollback:
    :type rollback: :class:`TaskOrchestrationContainer <azure.devops.v7_0.task.models.TaskOrchestrationContainer>`
    """
...
class TaskOrchestrationPlan(TaskOrchestrationPlanReference):
    ...
    :type version: int
    :param environment:
    :type environment: :class:`PlanEnvironment <azure.devops.v7_0.task.models.PlanEnvironment>`
    :param expanded_yaml:
    :type expanded_yaml: :class:`TaskLogReference <azure.devops.v7_0.task.models.TaskLogReference>`
    :param finish_time:
    :type finish_time: datetime
    :param implementation:
    :type implementation: :class:`TaskOrchestrationContainer <azure.devops.v7_0.task.models.TaskOrchestrationContainer>`
    :param initialization_log:
    :type initialization_log: :class:`TaskLogReference <azure.devops.v7_0.task.models.TaskLogReference>`
    ...
    :type state: object
    :param timeline:
    :type timeline: :class:`TimelineReference <azure.devops.v7_0.task.models.TimelineReference>`
    """
...
class Timeline(TimelineReference):
    ...
    :type last_changed_on: datetime
    :param records:
    :type records: list of :class:`TimelineRecord <azure.devops.v7_0.task.models.TimelineRecord>`
    """
