...
class BacklogConfiguration(Model):
    ...
    :type backlog_fields: :class:`BacklogFields <work.v4_1.models.BacklogFields>`
    ...
    :type portfolio_backlogs: list of :class:`BacklogLevelConfiguration <work.v4_1.models.BacklogLevelConfiguration>`
    :param requirement_backlog: Requirement backlog
    :type requirement_backlog: :class:`BacklogLevelConfiguration <work.v4_1.models.BacklogLevelConfiguration>`
    :param task_backlog: Task backlog
    :type task_backlog: :class:`BacklogLevelConfiguration <work.v4_1.models.BacklogLevelConfiguration>`
    :param url:
    :type url: str
    :param work_item_type_mapped_states: Mapped states for work item types
    :type work_item_type_mapped_states: list of :class:`WorkItemTypeStateInfo <work.v4_1.models.WorkItemTypeStateInfo>`
    """
...
class CapacityPatch(Model):
    ...
    :param activities:
    :type activities: list of :class:`Activity <work.v4_1.models.Activity>`
    :param days_off:
...
class Rule(Model):
    ...
    :param clauses:
    :type clauses: list of :class:`FilterClause <work.v4_1.models.FilterClause>`
    :param filter:
    :type filter: str
    :param is_enabled:
    :type is_enabled: str
...
class TimelineTeamData(Model):
    ...
    :type backlog: :class:`BacklogLevel <work.v4_1.models.BacklogLevel>`
    ...
    :type iterations: list of :class:`TimelineTeamIteration <work.v4_1.models.TimelineTeamIteration>`
    ...
    :type status: :class:`TimelineTeamStatus <work.v4_1.models.TimelineTeamStatus>`
    ...
    :type team_field_values: list of :class:`TeamFieldValue <work.v4_1.models.TeamFieldValue>`
    :param work_item_type_colors: Colors for the work item types.
    :type work_item_type_colors: list of :class:`WorkItemColor <work.v4_1.models.WorkItemColor>`
    """
...
class TimelineTeamIteration(Model):
    ...
    :type status: :class:`TimelineIterationStatus <work.v4_1.models.TimelineIterationStatus>`
...
class Board(BoardReference):
    ...
    :type can_edit: bool
    :param columns:
    :type columns: list of :class:`BoardColumn <work.v4_1.models.BoardColumn>`
    :param fields:
    :type fields: :class:`BoardFields <work.v4_1.models.BoardFields>`
    :param is_valid:
    :type is_valid: bool
    :param revision:
    :type revision: int
    :param rows:
    :type rows: list of :class:`BoardRow <work.v4_1.models.BoardRow>`
    """
...
class DeliveryViewData(PlanViewData):
    ...
    :type criteria_status: :class:`TimelineCriteriaStatus <work.v4_1.models.TimelineCriteriaStatus>`
    ...
    :type teams: list of :class:`TimelineTeamData <work.v4_1.models.TimelineTeamData>`
    """
...
class TeamMemberCapacity(TeamSettingsDataContractBase):
    ...
    :type team_member: :class:`Member <work.v4_1.models.Member>`
    """
