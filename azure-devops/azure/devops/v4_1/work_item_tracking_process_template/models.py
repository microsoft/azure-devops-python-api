...
class AdminBehavior(Model):
    ...
    :type fields: list of :class:`AdminBehaviorField <azure.devops.v4_1.work-item-tracking-process-template.models.AdminBehaviorField>`
...
class ProcessImportResult(Model):
    ...
    :type validation_results: list of :class:`ValidationIssue <azure.devops.v4_1.work-item-tracking-process-template.models.ValidationIssue>`
    """
