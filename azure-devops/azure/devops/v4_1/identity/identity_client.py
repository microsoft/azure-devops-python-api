...
class IdentityClient(Client):
    ...
    def create_or_bind_with_claims(self, source_identity):
        ...
        [Preview API]
        :param :class:`<Identity> <azure.devops.v4_1.identity.models.Identity>` source_identity:
        :rtype: :class:`<Identity> <azure.devops.v4_1.identity.models.Identity>`
        """
    ...
    def get_descriptor_by_id(self, id, is_master_id=None):
        ...
        :rtype: :class:`<str> <azure.devops.v4_1.identity.models.str>`
        """
        route_values = {}
        if id is not None:
    ...
    def create_groups(self, container):
        """CreateGroups.
        :param :class:`<object> <azure.devops.v4_1.identity.models.object>` container:
        :rtype: [Identity]
        """
    ...
    def get_identity_changes(self, identity_sequence_id, group_sequence_id, scope_id=None):
        ...
        :param str scope_id:
        :rtype: :class:`<ChangedIdentities> <azure.devops.v4_1.identity.models.ChangedIdentities>`
        """
        query_parameters = {}
    ...
    def update_identities(self, identities):
        """UpdateIdentities.
        :param :class:`<VssJsonCollectionWrapper> <azure.devops.v4_1.identity.models.VssJsonCollectionWrapper>` identities:
    ...
    def update_identity(self, identity, identity_id):
        """UpdateIdentity.
        :param :class:`<Identity> <azure.devops.v4_1.identity.models.Identity>` identity:
        :param str identity_id:
        """
        route_values = {}
        if identity_id is not None:
    ...
    def create_identity(self, framework_identity_info):
        """CreateIdentity.
        :param :class:`<FrameworkIdentityInfo> <azure.devops.v4_1.identity.models.FrameworkIdentityInfo>` framework_identity_info:
        :rtype: :class:`<Identity> <azure.devops.v4_1.identity.models.Identity>`
        """
    ...
    def read_identity_batch(self, batch_info):
        """ReadIdentityBatch.
        [Preview API]
        :param :class:`<IdentityBatchInfo> <azure.devops.v4_1.identity.models.IdentityBatchInfo>` batch_info:
        :rtype: [Identity]
        """
    ...
    def get_identity_snapshot(self, scope_id):
        ...
        [Preview API]
        :param str scope_id:
        :rtype: :class:`<IdentitySnapshot> <azure.devops.v4_1.identity.models.IdentitySnapshot>`
        """
        route_values = {}
        if scope_id is not None:
    ...
    def get_self(self):
        ...
        :rtype: :class:`<IdentitySelf> <azure.devops.v4_1.identity.models.IdentitySelf>`
        """
        response = self._send(http_method='GET',
    ...
    def create_scope(self, info, scope_id):
        """CreateScope.
        [Preview API]
        :param :class:`<CreateScopeInfo> <azure.devops.v4_1.identity.models.CreateScopeInfo>` info:
        :param str scope_id:
        :rtype: :class:`<IdentityScope> <azure.devops.v4_1.identity.models.IdentityScope>`
        """
        route_values = {}
        if scope_id is not None:
            route_values['scopeId'] = self._serialize.url('scope_id', scope_id, 'str')
    ...
    def rename_scope(self, rename_scope, scope_id):
        """RenameScope.
        [Preview API]
        :param :class:`<IdentityScope> <azure.devops.v4_1.identity.models.IdentityScope>` rename_scope:
        :param str scope_id:
        """
        route_values = {}
        if scope_id is not None:
    ...
    def get_signed_in_token(self):
        """GetSignedInToken.
        [Preview API]
        :rtype: :class:`<AccessTokenResult> <azure.devops.v4_1.identity.models.AccessTokenResult>`
        """
        response = self._send(http_method='GET',
    ...
    def get_tenant(self, tenant_id):
        ...
        [Preview API]
        :param str tenant_id:
        :rtype: :class:`<TenantInfo> <azure.devops.v4_1.identity.models.TenantInfo>`
        """
        route_values = {}
