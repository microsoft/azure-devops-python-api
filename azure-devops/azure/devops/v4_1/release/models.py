...
class ArtifactMetadata(Model):
    ...
    :type instance_reference: :class:`BuildVersion <azure.devops.v4_1.release.models.BuildVersion>`
    """
...
class ArtifactTypeDefinition(Model):
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v4_1.release.models.InputDescriptor>`
    :param name:
    :type name: str
...
class ArtifactVersion(Model):
    ...
    :type default_version: :class:`BuildVersion <azure.devops.v4_1.release.models.BuildVersion>`
    :param error_message:
    :type error_message: str
    :param source_id:
    :type source_id: str
    :param versions:
    :type versions: list of :class:`BuildVersion <azure.devops.v4_1.release.models.BuildVersion>`
    """
...
class ArtifactVersionQueryResult(Model):
    ...
    :type artifact_versions: list of :class:`ArtifactVersion <azure.devops.v4_1.release.models.ArtifactVersion>`
    """
...
class AutoTriggerIssue(Model):
    ...
    :param issue:
    :type issue: :class:`Issue <azure.devops.v4_1.release.models.Issue>`
    :param issue_source:
    :type issue_source: object
    :param project:
    :type project: :class:`ProjectReference <azure.devops.v4_1.release.models.ProjectReference>`
    :param release_definition_reference:
    :type release_definition_reference: :class:`ReleaseDefinitionShallowReference <azure.devops.v4_1.release.models.ReleaseDefinitionShallowReference>`
...
class Change(Model):
    ...
    :type author: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
...
class Deployment(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v4_1.release.models.ReferenceLinks>`
    ...
    :type conditions: list of :class:`Condition <azure.devops.v4_1.release.models.Condition>`
    ...
    :type last_modified_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    ...
    :type post_deploy_approvals: list of :class:`ReleaseApproval <azure.devops.v4_1.release.models.ReleaseApproval>`
    :param pre_deploy_approvals: Gets list of PreDeployApprovals.
    :type pre_deploy_approvals: list of :class:`ReleaseApproval <azure.devops.v4_1.release.models.ReleaseApproval>`
    ...
    :type release: :class:`ReleaseReference <azure.devops.v4_1.release.models.ReleaseReference>`
    ...
    :type release_definition: :class:`ReleaseDefinitionShallowReference <azure.devops.v4_1.release.models.ReleaseDefinitionShallowReference>`
    ...
    :type release_environment: :class:`ReleaseEnvironmentShallowReference <azure.devops.v4_1.release.models.ReleaseEnvironmentShallowReference>`
    :param requested_by: Gets the identity who requested.
    :type requested_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param requested_for: Gets the identity for whom deployment is requested.
    :type requested_for: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
...
class DeploymentAttempt(Model):
    ...
    :type issues: list of :class:`Issue <azure.devops.v4_1.release.models.Issue>`
    :param job:
    :type job: :class:`ReleaseTask <azure.devops.v4_1.release.models.ReleaseTask>`
    ...
    :type post_deployment_gates: :class:`ReleaseGates <azure.devops.v4_1.release.models.ReleaseGates>`
    :param pre_deployment_gates:
    :type pre_deployment_gates: :class:`ReleaseGates <azure.devops.v4_1.release.models.ReleaseGates>`
    :param queued_on:
    :type queued_on: datetime
    :param reason:
    :type reason: object
    :param release_deploy_phases:
    :type release_deploy_phases: list of :class:`ReleaseDeployPhase <azure.devops.v4_1.release.models.ReleaseDeployPhase>`
    :param requested_by:
    :type requested_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param requested_for:
    :type requested_for: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    ...
    :type status: object
    :param tasks:
    :type tasks: list of :class:`ReleaseTask <azure.devops.v4_1.release.models.ReleaseTask>`
    """
...
class DeploymentQueryParameters(Model):
    ...
    :type deployment_status: object
    :param environments:
    :type environments: list of :class:`DefinitionEnvironmentReference <azure.devops.v4_1.release.models.DefinitionEnvironmentReference>`
    :param expands:
    :type expands: object
    :param is_deleted:
...
class Folder(Model):
    ...
    :param created_by:
    :type created_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param created_on:
    :type created_on: datetime
    :param description:
    :type description: str
    :param last_changed_by:
    :type last_changed_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
...
class MailMessage(Model):
    ...
    :type body: str
    :param cC:
    :type cC: :class:`EmailRecipients <azure.devops.v4_1.release.models.EmailRecipients>`
    :param in_reply_to:
    ...
    :param reply_to:
    :type reply_to: :class:`EmailRecipients <azure.devops.v4_1.release.models.EmailRecipients>`
    :param sections:
    ...
    :type subject: str
    :param to:
    :type to: :class:`EmailRecipients <azure.devops.v4_1.release.models.EmailRecipients>`
    """
...
class ManualIntervention(Model):
    ...
    :type approver: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    ...
    :type release: :class:`ReleaseShallowReference <azure.devops.v4_1.release.models.ReleaseShallowReference>`
...
class Release(Model):
    ...
    :type artifacts: list of :class:`Artifact <azure.devops.v4_1.release.models.Artifact>`
    ...
    :type environments: list of :class:`ReleaseEnvironment <azure.devops.v4_1.release.models.ReleaseEnvironment>`
    :param id: Gets the unique identifier of this field.
    :type id: int
    ...
    :type modified_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param modified_on: Gets date on which it got modified.
    :type modified_on: datetime
    ...
    :type project_reference: :class:`ProjectReference <azure.devops.v4_1.release.models.ProjectReference>`
    :param properties:
    :type properties: :class:`object <azure.devops.v4_1.release.models.object>`
    ...
    :type variable_groups: list of :class:`VariableGroup <azure.devops.v4_1.release.models.VariableGroup>`
...
class ReleaseApproval(Model):
    ...
    :type approved_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param approver: Gets or sets the identity who should approve.
    :type approver: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    ...
    :type history: list of :class:`ReleaseApprovalHistory <azure.devops.v4_1.release.models.ReleaseApprovalHistory>`
    :param id: Gets the unique identifier of this field.
    :type id: int
...
class ReleaseApprovalHistory(Model):
    ...
    :type approver: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param changed_by:
    :type changed_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param comments:
    :type comments: str
    :param created_on:
    :type created_on: datetime
...
class ReleaseDefinition(Model):
    ...
    :type environments: list of :class:`ReleaseDefinitionEnvironment <azure.devops.v4_1.release.models.ReleaseDefinitionEnvironment>`
    :param id: Gets the unique identifier of this field.
    :type id: int
    :param is_deleted: Whether release definition is deleted.
    :type is_deleted: bool
    :param last_release: Gets the reference of last release.
    :type last_release: :class:`ReleaseReference <azure.devops.v4_1.release.models.ReleaseReference>`
    :param modified_by: Gets or sets the identity who modified.
    :type modified_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param modified_on: Gets date on which it got modified.
    :type modified_on: datetime
    ...
    :type pipeline_process: :class:`PipelineProcess <azure.devops.v4_1.release.models.PipelineProcess>`
    :param properties: Gets or sets properties.
    :type properties: :class:`object <azure.devops.v4_1.release.models.object>`
    :param release_name_format: Gets or sets the release name format.
    :type release_name_format: str
    :param retention_policy:
    :type retention_policy: :class:`RetentionPolicy <azure.devops.v4_1.release.models.RetentionPolicy>`
    :param revision: Gets the revision number.
    :type revision: int
    ...
    :type triggers: list of :class:`object <azure.devops.v4_1.release.models.object>`
...
class ReleaseDefinitionApprovals(Model):
    ...
    :type approval_options: :class:`ApprovalOptions <azure.devops.v4_1.release.models.ApprovalOptions>`
    :param approvals:
    :type approvals: list of :class:`ReleaseDefinitionApprovalStep <azure.devops.v4_1.release.models.ReleaseDefinitionApprovalStep>`
    """
...
class ReleaseDefinitionEnvironment(Model):
    ...
    :type conditions: list of :class:`Condition <azure.devops.v4_1.release.models.Condition>`
    :param demands:
    :type demands: list of :class:`object <azure.devops.v4_1.release.models.object>`
    :param deploy_phases:
    :type deploy_phases: list of :class:`object <azure.devops.v4_1.release.models.object>`
    :param deploy_step:
    :type deploy_step: :class:`ReleaseDefinitionDeployStep <azure.devops.v4_1.release.models.ReleaseDefinitionDeployStep>`
    :param environment_options:
    :type environment_options: :class:`EnvironmentOptions <azure.devops.v4_1.release.models.EnvironmentOptions>`
    :param execution_policy:
    :type execution_policy: :class:`EnvironmentExecutionPolicy <azure.devops.v4_1.release.models.EnvironmentExecutionPolicy>`
    :param id:
    :type id: int
    :param name:
    :type name: str
    :param owner:
    :type owner: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    :param post_deploy_approvals:
    :type post_deploy_approvals: :class:`ReleaseDefinitionApprovals <azure.devops.v4_1.release.models.ReleaseDefinitionApprovals>`
    :param post_deployment_gates:
    :type post_deployment_gates: :class:`ReleaseDefinitionGatesStep <azure.devops.v4_1.release.models.ReleaseDefinitionGatesStep>`
    :param pre_deploy_approvals:
    :type pre_deploy_approvals: :class:`ReleaseDefinitionApprovals <azure.devops.v4_1.release.models.ReleaseDefinitionApprovals>`
    :param pre_deployment_gates:
    :type pre_deployment_gates: :class:`ReleaseDefinitionGatesStep <azure.devops.v4_1.release.models.ReleaseDefinitionGatesStep>`
    :param process_parameters:
    :type process_parameters: :class:`ProcessParameters <azure.devops.v4_1.release.models.ProcessParameters>`
    :param properties:
    :type properties: :class:`object <azure.devops.v4_1.release.models.object>`
    :param queue_id:
    :type queue_id: int
    ...
    :type rank: int
    :param retention_policy:
    :type retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v4_1.release.models.EnvironmentRetentionPolicy>`
    :param run_options:
    :type run_options: dict
    :param schedules:
    :type schedules: list of :class:`ReleaseSchedule <azure.devops.v4_1.release.models.ReleaseSchedule>`
...
class ReleaseDefinitionEnvironmentSummary(Model):
    ...
    :type id: int
    :param last_releases:
    :type last_releases: list of :class:`ReleaseShallowReference <azure.devops.v4_1.release.models.ReleaseShallowReference>`
    :param name:
    :type name: str
    """
...
class ReleaseDefinitionEnvironmentTemplate(Model):
    ...
    :type description: str
    :param environment:
    :type environment: :class:`ReleaseDefinitionEnvironment <azure.devops.v4_1.release.models.ReleaseDefinitionEnvironment>`
    :param icon_task_id:
...
class ReleaseDefinitionGate(Model):
    ...
    :param tasks:
    :type tasks: list of :class:`WorkflowTask <azure.devops.v4_1.release.models.WorkflowTask>`
    """
...
class ReleaseDefinitionGatesStep(Model):
    ...
    :param gates:
    :type gates: list of :class:`ReleaseDefinitionGate <azure.devops.v4_1.release.models.ReleaseDefinitionGate>`
    :param gates_options:
    :type gates_options: :class:`ReleaseDefinitionGatesOptions <azure.devops.v4_1.release.models.ReleaseDefinitionGatesOptions>`
    :param id:
    :type id: int
    """
...
class ReleaseDefinitionSummary(Model):
    ...
    :param environments:
    :type environments: list of :class:`ReleaseDefinitionEnvironmentSummary <azure.devops.v4_1.release.models.ReleaseDefinitionEnvironmentSummary>`
    :param release_definition:
    :type release_definition: :class:`ReleaseDefinitionShallowReference <azure.devops.v4_1.release.models.ReleaseDefinitionShallowReference>`
    :param releases:
    :type releases: list of :class:`Release <azure.devops.v4_1.release.models.Release>`
    """
...
class ReleaseDeployPhase(Model):
    ...
    :type deployment_jobs: list of :class:`DeploymentJob <azure.devops.v4_1.release.models.DeploymentJob>`
    :param error_log:
    :type error_log: str
    :param id:
    :type id: int
    :param manual_interventions:
    :type manual_interventions: list of :class:`ManualIntervention <azure.devops.v4_1.release.models.ManualIntervention>`
    :param name:
    :type name: str
    :param phase_id:
    :type phase_id: str
...
class ReleaseEnvironment(Model):
    ...
    :type conditions: list of :class:`ReleaseCondition <azure.devops.v4_1.release.models.ReleaseCondition>`
    :param created_on: Gets date on which it got created.
    :type created_on: datetime
    ...
    :type deploy_phases_snapshot: list of :class:`object <azure.devops.v4_1.release.models.object>`
    :param deploy_steps: Gets deploy steps.
    :type deploy_steps: list of :class:`DeploymentAttempt <azure.devops.v4_1.release.models.DeploymentAttempt>`
    ...
    :type post_approvals_snapshot: :class:`ReleaseDefinitionApprovals <azure.devops.v4_1.release.models.ReleaseDefinitionApprovals>`
    :param post_deploy_approvals: Gets list of post deploy approvals.
    :type post_deploy_approvals: list of :class:`ReleaseApproval <azure.devops.v4_1.release.models.ReleaseApproval>`
    :param post_deployment_gates_snapshot:
    :type post_deployment_gates_snapshot: :class:`ReleaseDefinitionGatesStep <azure.devops.v4_1.release.models.ReleaseDefinitionGatesStep>`
    :param pre_approvals_snapshot: Gets list of pre deploy approvals snapshot.
    :type pre_approvals_snapshot: :class:`ReleaseDefinitionApprovals <azure.devops.v4_1.release.models.ReleaseDefinitionApprovals>`
    :param pre_deploy_approvals: Gets list of pre deploy approvals.
    :type pre_deploy_approvals: list of :class:`ReleaseApproval <azure.devops.v4_1.release.models.ReleaseApproval>`
    :param pre_deployment_gates_snapshot:
    :type pre_deployment_gates_snapshot: :class:`ReleaseDefinitionGatesStep <azure.devops.v4_1.release.models.ReleaseDefinitionGatesStep>`
    ...
    :type release_created_by: :class:`IdentityRef <azure.devops.v4_1.release.models.IdentityRef>`
    ...
    :type workflow_tasks: list of :class:`WorkflowTask <azure.devops.v4_1.release.models.WorkflowTask>`
    """
...
class ReleaseSettings(Model):
    ...
    :type retention_settings: :class:`RetentionSettings <azure.devops.v4_1.release.models.RetentionSettings>`
    """
...
class ReleaseStartMetadata(Model):
    ...
    :type artifacts: list of :class:`ArtifactMetadata <azure.devops.v4_1.release.models.ArtifactMetadata>`
...
class ReleaseTask(Model):
    ...
    :type status: object
    :param task:
    :type task: :class:`WorkflowTaskReference <azure.devops.v4_1.release.models.WorkflowTaskReference>`
...
class RetentionSettings(Model):
    ...
    :type default_environment_retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v4_1.release.models.EnvironmentRetentionPolicy>`
    :param maximum_environment_retention_policy:
    :type maximum_environment_retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v4_1.release.models.EnvironmentRetentionPolicy>`
    """
...
class VariableGroup(Model):
    ...
    :type provider_data: :class:`VariableGroupProviderData <azure.devops.v4_1.release.models.VariableGroupProviderData>`
