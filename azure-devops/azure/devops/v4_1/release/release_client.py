...
class ReleaseClient(Client):
    ...
    def update_release_approval(self, approval, project, approval_id):
        ...
        :param :class:`<ReleaseApproval> <azure.devops.v4_1.release.models.ReleaseApproval>` approval: ReleaseApproval object having status, approver and comments.
        :param str project: Project ID or project name
        :param int approval_id: Id of the approval.
        :rtype: :class:`<ReleaseApproval> <azure.devops.v4_1.release.models.ReleaseApproval>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_release_definition(self, release_definition, project):
        ...
        :param :class:`<ReleaseDefinition> <azure.devops.v4_1.release.models.ReleaseDefinition>` release_definition: release definition object to create.
        :param str project: Project ID or project name
        :rtype: :class:`<ReleaseDefinition> <azure.devops.v4_1.release.models.ReleaseDefinition>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_release_definition(self, release_definition, project):
        ...
        :param :class:`<ReleaseDefinition> <azure.devops.v4_1.release.models.ReleaseDefinition>` release_definition: Release definition object to update.
        :param str project: Project ID or project name
        :rtype: :class:`<ReleaseDefinition> <azure.devops.v4_1.release.models.ReleaseDefinition>`
        """
        route_values = {}
    ...
    def update_release_environment(self, environment_update_data, project, release_id, environment_id):
        ...
        :param :class:`<ReleaseEnvironmentUpdateMetadata> <azure.devops.v4_1.release.models.ReleaseEnvironmentUpdateMetadata>` environment_update_data: Environment update meta data.
        :param str project: Project ID or project name
        :param int release_id: Id of the release.
        :param int environment_id: Id of release environment.
        :rtype: :class:`<ReleaseEnvironment> <azure.devops.v4_1.release.models.ReleaseEnvironment>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_manual_intervention(self, project, release_id, manual_intervention_id):
        ...
        :rtype: :class:`<ManualIntervention> <azure.devops.v4_1.release.models.ManualIntervention>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_manual_intervention(self, manual_intervention_update_metadata, project, release_id, manual_intervention_id):
        ...
        :param :class:`<ManualInterventionUpdateMetadata> <azure.devops.v4_1.release.models.ManualInterventionUpdateMetadata>` manual_intervention_update_metadata: Meta data to update manual intervention.
        :param str project: Project ID or project name
        :param int release_id: Id of the release.
        :param int manual_intervention_id: Id of the manual intervention.
        :rtype: :class:`<ManualIntervention> <azure.devops.v4_1.release.models.ManualIntervention>`
    ...
    def create_release(self, release_start_metadata, project):
        ...
        :param :class:`<ReleaseStartMetadata> <azure.devops.v4_1.release.models.ReleaseStartMetadata>` release_start_metadata: Metadata to create a release.
        :param str project: Project ID or project name
        :rtype: :class:`<Release> <azure.devops.v4_1.release.models.Release>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_release_definition_summary(self, project, definition_id, release_count, include_artifact=None, definition_environment_ids_filter=None):
        ...
        :rtype: :class:`<ReleaseDefinitionSummary> <azure.devops.v4_1.release.models.ReleaseDefinitionSummary>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_release(self, release, project, release_id):
        ...
        :param :class:`<Release> <azure.devops.v4_1.release.models.Release>` release: Release object for update.
        :param str project: Project ID or project name
    ...
    def update_release_resource(self, release_update_metadata, project, release_id):
        ...
        :param :class:`<ReleaseUpdateMetadata> <azure.devops.v4_1.release.models.ReleaseUpdateMetadata>` release_update_metadata: Properties of release to update.
        :param str project: Project ID or project name
        :param int release_id: Id of the release to update.
        :rtype: :class:`<Release> <azure.devops.v4_1.release.models.Release>`
        """
