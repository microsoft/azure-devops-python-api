...
class GraphDescriptorResult(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v4_1.graph.models.ReferenceLinks>`
    :param value:
    :type value: :class:`str <azure.devops.v4_1.graph.models.str>`
    """
...
class GraphGlobalExtendedPropertyBatch(Model):
    ...
    :type subject_descriptors: list of :class:`str <azure.devops.v4_1.graph.models.str>`
    """
...
class GraphMembershipTraversal(Model):
    ...
    :type subject_descriptor: :class:`str <azure.devops.v4_1.graph.models.str>`
    ...
    :type traversed_subjects: list of :class:`str <azure.devops.v4_1.graph.models.str>`
    """
...
class GraphSubjectLookup(Model):
    ...
    :param lookup_keys:
    :type lookup_keys: list of :class:`GraphSubjectLookupKey <azure.devops.v4_1.graph.models.GraphSubjectLookupKey>`
    """
...
class GraphSubjectLookupKey(Model):
    ...
    :param descriptor:
    :type descriptor: :class:`str <azure.devops.v4_1.graph.models.str>`
    """
...
class PagedGraphGroups(Model):
    ...
    :type graph_groups: list of :class:`GraphGroup <azure.devops.v4_1.graph.models.GraphGroup>`
    """
...
class PagedGraphUsers(Model):
    ...
    :type graph_users: list of :class:`GraphUser <azure.devops.v4_1.graph.models.GraphUser>`
    """
