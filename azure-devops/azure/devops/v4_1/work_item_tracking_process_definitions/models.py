...
class FieldModel(Model):
    ...
    :type pick_list: :class:`PickListMetadataModel <azure.devops.v4_1.work-item-tracking.models.PickListMetadataModel>`
...
class PickListModel(PickListMetadataModel):
    ...
    :type items: list of :class:`PickListItemModel <azure.devops.v4_1.work-item-tracking.models.PickListItemModel>`
    """
