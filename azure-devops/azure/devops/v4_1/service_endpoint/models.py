...
class DataSource(Model):
    ...
    :type authentication_scheme: :class:`AuthenticationSchemeReference <azure.devops.v4_1.service-endpoint.models.AuthenticationSchemeReference>`
    :param endpoint_url:
    :type endpoint_url: str
    :param headers:
    :type headers: list of :class:`AuthorizationHeader <azure.devops.v4_1.service-endpoint.models.AuthorizationHeader>`
    :param name:
    :type name: str
    :param resource_url:
...
class DependsOn(Model):
    ...
    :type input: str
    :param map:
    :type map: list of :class:`DependencyBinding <azure.devops.v4_1.service-endpoint.models.DependencyBinding>`
    """
...
class EndpointUrl(Model):
    ...
    :type depends_on: :class:`DependsOn <azure.devops.v4_1.service-endpoint.models.DependsOn>`
...
class ServiceEndpoint(Model):
    ...
    :type administrators_group: :class:`IdentityRef <azure.devops.v4_1.service-endpoint.models.IdentityRef>`
    :param authorization: Gets or sets the authorization data for talking to the endpoint.
    :type authorization: :class:`EndpointAuthorization <azure.devops.v4_1.service-endpoint.models.EndpointAuthorization>`
    :param created_by: Gets or sets the identity reference for the user who created the Service endpoint.
    :type created_by: :class:`IdentityRef <azure.devops.v4_1.service-endpoint.models.IdentityRef>`
    :param data:
    :type data: dict
    ...
    :type operation_status: :class:`object <azure.devops.v4_1.service-endpoint.models.object>`
    :param readers_group: Gets or sets the identity reference for the readers group of the service endpoint.
    :type readers_group: :class:`IdentityRef <azure.devops.v4_1.service-endpoint.models.IdentityRef>`
...
class ServiceEndpointAuthenticationScheme(Model):
    ...
    :type authorization_headers: list of :class:`AuthorizationHeader <azure.devops.v4_1.service-endpoint.models.AuthorizationHeader>`
    :param client_certificates: Gets or sets the certificates of service endpoint authentication scheme.
    :type client_certificates: list of :class:`ClientCertificate <azure.devops.v4_1.service-endpoint.models.ClientCertificate>`
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v4_1.service-endpoint.models.InputDescriptor>`
...
class ServiceEndpointExecutionData(Model):
    ...
    :type definition: :class:`ServiceEndpointExecutionOwner <azure.devops.v4_1.service-endpoint.models.ServiceEndpointExecutionOwner>`
    ...
    :type owner: :class:`ServiceEndpointExecutionOwner <azure.devops.v4_1.service-endpoint.models.ServiceEndpointExecutionOwner>`
...
class ServiceEndpointExecutionOwner(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v4_1.service-endpoint.models.ReferenceLinks>`
...
class ServiceEndpointExecutionRecord(Model):
    ...
    :type data: :class:`ServiceEndpointExecutionData <azure.devops.v4_1.service-endpoint.models.ServiceEndpointExecutionData>`
...
class ServiceEndpointRequest(Model):
    ...
    :type data_source_details: :class:`DataSourceDetails <azure.devops.v4_1.service-endpoint.models.DataSourceDetails>`
    :param result_transformation_details: Gets or sets the result transformation details for the service endpoint request.
    :type result_transformation_details: :class:`ResultTransformationDetails <azure.devops.v4_1.service-endpoint.models.ResultTransformationDetails>`
    :param service_endpoint_details: Gets or sets the service endpoint details for the service endpoint request.
    :type service_endpoint_details: :class:`ServiceEndpointDetails <azure.devops.v4_1.service-endpoint.models.ServiceEndpointDetails>`
    """
...
class ServiceEndpointRequestResult(Model):
    ...
    :type result: :class:`object <azure.devops.v4_1.service-endpoint.models.object>`
...
class ServiceEndpointType(Model):
    ...
    :type authentication_schemes: list of :class:`ServiceEndpointAuthenticationScheme <azure.devops.v4_1.service-endpoint.models.ServiceEndpointAuthenticationScheme>`
    :param data_sources: Data sources of service endpoint type.
    :type data_sources: list of :class:`DataSource <azure.devops.v4_1.service-endpoint.models.DataSource>`
    :param dependency_data: Dependency data of service endpoint type.
    :type dependency_data: list of :class:`DependencyData <azure.devops.v4_1.service-endpoint.models.DependencyData>`
    ...
    :type endpoint_url: :class:`EndpointUrl <azure.devops.v4_1.service-endpoint.models.EndpointUrl>`
    :param help_link: Gets or sets the help link of service endpoint type.
    :type help_link: :class:`HelpLink <azure.devops.v4_1.service-endpoint.models.HelpLink>`
