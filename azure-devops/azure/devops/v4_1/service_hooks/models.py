...
class Consumer(Model):
    ...
    :type actions: list of :class:`ConsumerAction <service-hooks.v4_1.models.ConsumerAction>`
    ...
    :type external_configuration: :class:`ExternalConfigurationDescriptor <service-hooks.v4_1.models.ExternalConfigurationDescriptor>`
...
class Event(Model):
    ...
    :type detailed_message: :class:`FormattedEventMessage <service-hooks.v4_1.models.FormattedEventMessage>`
    ...
    :type message: :class:`FormattedEventMessage <service-hooks.v4_1.models.FormattedEventMessage>`
    ...
    :type session_token: :class:`SessionToken <service-hooks.v4_1.models.SessionToken>`
    """
...
class Notification(Model):
    ...
    :type details: :class:`NotificationDetails <service-hooks.v4_1.models.NotificationDetails>`
...
class SubscriptionDiagnostics(Model):
    ...
    :type delivery_results: :class:`SubscriptionTracing <microsoft.-visual-studio.-services.-notifications.-web-api.v4_1.models.SubscriptionTracing>`
    :param delivery_tracing:
    :type delivery_tracing: :class:`SubscriptionTracing <microsoft.-visual-studio.-services.-notifications.-web-api.v4_1.models.SubscriptionTracing>`
    :param evaluation_tracing:
    :type evaluation_tracing: :class:`SubscriptionTracing <microsoft.-visual-studio.-services.-notifications.-web-api.v4_1.models.SubscriptionTracing>`
    """
...
class SubscriptionsQuery(Model):
    ...
    :type consumer_input_filters: list of :class:`InputFilter <service-hooks.v4_1.models.InputFilter>`
    ...
    :type publisher_input_filters: list of :class:`InputFilter <service-hooks.v4_1.models.InputFilter>`
    :param results: Results from the query
    :type results: list of :class:`Subscription <service-hooks.v4_1.models.Subscription>`
