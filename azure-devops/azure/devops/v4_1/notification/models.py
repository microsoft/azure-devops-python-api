...
class BatchNotificationOperation(Model):
    ...
    :type notification_query_conditions: list of :class:`NotificationQueryCondition <notification.v4_1.models.NotificationQueryCondition>`
    """
...
class NotificationStatisticsQuery(Model):
    ...
    :param conditions:
    :type conditions: list of :class:`NotificationStatisticsQueryConditions <notification.v4_1.models.NotificationStatisticsQueryConditions>`
    """
...
class SubscriptionEvaluationRequest(Model):
    ...
    :type subscription_create_parameters: :class:`NotificationSubscriptionCreateParameters <notification.v4_1.models.NotificationSubscriptionCreateParameters>`
    """
...
class SubscriptionEvaluationResult(Model):
    ...
    :type events: :class:`EventsEvaluationResult <notification.v4_1.models.EventsEvaluationResult>`
    ...
    :type notifications: :class:`NotificationsEvaluationResult <notification.v4_1.models.NotificationsEvaluationResult>`
    """
...
class UpdateSubscripitonDiagnosticsParameters(Model):
    ...
    :param delivery_results:
    :type delivery_results: :class:`UpdateSubscripitonTracingParameters <notification.v4_1.models.UpdateSubscripitonTracingParameters>`
    :param delivery_tracing:
    :type delivery_tracing: :class:`UpdateSubscripitonTracingParameters <notification.v4_1.models.UpdateSubscripitonTracingParameters>`
    :param evaluation_tracing:
    :type evaluation_tracing: :class:`UpdateSubscripitonTracingParameters <notification.v4_1.models.UpdateSubscripitonTracingParameters>`
    """
...
class ValueDefinition(Model):
    ...
    :type data_source: list of :class:`InputValue <notification.v4_1.models.InputValue>`
...
class VssNotificationEvent(Model):
    ...
    :type actors: list of :class:`EventActor <microsoft.-visual-studio.-services.-web-api.v4_1.models.EventActor>`
    ...
    :type scopes: list of :class:`EventScope <microsoft.-visual-studio.-services.-web-api.v4_1.models.EventScope>`
    """
