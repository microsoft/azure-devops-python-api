...
class Control(Model):
    ...
    :type contribution: :class:`WitContribution <azure.devops.v4_1.work-item-tracking.models.WitContribution>`
...
class FieldRuleModel(Model):
    ...
    :param actions:
    :type actions: list of :class:`RuleActionModel <azure.devops.v4_1.work-item-tracking.models.RuleActionModel>`
    :param conditions:
    :type conditions: list of :class:`RuleConditionModel <azure.devops.v4_1.work-item-tracking.models.RuleConditionModel>`
    :param friendly_name:
...
class FormLayout(Model):
    ...
    :type extensions: list of :class:`Extension <azure.devops.v4_1.work-item-tracking.models.Extension>`
    :param pages: Top level tabs of the layout.
    :type pages: list of :class:`Page <azure.devops.v4_1.work-item-tracking.models.Page>`
    :param system_controls: Headers controls of the layout.
    :type system_controls: list of :class:`Control <azure.devops.v4_1.work-item-tracking.models.Control>`
    """
...
class Group(Model):
    ...
    :type controls: list of :class:`Control <azure.devops.v4_1.work-item-tracking.models.Control>`
...
class Page(Model):
    ...
    :type sections: list of :class:`Section <azure.devops.v4_1.work-item-tracking.models.Section>`
...
class ProcessModel(Model):
    ...
    :type projects: list of :class:`ProjectReference <azure.devops.v4_1.work-item-tracking.models.ProjectReference>`
    :param properties: Properties of the process
    :type properties: :class:`ProcessProperties <azure.devops.v4_1.work-item-tracking.models.ProcessProperties>`
    :param reference_name: Reference name of the process
    :type reference_name: str
...
class Section(Model):
    ...
    :param groups:
    :type groups: list of :class:`Group <azure.devops.v4_1.work-item-tracking.models.Group>`
    :param id: The id for the layout node.
    :type id: str
    :param overridden: A value indicating whether this layout node has been overridden by a child layout.
    :type overridden: bool
...
class WorkItemBehavior(Model):
    ...
    :type description: str
    :param fields:
    :type fields: list of :class:`WorkItemBehaviorField <azure.devops.v4_1.work-item-tracking.models.WorkItemBehaviorField>`
    :param id:
    :type id: str
    :param inherits:
    :type inherits: :class:`WorkItemBehaviorReference <azure.devops.v4_1.work-item-tracking.models.WorkItemBehaviorReference>`
    :param name:
    :type name: str
    :param overriden:
    :type overriden: bool
...
class WorkItemTypeBehavior(Model):
    ...
    :param behavior:
    :type behavior: :class:`WorkItemBehaviorReference <azure.devops.v4_1.work-item-tracking.models.WorkItemBehaviorReference>`
    :param is_default:
    :type is_default: bool
    :param url:
    :type url: str
...
class WorkItemTypeModel(Model):
    ...
    :param behaviors:
    :type behaviors: list of :class:`WorkItemTypeBehavior <azure.devops.v4_1.work-item-tracking.models.WorkItemTypeBehavior>`
    :param class_:
    :type class_: object
    :param color:
    :type color: str
    ...
    :type is_disabled: bool
    :param layout:
    :type layout: :class:`FormLayout <azure.devops.v4_1.work-item-tracking.models.FormLayout>`
    :param name:
    :type name: str
    :param states:
    :type states: list of :class:`WorkItemStateResultModel <azure.devops.v4_1.work-item-tracking.models.WorkItemStateResultModel>`
    :param url:
    :type url: str
    """
