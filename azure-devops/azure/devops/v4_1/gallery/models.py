...
class AcquisitionOptions(Model):
    ...
    :type default_operation: :class:`AcquisitionOperation <gallery.v4_1.models.AcquisitionOperation>`
    :param item_id: The item id that this options refer to
    :type item_id: str
    :param operations: Operations allowed for the ItemId in this target
    :type operations: list of :class:`AcquisitionOperation <gallery.v4_1.models.AcquisitionOperation>`
...
class AzureRestApiRequestModel(Model):
    ...
    :type asset_details: :class:`AssetDetails <gallery.v4_1.models.AssetDetails>`
...
class CategoriesResult(Model):
    ...
    :param categories:
    :type categories: list of :class:`ExtensionCategory <gallery.v4_1.models.ExtensionCategory>`
    """
...
class ExtensionDailyStats(Model):
    ...
    :type daily_stats: list of :class:`ExtensionDailyStat <gallery.v4_1.models.ExtensionDailyStat>`
...
class ExtensionQueryResult(Model):
    ...
    :type results: list of :class:`ExtensionFilterResult <gallery.v4_1.models.ExtensionFilterResult>`
    """
...
class PublishedExtension(Model):
    ...
    :param publisher:
    :type publisher: :class:`PublisherFacts <gallery.v4_1.models.PublisherFacts>`
    :param release_date: Date on which the extension first went public.
    :type release_date: datetime
    :param shared_with:
    :type shared_with: list of :class:`ExtensionShare <gallery.v4_1.models.ExtensionShare>`
    :param short_description:
    :type short_description: str
    :param statistics:
    :type statistics: list of :class:`ExtensionStatistic <gallery.v4_1.models.ExtensionStatistic>`
    :param tags:
    :type tags: list of str
    :param versions:
    :type versions: list of :class:`ExtensionVersion <gallery.v4_1.models.ExtensionVersion>`
    """
...
class QueryFilter(Model):
    ...
    :type criteria: list of :class:`FilterCriteria <gallery.v4_1.models.FilterCriteria>`
...
class Question(QnAItem):
    ...
    :type responses: list of :class:`Response <gallery.v4_1.models.Response>`
    """
