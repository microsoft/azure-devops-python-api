...
class DataSource(Model):
    ...
    :type authentication_scheme: :class:`AuthenticationSchemeReference <task-agent.v4_1.models.AuthenticationSchemeReference>`
    :param endpoint_url:
    :type endpoint_url: str
    :param headers:
    :type headers: list of :class:`AuthorizationHeader <task-agent.v4_1.models.AuthorizationHeader>`
    :param name:
    :type name: str
    :param resource_url:
...
class DependsOn(Model):
    ...
    :type input: str
    :param map:
    :type map: list of :class:`DependencyBinding <task-agent.v4_1.models.DependencyBinding>`
    """
...
class ServiceEndpoint(Model):
    ...
    :type administrators_group: :class:`IdentityRef <task-agent.v4_1.models.IdentityRef>`
    ...
    :type operation_status: :class:`object <task-agent.v4_1.models.object>`
    :param readers_group: Gets or sets the identity reference for the readers group of the service endpoint.
    :type readers_group: :class:`IdentityRef <task-agent.v4_1.models.IdentityRef>`
...
class TaskAgentAuthorization(Model):
    ...
    :type public_key: :class:`TaskAgentPublicKey <task-agent.v4_1.models.TaskAgentPublicKey>`
    """
...
class TaskAgentPoolMaintenanceDefinition(Model):
    ...
    :param options:
    :type options: :class:`TaskAgentPoolMaintenanceOptions <task-agent.v4_1.models.TaskAgentPoolMaintenanceOptions>`
    :param pool: Pool reference for the maintenance definition
    :type pool: :class:`TaskAgentPoolReference <task-agent.v4_1.models.TaskAgentPoolReference>`
    :param retention_policy:
    :type retention_policy: :class:`TaskAgentPoolMaintenanceRetentionPolicy <task-agent.v4_1.models.TaskAgentPoolMaintenanceRetentionPolicy>`
    :param schedule_setting:
    :type schedule_setting: :class:`TaskAgentPoolMaintenanceSchedule <task-agent.v4_1.models.TaskAgentPoolMaintenanceSchedule>`
    """
...
class TaskGroupStep(Model):
    ...
    :type task: :class:`TaskDefinitionReference <task-agent.v4_1.models.TaskDefinitionReference>`
