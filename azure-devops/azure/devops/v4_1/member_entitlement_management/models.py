...
class OperationResult(Model):
    ...
    :type result: :class:`MemberEntitlement <member-entitlement-management.v4_1.models.MemberEntitlement>`
    """
...
class GroupEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation.
    :type results: list of :class:`GroupOperationResult <member-entitlement-management.v4_1.models.GroupOperationResult>`
    """
...
class MemberEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation
    :type results: list of :class:`OperationResult <member-entitlement-management.v4_1.models.OperationResult>`
    """
