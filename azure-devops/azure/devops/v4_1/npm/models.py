...
class NpmPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <azure.devops.v4_1.npm.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <azure.devops.v4_1.npm.models.MinimalPackageDetails>`
    """
...
class Package(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v4_1.npm.models.ReferenceLinks>`
    ...
    :type source_chain: list of :class:`UpstreamSourceInfo <azure.devops.v4_1.npm.models.UpstreamSourceInfo>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <azure.devops.v4_1.npm.models.JsonPatchOperation>`
    """
