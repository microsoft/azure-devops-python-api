...
class TestClient(Client):
    ...
    def create_test_iteration_result_attachment(self, attachment_request_model, project, run_id, test_case_result_id, iteration_id, action_path=None):
        ...
        [Preview API]
        :param :class:`<TestAttachmentRequestModel> <azure.devops.v4_1.test.models.TestAttachmentRequestModel>` attachment_request_model:
        :param str project: Project ID or project name
        :param int run_id:
        :param int test_case_result_id:
        :param int iteration_id:
        :param str action_path:
        :rtype: :class:`<TestAttachmentReference> <azure.devops.v4_1.test.models.TestAttachmentReference>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_clone_information(self, project, clone_operation_id, include_details=None):
        ...
        :rtype: :class:`<CloneOperationInformation> <azure.devops.v4_1.test.models.CloneOperationInformation>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def clone_test_plan(self, clone_request_body, project, plan_id):
        """CloneTestPlan.
        [Preview API]
        :param :class:`<TestPlanCloneRequest> <azure.devops.v4_1.test.models.TestPlanCloneRequest>` clone_request_body:
        :param str project: Project ID or project name
        :param int plan_id:
        :rtype: :class:`<CloneOperationInformation> <azure.devops.v4_1.test.models.CloneOperationInformation>`
        """
    ...
    def clone_test_suite(self, clone_request_body, project, plan_id, source_suite_id):
        """CloneTestSuite.
        [Preview API]
        :param :class:`<TestSuiteCloneRequest> <azure.devops.v4_1.test.models.TestSuiteCloneRequest>` clone_request_body:
        :param str project: Project ID or project name
        :param int plan_id:
    ...
    def get_code_coverage_summary(self, project, build_id, delta_build_id=None):
        ...
        :rtype: :class:`<CodeCoverageSummary> <azure.devops.v4_1.test.models.CodeCoverageSummary>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_code_coverage_summary(self, coverage_data, project, build_id):
        ...
        :param :class:`<CodeCoverageData> <azure.devops.v4_1.test.models.CodeCoverageData>` coverage_data:
        :param str project: Project ID or project name
        :param int build_id:
        """
        route_values = {}
    ...
    def create_test_configuration(self, test_configuration, project):
        ...
        [Preview API]
        :param :class:`<TestConfiguration> <azure.devops.v4_1.test.models.TestConfiguration>` test_configuration:
        :param str project: Project ID or project name
        :rtype: :class:`<TestConfiguration> <azure.devops.v4_1.test.models.TestConfiguration>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def query_test_result_history(self, filter, project):
        ...
        [Preview API]
        :param :class:`<ResultsFilter> <azure.devops.v4_1.test.models.ResultsFilter>` filter:
        :param str project: Project ID or project name
        :rtype: :class:`<TestResultHistory> <azure.devops.v4_1.test.models.TestResultHistory>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_linked_work_items_by_query(self, work_item_query, project):
        ...
        [Preview API]
        :param :class:`<LinkedWorkItemsQuery> <azure.devops.v4_1.test.models.LinkedWorkItemsQuery>` work_item_query:
        :param str project: Project ID or project name
    ...
    def get_points_by_query(self, query, project, skip=None, top=None):
        """GetPointsByQuery.
        [Preview API]
        :param :class:`<TestPointsQuery> <azure.devops.v4_1.test.models.TestPointsQuery>` query:
        :param str project: Project ID or project name
        :param int skip:
        :param int top:
        :rtype: :class:`<TestPointsQuery> <azure.devops.v4_1.test.models.TestPointsQuery>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_test_result_details_for_build(self, project, build_id, publish_context=None, group_by=None, filter=None, orderby=None, should_include_results=None, query_run_summary_for_in_progress=None):
        ...
        :rtype: :class:`<TestResultsDetails> <azure.devops.v4_1.test.models.TestResultsDetails>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def publish_test_result_document(self, document, project, run_id):
        ...
        [Preview API]
        :param :class:`<TestResultDocument> <azure.devops.v4_1.test.models.TestResultDocument>` document:
        :param str project: Project ID or project name
        :param int run_id:
        :rtype: :class:`<TestResultDocument> <azure.devops.v4_1.test.models.TestResultDocument>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_result_groups_by_build(self, project, build_id, publish_context, fields=None):
        ...
        :param str publish_context:
        :param [str] fields:
        :rtype: :class:`<TestResultsGroupsForBuild> <azure.devops.v4_1.test.models.TestResultsGroupsForBuild>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_result_groups_by_release(self, project, release_id, publish_context, release_env_id=None, fields=None):
        ...
        :param int release_env_id:
        :param [str] fields:
        :rtype: :class:`<TestResultsGroupsForRelease> <azure.devops.v4_1.test.models.TestResultsGroupsForRelease>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_result_retention_settings(self, project):
        ...
        [Preview API]
        :param str project: Project ID or project name
        :rtype: :class:`<ResultRetentionSettings> <azure.devops.v4_1.test.models.ResultRetentionSettings>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_result_retention_settings(self, retention_settings, project):
        ...
        [Preview API]
        :param :class:`<ResultRetentionSettings> <azure.devops.v4_1.test.models.ResultRetentionSettings>` retention_settings:
        :param str project: Project ID or project name
        :rtype: :class:`<ResultRetentionSettings> <azure.devops.v4_1.test.models.ResultRetentionSettings>`
        """
        route_values = {}
    ...
    def get_test_results_by_query(self, query, project):
        ...
        [Preview API]
        :param :class:`<TestResultsQuery> <azure.devops.v4_1.test.models.TestResultsQuery>` query:
        :param str project: Project ID or project name
        :rtype: :class:`<TestResultsQuery> <azure.devops.v4_1.test.models.TestResultsQuery>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def query_test_results_report_for_build(self, project, build_id, publish_context=None, include_failure_details=None, build_to_compare=None):
        ...
        :param :class:`<BuildReference> <azure.devops.v4_1.test.models.BuildReference>` build_to_compare:
        :rtype: :class:`<TestResultSummary> <azure.devops.v4_1.test.models.TestResultSummary>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def query_test_results_report_for_release(self, project, release_id, release_env_id, publish_context=None, include_failure_details=None, release_to_compare=None):
        ...
        :param str publish_context:
        :param bool include_failure_details:
        :param :class:`<ReleaseReference> <azure.devops.v4_1.test.models.ReleaseReference>` release_to_compare:
        :rtype: :class:`<TestResultSummary> <azure.devops.v4_1.test.models.TestResultSummary>`
        """
        route_values = {}
        if project is not None:
    ...
    def query_test_summary_by_requirement(self, results_context, project, work_item_ids=None):
        ...
        [Preview API]
        :param :class:`<TestResultsContext> <azure.devops.v4_1.test.models.TestResultsContext>` results_context:
        :param str project: Project ID or project name
    ...
    def query_result_trend_for_build(self, filter, project):
        ...
        [Preview API]
        :param :class:`<TestResultTrendFilter> <azure.devops.v4_1.test.models.TestResultTrendFilter>` filter:
        :param str project: Project ID or project name
    ...
    def create_test_session(self, test_session, team_context):
        """CreateTestSession.
        [Preview API]
        :param :class:`<TestSession> <azure.devops.v4_1.test.models.TestSession>` test_session:
        :param :class:`<TeamContext> <azure.devops.v4_1.test.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TestSession> <azure.devops.v4_1.test.models.TestSession>`
        """
        project = None
        team = None
    ...
    def create_test_variable(self, test_variable, project):
        """CreateTestVariable.
        [Preview API]
        :param :class:`<TestVariable> <azure.devops.v4_1.test.models.TestVariable>` test_variable:
        :param str project: Project ID or project name
        :rtype: :class:`<TestVariable> <azure.devops.v4_1.test.models.TestVariable>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def add_work_item_to_test_links(self, work_item_to_test_links, project):
        ...
        [Preview API]
        :param :class:`<WorkItemToTestLinks> <azure.devops.v4_1.test.models.WorkItemToTestLinks>` work_item_to_test_links:
        :param str project: Project ID or project name
        :rtype: :class:`<WorkItemToTestLinks> <azure.devops.v4_1.test.models.WorkItemToTestLinks>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def query_test_method_linked_work_items(self, project, test_name):
        ...
        :param str project: Project ID or project name
        :param str test_name:
        :rtype: :class:`<TestToWorkItemLinks> <azure.devops.v4_1.test.models.TestToWorkItemLinks>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
