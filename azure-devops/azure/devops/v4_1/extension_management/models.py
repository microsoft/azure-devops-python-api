...
class ExtensionRequest(Model):
    ...
    :type requested_by: :class:`IdentityRef <extension-management.v4_1.models.IdentityRef>`
    ...
    :type resolved_by: :class:`IdentityRef <extension-management.v4_1.models.IdentityRef>`
    """
...
class InstalledExtensionQuery(Model):
    ...
    :param monikers:
    :type monikers: list of :class:`ExtensionIdentifier <extension-management.v4_1.models.ExtensionIdentifier>`
    """
...
class PublishedExtension(Model):
    ...
    :type installation_targets: list of :class:`InstallationTarget <microsoft.-visual-studio.-services.-gallery.-web-api.v4_1.models.InstallationTarget>`
    :param last_updated:
    :type last_updated: datetime
    ...
    :param publisher:
    :type publisher: :class:`PublisherFacts <microsoft.-visual-studio.-services.-gallery.-web-api.v4_1.models.PublisherFacts>`
    :param release_date: Date on which the extension first went public.
    :type release_date: datetime
    :param shared_with:
    :type shared_with: list of :class:`ExtensionShare <microsoft.-visual-studio.-services.-gallery.-web-api.v4_1.models.ExtensionShare>`
    :param short_description:
    :type short_description: str
    :param statistics:
    :type statistics: list of :class:`ExtensionStatistic <microsoft.-visual-studio.-services.-gallery.-web-api.v4_1.models.ExtensionStatistic>`
    :param tags:
    :type tags: list of str
    :param versions:
    :type versions: list of :class:`ExtensionVersion <microsoft.-visual-studio.-services.-gallery.-web-api.v4_1.models.ExtensionVersion>`
    """
...
class UserExtensionPolicy(Model):
    ...
    :type permissions: :class:`ExtensionPolicy <microsoft.-visual-studio.-services.-gallery.-web-api.v4_1.models.ExtensionPolicy>`
