...
class ExtensionManagementClient(Client):
    ...
    def update_installed_extension(self, extension):
        ...
        :param :class:`<InstalledExtension> <azure.devops.v4_1.extension-management.models.InstalledExtension>` extension:
        :rtype: :class:`<InstalledExtension> <azure.devops.v4_1.extension-management.models.InstalledExtension>`
        """
