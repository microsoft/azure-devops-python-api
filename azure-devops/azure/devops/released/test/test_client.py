...
class TestClient(Client):
    ...
    def create_test_result_attachment(self, attachment_request_model, project, run_id, test_case_result_id):
        ...
        :param :class:`<TestAttachmentRequestModel> <azure.devops.v7_0.test.models.TestAttachmentRequestModel>` attachment_request_model: Attachment details TestAttachmentRequestModel
        ...
        :rtype: :class:`<TestAttachmentReference> <azure.devops.v7_0.test.models.TestAttachmentReference>`
        """
        route_values = {}
    ...
    def create_test_sub_result_attachment(self, attachment_request_model, project, run_id, test_case_result_id, test_sub_result_id):
        ...
        Attach a file to a test result
        :param :class:`<TestAttachmentRequestModel> <azure.devops.v7_0.test.models.TestAttachmentRequestModel>` attachment_request_model: Attachment Request Model.
        :param str project: Project ID or project name
        :param int run_id: ID of the test run that contains the result.
    ...
    def get_test_iteration(self, project, run_id, test_case_result_id, iteration_id, include_action_results=None):
        ...
        :rtype: :class:`<TestIterationDetailsModel> <azure.devops.v7_0.test.models.TestIterationDetailsModel>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_point(self, project, plan_id, suite_id, point_ids, wit_fields=None):
        ...
        :rtype: :class:`<TestPoint> <azure.devops.v7_0.test.models.TestPoint>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_test_points(self, point_update_model, project, plan_id, suite_id, point_ids):
        """UpdateTestPoints.
        Update test points.
        :param :class:`<PointUpdateModel> <azure.devops.v7_0.test.models.PointUpdateModel>` point_update_model: Data to update.
        :param str project: Project ID or project name
        :param int plan_id: ID of the test plan.
        :param int suite_id: ID of the suite that contains the points.
    ...
    def get_points_by_query(self, query, project, skip=None, top=None):
        ...
        :param :class:`<TestPointsQuery> <azure.devops.v7_0.test.models.TestPointsQuery>` query: TestPointsQuery to get test points.
        :param str project: Project ID or project name
        :param int skip: Number of test points to skip..
        :param int top: Number of test points to return.
        :rtype: :class:`<TestPointsQuery> <azure.devops.v7_0.test.models.TestPointsQuery>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_result_retention_settings(self, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<ResultRetentionSettings> <azure.devops.v7_0.test.models.ResultRetentionSettings>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_result_retention_settings(self, retention_settings, project):
        ...
        :param :class:`<ResultRetentionSettings> <azure.devops.v7_0.test.models.ResultRetentionSettings>` retention_settings: Test result retention settings details to be updated
        :param str project: Project ID or project name
        :rtype: :class:`<ResultRetentionSettings> <azure.devops.v7_0.test.models.ResultRetentionSettings>`
        """
        route_values = {}
    ...
    def get_test_result_by_id(self, project, run_id, test_case_result_id, details_to_include=None):
        ...
        :rtype: :class:`<TestCaseResult> <azure.devops.v7_0.test.models.TestCaseResult>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_test_run_statistics(self, project, run_id):
        ...
        :rtype: :class:`<TestRunStatistic> <azure.devops.v7_0.test.models.TestRunStatistic>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_test_run(self, test_run, project):
        """CreateTestRun.
        Create new test run.
        :param :class:`<RunCreateModel> <azure.devops.v7_0.test.models.RunCreateModel>` test_run: Run details RunCreateModel
        :param str project: Project ID or project name
        :rtype: :class:`<TestRun> <azure.devops.v7_0.test.models.TestRun>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_test_run(self, run_update_model, project, run_id):
        ...
        :param :class:`<RunUpdateModel> <azure.devops.v7_0.test.models.RunUpdateModel>` run_update_model: Run details RunUpdateModel
        :param str project: Project ID or project name
    ...
    def create_test_session(self, test_session, team_context):
        ...
        :param :class:`<TestSession> <azure.devops.v7_0.test.models.TestSession>` test_session: Test session details for creation
        :param :class:`<TeamContext> <azure.devops.v7_0.test.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TestSession> <azure.devops.v7_0.test.models.TestSession>`
        """
        project = None
        team = None
    ...
    def update_test_session(self, test_session, team_context):
        ...
        :param :class:`<TestSession> <azure.devops.v7_0.test.models.TestSession>` test_session: Test session details for update
        :param :class:`<TeamContext> <azure.devops.v7_0.test.models.TeamContext>` team_context: The team context for the operation
        :rtype: :class:`<TestSession> <azure.devops.v7_0.test.models.TestSession>`
        """
        project = None
    ...
    def get_test_case_by_id(self, project, plan_id, suite_id, test_case_ids):
        ...
        :rtype: :class:`<SuiteTestCase> <azure.devops.v7_0.test.models.SuiteTestCase>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_suite_test_cases(self, suite_test_case_update_model, project, plan_id, suite_id, test_case_ids):
        ...
        :param :class:`<SuiteTestCaseUpdateModel> <azure.devops.v7_0.test.models.SuiteTestCaseUpdateModel>` suite_test_case_update_model: Model for updation of the properties of test case suite association.
        :param str project: Project ID or project name
        :param int plan_id: ID of the test plan that contains the suite.
        :param int suite_id: ID of the test suite to which the test cases must be added.
        :param str test_case_ids: IDs of the test cases to add to the suite. Ids are specified in comma separated format.
    ...
    def query_test_history(self, filter, project):
        ...
        :param :class:`<TestHistoryQuery> <azure.devops.v7_0.test.models.TestHistoryQuery>` filter: TestHistoryQuery to get history
        :param str project: Project ID or project name
        :rtype: :class:`<TestHistoryQuery> <azure.devops.v7_0.test.models.TestHistoryQuery>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
