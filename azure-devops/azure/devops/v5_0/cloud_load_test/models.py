...
class AgentGroup(Model):
    ...
    :type machine_access_data: list of :class:`AgentGroupAccessData <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.AgentGroupAccessData>`
    :param machine_configuration:
    :type machine_configuration: :class:`WebApiUserLoadTestMachineInput <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.WebApiUserLoadTestMachineInput>`
    :param tenant_id:
    :type tenant_id: str
    """
...
class CounterInstanceSamples(Model):
    ...
    :param values:
    :type values: list of :class:`CounterSample <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.CounterSample>`
    """
...
class CounterSamplesResult(Model):
    ...
    :param values:
    :type values: list of :class:`CounterInstanceSamples <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.CounterInstanceSamples>`
    """
...
class LoadTestDefinition(Model):
    ...
    :param browser_mixs:
    :type browser_mixs: list of :class:`BrowserMix <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.BrowserMix>`
    :param core_count:
    :type core_count: int
    :param cores_per_agent:
    :type cores_per_agent: int
    :param load_generation_geo_locations:
    :type load_generation_geo_locations: list of :class:`LoadGenerationGeoLocation <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.LoadGenerationGeoLocation>`
...
class LoadTestErrors(Model):
    ...
    :type occurrences: int
    :param types:
    :type types: list of :class:`object <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.object>`
    :param url:
    :type url: str
    """
...
class OverridableRunSettings(Model):
    ...
    :type static_agent_run_settings: :class:`StaticAgentRunSetting <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.StaticAgentRunSetting>`
    """
...
class PageSummary(Model):
    ...
    :type percentile_data: list of :class:`SummaryPercentileData <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.SummaryPercentileData>`
    :param scenario_name:
    :type scenario_name: str
    :param test_name:
    :type test_name: str
...
class SubType(Model):
    ...
    :type error_detail_list: list of :class:`ErrorDetails <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.ErrorDetails>`
    :param occurrences:
    :type occurrences: int
    :param sub_type_name:
...
class TenantDetails(Model):
    ...
    :type access_details: list of :class:`AgentGroupAccessData <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.AgentGroupAccessData>`
    :param id:
    :type id: str
    :param static_machines:
    :type static_machines: list of :class:`WebApiTestMachine <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.WebApiTestMachine>`
    :param user_load_agent_input:
    :type user_load_agent_input: :class:`WebApiUserLoadTestMachineInput <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.WebApiUserLoadTestMachineInput>`
...
class TestDefinitionBasic(Model):
    ...
    :param access_data:
    :type access_data: :class:`DropAccessData <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.DropAccessData>`
    :param created_by:
    :type created_by: IdentityRef
    :param created_date:
...
class TestDrop(Model):
    ...
    :type load_test_definition: :class:`LoadTestDefinition <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.LoadTestDefinition>`
    :param test_run_id:
...
class TestResults(Model):
    ...
    :type counter_groups: list of :class:`CounterGroup <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.CounterGroup>`
    :param diagnostics:
    :type diagnostics: :class:`Diagnostics <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.Diagnostics>`
    :param results_url:
...
class TestResultsSummary(Model):
    ...
    :type overall_page_summary: :class:`PageSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.PageSummary>`
    :param overall_request_summary:
    :type overall_request_summary: :class:`RequestSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.RequestSummary>`
    :param overall_scenario_summary:
    :type overall_scenario_summary: :class:`ScenarioSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.ScenarioSummary>`
    :param overall_test_summary:
    :type overall_test_summary: :class:`TestSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.TestSummary>`
    :param overall_transaction_summary:
    :type overall_transaction_summary: :class:`TransactionSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.TransactionSummary>`
    :param top_slow_pages:
    :type top_slow_pages: list of :class:`PageSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.PageSummary>`
    :param top_slow_requests:
    :type top_slow_requests: list of :class:`RequestSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.RequestSummary>`
    :param top_slow_tests:
    :type top_slow_tests: list of :class:`TestSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.TestSummary>`
    :param top_slow_transactions:
    :type top_slow_transactions: list of :class:`TransactionSummary <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.TransactionSummary>`
    """
...
class TestRunBasic(Model):
    ...
    :type run_specific_details: :class:`LoadTestRunDetails <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.LoadTestRunDetails>`
    :param run_type:
...
class TestRunCounterInstance(Model):
    ...
    :param summary_data:
    :type summary_data: :class:`WebInstanceSummaryData <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.WebInstanceSummaryData>`
    :param unique_name:
...
class WebApiLoadTestMachineInput(Model):
    ...
    :type setup_configuration: :class:`WebApiSetupParamaters <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.WebApiSetupParamaters>`
...
class TestDefinition(TestDefinitionBasic):
    ...
    :param run_settings:
    :type run_settings: :class:`LoadTestRunSettings <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.LoadTestRunSettings>`
    :param static_agent_run_settings:
    :type static_agent_run_settings: :class:`StaticAgentRunSetting <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.StaticAgentRunSetting>`
    :param test_details:
    :type test_details: :class:`LoadTest <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.LoadTest>`
    """
...
class TestRun(TestRunBasic):
    ...
    :type url: str
    :param abort_message:
    :type abort_message: :class:`TestRunAbortMessage <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.TestRunAbortMessage>`
    ...
    :type supersede_run_settings: :class:`OverridableRunSettings <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.OverridableRunSettings>`
    :param test_drop:
    :type test_drop: :class:`TestDropRef <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.TestDropRef>`
    :param test_settings:
    :type test_settings: :class:`TestSettings <azure.devops.v5_0.microsoft.-visual-studio.-test-service.-web-api-model.models.TestSettings>`
