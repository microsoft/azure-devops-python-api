...
class AccountMyWorkResult(Model):
    ...
    :type work_item_details: list of :class:`AccountWorkWorkItemModel <azure.devops.v5_0.work-item-tracking.models.AccountWorkWorkItemModel>`
    """
...
class IdentityReference(IdentityRef):
    ...
    :param _links: This field contains zero or more interesting links about the graph subject. These links may be invoked to obtain additional relationships or more detailed information about this graph subject.
    :type _links: :class:`ReferenceLinks <azure.devops.v5_0.work-item-tracking.models.ReferenceLinks>`
    :param descriptor: The descriptor is the primary way to reference the graph subject while the system is running. This field will uniquely identify the same graph subject across both Accounts and Organizations.
    :type descriptor: str
    :param display_name: This is the non-unique display name of the graph subject. To change this field, you must alter its value in the source provider.
    :type display_name: str
...
class ProjectWorkItemStateColors(Model):
    ...
    :type work_item_type_state_colors: list of :class:`WorkItemTypeStateColors <azure.devops.v5_0.work-item-tracking.models.WorkItemTypeStateColors>`
    """
...
class QueryHierarchyItemsResult(Model):
    ...
    :type value: list of :class:`QueryHierarchyItem <azure.devops.v5_0.work-item-tracking.models.QueryHierarchyItem>`
    """
...
class WorkItemLink(Model):
    ...
    :type source: :class:`WorkItemReference <azure.devops.v5_0.work-item-tracking.models.WorkItemReference>`
    :param target: The target work item.
    :type target: :class:`WorkItemReference <azure.devops.v5_0.work-item-tracking.models.WorkItemReference>`
    """
...
class WorkItemQueryClause(Model):
    ...
    :type clauses: list of :class:`WorkItemQueryClause <azure.devops.v5_0.work-item-tracking.models.WorkItemQueryClause>`
    :param field: Field associated with condition
    :type field: :class:`WorkItemFieldReference <azure.devops.v5_0.work-item-tracking.models.WorkItemFieldReference>`
    :param field_value: Right side of the condition when a field to field comparison
    :type field_value: :class:`WorkItemFieldReference <azure.devops.v5_0.work-item-tracking.models.WorkItemFieldReference>`
    ...
    :type operator: :class:`WorkItemFieldOperation <azure.devops.v5_0.work-item-tracking.models.WorkItemFieldOperation>`
...
class WorkItemQueryResult(Model):
    ...
    :type columns: list of :class:`WorkItemFieldReference <azure.devops.v5_0.work-item-tracking.models.WorkItemFieldReference>`
    ...
    :type sort_columns: list of :class:`WorkItemQuerySortColumn <azure.devops.v5_0.work-item-tracking.models.WorkItemQuerySortColumn>`
    :param work_item_relations: The work item links returned by the query.
    :type work_item_relations: list of :class:`WorkItemLink <azure.devops.v5_0.work-item-tracking.models.WorkItemLink>`
    :param work_items: The work items returned by the query.
    :type work_items: list of :class:`WorkItemReference <azure.devops.v5_0.work-item-tracking.models.WorkItemReference>`
    """
...
class WorkItemRelationUpdates(Model):
    ...
    :type added: list of :class:`WorkItemRelation <azure.devops.v5_0.work-item-tracking.models.WorkItemRelation>`
    :param removed: List of removed relations.
    :type removed: list of :class:`WorkItemRelation <azure.devops.v5_0.work-item-tracking.models.WorkItemRelation>`
    :param updated: List of updated relations.
    :type updated: list of :class:`WorkItemRelation <azure.devops.v5_0.work-item-tracking.models.WorkItemRelation>`
    """
...
class WorkItemTypeFieldInstanceBase(WorkItemFieldReference):
    ...
    :type dependent_fields: list of :class:`WorkItemFieldReference <azure.devops.v5_0.work-item-tracking.models.WorkItemFieldReference>`
...
class WorkItemTypeStateColors(Model):
    ...
    :type state_colors: list of :class:`WorkItemStateColor <azure.devops.v5_0.work-item-tracking.models.WorkItemStateColor>`
...
class WorkItemDelete(WorkItemDeleteReference):
    ...
    :type resource: :class:`WorkItem <azure.devops.v5_0.work-item-tracking.models.WorkItem>`
    """
...
class WorkItemType(WorkItemTrackingResource):
    ...
    :type field_instances: list of :class:`WorkItemTypeFieldInstance <azure.devops.v5_0.work-item-tracking.models.WorkItemTypeFieldInstance>`
    :param fields: The fields that exist on the work item type.
    :type fields: list of :class:`WorkItemTypeFieldInstance <azure.devops.v5_0.work-item-tracking.models.WorkItemTypeFieldInstance>`
    :param icon: The icon of the work item type.
    :type icon: :class:`WorkItemIcon <azure.devops.v5_0.work-item-tracking.models.WorkItemIcon>`
    ...
    :type states: list of :class:`WorkItemStateColor <azure.devops.v5_0.work-item-tracking.models.WorkItemStateColor>`
...
class WorkItemTypeCategory(WorkItemTrackingResource):
    ...
    :type default_work_item_type: :class:`WorkItemTypeReference <azure.devops.v5_0.work-item-tracking.models.WorkItemTypeReference>`
    ...
    :type work_item_types: list of :class:`WorkItemTypeReference <azure.devops.v5_0.work-item-tracking.models.WorkItemTypeReference>`
    """
...
class WorkItemUpdate(WorkItemTrackingResource):
    ...
    :type relations: :class:`WorkItemRelationUpdates <azure.devops.v5_0.work-item-tracking.models.WorkItemRelationUpdates>`
    :param rev: The revision number of work item update.
    :type rev: int
    :param revised_by: Identity for the work item update.
    :type revised_by: :class:`IdentityReference <azure.devops.v5_0.work-item-tracking.models.IdentityReference>`
...
class QueryHierarchyItem(WorkItemTrackingResource):
    ...
    :type children: list of :class:`QueryHierarchyItem <azure.devops.v5_0.work-item-tracking.models.QueryHierarchyItem>`
    :param clauses: The clauses for a flat query.
    :type clauses: :class:`WorkItemQueryClause <azure.devops.v5_0.work-item-tracking.models.WorkItemQueryClause>`
    :param columns: The columns of the query.
    :type columns: list of :class:`WorkItemFieldReference <azure.devops.v5_0.work-item-tracking.models.WorkItemFieldReference>`
    :param created_by: The identity who created the query item.
    :type created_by: :class:`IdentityReference <azure.devops.v5_0.work-item-tracking.models.IdentityReference>`
    ...
    :type last_executed_by: :class:`IdentityReference <azure.devops.v5_0.work-item-tracking.models.IdentityReference>`
    ...
    :type last_modified_by: :class:`IdentityReference <azure.devops.v5_0.work-item-tracking.models.IdentityReference>`
    :param last_modified_date: When the query item was last modified.
    :type last_modified_date: datetime
    :param link_clauses: The link query clause.
    :type link_clauses: :class:`WorkItemQueryClause <azure.devops.v5_0.work-item-tracking.models.WorkItemQueryClause>`
    ...
    :type source_clauses: :class:`WorkItemQueryClause <azure.devops.v5_0.work-item-tracking.models.WorkItemQueryClause>`
    :param target_clauses: The target clauses in a tree or one-hop link query.
    :type target_clauses: :class:`WorkItemQueryClause <azure.devops.v5_0.work-item-tracking.models.WorkItemQueryClause>`
...
class WorkItem(WorkItemTrackingResource):
    ...
    :type relations: list of :class:`WorkItemRelation <azure.devops.v5_0.work-item-tracking.models.WorkItemRelation>`
...
class WorkItemClassificationNode(WorkItemTrackingResource):
    ...
    :type children: list of :class:`WorkItemClassificationNode <azure.devops.v5_0.work-item-tracking.models.WorkItemClassificationNode>`
...
class WorkItemComments(WorkItemTrackingResource):
    ...
    :type comments: list of :class:`WorkItemComment <azure.devops.v5_0.work-item-tracking.models.WorkItemComment>`
...
class WorkItemField(WorkItemTrackingResource):
    ...
    :type supported_operations: list of :class:`WorkItemFieldOperation <azure.devops.v5_0.work-item-tracking.models.WorkItemFieldOperation>`
