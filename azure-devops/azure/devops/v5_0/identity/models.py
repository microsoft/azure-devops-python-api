...
class ChangedIdentities(Model):
    ...
    :type identities: list of :class:`Identity <azure.devops.v5_0.identities.models.Identity>`
    :param more_data: More data available, set to true if pagesize is specified.
    :type more_data: bool
    :param sequence_context: Last Identity SequenceId
    :type sequence_context: :class:`ChangedIdentitiesContext <azure.devops.v5_0.identities.models.ChangedIdentitiesContext>`
    """
...
class GroupMembership(Model):
    ...
    :type active: bool
    :param descriptor:
    :type descriptor: :class:`str <azure.devops.v5_0.identities.models.str>`
    :param id:
    :type id: str
    :param queried_id:
    :type queried_id: str
...
class IdentityBase(Model):
    ...
    :param member_of:
    :type member_of: list of :class:`str <azure.devops.v5_0.identities.models.str>`
    :param members:
    :type members: list of :class:`str <azure.devops.v5_0.identities.models.str>`
    :param meta_type_id:
    :type meta_type_id: int
    :param properties:
    :type properties: :class:`object <azure.devops.v5_0.identities.models.object>`
    ...
    :type subject_descriptor: :class:`str <azure.devops.v5_0.identities.models.str>`
...
class IdentityBatchInfo(Model):
    ...
    :param descriptors:
    :type descriptors: list of :class:`str <azure.devops.v5_0.identities.models.str>`
    :param identity_ids:
    ...
    :type subject_descriptors: list of :class:`str <azure.devops.v5_0.identities.models.str>`
    """
...
class IdentityScope(Model):
    ...
    :type administrators: :class:`str <azure.devops.v5_0.identities.models.str>`
    :param id:
    :type id: str
    :param is_active:
    :type is_active: bool
...
class IdentitySelf(Model):
    ...
    :type tenants: list of :class:`TenantInfo <azure.devops.v5_0.identities.models.TenantInfo>`
    """
...
class IdentitySnapshot(Model):
    ...
    :param groups:
    :type groups: list of :class:`Identity <azure.devops.v5_0.identities.models.Identity>`
    :param identity_ids:
    :type identity_ids: list of str
    :param memberships:
    :type memberships: list of :class:`GroupMembership <azure.devops.v5_0.identities.models.GroupMembership>`
    :param scope_id:
    :type scope_id: str
    :param scopes:
    :type scopes: list of :class:`IdentityScope <azure.devops.v5_0.identities.models.IdentityScope>`
    """
