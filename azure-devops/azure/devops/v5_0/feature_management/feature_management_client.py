...
class FeatureManagementClient(Client):
    ...
    def set_feature_state(self, feature, feature_id, user_scope, reason=None, reason_code=None):
        ...
        :param :class:`<ContributedFeatureState> <azure.devops.v5_0.feature_management.models.ContributedFeatureState>` feature: Posted feature state object. Should specify the effective value.
        :param str feature_id: Contribution id of the feature
    ...
    def query_feature_states(self, query):
        ...
        :param :class:`<ContributedFeatureStateQuery> <azure.devops.v5_0.feature_management.models.ContributedFeatureStateQuery>` query: Features to query along with current scope values
    ...
    def query_feature_states_for_default_scope(self, query, user_scope):
        ...
        :param :class:`<ContributedFeatureStateQuery> <azure.devops.v5_0.feature_management.models.ContributedFeatureStateQuery>` query: Query describing the features to query.
