...
class MemberEntitlementManagementClient(Client):
    ...
    def add_group_entitlement(self, group_entitlement, rule_option=None):
        ...
        :rtype: :class:`<GroupEntitlementOperationReference> <azure.devops.v5_0.member-entitlement-management.models.GroupEntitlementOperationReference>`
        """
        query_parameters = {}
    ...
    def get_group_entitlement(self, group_id):
        ...
        :rtype: :class:`<GroupEntitlement> <azure.devops.v5_0.member-entitlement-management.models.GroupEntitlement>`
        """
        route_values = {}
        if group_id is not None:
            route_values['groupId'] = self._serialize.url('group_id', group_id, 'str')
    ...
    def update_group_entitlement(self, document, group_id, rule_option=None):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v5_0.member-entitlement-management.models.[JsonPatchOperation]>` document: JsonPatchDocument containing the operations to perform on the group.
        :param str group_id: ID of the group.
    ...
    def get_group_members(self, group_id, max_results=None, paging_token=None):
        ...
        :rtype: :class:`<PagedGraphMemberList> <azure.devops.v5_0.member-entitlement-management.models.PagedGraphMemberList>`
        """
        route_values = {}
        if group_id is not None:
            route_values['groupId'] = self._serialize.url('group_id', group_id, 'str')
    ...
    def add_user_entitlement(self, user_entitlement):
        ...
        :param :class:`<UserEntitlement> <azure.devops.v5_0.member-entitlement-management.models.UserEntitlement>` user_entitlement: UserEntitlement object specifying License, Extensions and Project/Team groups the user should be added to.
        :rtype: :class:`<UserEntitlementsPostResponse> <azure.devops.v5_0.member-entitlement-management.models.UserEntitlementsPostResponse>`
        """
    ...
    def update_user_entitlements(self, document, do_not_send_invite_for_new_users=None):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v5_0.member-entitlement-management.models.[JsonPatchOperation]>` document: JsonPatchDocument containing the operations to perform.
        :param bool do_not_send_invite_for_new_users: Whether to send email invites to new users or not
        :rtype: :class:`<UserEntitlementOperationReference> <azure.devops.v5_0.member-entitlement-management.models.UserEntitlementOperationReference>`
        """
        query_parameters = {}
    ...
    def get_user_entitlement(self, user_id):
        ...
        :param str user_id: ID of the user.
        :rtype: :class:`<UserEntitlement> <azure.devops.v5_0.member-entitlement-management.models.UserEntitlement>`
        """
        route_values = {}
        if user_id is not None:
            route_values['userId'] = self._serialize.url('user_id', user_id, 'str')
    ...
    def update_user_entitlement(self, document, user_id):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v5_0.member-entitlement-management.models.[JsonPatchOperation]>` document: JsonPatchDocument containing the operations to perform on the user.
        :param str user_id: ID of the user.
        :rtype: :class:`<UserEntitlementsPatchResponse> <azure.devops.v5_0.member-entitlement-management.models.UserEntitlementsPatchResponse>`
        """
        route_values = {}
        if user_id is not None:
            route_values['userId'] = self._serialize.url('user_id', user_id, 'str')
    ...
    def get_users_summary(self, select=None):
        ...
        :rtype: :class:`<UsersSummary> <azure.devops.v5_0.member-entitlement-management.models.UsersSummary>`
        """
        query_parameters = {}
