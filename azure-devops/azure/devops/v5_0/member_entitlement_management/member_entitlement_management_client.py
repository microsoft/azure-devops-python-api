...
class MemberEntitlementManagementClient(Client):
    ...
    def add_user_entitlement(self, user_entitlement):
        ...
        :param :class:`<UserEntitlement> <azure.devops.v5_0.member_entitlement_management.models.UserEntitlement>` user_entitlement: UserEntitlement object specifying License, Extensions and Project/Team groups the user should be added to.
    ...
    def update_user_entitlements(self, document, do_not_send_invite_for_new_users=None):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v5_0.member_entitlement_management.models.[JsonPatchOperation]>` document: JsonPatchDocument containing the operations to perform.
