...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v5_0.uPack.models.ReferenceLinks>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <azure.devops.v5_0.uPack.models.JsonPatchOperation>`
    """
...
class UPackPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <azure.devops.v5_0.uPack.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <azure.devops.v5_0.uPack.models.MinimalPackageDetails>`
    """
