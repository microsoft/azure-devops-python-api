...
class WorkItemTrackingProcessClient(Client):
    ...
    def create_process_behavior(self, behavior, process_id):
        ...
        :rtype: :class:`<ProcessBehavior> <azure.devops.v5_0.work-item-tracking-process.models.ProcessBehavior>`
        """
        route_values = {}
    ...
    def create_control_in_group(self, control, process_id, wit_ref_name, group_id):
        ...
        :param :class:`<Control> <azure.devops.v5_0.work_item_tracking_process.models.Control>` control: The control.
        :param str process_id: The ID of the process.
        ...
        :rtype: :class:`<Control> <azure.devops.v5_0.work-item-tracking-process.models.Control>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_control(self, control, process_id, wit_ref_name, group_id, control_id):
        ...
        :param :class:`<Control> <azure.devops.v5_0.work_item_tracking_process.models.Control>` control: The updated control.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str group_id: The ID of the group.
        :param str control_id: The ID of the control.
    ...
    def add_field_to_work_item_type(self, field, process_id, wit_ref_name):
        ...
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<ProcessWorkItemTypeField> <azure.devops.v5_0.work-item-tracking-process.models.ProcessWorkItemTypeField>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_work_item_type_field(self, field, process_id, wit_ref_name, field_ref_name):
        ...
        :param :class:`<UpdateProcessWorkItemTypeFieldRequest> <azure.devops.v5_0.work_item_tracking_process.models.UpdateProcessWorkItemTypeFieldRequest>` field:
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str field_ref_name: The reference name of the field.
        :rtype: :class:`<ProcessWorkItemTypeField> <azure.devops.v5_0.work-item-tracking-process.models.ProcessWorkItemTypeField>`
    ...
    def add_group(self, group, process_id, wit_ref_name, page_id, section_id):
        ...
        :param :class:`<Group> <azure.devops.v5_0.work_item_tracking_process.models.Group>` group: The group.
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :param str page_id: The ID of the page to add the group to.
        :param str section_id: The ID of the section to add the group to.
        :rtype: :class:`<Group> <azure.devops.v5_0.work-item-tracking-process.models.Group>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def get_form_layout(self, process_id, wit_ref_name):
        ...
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<FormLayout> <azure.devops.v5_0.work-item-tracking-process.models.FormLayout>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_list(self, picklist):
        ...
        :param :class:`<PickList> <azure.devops.v5_0.work_item_tracking_process.models.PickList>` picklist: Picklist
        :rtype: :class:`<PickList> <azure.devops.v5_0.work-item-tracking-process.models.PickList>`
        """
    ...
    def add_page(self, page, process_id, wit_ref_name):
        ...
        :param str process_id: The ID of the process.
        :param str wit_ref_name: The reference name of the work item type.
        :rtype: :class:`<Page> <azure.devops.v5_0.work-item-tracking-process.models.Page>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_new_process(self, create_request):
        ...
        :rtype: :class:`<ProcessInfo> <azure.devops.v5_0.work-item-tracking-process.models.ProcessInfo>`
        """
    ...
    def add_process_work_item_type_rule(self, process_rule_create, process_id, wit_ref_name):
        ...
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<ProcessRule> <azure.devops.v5_0.work-item-tracking-process.models.ProcessRule>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_state_definition(self, state_model, process_id, wit_ref_name):
        ...
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v5_0.work-item-tracking-process.models.WorkItemStateResultModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def hide_state_definition(self, hide_state_model, process_id, wit_ref_name, state_id):
        ...
        :param :class:`<HideStateModel> <azure.devops.v5_0.work_item_tracking_process.models.HideStateModel>` hide_state_model:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :param str state_id: The ID of the state
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v5_0.work-item-tracking-process.models.WorkItemStateResultModel>`
    ...
    def create_process_work_item_type(self, work_item_type, process_id):
        ...
        :rtype: :class:`<ProcessWorkItemType> <azure.devops.v5_0.work-item-tracking-process.models.ProcessWorkItemType>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def add_behavior_to_work_item_type(self, behavior, process_id, wit_ref_name_for_behaviors):
        ...
        :param :class:`<WorkItemTypeBehavior> <azure.devops.v5_0.work_item_tracking_process.models.WorkItemTypeBehavior>` behavior:
        :param str process_id: The ID of the process
        :param str wit_ref_name_for_behaviors: Work item type reference name for the behavior
        :rtype: :class:`<WorkItemTypeBehavior> <azure.devops.v5_0.work-item-tracking-process.models.WorkItemTypeBehavior>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
