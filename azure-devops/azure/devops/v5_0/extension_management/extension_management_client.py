...
class ExtensionManagementClient(Client):
    ...
    def update_installed_extension(self, extension):
        ...
        :param :class:`<InstalledExtension> <azure.devops.v5_0.extension-management.models.InstalledExtension>` extension:
        :rtype: :class:`<InstalledExtension> <azure.devops.v5_0.extension-management.models.InstalledExtension>`
        """
