...
class BehaviorCreateModel(Model):
    ...
    def __init__(self, color=None, id=None, inherits=None, name=None):
...
class FieldModel(Model):
    ...
    :type pick_list: :class:`PickListMetadataModel <azure.devops.v5_0.work_item_tracking.models.PickListMetadataModel>`
...
class PickListModel(PickListMetadataModel):
    ...
    :type items: list of :class:`PickListItemModel <azure.devops.v5_0.work_item_tracking.models.PickListItemModel>`
    """
...
class WorkItemTypeFieldModel2(Model):
    ...
    def __init__(self, allow_groups=None, default_value=None, name=None, pick_list=None, read_only=None, reference_name=None, required=None, type=None, url=None):
        super(WorkItemTypeFieldModel2, self).__init__()
        self.allow_groups = allow_groups
        self.default_value = default_value
        self.name = name
        self.pick_list = pick_list
