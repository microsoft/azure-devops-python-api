...
class WorkItemTrackingProcessDefinitionsClient(Client):
    ...
    def __init__(self, base_url=None, creds=None):
        super(WorkItemTrackingProcessDefinitionsClient, self).__init__(base_url, creds)
    ...
    def create_behavior(self, behavior, process_id):
        ...
        :param :class:`<BehaviorCreateModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.BehaviorCreateModel>` behavior:
        :param str process_id: The ID of the process
        :rtype: :class:`<BehaviorModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.BehaviorModel>`
        """
        route_values = {}
    ...
    def replace_behavior(self, behavior_data, process_id, behavior_id):
        ...
        :param :class:`<BehaviorReplaceModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.BehaviorReplaceModel>` behavior_data:
        :param str process_id: The ID of the process
        :param str behavior_id: The ID of the behavior
        :rtype: :class:`<BehaviorModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.BehaviorModel>`
        """
    ...
    def add_control_to_group(self, control, process_id, wit_ref_name, group_id):
        ...
        :param :class:`<Control> <azure.devops.v5_0.work_item_tracking_process_definitions.models.Control>` control: The control
        :param str process_id: The ID of the process
        ...
        :rtype: :class:`<Control> <azure.devops.v5_0.work_item_tracking_process_definitions.models.Control>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def edit_control(self, control, process_id, wit_ref_name, group_id, control_id):
        ...
        :param :class:`<Control> <azure.devops.v5_0.work_item_tracking_process_definitions.models.Control>` control: The updated control
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
    ...
    def create_field(self, field, process_id):
        ...
        :param :class:`<FieldModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.FieldModel>` field:
        :param str process_id: The ID of the process
        :rtype: :class:`<FieldModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.FieldModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_field(self, field, process_id):
        ...
        :param :class:`<FieldUpdate> <azure.devops.v5_0.work_item_tracking_process_definitions.models.FieldUpdate>` field:
        :param str process_id: The ID of the process
        :rtype: :class:`<FieldModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.FieldModel>`
        """
        route_values = {}
    ...
    def add_group(self, group, process_id, wit_ref_name, page_id, section_id):
        ...
        :param :class:`<Group> <azure.devops.v5_0.work_item_tracking_process_definitions.models.Group>` group: The group
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :param str page_id: The ID of the page to add the group to
        :param str section_id: The ID of the section to add the group to
        :rtype: :class:`<Group> <azure.devops.v5_0.work_item_tracking_process_definitions.models.Group>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def edit_group(self, group, process_id, wit_ref_name, page_id, section_id, group_id):
        ...
        :param :class:`<Group> <azure.devops.v5_0.work_item_tracking_process_definitions.models.Group>` group: The updated group
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
    ...
    def get_form_layout(self, process_id, wit_ref_name):
        ...
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<FormLayout> <azure.devops.v5_0.work_item_tracking_process_definitions.models.FormLayout>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_list(self, picklist):
        ...
        :param :class:`<PickListModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.PickListModel>` picklist:
        :rtype: :class:`<PickListModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.PickListModel>`
        """
    ...
    def add_page(self, page, process_id, wit_ref_name):
        ...
        :param :class:`<Page> <azure.devops.v5_0.work_item_tracking_process_definitions.models.Page>` page: The page
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<Page> <azure.devops.v5_0.work_item_tracking_process_definitions.models.Page>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_state_definition(self, state_model, process_id, wit_ref_name):
        ...
        :param :class:`<WorkItemStateInputModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemStateInputModel>` state_model:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemStateResultModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def hide_state_definition(self, hide_state_model, process_id, wit_ref_name, state_id):
        ...
        :param :class:`<HideStateModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.HideStateModel>` hide_state_model:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :param str state_id: The ID of the state
        :rtype: :class:`<WorkItemStateResultModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemStateResultModel>`
    ...
    def add_behavior_to_work_item_type(self, behavior, process_id, wit_ref_name_for_behaviors):
        ...
        :param :class:`<WorkItemTypeBehavior> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemTypeBehavior>` behavior:
        :param str process_id: The ID of the process
        :param str wit_ref_name_for_behaviors: Work item type reference name for the behavior
        :rtype: :class:`<WorkItemTypeBehavior> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemTypeBehavior>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def create_work_item_type(self, work_item_type, process_id):
        ...
        :param :class:`<WorkItemTypeModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemTypeModel>` work_item_type:
        :param str process_id: The ID of the process
        :rtype: :class:`<WorkItemTypeModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemTypeModel>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
    ...
    def update_work_item_type(self, work_item_type_update, process_id, wit_ref_name):
        ...
        :param :class:`<WorkItemTypeUpdateModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemTypeUpdateModel>` work_item_type_update:
        :param str process_id: The ID of the process
        :param str wit_ref_name: The reference name of the work item type
        :rtype: :class:`<WorkItemTypeModel> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemTypeModel>`
        """
    ...
    def add_field_to_work_item_type(self, field, process_id, wit_ref_name_for_fields):
        ...
        :param :class:`<WorkItemTypeFieldModel2> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemTypeFieldModel2>` field:
        :param str process_id: The ID of the process
        :param str wit_ref_name_for_fields: Work item type reference name for the field
        :rtype: :class:`<WorkItemTypeFieldModel2> <azure.devops.v5_0.work_item_tracking_process_definitions.models.WorkItemTypeFieldModel2>`
        """
        route_values = {}
        if process_id is not None:
            route_values['processId'] = self._serialize.url('process_id', process_id, 'str')
        ...
        content = self._serialize.body(field, 'WorkItemTypeFieldModel2')
        response = self._send(http_method='POST',
                              location_id='976713b4-a62e-499e-94dc-eeb869ea9126',
                              version='5.0-preview.1',
                              route_values=route_values,
                              content=content)
        return self._deserialize('WorkItemTypeFieldModel2', response)
    ...
    def get_work_item_type_fields(self, process_id, wit_ref_name_for_fields):
        ...
        response = self._send(http_method='GET',
                              ...
                              version='5.0-preview.1',
                              route_values=route_values)
        return self._deserialize('[WorkItemTypeFieldModel2]', self._unwrap_collection(response))
