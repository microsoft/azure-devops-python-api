...
class ServiceHooksClient(Client):
    ...
    def get_subscription_diagnostics(self, subscription_id):
        ...
        :rtype: :class:`<SubscriptionDiagnostics> <azure.devops.v5_0.service-hooks.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def update_subscription_diagnostics(self, update_parameters, subscription_id):
        ...
        [Preview API]
        :param :class:`<UpdateSubscripitonDiagnosticsParameters> <azure.devops.v5_0.service-hooks.models.UpdateSubscripitonDiagnosticsParameters>` update_parameters:
        :param str subscription_id:
        :rtype: :class:`<SubscriptionDiagnostics> <azure.devops.v5_0.service-hooks.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def query_notifications(self, query):
        ...
        :param :class:`<NotificationsQuery> <azure.devops.v5_0.service-hooks.models.NotificationsQuery>` query:
    ...
    def query_input_values(self, input_values_query, publisher_id):
        """QueryInputValues.
        :param :class:`<InputValuesQuery> <azure.devops.v5_0.service-hooks.models.InputValuesQuery>` input_values_query:
        :param str publisher_id:
    ...
    def query_publishers(self, query):
        ...
        :param :class:`<PublishersQuery> <azure.devops.v5_0.service-hooks.models.PublishersQuery>` query:
    ...
    def create_subscription(self, subscription):
        ...
        :param :class:`<Subscription> <azure.devops.v5_0.service-hooks.models.Subscription>` subscription: Subscription to be created.
    ...
    def replace_subscription(self, subscription, subscription_id=None):
        ...
        :param :class:`<Subscription> <azure.devops.v5_0.service-hooks.models.Subscription>` subscription:
        :param str subscription_id:
        :rtype: :class:`<Subscription> <azure.devops.v5_0.service-hooks.models.Subscription>`
        """
        route_values = {}
    ...
    def create_subscriptions_query(self, query):
        ...
        :param :class:`<SubscriptionsQuery> <azure.devops.v5_0.service-hooks.models.SubscriptionsQuery>` query:
    ...
    def create_test_notification(self, test_notification, use_real_data=None):
        ...
        :param :class:`<Notification> <azure.devops.v5_0.service-hooks.models.Notification>` test_notification:
