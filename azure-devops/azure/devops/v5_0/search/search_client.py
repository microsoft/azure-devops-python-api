...
class SearchClient(Client):
    ...
    def fetch_code_search_results(self, request, project=None):
        ...
        :param :class:`<CodeSearchRequest> <azure.devops.v5_0.search.models.CodeSearchRequest>` request: The Code Search Request.
        :param str project: Project ID or project name
        :rtype: :class:`<CodeSearchResponse> <azure.devops.v5_0.search.models.CodeSearchResponse>`
        """
        route_values = {}
    ...
    def fetch_wiki_search_results(self, request, project=None):
        ...
        :param :class:`<WikiSearchRequest> <azure.devops.v5_0.search.models.WikiSearchRequest>` request: The Wiki Search Request.
        :param str project: Project ID or project name
        :rtype: :class:`<WikiSearchResponse> <azure.devops.v5_0.search.models.WikiSearchResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def fetch_work_item_search_results(self, request, project=None):
        ...
        [Preview API] Provides a set of results for the search text.
        :param :class:`<WorkItemSearchRequest> <azure.devops.v5_0.search.models.WorkItemSearchRequest>` request: The Work Item Search Request.
        :param str project: Project ID or project name
        :rtype: :class:`<WorkItemSearchResponse> <azure.devops.v5_0.search.models.WorkItemSearchResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
