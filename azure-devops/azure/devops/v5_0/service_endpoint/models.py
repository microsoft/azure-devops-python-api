...
class AzureManagementGroupQueryResult(Model):
    ...
    :type value: list of :class:`AzureManagementGroup <azure.devops.v5_0.service-endpoint.models.AzureManagementGroup>`
    """
...
class AzureSubscriptionQueryResult(Model):
    ...
    :type error_message: str
    :param value:
    :type value: list of :class:`AzureSubscription <azure.devops.v5_0.service-endpoint.models.AzureSubscription>`
    """
...
class DataSource(Model):
    ...
    :type authentication_scheme: :class:`AuthenticationSchemeReference <azure.devops.v5_0.service-endpoint.models.AuthenticationSchemeReference>`
    ...
    :param headers:
    :type headers: list of :class:`AuthorizationHeader <azure.devops.v5_0.service-endpoint.models.AuthorizationHeader>`
...
class DependsOn(Model):
    ...
    :type input: str
    :param map:
    :type map: list of :class:`DependencyBinding <azure.devops.v5_0.service-endpoint.models.DependencyBinding>`
    """
...
class EndpointUrl(Model):
    ...
    :type depends_on: :class:`DependsOn <azure.devops.v5_0.service-endpoint.models.DependsOn>`
...
class OAuthConfiguration(Model):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v5_0.service-endpoint.models.IdentityRef>`
    ...
    :type modified_by: :class:`IdentityRef <azure.devops.v5_0.service-endpoint.models.IdentityRef>`
...
class ServiceEndpoint(Model):
    ...
    :type administrators_group: :class:`IdentityRef <azure.devops.v5_0.service-endpoint.models.IdentityRef>`
    :param authorization: Gets or sets the authorization data for talking to the endpoint.
    :type authorization: :class:`EndpointAuthorization <azure.devops.v5_0.service-endpoint.models.EndpointAuthorization>`
    ...
    :type operation_status: :class:`object <azure.devops.v5_0.service-endpoint.models.object>`
    ...
    :type readers_group: :class:`IdentityRef <azure.devops.v5_0.service-endpoint.models.IdentityRef>`
...
class ServiceEndpointAuthenticationScheme(Model):
    ...
    :type authorization_headers: list of :class:`AuthorizationHeader <azure.devops.v5_0.service-endpoint.models.AuthorizationHeader>`
    ...
    :type client_certificates: list of :class:`ClientCertificate <azure.devops.v5_0.service-endpoint.models.ClientCertificate>`
    :param data_source_bindings:
    :type data_source_bindings: list of :class:`DataSourceBinding <azure.devops.v5_0.service-endpoint.models.DataSourceBinding>`
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v5_0.service-endpoint.models.InputDescriptor>`
...
class ServiceEndpointExecutionData(Model):
    ...
    :type definition: :class:`ServiceEndpointExecutionOwner <azure.devops.v5_0.service-endpoint.models.ServiceEndpointExecutionOwner>`
    ...
    :type owner: :class:`ServiceEndpointExecutionOwner <azure.devops.v5_0.service-endpoint.models.ServiceEndpointExecutionOwner>`
...
class ServiceEndpointExecutionOwner(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v5_0.service-endpoint.models.ReferenceLinks>`
...
class ServiceEndpointExecutionRecord(Model):
    ...
    :type data: :class:`ServiceEndpointExecutionData <azure.devops.v5_0.service-endpoint.models.ServiceEndpointExecutionData>`
...
class ServiceEndpointRequest(Model):
    ...
    :type data_source_details: :class:`DataSourceDetails <azure.devops.v5_0.service-endpoint.models.DataSourceDetails>`
    :param result_transformation_details: Gets or sets the result transformation details for the service endpoint request.
    :type result_transformation_details: :class:`ResultTransformationDetails <azure.devops.v5_0.service-endpoint.models.ResultTransformationDetails>`
    :param service_endpoint_details: Gets or sets the service endpoint details for the service endpoint request.
    :type service_endpoint_details: :class:`ServiceEndpointDetails <azure.devops.v5_0.service-endpoint.models.ServiceEndpointDetails>`
    """
...
class ServiceEndpointRequestResult(Model):
    ...
    :type result: :class:`object <azure.devops.v5_0.service-endpoint.models.object>`
...
class ServiceEndpointType(Model):
    ...
    :type authentication_schemes: list of :class:`ServiceEndpointAuthenticationScheme <azure.devops.v5_0.service-endpoint.models.ServiceEndpointAuthenticationScheme>`
    :param data_sources: Data sources of service endpoint type.
    :type data_sources: list of :class:`DataSource <azure.devops.v5_0.service-endpoint.models.DataSource>`
    :param dependency_data: Dependency data of service endpoint type.
    :type dependency_data: list of :class:`DependencyData <azure.devops.v5_0.service-endpoint.models.DependencyData>`
    ...
    :type endpoint_url: :class:`EndpointUrl <azure.devops.v5_0.service-endpoint.models.EndpointUrl>`
    :param help_link: Gets or sets the help link of service endpoint type.
    :type help_link: :class:`HelpLink <azure.devops.v5_0.service-endpoint.models.HelpLink>`
