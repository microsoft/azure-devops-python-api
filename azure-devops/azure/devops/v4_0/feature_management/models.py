...
class ContributedFeature(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v4_0.feature-management.models.ReferenceLinks>`
    ...
    :type default_value_rules: list of :class:`ContributedFeatureValueRule <azure.devops.v4_0.feature-management.models.ContributedFeatureValueRule>`
    ...
    :type override_rules: list of :class:`ContributedFeatureValueRule <azure.devops.v4_0.feature-management.models.ContributedFeatureValueRule>`
    :param scopes: The scopes/levels at which settings can set the enabled/disabled state of this feature
    :type scopes: list of :class:`ContributedFeatureSettingScope <azure.devops.v4_0.feature-management.models.ContributedFeatureSettingScope>`
...
class ContributedFeatureState(Model):
    ...
    :type scope: :class:`ContributedFeatureSettingScope <azure.devops.v4_0.feature-management.models.ContributedFeatureSettingScope>`
