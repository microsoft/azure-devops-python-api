...
class ConnectionData(Model):
    ...
    :type authenticated_user: :class:`Identity <azure.devops.v4_0.locations.models.Identity>`
    ...
    :type authorized_user: :class:`Identity <azure.devops.v4_0.locations.models.Identity>`
    ...
    :type location_service_data: :class:`LocationServiceData <azure.devops.v4_0.locations.models.LocationServiceData>`
...
class Identity(Model):
    ...
    :param descriptor:
    :type descriptor: :class:`str <azure.devops.v4_0.microsoft.-visual-studio.-services.-web-api.models.str>`
    :param id:
    :type id: str
    :param is_active:
    :type is_active: bool
    ...
    :param member_of:
    :type member_of: list of :class:`str <azure.devops.v4_0.microsoft.-visual-studio.-services.-web-api.models.str>`
    :param members:
    :type members: list of :class:`str <azure.devops.v4_0.microsoft.-visual-studio.-services.-web-api.models.str>`
    :param meta_type_id:
    :type meta_type_id: int
    :param properties:
    :type properties: :class:`object <azure.devops.v4_0.microsoft.-visual-studio.-services.-web-api.models.object>`
    ...
    :type subject_descriptor: :class:`str <azure.devops.v4_0.microsoft.-visual-studio.-services.-web-api.models.str>`
...
class LocationServiceData(Model):
    ...
    :type access_mappings: list of :class:`AccessMapping <azure.devops.v4_0.locations.models.AccessMapping>`
    ...
    :type service_definitions: list of :class:`ServiceDefinition <azure.devops.v4_0.locations.models.ServiceDefinition>`
...
class ServiceDefinition(Model):
    ...
    :type location_mappings: list of :class:`LocationMapping <azure.devops.v4_0.locations.models.LocationMapping>`
    ...
    :param properties:
    :type properties: :class:`object <azure.devops.v4_0.locations.models.object>`
    :param relative_path:
