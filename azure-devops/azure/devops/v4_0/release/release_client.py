...
class ReleaseClient(Client):
    ...
    def get_approval_history(self, project, approval_step_id):
        ...
        :rtype: :class:`<ReleaseApproval> <azure.devops.v4_0.release.models.ReleaseApproval>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_release_approval(self, approval, project, approval_id):
        ...
        :param :class:`<ReleaseApproval> <azure.devops.v4_0.release.models.ReleaseApproval>` approval: ReleaseApproval object having status, approver and comments.
        :param str project: Project ID or project name
        :param int approval_id: Id of the approval.
        :rtype: :class:`<ReleaseApproval> <azure.devops.v4_0.release.models.ReleaseApproval>`
        """
    ...
    def create_release_definition(self, release_definition, project):
        ...
        :param :class:`<ReleaseDefinition> <azure.devops.v4_0.release.models.ReleaseDefinition>` release_definition: release definition object to create.
        :param str project: Project ID or project name
        :rtype: :class:`<ReleaseDefinition> <azure.devops.v4_0.release.models.ReleaseDefinition>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_release_definition(self, release_definition, project):
        ...
        :param :class:`<ReleaseDefinition> <azure.devops.v4_0.release.models.ReleaseDefinition>` release_definition: Release definition object to update.
        :param str project: Project ID or project name
        :rtype: :class:`<ReleaseDefinition> <azure.devops.v4_0.release.models.ReleaseDefinition>`
        """
        route_values = {}
    ...
    def get_deployments_for_multiple_environments(self, query_parameters, project):
        ...
        [Preview API]
        :param :class:`<DeploymentQueryParameters> <azure.devops.v4_0.release.models.DeploymentQueryParameters>` query_parameters:
        :param str project: Project ID or project name
        :rtype: [Deployment]
        """
        route_values = {}
    ...
    def get_release_environment(self, project, release_id, environment_id):
        ...
        :rtype: :class:`<ReleaseEnvironment> <azure.devops.v4_0.release.models.ReleaseEnvironment>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_release_environment(self, environment_update_data, project, release_id, environment_id):
        ...
        :param :class:`<ReleaseEnvironmentUpdateMetadata> <azure.devops.v4_0.release.models.ReleaseEnvironmentUpdateMetadata>` environment_update_data: Environment update meta data.
        :param str project: Project ID or project name
    ...
    def create_definition_environment_template(self, template, project):
        ...
        [Preview API]
        :param :class:`<ReleaseDefinitionEnvironmentTemplate> <azure.devops.v4_0.release.models.ReleaseDefinitionEnvironmentTemplate>` template:
        :param str project: Project ID or project name
        :rtype: :class:`<ReleaseDefinitionEnvironmentTemplate> <azure.devops.v4_0.release.models.ReleaseDefinitionEnvironmentTemplate>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_folder(self, folder, project, path):
        ...
        :param :class:`<Folder> <azure.devops.v4_0.release.models.Folder>` folder:
        :param str project: Project ID or project name
        :param str path:
        :rtype: :class:`<Folder> <azure.devops.v4_0.release.models.Folder>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_input_values(self, query, project):
        """GetInputValues.
        [Preview API]
        :param :class:`<InputValuesQuery> <azure.devops.v4_0.release.models.InputValuesQuery>` query:
        :param str project: Project ID or project name
        :rtype: :class:`<InputValuesQuery> <azure.devops.v4_0.release.models.InputValuesQuery>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_manual_intervention(self, project, release_id, manual_intervention_id):
        ...
        :rtype: :class:`<ManualIntervention> <azure.devops.v4_0.release.models.ManualIntervention>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_manual_intervention(self, manual_intervention_update_metadata, project, release_id, manual_intervention_id):
        ...
        [Preview API]
        :param :class:`<ManualInterventionUpdateMetadata> <azure.devops.v4_0.release.models.ManualInterventionUpdateMetadata>` manual_intervention_update_metadata:
        :param str project: Project ID or project name
        :param int release_id:
        :param int manual_intervention_id:
        :rtype: :class:`<ManualIntervention> <azure.devops.v4_0.release.models.ManualIntervention>`
    ...
    def create_release(self, release_start_metadata, project):
        ...
        :param :class:`<ReleaseStartMetadata> <azure.devops.v4_0.release.models.ReleaseStartMetadata>` release_start_metadata: Metadata to create a release.
        :param str project: Project ID or project name
        :rtype: :class:`<Release> <azure.devops.v4_0.release.models.Release>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_release_definition_summary(self, project, definition_id, release_count, include_artifact=None, definition_environment_ids_filter=None):
        ...
        :rtype: :class:`<ReleaseDefinitionSummary> <azure.devops.v4_0.release.models.ReleaseDefinitionSummary>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_release(self, release, project, release_id):
        ...
        :param :class:`<Release> <azure.devops.v4_0.release.models.Release>` release: Release object for update.
        :param str project: Project ID or project name
    ...
    def update_release_resource(self, release_update_metadata, project, release_id):
        ...
        :param :class:`<ReleaseUpdateMetadata> <azure.devops.v4_0.release.models.ReleaseUpdateMetadata>` release_update_metadata: Properties of release to update.
        :param str project: Project ID or project name
        :param int release_id: Id of the release to update.
        :rtype: :class:`<Release> <azure.devops.v4_0.release.models.Release>`
        """
    ...
    def get_release_settings(self, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<ReleaseSettings> <azure.devops.v4_0.release.models.ReleaseSettings>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_release_settings(self, release_settings, project):
        ...
        :param :class:`<ReleaseSettings> <azure.devops.v4_0.release.models.ReleaseSettings>` release_settings:
        :param str project: Project ID or project name
        :rtype: :class:`<ReleaseSettings> <azure.devops.v4_0.release.models.ReleaseSettings>`
        """
        route_values = {}
    ...
    def send_summary_mail(self, mail_message, project, release_id):
        """SendSummaryMail.
        [Preview API]
        :param :class:`<MailMessage> <azure.devops.v4_0.release.models.MailMessage>` mail_message:
        :param str project: Project ID or project name
        :param int release_id:
        """
        route_values = {}
    ...
    def get_artifact_versions(self, project, release_definition_id):
        ...
        :param str project: Project ID or project name
        :param int release_definition_id:
        :rtype: :class:`<ArtifactVersionQueryResult> <azure.devops.v4_0.release.models.ArtifactVersionQueryResult>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
