...
class ArtifactMetadata(Model):
    ...
    :type instance_reference: :class:`BuildVersion <azure.devops.v4_0.release.models.BuildVersion>`
    """
...
class ArtifactTypeDefinition(Model):
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v4_0.release.models.InputDescriptor>`
    :param name:
    :type name: str
...
class ArtifactVersion(Model):
    ...
    :type default_version: :class:`BuildVersion <azure.devops.v4_0.release.models.BuildVersion>`
    :param error_message:
    :type error_message: str
    :param source_id:
    :type source_id: str
    :param versions:
    :type versions: list of :class:`BuildVersion <azure.devops.v4_0.release.models.BuildVersion>`
    """
...
class ArtifactVersionQueryResult(Model):
    ...
    :type artifact_versions: list of :class:`ArtifactVersion <azure.devops.v4_0.release.models.ArtifactVersion>`
    """
...
class AutoTriggerIssue(Model):
    ...
    :param issue:
    :type issue: :class:`Issue <azure.devops.v4_0.release.models.Issue>`
    :param issue_source:
    :type issue_source: object
    :param project:
    :type project: :class:`ProjectReference <azure.devops.v4_0.release.models.ProjectReference>`
    :param release_definition_reference:
    :type release_definition_reference: :class:`ReleaseDefinitionShallowReference <azure.devops.v4_0.release.models.ReleaseDefinitionShallowReference>`
...
class Change(Model):
    ...
    :type author: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
...
class Deployment(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v4_0.release.models.ReferenceLinks>`
    :param attempt:
    :type attempt: int
    :param conditions:
    :type conditions: list of :class:`Condition <azure.devops.v4_0.release.models.Condition>`
    :param definition_environment_id:
    :type definition_environment_id: int
    ...
    :type last_modified_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    ...
    :type post_deploy_approvals: list of :class:`ReleaseApproval <azure.devops.v4_0.release.models.ReleaseApproval>`
    :param pre_deploy_approvals:
    :type pre_deploy_approvals: list of :class:`ReleaseApproval <azure.devops.v4_0.release.models.ReleaseApproval>`
    :param queued_on:
    :type queued_on: datetime
    :param reason:
    :type reason: object
    :param release:
    :type release: :class:`ReleaseReference <azure.devops.v4_0.release.models.ReleaseReference>`
    :param release_definition:
    :type release_definition: :class:`ReleaseDefinitionShallowReference <azure.devops.v4_0.release.models.ReleaseDefinitionShallowReference>`
    :param release_environment:
    :type release_environment: :class:`ReleaseEnvironmentShallowReference <azure.devops.v4_0.release.models.ReleaseEnvironmentShallowReference>`
    :param requested_by:
    :type requested_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param requested_for:
    :type requested_for: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
...
class DeploymentAttempt(Model):
    ...
    :type id: int
    :param job:
    :type job: :class:`ReleaseTask <azure.devops.v4_0.release.models.ReleaseTask>`
    :param last_modified_by:
    :type last_modified_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param last_modified_on:
    :type last_modified_on: datetime
    ...
    :type release_deploy_phases: list of :class:`ReleaseDeployPhase <azure.devops.v4_0.release.models.ReleaseDeployPhase>`
    :param requested_by:
    :type requested_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param requested_for:
    :type requested_for: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    ...
    :type status: object
    :param tasks:
    :type tasks: list of :class:`ReleaseTask <azure.devops.v4_0.release.models.ReleaseTask>`
    """
...
class DeploymentQueryParameters(Model):
    ...
    :type deployment_status: object
    :param environments:
    :type environments: list of :class:`DefinitionEnvironmentReference <azure.devops.v4_0.release.models.DefinitionEnvironmentReference>`
    :param expands:
    :type expands: object
    :param is_deleted:
...
class Folder(Model):
    ...
    :param created_by:
    :type created_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param created_on:
    :type created_on: datetime
    :param description:
    :type description: str
    :param last_changed_by:
    :type last_changed_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
...
class MailMessage(Model):
    ...
    :type body: str
    :param cC:
    :type cC: :class:`EmailRecipients <azure.devops.v4_0.release.models.EmailRecipients>`
    :param in_reply_to:
    ...
    :param reply_to:
    :type reply_to: :class:`EmailRecipients <azure.devops.v4_0.release.models.EmailRecipients>`
    :param sections:
    ...
    :type subject: str
    :param to:
    :type to: :class:`EmailRecipients <azure.devops.v4_0.release.models.EmailRecipients>`
    """
...
class ManualIntervention(Model):
    ...
    :param approver:
    :type approver: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param comments:
    :type comments: str
    :param created_on:
    :type created_on: datetime
    ...
    :type name: str
    :param release:
    :type release: :class:`ReleaseShallowReference <azure.devops.v4_0.release.models.ReleaseShallowReference>`
    :param release_definition:
    :type release_definition: :class:`ReleaseDefinitionShallowReference <azure.devops.v4_0.release.models.ReleaseDefinitionShallowReference>`
    :param release_environment:
    :type release_environment: :class:`ReleaseEnvironmentShallowReference <azure.devops.v4_0.release.models.ReleaseEnvironmentShallowReference>`
...
class Release(Model):
    ...
    :type artifacts: list of :class:`Artifact <azure.devops.v4_0.release.models.Artifact>`
    ...
    :type environments: list of :class:`ReleaseEnvironment <azure.devops.v4_0.release.models.ReleaseEnvironment>`
    :param id: Gets the unique identifier of this field.
    :type id: int
    ...
    :type modified_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    ...
    :type project_reference: :class:`ProjectReference <azure.devops.v4_0.release.models.ProjectReference>`
    :param properties:
    :type properties: :class:`object <azure.devops.v4_0.release.models.object>`
    ...
    :type variable_groups: list of :class:`VariableGroup <azure.devops.v4_0.release.models.VariableGroup>`
...
class ReleaseApproval(Model):
    ...
    :type approved_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    ...
    :type history: list of :class:`ReleaseApprovalHistory <azure.devops.v4_0.release.models.ReleaseApprovalHistory>`
    :param id: Gets the unique identifier of this field.
    :type id: int
...
class ReleaseApprovalHistory(Model):
    ...
    :type approver: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param changed_by:
    :type changed_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param comments:
    :type comments: str
    :param created_on:
    :type created_on: datetime
...
class ReleaseDefinition(Model):
    ...
    :type environments: list of :class:`ReleaseDefinitionEnvironment <azure.devops.v4_0.release.models.ReleaseDefinitionEnvironment>`
    :param id: Gets the unique identifier of this field.
    :type id: int
    :param last_release: Gets the reference of last release.
    :type last_release: :class:`ReleaseReference <azure.devops.v4_0.release.models.ReleaseReference>`
    :param modified_by: Gets or sets the identity who modified.
    :type modified_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param modified_on: Gets date on which it got modified.
    :type modified_on: datetime
    ...
    :type retention_policy: :class:`RetentionPolicy <azure.devops.v4_0.release.models.RetentionPolicy>`
    :param revision: Gets the revision number.
    :type revision: int
    ...
    :type triggers: list of :class:`object <azure.devops.v4_0.release.models.object>`
...
class ReleaseDefinitionApprovals(Model):
    ...
    :type approval_options: :class:`ApprovalOptions <azure.devops.v4_0.release.models.ApprovalOptions>`
    :param approvals:
    :type approvals: list of :class:`ReleaseDefinitionApprovalStep <azure.devops.v4_0.release.models.ReleaseDefinitionApprovalStep>`
    """
...
class ReleaseDefinitionEnvironment(Model):
    ...
    :type conditions: list of :class:`Condition <azure.devops.v4_0.release.models.Condition>`
    :param demands:
    :type demands: list of :class:`object <azure.devops.v4_0.release.models.object>`
    :param deploy_phases:
    :type deploy_phases: list of :class:`object <azure.devops.v4_0.release.models.object>`
    :param deploy_step:
    :type deploy_step: :class:`ReleaseDefinitionDeployStep <azure.devops.v4_0.release.models.ReleaseDefinitionDeployStep>`
    :param environment_options:
    :type environment_options: :class:`EnvironmentOptions <azure.devops.v4_0.release.models.EnvironmentOptions>`
    :param execution_policy:
    :type execution_policy: :class:`EnvironmentExecutionPolicy <azure.devops.v4_0.release.models.EnvironmentExecutionPolicy>`
    :param id:
    :type id: int
    :param name:
    :type name: str
    :param owner:
    :type owner: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    :param post_deploy_approvals:
    :type post_deploy_approvals: :class:`ReleaseDefinitionApprovals <azure.devops.v4_0.release.models.ReleaseDefinitionApprovals>`
    :param pre_deploy_approvals:
    :type pre_deploy_approvals: :class:`ReleaseDefinitionApprovals <azure.devops.v4_0.release.models.ReleaseDefinitionApprovals>`
    :param process_parameters:
    :type process_parameters: :class:`ProcessParameters <azure.devops.v4_0.release.models.ProcessParameters>`
    :param properties:
    :type properties: :class:`object <azure.devops.v4_0.release.models.object>`
    :param queue_id:
    :type queue_id: int
    ...
    :type rank: int
    :param retention_policy:
    :type retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v4_0.release.models.EnvironmentRetentionPolicy>`
    :param run_options:
    :type run_options: dict
    :param schedules:
    :type schedules: list of :class:`ReleaseSchedule <azure.devops.v4_0.release.models.ReleaseSchedule>`
    :param variables:
    :type variables: dict
    """
...
class ReleaseDefinitionEnvironmentSummary(Model):
    ...
    :type id: int
    :param last_releases:
    :type last_releases: list of :class:`ReleaseShallowReference <azure.devops.v4_0.release.models.ReleaseShallowReference>`
    :param name:
    :type name: str
    """
...
class ReleaseDefinitionEnvironmentTemplate(Model):
    ...
    :type description: str
    :param environment:
    :type environment: :class:`ReleaseDefinitionEnvironment <azure.devops.v4_0.release.models.ReleaseDefinitionEnvironment>`
    :param icon_task_id:
...
class ReleaseDefinitionSummary(Model):
    ...
    :param environments:
    :type environments: list of :class:`ReleaseDefinitionEnvironmentSummary <azure.devops.v4_0.release.models.ReleaseDefinitionEnvironmentSummary>`
    :param release_definition:
    :type release_definition: :class:`ReleaseDefinitionShallowReference <azure.devops.v4_0.release.models.ReleaseDefinitionShallowReference>`
    :param releases:
    :type releases: list of :class:`Release <azure.devops.v4_0.release.models.Release>`
    """
...
class ReleaseDeployPhase(Model):
    ...
    :type deployment_jobs: list of :class:`DeploymentJob <azure.devops.v4_0.release.models.DeploymentJob>`
    :param error_log:
    :type error_log: str
    :param id:
    :type id: int
    :param manual_interventions:
    :type manual_interventions: list of :class:`ManualIntervention <azure.devops.v4_0.release.models.ManualIntervention>`
    :param phase_type:
...
class ReleaseEnvironment(Model):
    ...
    :type conditions: list of :class:`ReleaseCondition <azure.devops.v4_0.release.models.ReleaseCondition>`
    :param created_on: Gets date on which it got created.
    :type created_on: datetime
    ...
    :type deploy_phases_snapshot: list of :class:`object <azure.devops.v4_0.release.models.object>`
    :param deploy_steps: Gets deploy steps.
    :type deploy_steps: list of :class:`DeploymentAttempt <azure.devops.v4_0.release.models.DeploymentAttempt>`
    ...
    :type post_approvals_snapshot: :class:`ReleaseDefinitionApprovals <azure.devops.v4_0.release.models.ReleaseDefinitionApprovals>`
    ...
    :type pre_approvals_snapshot: :class:`ReleaseDefinitionApprovals <azure.devops.v4_0.release.models.ReleaseDefinitionApprovals>`
    ...
    :type release_created_by: :class:`IdentityRef <azure.devops.v4_0.release.models.IdentityRef>`
    ...
    :type workflow_tasks: list of :class:`WorkflowTask <azure.devops.v4_0.release.models.WorkflowTask>`
    """
...
class ReleaseSettings(Model):
    ...
    :type retention_settings: :class:`RetentionSettings <azure.devops.v4_0.release.models.RetentionSettings>`
    """
...
class ReleaseStartMetadata(Model):
    ...
    :type artifacts: list of :class:`ArtifactMetadata <azure.devops.v4_0.release.models.ArtifactMetadata>`
...
class ReleaseTask(Model):
    ...
    :type id: int
    :param issues:
    :type issues: list of :class:`Issue <azure.devops.v4_0.release.models.Issue>`
    :param line_count:
    ...
    :type status: object
    :param task:
    :type task: :class:`WorkflowTaskReference <azure.devops.v4_0.release.models.WorkflowTaskReference>`
...
class RetentionSettings(Model):
    ...
    :type default_environment_retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v4_0.release.models.EnvironmentRetentionPolicy>`
    :param maximum_environment_retention_policy:
    :type maximum_environment_retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v4_0.release.models.EnvironmentRetentionPolicy>`
    """
...
class VariableGroup(Model):
    ...
    :type provider_data: :class:`VariableGroupProviderData <azure.devops.v4_0.release.models.VariableGroupProviderData>`
...
class ReleaseDefinitionDeployStep(ReleaseDefinitionEnvironmentStep):
    ...
    :type tasks: list of :class:`WorkflowTask <azure.devops.v4_0.release.models.WorkflowTask>`
    """
