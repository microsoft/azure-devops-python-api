...
class DataProviderQuery(Model):
    ...
    :type context: :class:`DataProviderContext <contributions.v4_0.models.DataProviderContext>`
...
class ExtensionLicensing(Model):
    ...
    :type overrides: list of :class:`LicensingOverride <contributions.v4_0.models.LicensingOverride>`
    """
...
class InstalledExtensionState(Model):
    ...
    :type installation_issues: list of :class:`InstalledExtensionStateIssue <contributions.v4_0.models.InstalledExtensionStateIssue>`
