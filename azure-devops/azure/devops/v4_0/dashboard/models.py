...
class Dashboard(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v4_0.dashboard.models.ReferenceLinks>`
    :param description:
    ...
    :type url: str
    :param widgets:
    :type widgets: list of :class:`Widget <azure.devops.v4_0.dashboard.models.Widget>`
    """
...
class DashboardGroup(Model):
    ...
    :type dashboard_entries: list of :class:`DashboardGroupEntry <azure.devops.v4_0.dashboard.models.DashboardGroupEntry>`
    :param permission:
...
class Widget(Model):
    ...
    :type allowed_sizes: list of :class:`WidgetSize <azure.devops.v4_0.dashboard.models.WidgetSize>`
    ...
    :type dashboard: :class:`Dashboard <azure.devops.v4_0.dashboard.models.Dashboard>`
    :param eTag:
    :type eTag: str
    :param id:
    :type id: str
    ...
    :type lightbox_options: :class:`LightboxOptions <azure.devops.v4_0.dashboard.models.LightboxOptions>`
    :param loading_image_url:
    :type loading_image_url: str
    :param name:
    :type name: str
    :param position:
    :type position: :class:`WidgetPosition <azure.devops.v4_0.dashboard.models.WidgetPosition>`
    :param settings:
    :type settings: str
    :param settings_version:
    :type settings_version: :class:`SemanticVersion <azure.devops.v4_0.dashboard.models.SemanticVersion>`
    :param size:
    :type size: :class:`WidgetSize <azure.devops.v4_0.dashboard.models.WidgetSize>`
    :param type_id:
    :type type_id: str
    :param url:
    :type url: str
...
class WidgetMetadataResponse(Model):
    ...
    :type widget_metadata: :class:`WidgetMetadata <azure.devops.v4_0.dashboard.models.WidgetMetadata>`
    """
...
class WidgetTypesResponse(Model):
    ...
    :type uri: str
    :param widget_types:
    :type widget_types: list of :class:`WidgetMetadata <azure.devops.v4_0.dashboard.models.WidgetMetadata>`
    """
