...
class Account(Model):
    ...
    :type properties: :class:`object <azure.devops.v4_0.accounts.models.object>`
...
class AccountCreateInfoInternal(Model):
    ...
    :param preferences:
    :type preferences: :class:`AccountPreferencesInternal <azure.devops.v4_0.accounts.models.AccountPreferencesInternal>`
    :param properties:
    :type properties: :class:`object <azure.devops.v4_0.accounts.models.object>`
