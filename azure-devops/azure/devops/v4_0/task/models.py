...
class PlanEnvironment(Model):
    ...
    :param mask:
    :type mask: list of :class:`MaskHint <task.v4_0.models.MaskHint>`
    :param options:
    :type options: dict
    :param variables:
    :type variables: dict
...
class TaskOrchestrationQueuedPlanGroup(Model):
    ...
    :type plan_group: str
    :param plans:
    :type plans: list of :class:`TaskOrchestrationQueuedPlan <task.v4_0.models.TaskOrchestrationQueuedPlan>`
    :param project:
    :type project: :class:`ProjectReference <task.v4_0.models.ProjectReference>`
    :param queue_position:
    :type queue_position: int
    """
...
class TimelineRecord(Model):
    ...
    :param details:
    :type details: :class:`TimelineReference <task.v4_0.models.TimelineReference>`
    :param error_count:
    ...
    :type id: str
    :param issues:
    :type issues: list of :class:`Issue <task.v4_0.models.Issue>`
    :param last_modified:
    :type last_modified: datetime
    :param location:
    :type location: str
    :param log:
    :type log: :class:`TaskLogReference <task.v4_0.models.TaskLogReference>`
    :param name:
    :type name: str
    :param order:
    :type order: int
    ...
    :type state: object
    :param task:
    :type task: :class:`TaskReference <task.v4_0.models.TaskReference>`
    :param type:
    :type type: str
    :param variables:
    :type variables: dict
...
class TaskOrchestrationContainer(TaskOrchestrationItem):
    ...
    :type item_type: object
    :param children:
    :type children: list of :class:`TaskOrchestrationItem <task.v4_0.models.TaskOrchestrationItem>`
    ...
    :type parallel: bool
    :param rollback:
    :type rollback: :class:`TaskOrchestrationContainer <task.v4_0.models.TaskOrchestrationContainer>`
    """
