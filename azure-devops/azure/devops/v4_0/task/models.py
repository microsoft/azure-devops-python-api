...
class PlanEnvironment(Model):
    ...
    :param mask:
    :type mask: list of :class:`MaskHint <azure.devops.v4_0.task.models.MaskHint>`
    :param options:
    :type options: dict
    :param variables:
    :type variables: dict
...
class TaskAttachment(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v4_0.task.models.ReferenceLinks>`
    :param created_on:
...
class TaskOrchestrationPlanReference(Model):
    ...
    :param definition:
    :type definition: :class:`TaskOrchestrationOwner <azure.devops.v4_0.task.models.TaskOrchestrationOwner>`
    :param owner:
    :type owner: :class:`TaskOrchestrationOwner <azure.devops.v4_0.task.models.TaskOrchestrationOwner>`
    :param plan_id:
    :type plan_id: str
    :param plan_type:
    :type plan_type: str
...
class TaskOrchestrationQueuedPlanGroup(Model):
    ...
    :type plan_group: str
    :param plans:
    :type plans: list of :class:`TaskOrchestrationQueuedPlan <azure.devops.v4_0.task.models.TaskOrchestrationQueuedPlan>`
    :param project:
    :type project: :class:`ProjectReference <azure.devops.v4_0.task.models.ProjectReference>`
    :param queue_position:
    :type queue_position: int
    """
...
class TimelineRecord(Model):
    ...
    :param details:
    :type details: :class:`TimelineReference <azure.devops.v4_0.task.models.TimelineReference>`
    :param error_count:
    ...
    :type id: str
    :param issues:
    :type issues: list of :class:`Issue <azure.devops.v4_0.task.models.Issue>`
    :param last_modified:
    :type last_modified: datetime
    :param location:
    :type location: str
    :param log:
    :type log: :class:`TaskLogReference <azure.devops.v4_0.task.models.TaskLogReference>`
    :param name:
    :type name: str
    :param order:
    :type order: int
    ...
    :type state: object
    :param task:
    :type task: :class:`TaskReference <azure.devops.v4_0.task.models.TaskReference>`
    :param type:
    :type type: str
    :param variables:
    :type variables: dict
...
class TaskOrchestrationContainer(TaskOrchestrationItem):
    ...
    :type item_type: object
    :param children:
    :type children: list of :class:`TaskOrchestrationItem <azure.devops.v4_0.task.models.TaskOrchestrationItem>`
    ...
    :type parallel: bool
    :param rollback:
    :type rollback: :class:`TaskOrchestrationContainer <azure.devops.v4_0.task.models.TaskOrchestrationContainer>`
    """
...
class TaskOrchestrationPlan(TaskOrchestrationPlanReference):
    ...
    :type version: int
    :param environment:
    :type environment: :class:`PlanEnvironment <azure.devops.v4_0.task.models.PlanEnvironment>`
    :param finish_time:
    :type finish_time: datetime
    :param implementation:
    :type implementation: :class:`TaskOrchestrationContainer <azure.devops.v4_0.task.models.TaskOrchestrationContainer>`
    :param plan_group:
    :type plan_group: str
    ...
    :type state: object
    :param timeline:
    :type timeline: :class:`TimelineReference <azure.devops.v4_0.task.models.TimelineReference>`
    """
...
class Timeline(TimelineReference):
    ...
    :type last_changed_on: datetime
    :param records:
    :type records: list of :class:`TimelineRecord <azure.devops.v4_0.task.models.TimelineRecord>`
    """
