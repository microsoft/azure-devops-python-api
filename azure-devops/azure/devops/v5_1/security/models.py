...
class AccessControlEntry(Model):
    ...
    :type extended_info: :class:`AceExtendedInformation <azure.devops.v5_1..models.AceExtendedInformation>`
    """
...
class PermissionEvaluationBatch(Model):
    ...
    :type evaluations: list of :class:`PermissionEvaluation <azure.devops.v5_1..models.PermissionEvaluation>`
    """
...
class SecurityNamespaceDescription(Model):
    ...
    :type actions: list of :class:`ActionDefinition <azure.devops.v5_1..models.ActionDefinition>`
