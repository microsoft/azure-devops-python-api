...
class ConnectionData(Model):
    ...
    :type authenticated_user: :class:`Identity <azure.devops.v5_1..models.Identity>`
    ...
    :type authorized_user: :class:`Identity <azure.devops.v5_1..models.Identity>`
    ...
    :type location_service_data: :class:`LocationServiceData <azure.devops.v5_1..models.LocationServiceData>`
...
class LocationServiceData(Model):
    ...
    :type access_mappings: list of :class:`AccessMapping <azure.devops.v5_1..models.AccessMapping>`
    ...
    :type service_definitions: list of :class:`ServiceDefinition <azure.devops.v5_1..models.ServiceDefinition>`
...
class ServiceDefinition(Model):
    ...
    :type location_mappings: list of :class:`LocationMapping <azure.devops.v5_1..models.LocationMapping>`
