...
class ProjectInfo(Model):
    ...
    :type properties: list of :class:`ProjectProperty <azure.devops.v5_1..models.ProjectProperty>`
...
class Proxy(Model):
    ...
    :param authorization:
    :type authorization: :class:`ProxyAuthorization <azure.devops.v5_1..models.ProxyAuthorization>`
...
class ProxyAuthorization(Model):
    ...
    :type identity: :class:`str <azure.devops.v5_1..models.str>`
    :param public_key: Gets or sets the public key used to verify the identity of this proxy. Only specify on hosted.
    :type public_key: :class:`PublicKey <azure.devops.v5_1..models.PublicKey>`
    """
...
class TeamMember(Model):
    ...
    :param identity:
    :type identity: :class:`IdentityRef <azure.devops.v5_1..models.IdentityRef>`
    :param is_team_admin:
...
class TeamProject(TeamProjectReference):
    ...
    :type default_team: :class:`WebApiTeamRef <azure.devops.v5_1..models.WebApiTeamRef>`
    """
...
class WebApiConnectedService(WebApiConnectedServiceRef):
    ...
    :type authenticated_by: :class:`IdentityRef <azure.devops.v5_1..models.IdentityRef>`
...
class WebApiConnectedServiceDetails(WebApiConnectedServiceRef):
    ...
    :type connected_service_meta_data: :class:`WebApiConnectedService <azure.devops.v5_1..models.WebApiConnectedService>`
