...
class PolicyConfigurationRef(Model):
    ...
    :type type: :class:`PolicyTypeRef <azure.devops.v5_1.microsoft.-team-foundation.-policy.-web-api.models.PolicyTypeRef>`
...
class PolicyConfiguration(VersionedPolicyConfigurationRef):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v5_1.microsoft.-team-foundation.-policy.-web-api.models.ReferenceLinks>`
    :param created_by: A reference to the identity that created the policy.
    :type created_by: :class:`IdentityRef <azure.devops.v5_1.microsoft.-team-foundation.-policy.-web-api.models.IdentityRef>`
