...
class AccessTokenResult(Model):
    ...
    :param access_token:
    :type access_token: :class:`JsonWebToken <azure.devops.v5_1.microsoft.-visual-studio.-services.-web-api.models.JsonWebToken>`
    ...
    :type has_error: bool
    :param refresh_token:
    :type refresh_token: :class:`RefreshTokenGrant <azure.devops.v5_1.microsoft.-visual-studio.-services.-web-api.models.RefreshTokenGrant>`
    :param token_type:
    :type token_type: str
    :param valid_to:
...
class RefreshTokenGrant(AuthorizationGrant):
    ...
    :type grant_type: object
    :param jwt:
    :type jwt: :class:`JsonWebToken <azure.devops.v5_1.microsoft.-visual-studio.-services.-web-api.models.JsonWebToken>`
    """
