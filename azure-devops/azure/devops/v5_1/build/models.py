...
class Build(Model):
    ...
    :type controller: :class:`BuildController <azure.devops.v5_1..models.BuildController>`
    :param definition: The definition associated with the build.
    :type definition: :class:`DefinitionReference <azure.devops.v5_1..models.DefinitionReference>`
    ...
    :type last_changed_by: :class:`IdentityRef <azure.devops.v5_1..models.IdentityRef>`
    ...
    :type logs: :class:`BuildLogReference <azure.devops.v5_1..models.BuildLogReference>`
    :param orchestration_plan: The orchestration plan for the build.
    :type orchestration_plan: :class:`TaskOrchestrationPlanReference <azure.devops.v5_1..models.TaskOrchestrationPlanReference>`
    :param parameters: The parameters for the build.
    :type parameters: str
    :param plans: Orchestration plans associated with the build (build, cleanup)
    :type plans: list of :class:`TaskOrchestrationPlanReference <azure.devops.v5_1..models.TaskOrchestrationPlanReference>`
    ...
    :type queue: :class:`AgentPoolQueue <azure.devops.v5_1..models.AgentPoolQueue>`
    ...
    :type repository: :class:`BuildRepository <azure.devops.v5_1..models.BuildRepository>`
    ...
    :type requested_for: :class:`IdentityRef <azure.devops.v5_1..models.IdentityRef>`
    ...
    :type triggered_by_build: :class:`Build <azure.devops.v5_1..models.Build>`
    ...
    :type validation_results: list of :class:`BuildRequestValidationResult <azure.devops.v5_1..models.BuildRequestValidationResult>`
    """
...
class BuildArtifact(Model):
    ...
    :type resource: :class:`ArtifactResource <azure.devops.v5_1..models.ArtifactResource>`
    """
...
class BuildDefinitionTemplate(Model):
    ...
    :type template: :class:`BuildDefinition <azure.devops.v5_1..models.BuildDefinition>`
    """
...
class BuildDefinitionTemplate3_2(Model):
    ...
    :type name: str
    :param template:
    :type template: :class:`BuildDefinition3_2 <azure.devops.v5_1..models.BuildDefinition3_2>`
    """
...
class BuildOption(Model):
    ...
    :type definition: :class:`BuildOptionDefinitionReference <azure.devops.v5_1..models.BuildOptionDefinitionReference>`
...
class BuildSettings(Model):
    ...
    :type default_retention_policy: :class:`RetentionPolicy <azure.devops.v5_1..models.RetentionPolicy>`
    :param maximum_retention_policy: The maximum retention policy.
    :type maximum_retention_policy: :class:`RetentionPolicy <azure.devops.v5_1..models.RetentionPolicy>`
    """
...
class ProcessParameters(Model):
    ...
    :type data_source_bindings: list of :class:`DataSourceBindingBase <azure.devops.v5_1..models.DataSourceBindingBase>`
    :param inputs:
    :type inputs: list of :class:`TaskInputDefinitionBase <azure.devops.v5_1..models.TaskInputDefinitionBase>`
    :param source_definitions:
    :type source_definitions: list of :class:`TaskSourceDefinitionBase <azure.devops.v5_1..models.TaskSourceDefinitionBase>`
    """
...
class SourceProviderAttributes(Model):
    ...
    :type supported_triggers: list of :class:`SupportedTrigger <azure.devops.v5_1..models.SupportedTrigger>`
    """
...
class SourceRepositories(Model):
    ...
    :type repositories: list of :class:`SourceRepository <azure.devops.v5_1..models.SourceRepository>`
...
class TimelineRecord(Model):
    ...
    :type details: :class:`TimelineReference <azure.devops.v5_1..models.TimelineReference>`
    ...
    :type identifier: str
    :param issues:
    :type issues: list of :class:`Issue <azure.devops.v5_1..models.Issue>`
    ...
    :type log: :class:`BuildLogReference <azure.devops.v5_1..models.BuildLogReference>`
    :param name: The name.
    :type name: str
    ...
    :type previous_attempts: list of :class:`TimelineAttempt <azure.devops.v5_1..models.TimelineAttempt>`
    :param result: The result.
    :type result: object
    ...
    :type task: :class:`TaskReference <azure.devops.v5_1..models.TaskReference>`
...
class BuildDefinitionReference(DefinitionReference):
    ...
    :type authored_by: :class:`IdentityRef <azure.devops.v5_1..models.IdentityRef>`
    :param draft_of: A reference to the definition that this definition is a draft of, if this is a draft definition.
    :type draft_of: :class:`DefinitionReference <azure.devops.v5_1..models.DefinitionReference>`
    :param drafts: The list of drafts associated with this definition, if this is not a draft definition.
    :type drafts: list of :class:`DefinitionReference <azure.devops.v5_1..models.DefinitionReference>`
    :param latest_build:
    :type latest_build: :class:`Build <azure.devops.v5_1..models.Build>`
    :param latest_completed_build:
    :type latest_completed_build: :class:`Build <azure.devops.v5_1..models.Build>`
    :param metrics:
    :type metrics: list of :class:`BuildMetric <azure.devops.v5_1..models.BuildMetric>`
...
class BuildOptionDefinition(BuildOptionDefinitionReference):
    ...
    :type groups: list of :class:`BuildOptionGroupDefinition <azure.devops.v5_1..models.BuildOptionGroupDefinition>`
    :param inputs: The list of inputs defined for the build option.
    :type inputs: list of :class:`BuildOptionInputDefinition <azure.devops.v5_1..models.BuildOptionInputDefinition>`
...
class Timeline(TimelineReference):
    ...
    :type last_changed_on: datetime
    :param records:
    :type records: list of :class:`TimelineRecord <azure.devops.v5_1..models.TimelineRecord>`
    """
...
class BuildDefinition(BuildDefinitionReference):
    ...
    :param options:
    :type options: list of :class:`BuildOption <azure.devops.v5_1..models.BuildOption>`
    :param process: The build process.
    :type process: :class:`object <azure.devops.v5_1..models.object>`
    :param process_parameters: The process parameters for this definition.
    :type process_parameters: :class:`ProcessParameters <azure.devops.v5_1..models.ProcessParameters>`
    :param properties:
    :type properties: :class:`object <azure.devops.v5_1..models.object>`
    :param repository: The repository.
    :type repository: :class:`BuildRepository <azure.devops.v5_1..models.BuildRepository>`
    :param retention_rules:
    :type retention_rules: list of :class:`RetentionPolicy <azure.devops.v5_1..models.RetentionPolicy>`
    :param tags:
    :type tags: list of str
    :param triggers:
    :type triggers: list of :class:`object <azure.devops.v5_1..models.object>`
    :param variable_groups:
    :type variable_groups: list of :class:`VariableGroup <azure.devops.v5_1..models.VariableGroup>`
    :param variables:
    :type variables: dict
    """
...
class BuildDefinition3_2(BuildDefinitionReference3_2):
    ...
    :type badge_enabled: bool
    :param build:
    :type build: list of :class:`BuildDefinitionStep <azure.devops.v5_1..models.BuildDefinitionStep>`
    :param build_number_format: The build number format
    :type build_number_format: str
