...
class AggregatedResultsAnalysis(Model):
    ...
    :type previous_context: :class:`TestResultsContext <azure.devops.v5_1.microsoft.-team-foundation.-test-management.-web-api.models.TestResultsContext>`
    :param results_by_outcome:
    :type results_by_outcome: dict
    :param results_difference:
    :type results_difference: :class:`AggregatedResultsDifference <azure.devops.v5_1.microsoft.-team-foundation.-test-management.-web-api.models.AggregatedResultsDifference>`
...
class ProcessParameters(Model):
    ...
    :type data_source_bindings: list of :class:`DataSourceBindingBase <azure.devops.v5_1.microsoft.-team-foundation.-distributed-task.-common.-contracts.models.DataSourceBindingBase>`
    :param inputs:
    :type inputs: list of :class:`TaskInputDefinitionBase <azure.devops.v5_1.microsoft.-team-foundation.-distributed-task.-common.-contracts.models.TaskInputDefinitionBase>`
    :param source_definitions:
    :type source_definitions: list of :class:`TaskSourceDefinitionBase <azure.devops.v5_1.microsoft.-team-foundation.-distributed-task.-common.-contracts.models.TaskSourceDefinitionBase>`
    """
...
class TestResultsContext(Model):
    ...
    :param build:
    :type build: :class:`BuildReference <azure.devops.v5_1.microsoft.-team-foundation.-test-management.-web-api.models.BuildReference>`
    :param context_type:
    :type context_type: object
    :param release:
    :type release: :class:`ReleaseReference <azure.devops.v5_1.microsoft.-team-foundation.-test-management.-web-api.models.ReleaseReference>`
    """
