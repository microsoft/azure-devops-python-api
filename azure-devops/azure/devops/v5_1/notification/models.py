...
class VssNotificationEvent(Model):
    ...
    :type actors: list of :class:`EventActor <azure.devops.v5_1.microsoft.-visual-studio.-services.-web-api.models.EventActor>`
    ...
    :type scopes: list of :class:`EventScope <azure.devops.v5_1.microsoft.-visual-studio.-services.-web-api.models.EventScope>`
