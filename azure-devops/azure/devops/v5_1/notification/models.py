...
class BatchNotificationOperation(Model):
    ...
    :type notification_query_conditions: list of :class:`NotificationQueryCondition <azure.devops.v5_1..models.NotificationQueryCondition>`
    """
...
class ExpressionFilterModel(Model):
    ...
    :type clauses: list of :class:`ExpressionFilterClause <azure.devops.v5_1..models.ExpressionFilterClause>`
    :param groups: Grouping of clauses in the subscription
    :type groups: list of :class:`ExpressionFilterGroup <azure.devops.v5_1..models.ExpressionFilterGroup>`
...
class INotificationDiagnosticLog(Model):
    ...
    :type log_type: str
    :param messages:
    :type messages: list of :class:`NotificationDiagnosticLogMessage <azure.devops.v5_1..models.NotificationDiagnosticLogMessage>`
    :param properties:
...
class NotificationEventField(Model):
    ...
    :type field_type: :class:`NotificationEventFieldType <azure.devops.v5_1..models.NotificationEventFieldType>`
...
class NotificationEventFieldType(Model):
    ...
    :type operator_constraints: list of :class:`OperatorConstraint <azure.devops.v5_1..models.OperatorConstraint>`
    :param operators: Gets or sets the list of operators that this type supports.
    :type operators: list of :class:`NotificationEventFieldOperator <azure.devops.v5_1..models.NotificationEventFieldOperator>`
    ...
    :type value: :class:`ValueDefinition <azure.devops.v5_1..models.ValueDefinition>`
    """
...
class NotificationEventPublisher(Model):
    ...
    :type subscription_management_info: :class:`SubscriptionManagement <azure.devops.v5_1..models.SubscriptionManagement>`
    :param url:
    :type url: str
    """
...
class NotificationEventType(Model):
    ...
    :param category:
    :type category: :class:`NotificationEventTypeCategory <azure.devops.v5_1..models.NotificationEventTypeCategory>`
    ...
    :type event_publisher: :class:`NotificationEventPublisher <azure.devops.v5_1..models.NotificationEventPublisher>`
    :param fields:
    :type fields: dict
    :param has_initiator:
    ...
    :type name: str
    :param roles:
    :type roles: list of :class:`NotificationEventRole <azure.devops.v5_1..models.NotificationEventRole>`
...
class NotificationReason(Model):
    ...
    :type target_identities: list of :class:`IdentityRef <azure.devops.v5_1..models.IdentityRef>`
    """
...
class NotificationStatisticsQuery(Model):
    ...
    :param conditions:
    :type conditions: list of :class:`NotificationStatisticsQueryConditions <azure.devops.v5_1..models.NotificationStatisticsQueryConditions>`
    """
...
class NotificationSubscription(Model):
    ...
    :type admin_settings: :class:`SubscriptionAdminSettings <azure.devops.v5_1..models.SubscriptionAdminSettings>`
    :param channel: Channel for delivering notifications triggered by the subscription.
    :type channel: :class:`ISubscriptionChannel <azure.devops.v5_1..models.ISubscriptionChannel>`
    ...
    :type diagnostics: :class:`SubscriptionDiagnostics <azure.devops.v5_1..models.SubscriptionDiagnostics>`
    ...
    :type filter: :class:`ISubscriptionFilter <azure.devops.v5_1..models.ISubscriptionFilter>`
    ...
    :type scope: :class:`SubscriptionScope <azure.devops.v5_1..models.SubscriptionScope>`
    ...
    :type user_settings: :class:`SubscriptionUserSettings <azure.devops.v5_1..models.SubscriptionUserSettings>`
    """
...
class NotificationSubscriptionTemplate(Model):
    ...
    :type notification_event_information: :class:`NotificationEventType <azure.devops.v5_1..models.NotificationEventType>`
    :param type:
    :type type: object
    """
...
class SubscriptionEvaluationRequest(Model):
    ...
    :type subscription_create_parameters: :class:`NotificationSubscriptionCreateParameters <azure.devops.v5_1..models.NotificationSubscriptionCreateParameters>`
    """
...
class SubscriptionEvaluationResult(Model):
    ...
    :type events: :class:`EventsEvaluationResult <azure.devops.v5_1..models.EventsEvaluationResult>`
    ...
    :type notifications: :class:`NotificationsEvaluationResult <azure.devops.v5_1..models.NotificationsEvaluationResult>`
    """
...
class SubscriptionQuery(Model):
    ...
    :type conditions: list of :class:`SubscriptionQueryCondition <azure.devops.v5_1..models.SubscriptionQueryCondition>`
...
class ValueDefinition(Model):
    ...
    :type data_source: list of :class:`InputValue <azure.devops.v5_1..models.InputValue>`
...
class VssNotificationEvent(Model):
    ...
    :type actors: list of :class:`EventActor <azure.devops.v5_1..models.EventActor>`
    ...
    :type scopes: list of :class:`EventScope <azure.devops.v5_1..models.EventScope>`
...
class FieldValuesQuery(InputValuesQuery):
    ...
    :type resource: object
    :param input_values:
    :type input_values: list of :class:`FieldInputValues <azure.devops.v5_1..models.FieldInputValues>`
    :param scope:
    :type scope: str
    """
