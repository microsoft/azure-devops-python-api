...
class FieldModel(Model):
    ...
    :type pick_list: :class:`PickListMetadataModel <azure.devops.v5_1.work_item_tracking.models.PickListMetadataModel>`
...
class PickListModel(PickListMetadataModel):
    ...
    :type items: list of :class:`PickListItemModel <azure.devops.v5_1.work_item_tracking.models.PickListItemModel>`
    """
