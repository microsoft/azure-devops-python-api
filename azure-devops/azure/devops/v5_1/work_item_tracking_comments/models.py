...
class WorkItemCommentResponse(WorkItemTrackingResource):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v5_1.work-item-tracking.models.IdentityRef>`
    ...
    :type created_on_behalf_of: :class:`IdentityRef <azure.devops.v5_1.work-item-tracking.models.IdentityRef>`
    ...
    :type modified_by: :class:`IdentityRef <azure.devops.v5_1.work-item-tracking.models.IdentityRef>`
    :param modified_date: The last modification date of the comment.
    :type modified_date: datetime
    :param reactions: The reactions of the comment.
    :type reactions: list of :class:`WorkItemCommentReactionResponse <azure.devops.v5_1.work-item-tracking.models.WorkItemCommentReactionResponse>`
    :param text: The text of the comment.
    :type text: str
...
class WorkItemCommentsResponse(WorkItemTrackingResource):
    ...
    :type comments: list of :class:`WorkItemCommentResponse <azure.devops.v5_1.work-item-tracking.models.WorkItemCommentResponse>`
