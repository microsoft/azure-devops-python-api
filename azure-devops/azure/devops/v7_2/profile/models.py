...
class Profile(Model):
    ...
    :type application_container: :class:`AttributesContainer <azure.devops.v7_2.profile.models.AttributesContainer>`
...
class ProfileAttributeBase(Model):
    ...
    :type descriptor: :class:`AttributeDescriptor <azure.devops.v7_2.profile.models.AttributeDescriptor>`
