...
class BacklogColumn(Model):
    ...
    :type column_field_reference: :class:`WorkItemFieldReference <azure.devops.v7_2.work.models.WorkItemFieldReference>`
    :param width:
    :type width: int
    """
...
class BacklogConfiguration(Model):
    ...
    :type backlog_fields: :class:`BacklogFields <azure.devops.v7_2.work.models.BacklogFields>`
    ...
    :type portfolio_backlogs: list of :class:`BacklogLevelConfiguration <azure.devops.v7_2.work.models.BacklogLevelConfiguration>`
    :param requirement_backlog: Requirement backlog
    :type requirement_backlog: :class:`BacklogLevelConfiguration <azure.devops.v7_2.work.models.BacklogLevelConfiguration>`
    :param task_backlog: Task backlog
    :type task_backlog: :class:`BacklogLevelConfiguration <azure.devops.v7_2.work.models.BacklogLevelConfiguration>`
    :param url:
    :type url: str
    :param work_item_type_mapped_states: Mapped states for work item types
    :type work_item_type_mapped_states: list of :class:`WorkItemTypeStateInfo <azure.devops.v7_2.work.models.WorkItemTypeStateInfo>`
    """
...
class BacklogLevelConfiguration(Model):
    ...
    :type add_panel_fields: list of :class:`WorkItemFieldReference <azure.devops.v7_2.work.models.WorkItemFieldReference>`
    :param color: Color for the backlog level
    :type color: str
    :param column_fields: Default list of columns for the backlog
    :type column_fields: list of :class:`BacklogColumn <azure.devops.v7_2.work.models.BacklogColumn>`
    :param default_work_item_type: Default Work Item Type for the backlog
    :type default_work_item_type: :class:`WorkItemTypeReference <azure.devops.v7_2.work.models.WorkItemTypeReference>`
    ...
    :type work_item_types: list of :class:`WorkItemTypeReference <azure.devops.v7_2.work.models.WorkItemTypeReference>`
    """
...
class BacklogLevelWorkItems(Model):
    ...
    :type work_items: list of :class:`WorkItemLink <azure.devops.v7_2.work.models.WorkItemLink>`
    """
...
class BoardCardRuleSettings(Model):
    """
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.work.models.ReferenceLinks>`
    :param rules:
    :type rules: dict
    :param url:
    :type url: str
...
class BoardFields(Model):
    """
    :param column_field:
    :type column_field: :class:`FieldReference <azure.devops.v7_2.work.models.FieldReference>`
    :param done_field:
    :type done_field: :class:`FieldReference <azure.devops.v7_2.work.models.FieldReference>`
    :param row_field:
    :type row_field: :class:`FieldReference <azure.devops.v7_2.work.models.FieldReference>`
    """
...
class CapacityPatch(Model):
    ...
    :param activities:
    :type activities: list of :class:`Activity <azure.devops.v7_2.work.models.Activity>`
    :param days_off:
    :type days_off: list of :class:`DateRange <azure.devops.v7_2.work.models.DateRange>`
    """
...
class IterationCapacity(Model):
    ...
    :param teams:
    :type teams: list of :class:`TeamCapacityTotals <azure.devops.v7_2.work.models.TeamCapacityTotals>`
...
class Plan(Model):
    ...
    :type created_by_identity: :class:`IdentityRef <azure.devops.v7_2.work.models.IdentityRef>`
    ...
    :type modified_by_identity: :class:`IdentityRef <azure.devops.v7_2.work.models.IdentityRef>`
...
class PredefinedQuery(Model):
    ...
    :type results: list of :class:`WorkItem <azure.devops.v7_2.work.models.WorkItem>`
...
class ProcessConfiguration(Model):
    ...
    :type bug_work_items: :class:`CategoryConfiguration <azure.devops.v7_2.work.models.CategoryConfiguration>`
    :param portfolio_backlogs: Details about portfolio backlogs
    :type portfolio_backlogs: list of :class:`CategoryConfiguration <azure.devops.v7_2.work.models.CategoryConfiguration>`
    :param requirement_backlog: Details of requirement backlog
    :type requirement_backlog: :class:`CategoryConfiguration <azure.devops.v7_2.work.models.CategoryConfiguration>`
    :param task_backlog: Details of task backlog
    :type task_backlog: :class:`CategoryConfiguration <azure.devops.v7_2.work.models.CategoryConfiguration>`
...
class Rule(Model):
    """
    :param clauses:
    :type clauses: list of :class:`FilterClause <azure.devops.v7_2.work.models.FilterClause>`
    :param filter:
    :type filter: str
    :param is_enabled:
    :type is_enabled: str
...
class TaskboardColumn(Model):
    ...
    :type mappings: list of :class:`ITaskboardColumnMapping <azure.devops.v7_2.work.models.ITaskboardColumnMapping>`
...
class TaskboardColumns(Model):
    """
    :param columns:
    :type columns: list of :class:`TaskboardColumn <azure.devops.v7_2.work.models.TaskboardColumn>`
...
class TeamAutomationRulesSettingsRequestModel(Model):
    """
    :param backlog_level_name:
    :type backlog_level_name: str
    :param rules_states:
    :type rules_states: dict
    """

    _attribute_map = {
        'backlog_level_name': {'key': 'backlogLevelName', 'type': 'str'},
        'rules_states': {'key': 'rulesStates', 'type': '{bool}'}
    }

    def __init__(self, backlog_level_name=None, rules_states=None):
        super(TeamAutomationRulesSettingsRequestModel, self).__init__()
        self.backlog_level_name = backlog_level_name
        self.rules_states = rules_states
...
class TeamCapacity(Model):
    ...
    :param team_members:
    :type team_members: list of :class:`TeamMemberCapacityIdentityRef <azure.devops.v7_2.work.models.TeamMemberCapacityIdentityRef>`
...
class TeamFieldValuesPatch(Model):
    ...
    :param values:
    :type values: list of :class:`TeamFieldValue <azure.devops.v7_2.work.models.TeamFieldValue>`
    """
...
class TeamSettingsIteration(TeamSettingsDataContractBase):
    ...
    :type attributes: :class:`TeamIterationAttributes <azure.devops.v7_2.work.models.TeamIterationAttributes>`
...
class TimelineTeamData(Model):
    ...
    :type backlog: :class:`BacklogLevel <azure.devops.v7_2.work.models.BacklogLevel>`
    ...
    :type iterations: list of :class:`TimelineTeamIteration <azure.devops.v7_2.work.models.TimelineTeamIteration>`
    ...
    :type status: :class:`TimelineTeamStatus <azure.devops.v7_2.work.models.TimelineTeamStatus>`
    ...
    :type team_field_values: list of :class:`TeamFieldValue <azure.devops.v7_2.work.models.TeamFieldValue>`
    ...
    :type work_item_type_colors: list of :class:`WorkItemColor <azure.devops.v7_2.work.models.WorkItemColor>`
    """
...
class TimelineTeamIteration(Model):
    ...
    :type status: :class:`TimelineIterationStatus <azure.devops.v7_2.work.models.TimelineIterationStatus>`
...
class UpdateTaskboardColumn(Model):
    ...
    :type id: str
    :param mappings: Work item type states mapped to this column to support auto state update when column is updated.
    :type mappings: list of :class:`TaskboardColumnMapping <azure.devops.v7_2.work.models.TaskboardColumnMapping>`
...
class WorkItemLink(Model):
    ...
    :type source: :class:`WorkItemReference <azure.devops.v7_2.microsoft._team_foundation._work_item_tracking._web_api.models.WorkItemReference>`
    :param target: The target work item.
    :type target: :class:`WorkItemReference <azure.devops.v7_2.microsoft._team_foundation._work_item_tracking._web_api.models.WorkItemReference>`
    """
...
class Board(BoardReference):
    ...
    :type can_edit: bool
    :param columns:
    :type columns: list of :class:`BoardColumn <azure.devops.v7_2.work.models.BoardColumn>`
    :param fields:
    :type fields: :class:`BoardFields <azure.devops.v7_2.work.models.BoardFields>`
    :param is_valid:
    :type is_valid: bool
    :param revision:
    :type revision: int
    :param rows:
    :type rows: list of :class:`BoardRow <azure.devops.v7_2.work.models.BoardRow>`
    """
...
class DeliveryViewData(PlanViewData):
    ...
    :type criteria_status: :class:`TimelineCriteriaStatus <azure.devops.v7_2.work.models.TimelineCriteriaStatus>`
    ...
    :type parent_item_maps: list of :class:`ParentChildWIMap <azure.devops.v7_2.work.models.ParentChildWIMap>`
    :param start_date: The start date for the delivery view data
    :type start_date: datetime
    :param teams: All the team data
    :type teams: list of :class:`TimelineTeamData <azure.devops.v7_2.work.models.TimelineTeamData>`
    ...
    def __init__(self, id=None, revision=None, child_id_to_parent_id_map=None, criteria_status=None, end_date=None, max_expanded_teams=None, parent_item_maps=None, start_date=None, teams=None, work_item_dependencies=None, work_item_violations=None):
...
class IterationWorkItems(TeamSettingsDataContractBase):
    ...
    :type work_item_relations: list of :class:`WorkItemLink <azure.devops.v7_2.work.models.WorkItemLink>`
    """
...
class TeamFieldValues(TeamSettingsDataContractBase):
    ...
    :type field: :class:`FieldReference <azure.devops.v7_2.work.models.FieldReference>`
...
class TeamMemberCapacity(CapacityContractBase):
    ...
    :type team_member: :class:`Member <azure.devops.v7_2.work.models.Member>`
    """
...
class TeamMemberCapacityIdentityRef(CapacityContractBase):
    ...
    :type team_member: :class:`IdentityRef <azure.devops.v7_2.work.models.IdentityRef>`
    """
...
class TeamSetting(TeamSettingsDataContractBase):
    ...
    :type backlog_iteration: :class:`TeamSettingsIteration <azure.devops.v7_2.work.models.TeamSettingsIteration>`
    ...
    :type default_iteration: :class:`TeamSettingsIteration <azure.devops.v7_2.work.models.TeamSettingsIteration>`
...
class WorkItemTrackingResource(WorkItemTrackingResourceReference):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.microsoft._team_foundation._work_item_tracking._web_api.models.ReferenceLinks>`
    """
...
class WorkItem(WorkItemTrackingResource):
    ...
    :type comment_version_ref: :class:`WorkItemCommentVersionRef <azure.devops.v7_2.microsoft._team_foundation._work_item_tracking._web_api.models.WorkItemCommentVersionRef>`
    :param fields: Map of field and values for the work item.
    :type fields: dict
    :param id: The work item ID.
    :type id: int
    :param relations: Relations of the work item.
    :type relations: list of :class:`WorkItemRelation <azure.devops.v7_2.microsoft._team_foundation._work_item_tracking._web_api.models.WorkItemRelation>`
