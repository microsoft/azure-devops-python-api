...
class SessionTokenResult(Model):
    ...
    :type has_error: bool
    :param session_token:
    :type session_token: :class:`SessionToken <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.SessionToken>`
...
class TokenAdminPagedSessionTokens(Model):
    ...
    :type value: list of :class:`SessionToken <azure.devops.v7_2.token_admin.models.SessionToken>`
    """
