...
class AzureManagementGroupQueryResult(Model):
    ...
    :type value: list of :class:`AzureManagementGroup <azure.devops.v7_2.service_endpoint.models.AzureManagementGroup>`
    """
...
class AzureSubscriptionQueryResult(Model):
    ...
    :type error_message: str
    :param value:
    :type value: list of :class:`AzureSubscription <azure.devops.v7_2.service_endpoint.models.AzureSubscription>`
    """
...
class DataSource(Model):
    ...
    :type authentication_scheme: :class:`AuthenticationSchemeReference <azure.devops.v7_2.service_endpoint.models.AuthenticationSchemeReference>`
    ...
    :type headers: list of :class:`AuthorizationHeader <azure.devops.v7_2.service_endpoint.models.AuthorizationHeader>`
...
class DependsOn(Model):
    ...
    :type map: list of :class:`DependencyBinding <azure.devops.v7_2.service_endpoint.models.DependencyBinding>`
    """
...
class EndpointUrl(Model):
    ...
    :type depends_on: :class:`DependsOn <azure.devops.v7_2.service_endpoint.models.DependsOn>`
...
class OAuthConfiguration(Model):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v7_2.service_endpoint.models.IdentityRef>`
    ...
    :type modified_by: :class:`IdentityRef <azure.devops.v7_2.service_endpoint.models.IdentityRef>`
...
class ServiceEndpoint(Model):
    ...
    :type administrators_group: :class:`IdentityRef <azure.devops.v7_2.service_endpoint.models.IdentityRef>`
    :param authorization: Gets or sets the authorization data for talking to the endpoint.
    :type authorization: :class:`EndpointAuthorization <azure.devops.v7_2.service_endpoint.models.EndpointAuthorization>`
    ...
    :type id: str
    :param is_outdated: Indicates whether service endpoint is outdated or not.
    ...
    :type operation_status: :class:`object <azure.devops.v7_2.service_endpoint.models.object>`
    ...
    :type readers_group: :class:`IdentityRef <azure.devops.v7_2.service_endpoint.models.IdentityRef>`
    :param service_endpoint_project_references: All other project references where the service endpoint is shared.
    :type service_endpoint_project_references: list of :class:`ServiceEndpointProjectReference <azure.devops.v7_2.service_endpoint.models.ServiceEndpointProjectReference>`
    ...
    _attribute_map = {
        ...
        'id': {'key': 'id', 'type': 'str'},
        'is_outdated': {'key': 'isOutdated', 'type': 'bool'},
    ...
    def __init__(self, administrators_group=None, authorization=None, created_by=None, data=None, description=None, group_scope_id=None, id=None, is_outdated=None, is_ready=None, is_shared=None, name=None, operation_status=None, owner=None, readers_group=None, service_endpoint_project_references=None, type=None, url=None):
...
class ServiceEndpointAuthenticationScheme(Model):
    ...
    :type authorization_headers: list of :class:`AuthorizationHeader <azure.devops.v7_2.service_endpoint.models.AuthorizationHeader>`
    ...
    :type client_certificates: list of :class:`ClientCertificate <azure.devops.v7_2.service_endpoint.models.ClientCertificate>`
    :param data_source_bindings: Gets or sets the data source bindings of the endpoint.
    :type data_source_bindings: list of :class:`DataSourceBinding <azure.devops.v7_2.service_endpoint.models.DataSourceBinding>`
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v7_2.service_endpoint.models.InputDescriptor>`
...
class ServiceEndpointExecutionData(Model):
    ...
    :type definition: :class:`ServiceEndpointExecutionOwner <azure.devops.v7_2.service_endpoint.models.ServiceEndpointExecutionOwner>`
    ...
    :type owner: :class:`ServiceEndpointExecutionOwner <azure.devops.v7_2.service_endpoint.models.ServiceEndpointExecutionOwner>`
...
class ServiceEndpointExecutionOwner(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.service_endpoint.models.ReferenceLinks>`
...
class ServiceEndpointExecutionRecord(Model):
    ...
    :type data: :class:`ServiceEndpointExecutionData <azure.devops.v7_2.service_endpoint.models.ServiceEndpointExecutionData>`
...
class ServiceEndpointProjectReference(Model):
    ...
    :type project_reference: :class:`ProjectReference <azure.devops.v7_2.service_endpoint.models.ProjectReference>`
    """
...
class ServiceEndpointRequest(Model):
    ...
    :type data_source_details: :class:`DataSourceDetails <azure.devops.v7_2.service_endpoint.models.DataSourceDetails>`
    :param result_transformation_details: Gets or sets the result transformation details for the service endpoint request.
    :type result_transformation_details: :class:`ResultTransformationDetails <azure.devops.v7_2.service_endpoint.models.ResultTransformationDetails>`
    :param service_endpoint_details: Gets or sets the service endpoint details for the service endpoint request.
    :type service_endpoint_details: :class:`ServiceEndpointDetails <azure.devops.v7_2.service_endpoint.models.ServiceEndpointDetails>`
    """
...
class ServiceEndpointRequestResult(Model):
    ...
    :param activity_id: Gets or sets the activity id of the service endpoint request result.
    ...
    :type result: :class:`object <azure.devops.v7_2.service_endpoint.models.object>`
    ...
    def __init__(self, activity_id=None, callback_context_parameters=None, callback_required=None, error_message=None, result=None, status_code=None):
...
class ServiceEndpointType(Model):
    ...
    :type authentication_schemes: list of :class:`ServiceEndpointAuthenticationScheme <azure.devops.v7_2.service_endpoint.models.ServiceEndpointAuthenticationScheme>`
    :param data_sources: Data sources of service endpoint type.
    :type data_sources: list of :class:`DataSource <azure.devops.v7_2.service_endpoint.models.DataSource>`
    :param dependency_data: Dependency data of service endpoint type.
    :type dependency_data: list of :class:`DependencyData <azure.devops.v7_2.service_endpoint.models.DependencyData>`
    ...
    :type endpoint_url: :class:`EndpointUrl <azure.devops.v7_2.service_endpoint.models.EndpointUrl>`
    :param help_link: Gets or sets the help link of service endpoint type.
    :type help_link: :class:`HelpLink <azure.devops.v7_2.service_endpoint.models.HelpLink>`
