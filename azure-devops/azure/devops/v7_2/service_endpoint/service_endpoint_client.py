...
class ServiceEndpointClient(Client):
    ...
    def execute_service_endpoint_request(self, service_endpoint_request, project, endpoint_id):
        ...
        :param :class:`<ServiceEndpointRequest> <azure.devops.v7_2.service_endpoint.models.ServiceEndpointRequest>` service_endpoint_request: Service endpoint request.
        :param str project: Project ID or project name
        :param str endpoint_id: Id of the service endpoint.
        :rtype: :class:`<ServiceEndpointRequestResult> <azure.devops.v7_2.service_endpoint.models.ServiceEndpointRequestResult>`
        """
        route_values = {}
    ...
    def create_service_endpoint(self, endpoint):
        ...
        :param :class:`<ServiceEndpoint> <azure.devops.v7_2.service_endpoint.models.ServiceEndpoint>` endpoint: Service endpoint to create
        :rtype: :class:`<ServiceEndpoint> <azure.devops.v7_2.service_endpoint.models.ServiceEndpoint>`
        """
    ...
    def update_service_endpoint(self, endpoint, endpoint_id, operation=None):
        ...
        :param :class:`<ServiceEndpoint> <azure.devops.v7_2.service_endpoint.models.ServiceEndpoint>` endpoint: Updated data for the endpoint
    ...
    def get_service_endpoints(self, project, type=None, auth_schemes=None, endpoint_ids=None, owner=None, include_failed=None, include_details=None, action_filter=None):
        """GetServiceEndpoints.
        ...
        :param str action_filter: The "actionFilter" parameter allows users to evaluate requestor permissions and retrieve a list of endpoints that match the specified conditions, ensuring that only relevant endpoints are returned based on their permissions
        :rtype: [ServiceEndpoint]
        """
        route_values = {}
        if project is not None:
    ...
    def get_service_endpoint_execution_records(self, project, endpoint_id, top=None, continuation_token=None):
        ...
        :rtype: :class:`<[ServiceEndpointExecutionRecord]> <azure.devops.v7_2.service_endpoint.models.[ServiceEndpointExecutionRecord]>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
