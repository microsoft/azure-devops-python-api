...
class Permission(Model):
    ...
    :param authorized_by:
    :type authorized_by: :class:`IdentityRef <azure.devops.v7_2.pipeline_permissions.models.IdentityRef>`
    :param authorized_on:
...
class ResourcePipelinePermissions(Model):
    """
    :param all_pipelines:
    :type all_pipelines: :class:`Permission <azure.devops.v7_2.pipeline_permissions.models.Permission>`
    :param pipelines:
    :type pipelines: list of :class:`PipelinePermission <azure.devops.v7_2.pipeline_permissions.models.PipelinePermission>`
    :param resource:
    :type resource: :class:`Resource <azure.devops.v7_2.pipeline_permissions.models.Resource>`
    """
