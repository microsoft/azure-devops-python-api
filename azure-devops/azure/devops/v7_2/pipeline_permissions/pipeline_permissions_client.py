...
class PipelinePermissionsClient(Client):
    ...
    def get_pipeline_permissions_for_resource(self, project, resource_type, resource_id):
        ...
        :rtype: :class:`<ResourcePipelinePermissions> <azure.devops.v7_2.pipeline_permissions.models.ResourcePipelinePermissions>`
        """
        route_values = {}
    ...
    def update_pipeline_permisions_for_resource(self, resource_authorization, project, resource_type, resource_id):
        ...
        :param :class:`<ResourcePipelinePermissions> <azure.devops.v7_2.pipeline_permissions.models.ResourcePipelinePermissions>` resource_authorization:
        :param str project: Project ID or project name
        :param str resource_type:
        :param str resource_id:
        :rtype: :class:`<ResourcePipelinePermissions> <azure.devops.v7_2.pipeline_permissions.models.ResourcePipelinePermissions>`
