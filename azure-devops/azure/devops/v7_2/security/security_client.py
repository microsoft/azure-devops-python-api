...
class SecurityClient(Client):
    ...
    def set_access_control_entries(self, container, security_namespace_id):
        ...
        :param :class:`<object> <azure.devops.v7_2.security.models.object>` container:
        :param str security_namespace_id: Security namespace identifier.
    ...
    def set_access_control_lists(self, access_control_lists, security_namespace_id):
        ...
        :param :class:`<VssJsonCollectionWrapper> <azure.devops.v7_2.security.models.VssJsonCollectionWrapper>` access_control_lists: A list of ACLs to create or update.
        :param str security_namespace_id: Security namespace identifier.
        """
        route_values = {}
        if security_namespace_id is not None:
    ...
    def has_permissions_batch(self, eval_batch):
        ...
        :param :class:`<PermissionEvaluationBatch> <azure.devops.v7_2.security.models.PermissionEvaluationBatch>` eval_batch: The set of evaluation requests.
        :rtype: :class:`<PermissionEvaluationBatch> <azure.devops.v7_2.security.models.PermissionEvaluationBatch>`
        """
    ...
    def remove_permission(self, security_namespace_id, descriptor, permissions=None, token=None):
        ...
        :rtype: :class:`<AccessControlEntry> <azure.devops.v7_2.security.models.AccessControlEntry>`
        """
        route_values = {}
        if security_namespace_id is not None:
            route_values['securityNamespaceId'] = self._serialize.url('security_namespace_id', security_namespace_id, 'str')
