...
class SearchClient(Client):
    ...
    def fetch_scroll_code_search_results(self, request, project=None):
        ...
        :param :class:`<ScrollSearchRequest> <azure.devops.v7_2.search.models.ScrollSearchRequest>` request: The Code Search Request.
        :param str project: Project ID or project name
        :rtype: :class:`<CodeSearchResponse> <azure.devops.v7_2.search.models.CodeSearchResponse>`
        """
        route_values = {}
    ...
    def fetch_code_search_results(self, request, project=None):
        ...
        [Preview API] Provides a set of results for the search text.
        :param :class:`<CodeSearchRequest> <azure.devops.v7_2.search.models.CodeSearchRequest>` request: The Code Search Request.
        :param str project: Project ID or project name
        :rtype: :class:`<CodeSearchResponse> <azure.devops.v7_2.search.models.CodeSearchResponse>`
        """
        route_values = {}
    ...
    def fetch_package_search_results(self, request):
        ...
        [Preview API] Provides a set of results for the search text.
        :param :class:`<PackageSearchRequest> <azure.devops.v7_2.search.models.PackageSearchRequest>` request: The Package Search Request.
        :rtype: :class:`<PackageSearchResponse> <azure.devops.v7_2.search.models.PackageSearchResponse>`
        """
    ...
    def get_repository_status(self, project, repository):
        ...
        :rtype: :class:`<RepositoryStatusResponse> <azure.devops.v7_2.search.models.RepositoryStatusResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_tfvc_repository_status(self, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<TfvcRepositoryStatusResponse> <azure.devops.v7_2.search.models.TfvcRepositoryStatusResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def fetch_wiki_search_results(self, request, project=None):
        ...
        :param :class:`<WikiSearchRequest> <azure.devops.v7_2.search.models.WikiSearchRequest>` request: The Wiki Search Request.
        :param str project: Project ID or project name
        :rtype: :class:`<WikiSearchResponse> <azure.devops.v7_2.search.models.WikiSearchResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def fetch_work_item_search_results(self, request, project=None):
        ...
        [Preview API] Provides a set of results for the search text.
        :param :class:`<WorkItemSearchRequest> <azure.devops.v7_2.search.models.WorkItemSearchRequest>` request: The Work Item Search Request.
        :param str project: Project ID or project name
        :rtype: :class:`<WorkItemSearchResponse> <azure.devops.v7_2.search.models.WorkItemSearchResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
