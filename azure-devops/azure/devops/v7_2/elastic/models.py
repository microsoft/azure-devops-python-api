...
class ElasticPoolCreationResult(Model):
    ...
    :type agent_pool: :class:`TaskAgentPool <azure.devops.v7_2.elastic.models.TaskAgentPool>`
    :param agent_queue: Created agent queue
    :type agent_queue: :class:`TaskAgentQueue <azure.devops.v7_2.elastic.models.TaskAgentQueue>`
    :param elastic_pool: Created elastic pool
    :type elastic_pool: :class:`ElasticPool <azure.devops.v7_2.elastic.models.ElasticPool>`
    """
...
class TaskAgentQueue(Model):
    ...
    :type pool: :class:`TaskAgentPoolReference <azure.devops.v7_2.elastic.models.TaskAgentPoolReference>`
...
class TaskAgentPool(TaskAgentPoolReference):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v7_2.elastic.models.IdentityRef>`
    :param created_on: The date/time of the pool creation.
    :type created_on: datetime
    :param owner: Owner or administrator of the pool.
    :type owner: :class:`IdentityRef <azure.devops.v7_2.elastic.models.IdentityRef>`
    :param properties:
    :type properties: :class:`object <azure.devops.v7_2.elastic.models.object>`
