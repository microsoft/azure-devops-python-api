...
class NuGetClient(Client):
    ...
    def update_package_versions(self, batch_request, feed_id, project=None):
        ...
        :param :class:`<NuGetPackagesBatchRequest> <azure.devops.v7_2.nuget.models.NuGetPackagesBatchRequest>` batch_request: Information about the packages to update, the operation to perform, and its associated data.
        :param str feed_id: Name or ID of the feed.
        :param str project: Project ID or project name
        """
        route_values = {}
    ...
    def update_recycle_bin_package_versions(self, batch_request, feed_id, project=None):
        ...
        :param :class:`<NuGetPackagesBatchRequest> <azure.devops.v7_2.nuget.models.NuGetPackagesBatchRequest>` batch_request: Information about the packages to update, the operation to perform, and its associated data. <c>Operation</c> must be <c>PermanentDelete</c> or <c>RestoreToFeed</c>
        :param str feed_id: Name or ID of the feed.
        :param str project: Project ID or project name
        """
        route_values = {}
    ...
    def get_package_version_metadata_from_recycle_bin(self, feed_id, package_name, package_version, project=None):
        ...
        :param str package_version: Version of the package.
        :param str project: Project ID or project name
        :rtype: :class:`<NuGetPackageVersionDeletionState> <azure.devops.v7_2.nuget.models.NuGetPackageVersionDeletionState>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def restore_package_version_from_recycle_bin(self, package_version_details, feed_id, package_name, package_version, project=None):
        ...
        :param :class:`<NuGetRecycleBinPackageVersionDetails> <azure.devops.v7_2.nuget.models.NuGetRecycleBinPackageVersionDetails>` package_version_details: Set the 'Deleted' member to 'false' to apply the restore operation
        :param str feed_id: Name or ID of the feed.
        :param str package_name: Name of the package.
        :param str package_version: Version of the package.
        :param str project: Project ID or project name
    ...
    def get_upstreaming_behavior(self, feed_id, package_name, project=None):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<UpstreamingBehavior> <azure.devops.v7_2.nuget.models.UpstreamingBehavior>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def set_upstreaming_behavior(self, feed_id, package_name, behavior, project=None):
        ...
        :param str feed_id: The name or id of the feed
        :param str package_name: The name of the package
        :param :class:`<UpstreamingBehavior> <azure.devops.v7_2.nuget.models.UpstreamingBehavior>` behavior: The behavior to apply to the package within the scope of the feed
        :param str project: Project ID or project name
        """
        route_values = {}
        if project is not None:
    ...
    def delete_package_version(self, feed_id, package_name, package_version, project=None):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<Package> <azure.devops.v7_2.nuget.models.Package>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_package_version(self, package_version_details, feed_id, package_name, package_version, project=None):
        ...
        :param :class:`<PackageVersionDetails> <azure.devops.v7_2.nuget.models.PackageVersionDetails>` package_version_details: New state to apply to the referenced package.
        :param str feed_id: Name or ID of the feed.
