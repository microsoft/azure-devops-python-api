...
class ApprovalCheckDefinitionReference(Model):
    """
    :param id:
    :type id: str
    """
    ...
    def __init__(self, id=None):
        super(ApprovalCheckDefinitionReference, self).__init__()
        self.id = id
...
class ApprovalConfig(Model):
    ...
    :type approvers: list of :class:`IdentityRef <azure.devops.v7_2.microsoft._azure._pipelines._approval._web_api.models.IdentityRef>`
    :param blocked_approvers: Identities which are not allowed to approve.
    :type blocked_approvers: list of :class:`IdentityRef <azure.devops.v7_2.microsoft._azure._pipelines._approval._web_api.models.IdentityRef>`
    :param definition_ref: Determines approval check type and its settings.
    :type definition_ref: :class:`ApprovalCheckDefinitionReference <azure.devops.v7_2.microsoft._azure._pipelines._approval._web_api.models.ApprovalCheckDefinitionReference>`
    ...
    _attribute_map = {
        ...
        'definition_ref': {'key': 'definitionRef', 'type': 'ApprovalCheckDefinitionReference'},
    ...
    def __init__(self, approvers=None, blocked_approvers=None, definition_ref=None, execution_order=None, instructions=None, min_required_approvers=None):
...
class ApprovalConfigSettings(ApprovalConfig):
    ...
    def __init__(self, approvers=None, blocked_approvers=None, definition_ref=None, execution_order=None, instructions=None, min_required_approvers=None, requester_cannot_be_approver=None):
        super(ApprovalConfigSettings, self).__init__(approvers=approvers, blocked_approvers=blocked_approvers, definition_ref=definition_ref, execution_order=execution_order, instructions=instructions, min_required_approvers=min_required_approvers)
...
class CheckConfigurationRef(Model):
    ...
    :type resource: :class:`Resource <azure.devops.v7_2.pipelines_checks.models.Resource>`
    :param type: Check configuration type
    :type type: :class:`CheckType <azure.devops.v7_2.pipelines_checks.models.CheckType>`
...
class CheckIssue(Model):
    """
    An issue (error, warning) associated with a check configuration.

    :param description: Short summary of the check - its name and resource.
    :type description: str
    :param detailed_message: A more detailed description of issue.
    ...
    def __init__(self, description=None, detailed_message=None, message=None, type=None):
        super(CheckIssue, self).__init__()
...
class CheckRunResult(Model):
    """
    :param modified_by: Identity of person who modified check result.
    :type modified_by: :class:`IdentityRef <azure.devops.v7_2.pipelines_checks.models.IdentityRef>`
...
class CheckRunUpdate(Model):
    """
    :param check_run_id: Check run id of modified check run.
    :type check_run_id: str
    :param check_suite_id: Check suite id of modified check run.
    :type check_suite_id: str
    :param modified_by: Identity of person who modified check result.
    :type modified_by: :class:`IdentityRef <azure.devops.v7_2.pipelines_checks.models.IdentityRef>`
    :param modified_on: Time of check run's result modification.
    :type modified_on: datetime
    :param status: New check run status introduced by result update.
    :type status: object
    """

    _attribute_map = {
        'check_run_id': {'key': 'checkRunId', 'type': 'str'},
        'check_suite_id': {'key': 'checkSuiteId', 'type': 'str'},
        'modified_by': {'key': 'modifiedBy', 'type': 'IdentityRef'},
        'modified_on': {'key': 'modifiedOn', 'type': 'iso-8601'},
        'status': {'key': 'status', 'type': 'object'}
    }

    def __init__(self, check_run_id=None, check_suite_id=None, modified_by=None, modified_on=None, status=None):
        super(CheckRunUpdate, self).__init__()
...
class CheckSuiteRef(Model):
    ...
    :type context: :class:`object <azure.devops.v7_2.pipelines_checks.models.object>`
...
class CheckSuiteRequest(Model):
    ...
    :type id: str
    :param resources:
    :type resources: list of :class:`Resource <azure.devops.v7_2.pipelines_checks.models.Resource>`
    """
...
class CheckSuiteUpdateParameter(Model):
    """
    :param action: Action that has to be taken for the specified check.
    :type action: object
    :param check_id: Check id of the check run to be updated.
    :type check_id: str
    """

    _attribute_map = {
        'action': {'key': 'action', 'type': 'object'},
        'check_id': {'key': 'checkId', 'type': 'str'}
    }

    def __init__(self, action=None, check_id=None):
        super(CheckSuiteUpdateParameter, self).__init__()
        self.action = action
...
class TaskCheckConfig(Model):
    ...
    :type definition_ref: :class:`TaskCheckDefinitionReference <azure.devops.v7_2.microsoft._azure._pipelines._task_check._web_api.models.TaskCheckDefinitionReference>`
    :param display_name:
    :type display_name: str
    :param inputs:
    :type inputs: dict
...
class CheckConfiguration(CheckConfigurationRef):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.pipelines_checks.models.ReferenceLinks>`
    :param created_by: Identity of person who configured check.
    :type created_by: :class:`IdentityRef <azure.devops.v7_2.pipelines_checks.models.IdentityRef>`
    :param created_on: Time when check got configured.
    :type created_on: datetime
    :param is_disabled: Is check disabled.
    :type is_disabled: bool
    :param issue: Issue connected to check configuration.
    :type issue: :class:`CheckIssue <azure.devops.v7_2.pipelines_checks.models.CheckIssue>`
    ...
    def __init__(self, id=None, resource=None, type=None, url=None, _links=None, created_by=None, created_on=None, is_disabled=None, issue=None, modified_by=None, modified_on=None, timeout=None):
...
class CheckRun(CheckRunResult):
    ...
    :type check_configuration_ref: :class:`CheckConfigurationRef <azure.devops.v7_2.pipelines_checks.models.CheckConfigurationRef>`
    :param completed_date:
    :type completed_date: datetime
    :param created_date:
    :type created_date: datetime
    :param evaluation_order:
    :type evaluation_order: object
    :param id:
    :type id: str
    :param result_updates: List of check run result updates.
    :type result_updates: list of :class:`CheckRunUpdate <azure.devops.v7_2.pipelines_checks.models.CheckRunUpdate>`
    """
    ...
    _attribute_map = {
        ...
        'evaluation_order': {'key': 'evaluationOrder', 'type': 'object'},
        'id': {'key': 'id', 'type': 'str'},
        'result_updates': {'key': 'resultUpdates', 'type': '[CheckRunUpdate]'}
    }

    def __init__(self, modified_by=None, result_message=None, status=None, check_configuration_ref=None, completed_date=None, created_date=None, evaluation_order=None, id=None, result_updates=None):
        super(CheckRun, self).__init__(modified_by=modified_by, result_message=result_message, status=status)
...
class CheckSuite(CheckSuiteRef):
    ...
    :type check_runs: list of :class:`CheckRun <azure.devops.v7_2.pipelines_checks.models.CheckRun>`
...
__all__ = [
    'ApprovalCheckDefinitionReference',
    'ApprovalConfig',
