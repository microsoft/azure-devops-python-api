...
class PipelinesChecksClient(Client):
    ...
    def add_check_configuration(self, configuration, project):
        ...
        :param :class:`<CheckConfiguration> <azure.devops.v7_2.pipelines_checks.models.CheckConfiguration>` configuration:
        :param str project: Project ID or project name
        :rtype: :class:`<CheckConfiguration> <azure.devops.v7_2.pipelines_checks.models.CheckConfiguration>`
        """
        route_values = {}
    ...
    def update_check_configuration(self, configuration, project, id):
        ...
        :param :class:`<CheckConfiguration> <azure.devops.v7_2.pipelines_checks.models.CheckConfiguration>` configuration: check configuration
        :param str project: Project ID or project name
        :param int id: check configuration id
        :rtype: :class:`<CheckConfiguration> <azure.devops.v7_2.pipelines_checks.models.CheckConfiguration>`
        """
    ...
    def evaluate_check_suite(self, request, project, expand=None):
        ...
        :param :class:`<CheckSuiteRequest> <azure.devops.v7_2.pipelines_checks.models.CheckSuiteRequest>` request:
        :param str project: Project ID or project name
        :param str expand:
        :rtype: :class:`<CheckSuite> <azure.devops.v7_2.pipelines_checks.models.CheckSuite>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_check_suite(self, request, project, check_suite_id, expand=None):
        """UpdateCheckSuite.
        [Preview API] Update a check run of a check suite
        :param :class:`<CheckSuiteUpdateParameter> <azure.devops.v7_2.pipelines_checks.models.CheckSuiteUpdateParameter>` request:
        :param str project: Project ID or project name
        :param str check_suite_id:
        :param str expand:
        :rtype: :class:`<CheckSuite> <azure.devops.v7_2.pipelines_checks.models.CheckSuite>`
        ...
        if expand is not None:
            query_parameters['$expand'] = self._serialize.query('expand', expand, 'str')
        content = self._serialize.body(request, 'CheckSuiteUpdateParameter')
        response = self._send(http_method='PATCH',
                              location_id='91282c1d-c183-444f-9554-1485bfb3879d',
                              version='7.2-preview.1',
                              route_values=route_values,
