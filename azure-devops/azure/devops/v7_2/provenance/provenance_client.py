...
class ProvenanceClient(Client):
    ...
    def create_session(self, session_request, protocol, project=None):
        ...
        :param :class:`<SessionRequest> <azure.devops.v7_2.provenance.models.SessionRequest>` session_request: The feed and metadata for the session
        :param str protocol: The protocol that the session will target
        :param str project: Project ID or project name
        :rtype: :class:`<SessionResponse> <azure.devops.v7_2.provenance.models.SessionResponse>`
        """
        route_values = {}
