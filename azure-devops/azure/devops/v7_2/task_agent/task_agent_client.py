...
class TaskAgentClient(Client):
    ...
    def add_agent_cloud(self, agent_cloud):
        """AddAgentCloud.
        [Preview API]
        :param :class:`<TaskAgentCloud> <azure.devops.v7_2.task_agent.models.TaskAgentCloud>` agent_cloud:
        :rtype: :class:`<TaskAgentCloud> <azure.devops.v7_2.task_agent.models.TaskAgentCloud>`
        """
    ...
    def update_agent_cloud(self, updated_cloud, agent_cloud_id):
        """UpdateAgentCloud.
        [Preview API]
        :param :class:`<TaskAgentCloud> <azure.devops.v7_2.task_agent.models.TaskAgentCloud>` updated_cloud:
        :param int agent_cloud_id:
        :rtype: :class:`<TaskAgentCloud> <azure.devops.v7_2.task_agent.models.TaskAgentCloud>`
        """
        route_values = {}
    ...
    def add_agent(self, agent, pool_id):
        ...
        :param :class:`<TaskAgent> <azure.devops.v7_2.task_agent.models.TaskAgent>` agent: Details about the agent being added
        :param int pool_id: The agent pool in which to add the agent
        :rtype: :class:`<TaskAgent> <azure.devops.v7_2.task_agent.models.TaskAgent>`
        """
        route_values = {}
    ...
    def replace_agent(self, agent, pool_id, agent_id):
        ...
        :param :class:`<TaskAgent> <azure.devops.v7_2.task_agent.models.TaskAgent>` agent: Updated details about the replacing agent
    ...
    def update_agent(self, agent, pool_id, agent_id):
        ...
        :param :class:`<TaskAgent> <azure.devops.v7_2.task_agent.models.TaskAgent>` agent: Updated details about the agent
        :param int pool_id: The agent pool to use
    ...
    def add_deployment_group(self, deployment_group, project):
        ...
        :param :class:`<DeploymentGroupCreateParameter> <azure.devops.v7_2.task_agent.models.DeploymentGroupCreateParameter>` deployment_group: Deployment group to create.
        :param str project: Project ID or project name
        :rtype: :class:`<DeploymentGroup> <azure.devops.v7_2.task_agent.models.DeploymentGroup>`
        """
        route_values = {}
    ...
    def update_deployment_group(self, deployment_group, project, deployment_group_id):
        ...
        :param :class:`<DeploymentGroupUpdateParameter> <azure.devops.v7_2.task_agent.models.DeploymentGroupUpdateParameter>` deployment_group: Deployment group to update.
        :param str project: Project ID or project name
        :param int deployment_group_id: ID of the deployment group.
        :rtype: :class:`<DeploymentGroup> <azure.devops.v7_2.task_agent.models.DeploymentGroup>`
        """
    ...
    def has_pool_permissions(self, pool_id, permissions):
        """HasPoolPermissions.
        [Preview API] Checks if current identity has passed permissions on a pool.
        :param int pool_id: Id of the pool to check
        :param int permissions: Permissions to check. Multiple permissions might be merged into single value using bitwise OR operator (e.g. AgentPoolPermissions.Manage | AgentPoolPermissions.View)
        :rtype: bool
        """
        route_values = {}
        if pool_id is not None:
        ...
        response = self._send(http_method='GET',
                              location_id='162778f3-4b48-48f3-9d58-436fb9c407bc',
                              version='7.2-preview.1',
                              route_values=route_values)
    ...
    def add_agent_pool(self, pool):
        ...
        :param :class:`<TaskAgentPool> <azure.devops.v7_2.task_agent.models.TaskAgentPool>` pool: Details about the new agent pool
        :rtype: :class:`<TaskAgentPool> <azure.devops.v7_2.task_agent.models.TaskAgentPool>`
        """
    ...
    def update_agent_pool(self, pool, pool_id):
        ...
        :param :class:`<TaskAgentPool> <azure.devops.v7_2.task_agent.models.TaskAgentPool>` pool: Updated agent pool details
    ...
    def add_agent_queue(self, queue, project=None, authorize_pipelines=None):
        ...
        :param :class:`<TaskAgentQueue> <azure.devops.v7_2.task_agent.models.TaskAgentQueue>` queue: Details about the queue to create
        :param str project: Project ID or project name
        :param bool authorize_pipelines: Automatically authorize this queue when using YAML
        :rtype: :class:`<TaskAgentQueue> <azure.devops.v7_2.task_agent.models.TaskAgentQueue>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_deployment_target(self, project, deployment_group_id, target_id, expand=None):
        ...
        :param str expand: Include these additional details in the returned objects.
        :rtype: :class:`<DeploymentMachine> <azure.devops.v7_2.task_agent.models.DeploymentMachine>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def add_task_group(self, task_group, project):
        ...
        :param :class:`<TaskGroupCreateParameter> <azure.devops.v7_2.task_agent.models.TaskGroupCreateParameter>` task_group: Task group object to create.
        :param str project: Project ID or project name
        :rtype: :class:`<TaskGroup> <azure.devops.v7_2.task_agent.models.TaskGroup>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_task_group(self, task_group, project, task_group_id=None):
        ...
        :param :class:`<TaskGroupUpdateParameter> <azure.devops.v7_2.task_agent.models.TaskGroupUpdateParameter>` task_group: Task group to update.
        :param str project: Project ID or project name
    ...
    def add_variable_group(self, variable_group_parameters):
        ...
        :param :class:`<VariableGroupParameters> <azure.devops.v7_2.task_agent.models.VariableGroupParameters>` variable_group_parameters:
        :rtype: :class:`<VariableGroup> <azure.devops.v7_2.task_agent.models.VariableGroup>`
        """
