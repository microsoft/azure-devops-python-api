...
class AccessLevel(Model):
    ...
    :param account_license_type: Type of Account License (e.g. Express, Stakeholder etc.). To use the AccountLicenseType, LicensingSource should be defined as 'account' in the request body.
    ...
    :param msdn_license_type: Type of MSDN License (e.g. Visual Studio Professional, Visual Studio Enterprise etc.). To use the MsdnLicenseType, LicensingSource should be defined as 'msdn' in the request body.
...
class EntitlementBase(Model):
    """
    :param access_level: Member's access level denoted by a license.
    :type access_level: :class:`AccessLevel <azure.devops.v7_2.member_entitlement_management.models.AccessLevel>`
    :param date_created: [Readonly] Date the member was added to the collection.
    :type date_created: datetime
    :param group_assignments: [Readonly] GroupEntitlements that this member belongs to.
    :type group_assignments: list of :class:`GroupEntitlement <azure.devops.v7_2.member_entitlement_management.models.GroupEntitlement>`
    :param id: The unique identifier which matches the Id of the Identity associated with the GraphMember.
    :type id: str
    :param last_accessed_date: [Readonly] Date the member last accessed the collection.
    ...
    :type project_entitlements: list of :class:`ProjectEntitlement <azure.devops.v7_2.member_entitlement_management.models.ProjectEntitlement>`
    """
    ...
    def __init__(self, access_level=None, date_created=None, group_assignments=None, id=None, last_accessed_date=None, project_entitlements=None):
        super(EntitlementBase, self).__init__()
...
class EntitlementOperationResultBase(Model):
    """
    :param errors: List of error codes paired with their corresponding error messages.
    :type errors: list of { key: int; value: str }
    :param is_success: Success status of the operation.
    ...
    def __init__(self, errors=None, is_success=None, result=None):
        super(EntitlementOperationResultBase, self).__init__()
        self.errors = errors
        self.is_success = is_success
        self.result = result
...
class GraphSubjectBase(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.ReferenceLinks>`
...
class GroupEntitlement(Model):
    ...
    :type extension_rules: list of :class:`Extension <azure.devops.v7_2.member_entitlement_management.models.Extension>`
    :param group: Member reference.
    :type group: :class:`GraphGroup <azure.devops.v7_2.member_entitlement_management.models.GraphGroup>`
    ...
    :type license_rule: :class:`AccessLevel <azure.devops.v7_2.member_entitlement_management.models.AccessLevel>`
    :param members: Group members. Only used when creating a new group.
    :type members: list of :class:`UserEntitlement <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>`
    :param project_entitlements: Relation between a project and the member's effective permissions in that project.
    :type project_entitlements: list of :class:`ProjectEntitlement <azure.devops.v7_2.member_entitlement_management.models.ProjectEntitlement>`
...
class GroupOperationResult(BaseOperationResult):
    ...
    :type result: :class:`GroupEntitlement <azure.devops.v7_2.member_entitlement_management.models.GroupEntitlement>`
    """
...
class GroupOption(Model):
    ...
    :type access_level: :class:`AccessLevel <azure.devops.v7_2.member_entitlement_management.models.AccessLevel>`
    :param group: Group
    :type group: :class:`Group <azure.devops.v7_2.member_entitlement_management.models.Group>`
    """
...
class MemberEntitlement2(EntitlementBase):
    """
    ...
    :type project_entitlements: list of :class:`ProjectEntitlement <azure.devops.v7_2.member_entitlement_management.models.ProjectEntitlement>`
    :param member:
    :type member: :class:`AadGraphMember <azure.devops.v7_2.member_entitlement_management.models.AadGraphMember>`
    """
    ...
    _attribute_map = {
        ...
        'last_accessed_date': {'key': 'lastAccessedDate', 'type': 'iso-8601'},
        'project_entitlements': {'key': 'projectEntitlements', 'type': '[ProjectEntitlement]'},
        'member': {'key': 'member', 'type': 'AadGraphMember'}
    }

    def __init__(self, access_level=None, date_created=None, group_assignments=None, id=None, last_accessed_date=None, project_entitlements=None, member=None):
        super(MemberEntitlement2, self).__init__(access_level=access_level, date_created=date_created, group_assignments=group_assignments, id=id, last_accessed_date=last_accessed_date, project_entitlements=project_entitlements)
        self.member = member


class MemberEntitlement2OperationResult(EntitlementOperationResultBase):
    """
    ...
    def __init__(self, member_id=None):
        super(MemberEntitlement2OperationResult, self).__init__()
        self.member_id = member_id


class MemberEntitlement2ResponseBase(Model):
    """
    ...
    :type member_entitlement: :class:`MemberEntitlement2 <azure.devops.v7_2.member_entitlement_management.models.MemberEntitlement2>`
    """

    _attribute_map = {
        'is_success': {'key': 'isSuccess', 'type': 'bool'},
        'member_entitlement': {'key': 'memberEntitlement', 'type': 'MemberEntitlement2'}
    }

    def __init__(self, is_success=None, member_entitlement=None):
        super(MemberEntitlement2ResponseBase, self).__init__()
        self.is_success = is_success
...
class MemberEntitlementsResponseBase(Model):
    ...
    :type is_success: bool
    :param member_entitlement: Result of the member entitlement after the operations. have been applied
    :type member_entitlement: :class:`MemberEntitlement <azure.devops.v7_2.member_entitlement_management.models.MemberEntitlement>`
    """
...
class OperationResult(Model):
    ...
    :type result: :class:`MemberEntitlement <azure.devops.v7_2.member_entitlement_management.models.MemberEntitlement>`
    """
...
class PagedGraphMemberList(Model):
    ...
    :param items:
    :type items: list of :class:`UserEntitlement <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>`
    :param members:
    :type members: list of :class:`UserEntitlement <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>`
    :param total_count:
    ...
    _attribute_map = {
        ...
        'items': {'key': 'items', 'type': '[UserEntitlement]'},
        'members': {'key': 'members', 'type': '[UserEntitlement]'},
        'total_count': {'key': 'totalCount', 'type': 'int'}
    }

    def __init__(self, continuation_token=None, items=None, members=None, total_count=None):
...
class PagedUserEntitlementsList(Model):
    """
    A page of user entitlements

    :param continuation_token: The continuation token for next page of data. Can be null, if no more data exists.
    :type continuation_token: str
    :param items: The requested user entitlement items.
    :type items: list of :class:`UserEntitlement <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>`
    :param total_count: The total count of the existing user entitlement items.
    :type total_count: int
    """
    ...
    def __init__(self, continuation_token=None, items=None, total_count=None):
        super(PagedUserEntitlementsList, self).__init__()
        self.continuation_token = continuation_token
        self.items = items
        self.total_count = total_count
...
class ProjectEntitlement(Model):
    ...
    :type project_ref: :class:`ProjectRef <azure.devops.v7_2.member_entitlement_management.models.ProjectRef>`
    :param team_refs: Team Ref.
    :type team_refs: list of :class:`TeamRef <azure.devops.v7_2.member_entitlement_management.models.TeamRef>`
    """
...
class ServicePrincipalEntitlement(EntitlementBase):
    """
    :param access_level: Member's access level denoted by a license.
    :type access_level: :class:`AccessLevel <azure.devops.v7_2.member_entitlement_management.models.AccessLevel>`
    :param date_created: [Readonly] Date the member was added to the collection.
    ...
    :param project_entitlements: Relation between a project and the member's effective permissions in that project.
    :type project_entitlements: list of :class:`ProjectEntitlement <azure.devops.v7_2.member_entitlement_management.models.ProjectEntitlement>`
    :param service_principal: ServicePrincipal reference.
    :type service_principal: :class:`GraphServicePrincipal <azure.devops.v7_2.member_entitlement_management.models.GraphServicePrincipal>`
    """
    ...
    _attribute_map = {
        ...
        'last_accessed_date': {'key': 'lastAccessedDate', 'type': 'iso-8601'},
        'project_entitlements': {'key': 'projectEntitlements', 'type': '[ProjectEntitlement]'},
        'service_principal': {'key': 'servicePrincipal', 'type': 'GraphServicePrincipal'}
    }

    def __init__(self, access_level=None, date_created=None, group_assignments=None, id=None, last_accessed_date=None, project_entitlements=None, service_principal=None):
        super(ServicePrincipalEntitlement, self).__init__(access_level=access_level, date_created=date_created, group_assignments=group_assignments, id=id, last_accessed_date=last_accessed_date, project_entitlements=project_entitlements)
        self.service_principal = service_principal


class ServicePrincipalEntitlementOperationReference(OperationReference):
    """
    :param id: Unique identifier for the operation.
    :type id: str
    :param plugin_id: Unique identifier for the plugin.
    ...
    :type results: list of :class:`ServicePrincipalEntitlementOperationResult <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlementOperationResult>`
    """
    ...
    _attribute_map = {
        ...
        'results': {'key': 'results', 'type': '[ServicePrincipalEntitlementOperationResult]'}
    }

    def __init__(self, id=None, plugin_id=None, status=None, url=None, completed=None, have_results_succeeded=None, results=None):
        super(ServicePrincipalEntitlementOperationReference, self).__init__(id=id, plugin_id=plugin_id, status=status, url=url)
        self.completed = completed
        self.have_results_succeeded = have_results_succeeded
        self.results = results


class ServicePrincipalEntitlementOperationResult(EntitlementOperationResultBase):
    """
    :param service_principal_id: Identifier of the ServicePrincipal being acted upon.
    ...
    def __init__(self, service_principal_id=None):
        super(ServicePrincipalEntitlementOperationResult, self).__init__()
        self.service_principal_id = service_principal_id


class ServicePrincipalEntitlementsResponseBase(Model):
    """
    :param is_success:
    :type is_success: bool
    :param service_principal_entitlement:
    :type service_principal_entitlement: :class:`ServicePrincipalEntitlement <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlement>`
    """

    _attribute_map = {
        'is_success': {'key': 'isSuccess', 'type': 'bool'},
        'service_principal_entitlement': {'key': 'servicePrincipalEntitlement', 'type': 'ServicePrincipalEntitlement'}
    }

    def __init__(self, is_success=None, service_principal_entitlement=None):
        super(ServicePrincipalEntitlementsResponseBase, self).__init__()
        self.is_success = is_success
        self.service_principal_entitlement = service_principal_entitlement
...
class UserEntitlement(EntitlementBase):
    """
    ...
    :type extensions: list of :class:`Extension <azure.devops.v7_2.member_entitlement_management.models.Extension>`
    :param user: User reference.
    :type user: :class:`GraphUser <azure.devops.v7_2.member_entitlement_management.models.GraphUser>`
    """
    ...
    def __init__(self, access_level=None, date_created=None, group_assignments=None, id=None, last_accessed_date=None, project_entitlements=None, extensions=None, user=None):
        super(UserEntitlement, self).__init__(access_level=access_level, date_created=date_created, group_assignments=group_assignments, id=id, last_accessed_date=last_accessed_date, project_entitlements=project_entitlements)
...
class UserEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation.
    :type results: list of :class:`UserEntitlementOperationResult <azure.devops.v7_2.member_entitlement_management.models.UserEntitlementOperationResult>`
    """
...
class UserEntitlementOperationResult(EntitlementOperationResultBase):
    """
...
class UserEntitlementsResponseBase(Model):
    ...
    :type user_entitlement: :class:`UserEntitlement <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>`
    """
...
class UsersSummary(Model):
    ...
    :type available_access_levels: list of :class:`AccessLevel <azure.devops.v7_2.member_entitlement_management.models.AccessLevel>`
    :param default_access_level: Default Access Level
    :type default_access_level: :class:`AccessLevel <azure.devops.v7_2.member_entitlement_management.models.AccessLevel>`
    :param extensions: Summary of Extensions in the organization
    :type extensions: list of :class:`ExtensionSummaryData <azure.devops.v7_2.member_entitlement_management.models.ExtensionSummaryData>`
    :param group_options: Group Options
    :type group_options: list of :class:`GroupOption <azure.devops.v7_2.member_entitlement_management.models.GroupOption>`
    :param licenses: Summary of Licenses in the organization
    :type licenses: list of :class:`LicenseSummaryData <azure.devops.v7_2.member_entitlement_management.models.LicenseSummaryData>`
    :param project_refs: Summary of Projects in the organization
    :type project_refs: list of :class:`ProjectRef <azure.devops.v7_2.member_entitlement_management.models.ProjectRef>`
    """
...
class GroupEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation.
    :type results: list of :class:`GroupOperationResult <azure.devops.v7_2.member_entitlement_management.models.GroupOperationResult>`
    """
...
class LicenseSummaryData(SummaryData):
    ...
    :param total: Total Count.
    :type total: int
    :param account_license_type: Type of Account License. To use the AccountLicenseType, LicensingSource should be defined as 'account' in the request body.
    :type account_license_type: object
    ...
    :param msdn_license_type: Type of MSDN License. To use the MsdnLicenseType, LicensingSource should be defined as 'msdn' in the request body.
    :type msdn_license_type: object
...
class MemberEntitlement(UserEntitlement):
    ...
    :type member: :class:`GraphMember <azure.devops.v7_2.member_entitlement_management.models.GraphMember>`
    """
    ...
    def __init__(self, access_level=None, date_created=None, group_assignments=None, id=None, last_accessed_date=None, project_entitlements=None, extensions=None, user=None, member=None):
        super(MemberEntitlement, self).__init__(access_level=access_level, date_created=date_created, group_assignments=group_assignments, id=id, last_accessed_date=last_accessed_date, project_entitlements=project_entitlements, extensions=extensions, user=user)
        self.member = member


class MemberEntitlement2OperationReference(OperationReference):
    """
    :param id: Unique identifier for the operation.
    :type id: str
    :param plugin_id: Unique identifier for the plugin.
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation.
    :type results: list of :class:`MemberEntitlement2OperationResult <azure.devops.v7_2.member_entitlement_management.models.MemberEntitlement2OperationResult>`
    """
    ...
    _attribute_map = {
        ...
        'completed': {'key': 'completed', 'type': 'bool'},
        'have_results_succeeded': {'key': 'haveResultsSucceeded', 'type': 'bool'},
        'results': {'key': 'results', 'type': '[MemberEntitlement2OperationResult]'}
    }

    def __init__(self, id=None, plugin_id=None, status=None, url=None, completed=None, have_results_succeeded=None, results=None):
        super(MemberEntitlement2OperationReference, self).__init__(id=id, plugin_id=plugin_id, status=status, url=url)
        self.completed = completed
        self.have_results_succeeded = have_results_succeeded
        self.results = results


class MemberEntitlement2PatchResponse(MemberEntitlement2ResponseBase):
    """
    :param is_success: True if all operations were successful.
    :type is_success: bool
    :param member_entitlement: Result of the member entitlement after the operations. have been applied
    ...
    :type operation_results: list of :class:`MemberEntitlement2OperationResult <azure.devops.v7_2.member_entitlement_management.models.MemberEntitlement2OperationResult>`
    """

    _attribute_map = {
        'is_success': {'key': 'isSuccess', 'type': 'bool'},
        'member_entitlement': {'key': 'memberEntitlement', 'type': 'MemberEntitlement2'},
        'operation_results': {'key': 'operationResults', 'type': '[MemberEntitlement2OperationResult]'}
    }

    def __init__(self, is_success=None, member_entitlement=None, operation_results=None):
        super(MemberEntitlement2PatchResponse, self).__init__(is_success=is_success, member_entitlement=member_entitlement)
        self.operation_results = operation_results


class MemberEntitlement2PostResponse(MemberEntitlement2ResponseBase):
    """
    :param is_success: True if all operations were successful.
    :type is_success: bool
    :param member_entitlement: Result of the member entitlement after the operations. have been applied
    ...
    :type operation_result: :class:`MemberEntitlement2OperationResult <azure.devops.v7_2.member_entitlement_management.models.MemberEntitlement2OperationResult>`
    """

    _attribute_map = {
        'is_success': {'key': 'isSuccess', 'type': 'bool'},
        'member_entitlement': {'key': 'memberEntitlement', 'type': 'MemberEntitlement2'},
        'operation_result': {'key': 'operationResult', 'type': 'MemberEntitlement2OperationResult'}
    }

    def __init__(self, is_success=None, member_entitlement=None, operation_result=None):
        super(MemberEntitlement2PostResponse, self).__init__(is_success=is_success, member_entitlement=member_entitlement)
...
class MemberEntitlementOperationReference(OperationReference):
    ...
    :type have_results_succeeded: bool
    :param results: List of results for each operation
    :type results: list of :class:`OperationResult <azure.devops.v7_2.member_entitlement_management.models.OperationResult>`
    """
...
class MemberEntitlementsPatchResponse(MemberEntitlementsResponseBase):
    ...
    :type member_entitlement: :class:`MemberEntitlement <azure.devops.v7_2.member_entitlement_management.models.MemberEntitlement>`
    :param operation_results: List of results for each operation
    :type operation_results: list of :class:`OperationResult <azure.devops.v7_2.member_entitlement_management.models.OperationResult>`
    """
...
class MemberEntitlementsPostResponse(MemberEntitlementsResponseBase):
    ...
    :type member_entitlement: :class:`MemberEntitlement <azure.devops.v7_2.member_entitlement_management.models.MemberEntitlement>`
    :param operation_result: Operation result
    :type operation_result: :class:`OperationResult <azure.devops.v7_2.member_entitlement_management.models.OperationResult>`
    """
...
class ServicePrincipalEntitlementsPatchResponse(ServicePrincipalEntitlementsResponseBase):
    """
    :param is_success:
    :type is_success: bool
    :param service_principal_entitlement:
    :type service_principal_entitlement: :class:`ServicePrincipalEntitlement <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlement>`
    :param operation_results:
    :type operation_results: list of :class:`ServicePrincipalEntitlementOperationResult <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlementOperationResult>`
    """

    _attribute_map = {
        'is_success': {'key': 'isSuccess', 'type': 'bool'},
        'service_principal_entitlement': {'key': 'servicePrincipalEntitlement', 'type': 'ServicePrincipalEntitlement'},
        'operation_results': {'key': 'operationResults', 'type': '[ServicePrincipalEntitlementOperationResult]'}
    }

    def __init__(self, is_success=None, service_principal_entitlement=None, operation_results=None):
        super(ServicePrincipalEntitlementsPatchResponse, self).__init__(is_success=is_success, service_principal_entitlement=service_principal_entitlement)
        self.operation_results = operation_results


class ServicePrincipalEntitlementsPostResponse(ServicePrincipalEntitlementsResponseBase):
    """
    :param is_success:
    :type is_success: bool
    :param service_principal_entitlement:
    ...
    :type operation_result: :class:`ServicePrincipalEntitlementOperationResult <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlementOperationResult>`
    """

    _attribute_map = {
        'is_success': {'key': 'isSuccess', 'type': 'bool'},
        'service_principal_entitlement': {'key': 'servicePrincipalEntitlement', 'type': 'ServicePrincipalEntitlement'},
        'operation_result': {'key': 'operationResult', 'type': 'ServicePrincipalEntitlementOperationResult'}
    }

    def __init__(self, is_success=None, service_principal_entitlement=None, operation_result=None):
        super(ServicePrincipalEntitlementsPostResponse, self).__init__(is_success=is_success, service_principal_entitlement=service_principal_entitlement)
        self.operation_result = operation_result
...
class UserEntitlementsPatchResponse(UserEntitlementsResponseBase):
    ...
    :type user_entitlement: :class:`UserEntitlement <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>`
    :param operation_results: List of results for each operation.
    :type operation_results: list of :class:`UserEntitlementOperationResult <azure.devops.v7_2.member_entitlement_management.models.UserEntitlementOperationResult>`
    """
...
class UserEntitlementsPostResponse(UserEntitlementsResponseBase):
    ...
    :type user_entitlement: :class:`UserEntitlement <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>`
    :param operation_result: Operation result.
    :type operation_result: :class:`UserEntitlementOperationResult <azure.devops.v7_2.member_entitlement_management.models.UserEntitlementOperationResult>`
    """
...
class AadGraphMember(GraphMember):
    """
    :param _links: This field contains zero or more interesting links about the graph subject. These links may be invoked to obtain additional relationships or more detailed information about this graph subject.
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.ReferenceLinks>`
    :param descriptor: The descriptor is the primary way to reference the graph subject while the system is running. This field will uniquely identify the same graph subject across both Accounts and Organizations.
    ...
    def __init__(self, _links=None, descriptor=None, display_name=None, url=None, legacy_descriptor=None, origin=None, origin_id=None, subject_kind=None, domain=None, mail_address=None, principal_name=None, directory_alias=None, is_deleted_in_origin=None, metadata_update_date=None, meta_type=None):
        super(AadGraphMember, self).__init__(_links=_links, descriptor=descriptor, display_name=display_name, url=url, legacy_descriptor=legacy_descriptor, origin=origin, origin_id=origin_id, subject_kind=subject_kind, domain=domain, mail_address=mail_address, principal_name=principal_name)
...
class GraphServicePrincipal(AadGraphMember):
    """
    :param _links: This field contains zero or more interesting links about the graph subject. These links may be invoked to obtain additional relationships or more detailed information about this graph subject.
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.ReferenceLinks>`
    :param descriptor: The descriptor is the primary way to reference the graph subject while the system is running. This field will uniquely identify the same graph subject across both Accounts and Organizations.
    ...
    def __init__(self, _links=None, descriptor=None, display_name=None, url=None, legacy_descriptor=None, origin=None, origin_id=None, subject_kind=None, domain=None, mail_address=None, principal_name=None, directory_alias=None, is_deleted_in_origin=None, metadata_update_date=None, meta_type=None, application_id=None):
        super(GraphServicePrincipal, self).__init__(_links=_links, descriptor=descriptor, display_name=display_name, url=url, legacy_descriptor=legacy_descriptor, origin=origin, origin_id=origin_id, subject_kind=subject_kind, domain=domain, mail_address=mail_address, principal_name=principal_name, directory_alias=directory_alias, is_deleted_in_origin=is_deleted_in_origin, metadata_update_date=metadata_update_date, meta_type=meta_type)
        self.application_id = application_id


class GraphUser(AadGraphMember):
    """
    :param _links: This field contains zero or more interesting links about the graph subject. These links may be invoked to obtain additional relationships or more detailed information about this graph subject.
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.ReferenceLinks>`
    :param descriptor: The descriptor is the primary way to reference the graph subject while the system is running. This field will uniquely identify the same graph subject across both Accounts and Organizations.
    ...
    def __init__(self, _links=None, descriptor=None, display_name=None, url=None, legacy_descriptor=None, origin=None, origin_id=None, subject_kind=None, domain=None, mail_address=None, principal_name=None, directory_alias=None, is_deleted_in_origin=None, metadata_update_date=None, meta_type=None):
        super(GraphUser, self).__init__(_links=_links, descriptor=descriptor, display_name=display_name, url=url, legacy_descriptor=legacy_descriptor, origin=origin, origin_id=origin_id, subject_kind=subject_kind, domain=domain, mail_address=mail_address, principal_name=principal_name, directory_alias=directory_alias, is_deleted_in_origin=is_deleted_in_origin, metadata_update_date=metadata_update_date, meta_type=meta_type)
