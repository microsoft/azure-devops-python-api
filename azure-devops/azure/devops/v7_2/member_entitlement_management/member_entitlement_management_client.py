...
class MemberEntitlementManagementClient(Client):
    ...
    def add_group_entitlement(self, group_entitlement, rule_option=None):
        ...
        :rtype: :class:`<GroupEntitlementOperationReference> <azure.devops.v7_2.member_entitlement_management.models.GroupEntitlementOperationReference>`
        """
        query_parameters = {}
    ...
    def get_group_entitlement(self, group_id):
        ...
        :rtype: :class:`<GroupEntitlement> <azure.devops.v7_2.member_entitlement_management.models.GroupEntitlement>`
        """
        route_values = {}
        if group_id is not None:
            route_values['groupId'] = self._serialize.url('group_id', group_id, 'str')
    ...
    def update_group_entitlement(self, document, group_id, rule_option=None):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_2.member_entitlement_management.models.[JsonPatchOperation]>` document: JsonPatchDocument containing the operations to perform on the group.
        :param str group_id: ID of the group.
    ...
    def search_member_entitlements(self, continuation_token=None, select=None, filter=None, order_by=None):
        ...
        :param str filter:
        :param str order_by:
        :rtype: :class:`<PagedList> <azure.devops.v7_2.member_entitlement_management.models.PagedList>`
        """
        query_parameters = {}
    ...
    def get_group_members(self, group_id, max_results=None, paging_token=None):
        ...
        :rtype: :class:`<PagedGraphMemberList> <azure.devops.v7_2.member_entitlement_management.models.PagedGraphMemberList>`
        """
        route_values = {}
        if group_id is not None:
            route_values['groupId'] = self._serialize.url('group_id', group_id, 'str')
    ...
    def add_service_principal_entitlement(self, service_principal_entitlement):
        ...
        :param :class:`<ServicePrincipalEntitlement> <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlement>` service_principal_entitlement: ServicePrincipalEntitlement object specifying License, Extensions and Project/Team groups the service principal should be added to.
        :rtype: :class:`<ServicePrincipalEntitlementsPostResponse> <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlementsPostResponse>`
        """
    ...
    def update_service_principal_entitlements(self, document):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_2.member_entitlement_management.models.[JsonPatchOperation]>` document: JsonPatchDocument containing the operations to perform.
        :rtype: :class:`<ServicePrincipalEntitlementOperationReference> <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlementOperationReference>`
        """
        content = self._serialize.body(document, '[JsonPatchOperation]')
        response = self._send(http_method='PATCH',
                              location_id='f03dbf50-80f8-41b7-8ca2-65b6a178caba',
    ...
    def get_service_principal_entitlement(self, service_principal_id):
        ...
        :param str service_principal_id: ID of the service principal.
        :rtype: :class:`<ServicePrincipalEntitlement> <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlement>`
        """
        route_values = {}
        if service_principal_id is not None:
            route_values['servicePrincipalId'] = self._serialize.url('service_principal_id', service_principal_id, 'str')
    ...
    def update_service_principal_entitlement(self, document, service_principal_id):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_2.member_entitlement_management.models.[JsonPatchOperation]>` document: JsonPatchDocument containing the operations to perform on the service principal.
        :param str service_principal_id: ID of the service principal.
        :rtype: :class:`<ServicePrincipalEntitlementsPatchResponse> <azure.devops.v7_2.member_entitlement_management.models.ServicePrincipalEntitlementsPatchResponse>`
        """
        route_values = {}
        if service_principal_id is not None:
            route_values['servicePrincipalId'] = self._serialize.url('service_principal_id', service_principal_id, 'str')
    ...
    def add_user_entitlement(self, user_entitlement):
        ...
        :param :class:`<UserEntitlement> <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>` user_entitlement: UserEntitlement object specifying License, Extensions and Project/Team groups the user should be added to.
        :rtype: :class:`<UserEntitlementsPostResponse> <azure.devops.v7_2.member_entitlement_management.models.UserEntitlementsPostResponse>`
        """
    ...
    def search_user_entitlements(self, continuation_token=None, select=None, filter=None, order_by=None):
        ...
        :rtype: :class:`<PagedUserEntitlementsList> <azure.devops.v7_2.member_entitlement_management.models.PagedUserEntitlementsList>`
        """
        query_parameters = {}
        if continuation_token is not None:
            query_parameters['continuationToken'] = self._serialize.query('continuation_token', continuation_token, 'str')
        ...
        response = self._send(http_method='GET',
                              ...
                              version='7.2-preview.4',
                              query_parameters=query_parameters)
        return self._deserialize('PagedUserEntitlementsList', response)
    ...
    def update_user_entitlements(self, document, do_not_send_invite_for_new_users=None):
        ...
        :rtype: :class:`<UserEntitlementOperationReference> <azure.devops.v7_2.member_entitlement_management.models.UserEntitlementOperationReference>`
        """
        query_parameters = {}
    ...
    def get_user_entitlement(self, user_id):
        ...
        :param str user_id: ID of the user.
        :rtype: :class:`<UserEntitlement> <azure.devops.v7_2.member_entitlement_management.models.UserEntitlement>`
        """
        route_values = {}
        if user_id is not None:
            route_values['userId'] = self._serialize.url('user_id', user_id, 'str')
    ...
    def update_user_entitlement(self, document, user_id):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_2.member_entitlement_management.models.[JsonPatchOperation]>` document: JsonPatchDocument containing the operations to perform on the user.
        :param str user_id: ID of the user.
        :rtype: :class:`<UserEntitlementsPatchResponse> <azure.devops.v7_2.member_entitlement_management.models.UserEntitlementsPatchResponse>`
        """
        route_values = {}
        if user_id is not None:
            route_values['userId'] = self._serialize.url('user_id', user_id, 'str')
    ...
    def get_users_summary(self, select=None):
        ...
        :rtype: :class:`<UsersSummary> <azure.devops.v7_2.member_entitlement_management.models.UsersSummary>`
        """
        query_parameters = {}
        if select is not None:
            query_parameters['select'] = self._serialize.query('select', select, 'str')
