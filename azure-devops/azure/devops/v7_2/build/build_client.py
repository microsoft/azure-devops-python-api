...
class BuildClient(Client):
    ...
    def create_artifact(self, artifact, project, build_id):
        ...
        :param :class:`<BuildArtifact> <azure.devops.v7_2.build.models.BuildArtifact>` artifact: The artifact.
        :param str project: Project ID or project name
        :param int build_id: The ID of the build.
        :rtype: :class:`<BuildArtifact> <azure.devops.v7_2.build.models.BuildArtifact>`
        """
        route_values = {}
    ...
    def get_build_badge(self, project, repo_type, repo_id=None, branch_name=None):
        ...
        :rtype: :class:`<BuildBadge> <azure.devops.v7_2.build.models.BuildBadge>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_build(self, project, build_id, property_filters=None):
        ...
        :rtype: :class:`<Build> <azure.devops.v7_2.build.models.Build>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def queue_build(self, build, project, ignore_warnings=None, check_in_ticket=None, source_build_id=None, definition_id=None):
        ...
        :param :class:`<Build> <azure.devops.v7_2.build.models.Build>` build:
        :param str project: Project ID or project name
    ...
    def update_build(self, build, project, build_id, retry=None):
        ...
        :param :class:`<Build> <azure.devops.v7_2.build.models.Build>` build: The build.
        :param str project: Project ID or project name
        :param int build_id: The ID of the build.
        :param bool retry:
        :rtype: :class:`<Build> <azure.devops.v7_2.build.models.Build>`
    ...
    def get_build_changes(self, project, build_id, continuation_token=None, top=None, include_source_change=None):
        ...
        :rtype: :class:`<[Change]> <azure.devops.v7_2.build.models.[Change]>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_build_controller(self, controller_id):
        ...
        :rtype: :class:`<BuildController> <azure.devops.v7_2.build.models.BuildController>`
        """
        route_values = {}
    ...
    def create_definition(self, definition, project, definition_to_clone_id=None, definition_to_clone_revision=None):
        ...
        :param :class:`<BuildDefinition> <azure.devops.v7_2.build.models.BuildDefinition>` definition: The definition.
        :param str project: Project ID or project name
        :param int definition_to_clone_id:
        :param int definition_to_clone_revision:
        :rtype: :class:`<BuildDefinition> <azure.devops.v7_2.build.models.BuildDefinition>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_definitions(self, project, name=None, repository_id=None, repository_type=None, query_order=None, top=None, continuation_token=None, min_metrics_time=None, definition_ids=None, path=None, built_after=None, not_built_after=None, include_all_properties=None, include_latest_builds=None, task_id_filter=None, process_type=None, yaml_filename=None):
        ...
        :rtype: :class:`<[BuildDefinitionReference]> <azure.devops.v7_2.build.models.[BuildDefinitionReference]>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_definition(self, definition, project, definition_id, secrets_source_definition_id=None, secrets_source_definition_revision=None):
        ...
        :param :class:`<BuildDefinition> <azure.devops.v7_2.build.models.BuildDefinition>` definition: The new version of the definition. Its "Revision" property must match the existing definition for the update to be accepted.
        :param str project: Project ID or project name
        :param int definition_id: The ID of the definition.
    ...
    def create_folder(self, folder, project, path):
        ...
        :param :class:`<Folder> <azure.devops.v7_2.build.models.Folder>` folder: The folder.
        :param str project: Project ID or project name
        :param str path: The full path of the folder.
        :rtype: :class:`<Folder> <azure.devops.v7_2.build.models.Folder>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_folder(self, folder, project, path):
        ...
        :param :class:`<Folder> <azure.devops.v7_2.build.models.Folder>` folder: The new version of the folder.
        :param str project: Project ID or project name
        :param str path: The full path to the folder.
        :rtype: :class:`<Folder> <azure.devops.v7_2.build.models.Folder>`
        """
    ...
    def get_build_general_settings(self, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<PipelineGeneralSettings> <azure.devops.v7_2.build.models.PipelineGeneralSettings>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_build_general_settings(self, new_settings, project):
        ...
        :param :class:`<PipelineGeneralSettings> <azure.devops.v7_2.build.models.PipelineGeneralSettings>` new_settings:
        :param str project: Project ID or project name
        :rtype: :class:`<PipelineGeneralSettings> <azure.devops.v7_2.build.models.PipelineGeneralSettings>`
        """
        route_values = {}
    ...
    def get_retention_history(self, days_to_lookback=None):
        ...
        :rtype: :class:`<BuildRetentionHistory> <azure.devops.v7_2.build.models.BuildRetentionHistory>`
        """
        query_parameters = {}
    ...
    def get_retention_lease(self, project, lease_id):
        ...
        :param str project: Project ID or project name
        :param int lease_id:
        :rtype: :class:`<RetentionLease> <azure.devops.v7_2.build.models.RetentionLease>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_retention_lease(self, lease_update, project, lease_id):
        ...
        :param :class:`<RetentionLeaseUpdate> <azure.devops.v7_2.build.models.RetentionLeaseUpdate>` lease_update: The new data for the retention lease.
        :param str project: Project ID or project name
    ...
    def get_build_properties(self, project, build_id, filter=None):
        ...
        :rtype: :class:`<object> <azure.devops.v7_2.build.models.object>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_build_properties(self, document, project, build_id):
        ...
        :param :class:`<[JsonPatchOperation]> <azure.devops.v7_2.build.models.[JsonPatchOperation]>` document: A json-patch document describing the properties to update.
        :param str project: Project ID or project name
        :param int build_id: The ID of the build.
        :rtype: :class:`<object> <azure.devops.v7_2.build.models.object>`
        """
    ...
    def get_pull_request(self, project, provider_name, pull_request_id, repository_id=None, service_endpoint_id=None):
        ...
        :param str service_endpoint_id: If specified, the ID of the service endpoint to query. Can only be omitted for providers that do not use service endpoints, e.g. TFVC or TFGit.
        :rtype: :class:`<PullRequest> <azure.devops.v7_2.build.models.PullRequest>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_build_report(self, project, build_id, type=None):
        ...
        :param int build_id: The ID of the build.
        :param str type:
        :rtype: :class:`<BuildReportMetadata> <azure.devops.v7_2.build.models.BuildReportMetadata>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def list_repositories(self, project, provider_name, service_endpoint_id=None, repository=None, result_set=None, page_results=None, continuation_token=None):
        ...
        :rtype: :class:`<SourceRepositories> <azure.devops.v7_2.build.models.SourceRepositories>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_resource_usage(self):
        ...
        :rtype: :class:`<BuildResourceUsage> <azure.devops.v7_2.build.models.BuildResourceUsage>`
        """
        response = self._send(http_method='GET',
    ...
    def get_retention_settings(self, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<ProjectRetentionSetting> <azure.devops.v7_2.build.models.ProjectRetentionSetting>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_retention_settings(self, update_model, project):
        ...
        :param :class:`<UpdateProjectRetentionSettingModel> <azure.devops.v7_2.build.models.UpdateProjectRetentionSettingModel>` update_model:
        :param str project: Project ID or project name
        :rtype: :class:`<ProjectRetentionSetting> <azure.devops.v7_2.build.models.ProjectRetentionSetting>`
        """
        route_values = {}
    ...
    def get_build_settings(self, project=None):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<BuildSettings> <azure.devops.v7_2.build.models.BuildSettings>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_build_settings(self, settings, project=None):
        ...
        :param :class:`<BuildSettings> <azure.devops.v7_2.build.models.BuildSettings>` settings: The new settings.
        :param str project: Project ID or project name
        :rtype: :class:`<BuildSettings> <azure.devops.v7_2.build.models.BuildSettings>`
        """
        route_values = {}
    ...
    def update_stage(self, update_parameters, build_id, stage_ref_name, project=None):
        ...
        :param :class:`<UpdateStageParameters> <azure.devops.v7_2.build.models.UpdateStageParameters>` update_parameters:
        :param int build_id:
    ...
    def update_build_tags(self, update_parameters, project, build_id):
        ...
        :param :class:`<UpdateTagParameters> <azure.devops.v7_2.build.models.UpdateTagParameters>` update_parameters: The tags to add/remove.
        :param str project: Project ID or project name
        :param int build_id: The ID of the build.
        :rtype: [str]
        """
    ...
    def get_template(self, project, template_id):
        ...
        :rtype: :class:`<BuildDefinitionTemplate> <azure.devops.v7_2.build.models.BuildDefinitionTemplate>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def save_template(self, template, project, template_id):
        ...
        :param :class:`<BuildDefinitionTemplate> <azure.devops.v7_2.build.models.BuildDefinitionTemplate>` template: The new version of the template.
        :param str project: Project ID or project name
        :param str template_id: The ID of the template.
        :rtype: :class:`<BuildDefinitionTemplate> <azure.devops.v7_2.build.models.BuildDefinitionTemplate>`
        """
    ...
    def get_build_timeline(self, project, build_id, timeline_id=None, change_id=None, plan_id=None):
        ...
        :param int change_id:
        :param str plan_id:
        :rtype: :class:`<Timeline> <azure.devops.v7_2.build.models.Timeline>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_definition_yaml(self, project, definition_id, revision=None, min_metrics_time=None, property_filters=None, include_latest_builds=None):
        ...
        :param [str] property_filters: A comma-delimited list of properties to include in the results.
        :param bool include_latest_builds:
        :rtype: :class:`<YamlBuild> <azure.devops.v7_2.build.models.YamlBuild>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
