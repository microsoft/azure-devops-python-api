...
class AgentPoolQueue(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.build.models.ReferenceLinks>`
    :param id: The ID of the queue.
    :type id: int
    :param name: The name of the queue.
    :type name: str
    :param pool: The pool used by this queue.
    :type pool: :class:`TaskAgentPoolReference <azure.devops.v7_2.build.models.TaskAgentPoolReference>`
...
class Build(Model):
    ...
    :type agent_specification: :class:`AgentSpecification <azure.devops.v7_2.build.models.AgentSpecification>`
    ...
    :type controller: :class:`BuildController <azure.devops.v7_2.build.models.BuildController>`
    :param definition: The definition associated with the build.
    :type definition: :class:`DefinitionReference <azure.devops.v7_2.build.models.DefinitionReference>`
    ...
    :type deleted_by: :class:`IdentityRef <azure.devops.v7_2.build.models.IdentityRef>`
    ...
    :type demands: list of :class:`object <azure.devops.v7_2.build.models.object>`
    ...
    :type last_changed_by: :class:`IdentityRef <azure.devops.v7_2.build.models.IdentityRef>`
    ...
    :type logs: :class:`BuildLogReference <azure.devops.v7_2.build.models.BuildLogReference>`
    :param orchestration_plan: The orchestration plan for the build.
    :type orchestration_plan: :class:`TaskOrchestrationPlanReference <azure.devops.v7_2.build.models.TaskOrchestrationPlanReference>`
    :param parameters: The parameters for the build.
    :type parameters: str
    :param plans: Orchestration plans associated with the build (build, cleanup)
    :type plans: list of :class:`TaskOrchestrationPlanReference <azure.devops.v7_2.build.models.TaskOrchestrationPlanReference>`
    :param priority: Azure Pipelines does not support job priority. This field is deprecated.
    :type priority: object
    :param project: The team project.
    :type project: :class:`TeamProjectReference <azure.devops.v7_2.build.models.TeamProjectReference>`
    :param properties:
    :type properties: :class:`object <azure.devops.v7_2.build.models.object>`
    ...
    :type queue: :class:`AgentPoolQueue <azure.devops.v7_2.build.models.AgentPoolQueue>`
    ...
    :type repository: :class:`BuildRepository <azure.devops.v7_2.build.models.BuildRepository>`
    :param requested_by: The identity that queued the build.
    :type requested_by: :class:`IdentityRef <azure.devops.v7_2.build.models.IdentityRef>`
    :param requested_for: The identity on whose behalf the build was queued.
    :type requested_for: :class:`IdentityRef <azure.devops.v7_2.build.models.IdentityRef>`
    ...
    :type triggered_by_build: :class:`Build <azure.devops.v7_2.build.models.Build>`
    ...
    :type validation_results: list of :class:`BuildRequestValidationResult <azure.devops.v7_2.build.models.BuildRequestValidationResult>`
    """
...
class BuildArtifact(Model):
    ...
    :type resource: :class:`ArtifactResource <azure.devops.v7_2.build.models.ArtifactResource>`
...
class BuildDefinitionRevision(Model):
    ...
    :type changed_by: :class:`IdentityRef <azure.devops.v7_2.build.models.IdentityRef>`
...
class BuildDefinitionStep(Model):
    ...
    :type task: :class:`TaskDefinitionReference <azure.devops.v7_2.build.models.TaskDefinitionReference>`
...
class BuildDefinitionTemplate(Model):
    ...
    :type template: :class:`BuildDefinition <azure.devops.v7_2.build.models.BuildDefinition>`
    """
...
class BuildDefinitionTemplate3_2(Model):
    ...
    :type name: str
    :param template:
    :type template: :class:`BuildDefinition3_2 <azure.devops.v7_2.build.models.BuildDefinition3_2>`
    """
...
class BuildOption(Model):
    ...
    :type definition: :class:`BuildOptionDefinitionReference <azure.devops.v7_2.build.models.BuildOptionDefinitionReference>`
...
class BuildRetentionHistory(Model):
    ...
    :type build_retention_samples: list of :class:`BuildRetentionSample <azure.devops.v7_2.build.models.BuildRetentionSample>`
    """
...
class BuildSettings(Model):
    ...
    :type default_retention_policy: :class:`RetentionPolicy <azure.devops.v7_2.build.models.RetentionPolicy>`
    :param maximum_retention_policy: The maximum retention policy.
    :type maximum_retention_policy: :class:`RetentionPolicy <azure.devops.v7_2.build.models.RetentionPolicy>`
    """
...
class Change(Model):
    ...
    :type author: :class:`IdentityRef <azure.devops.v7_2.build.models.IdentityRef>`
...
class Folder(Model):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v7_2.build.models.IdentityRef>`
...
class PipelineGeneralSettings(Model):
    ...
    :param builds_enabled_for_forks: Enable forked repositories to build pull requests.
    :type builds_enabled_for_forks: bool
    :param disable_classic_build_pipeline_creation: Disable classic build pipelines creation.
    :type disable_classic_build_pipeline_creation: bool
    :param disable_classic_pipeline_creation: Disable classic pipelines creation.
    :type disable_classic_pipeline_creation: bool
    :param disable_classic_release_pipeline_creation: Disable classic release pipelines creation.
    :type disable_classic_release_pipeline_creation: bool
    :param disable_implied_yAMLCi_trigger: Disable implied pipeline CI triggers if the trigger section in YAML is missing.
    :type disable_implied_yAMLCi_trigger: bool
    :param enable_shell_tasks_args_sanitizing: Enable shell tasks args sanitizing.
    :type enable_shell_tasks_args_sanitizing: bool
    :param enable_shell_tasks_args_sanitizing_audit: Enable shell tasks args sanitizing preview.
    :type enable_shell_tasks_args_sanitizing_audit: bool
    ...
    :param enforce_job_auth_scope_for_forks: Enforce job auth scope for builds of forked repositories.
    :type enforce_job_auth_scope_for_forks: bool
    ...
    :param enforce_no_access_to_secrets_from_forks: Enforce no access to secrets for builds of forked repositories.
    :type enforce_no_access_to_secrets_from_forks: bool
    ...
    :param fork_protection_enabled: Enable settings that enforce certain levels of protection for building pull requests from forks globally.
    :type fork_protection_enabled: bool
    :param is_comment_required_for_pull_request: Make comments required to have builds in all pull requests.
    :type is_comment_required_for_pull_request: bool
    :param publish_pipeline_metadata: Allows pipelines to record metadata.
    :type publish_pipeline_metadata: bool
    :param require_comments_for_non_team_member_and_non_contributors: Make comments required to have builds in pull requests from non-team members and non-contributors.
    :type require_comments_for_non_team_member_and_non_contributors: bool
    :param require_comments_for_non_team_members_only: Make comments required to have builds in pull requests from non-team members.
    :type require_comments_for_non_team_members_only: bool
    ...
    _attribute_map = {
        ...
        'builds_enabled_for_forks': {'key': 'buildsEnabledForForks', 'type': 'bool'},
        'disable_classic_build_pipeline_creation': {'key': 'disableClassicBuildPipelineCreation', 'type': 'bool'},
        'disable_classic_pipeline_creation': {'key': 'disableClassicPipelineCreation', 'type': 'bool'},
        'disable_classic_release_pipeline_creation': {'key': 'disableClassicReleasePipelineCreation', 'type': 'bool'},
        'disable_implied_yAMLCi_trigger': {'key': 'disableImpliedYAMLCiTrigger', 'type': 'bool'},
        'enable_shell_tasks_args_sanitizing': {'key': 'enableShellTasksArgsSanitizing', 'type': 'bool'},
        'enable_shell_tasks_args_sanitizing_audit': {'key': 'enableShellTasksArgsSanitizingAudit', 'type': 'bool'},
        'enforce_job_auth_scope': {'key': 'enforceJobAuthScope', 'type': 'bool'},
        'enforce_job_auth_scope_for_forks': {'key': 'enforceJobAuthScopeForForks', 'type': 'bool'},
        'enforce_job_auth_scope_for_releases': {'key': 'enforceJobAuthScopeForReleases', 'type': 'bool'},
        'enforce_no_access_to_secrets_from_forks': {'key': 'enforceNoAccessToSecretsFromForks', 'type': 'bool'},
    ...
    def __init__(self, audit_enforce_settable_var=None, builds_enabled_for_forks=None, disable_classic_build_pipeline_creation=None, disable_classic_pipeline_creation=None, disable_classic_release_pipeline_creation=None, disable_implied_yAMLCi_trigger=None, enable_shell_tasks_args_sanitizing=None, enable_shell_tasks_args_sanitizing_audit=None, enforce_job_auth_scope=None, enforce_job_auth_scope_for_forks=None, enforce_job_auth_scope_for_releases=None, enforce_no_access_to_secrets_from_forks=None, enforce_referenced_repo_scoped_token=None, enforce_settable_var=None, fork_protection_enabled=None, is_comment_required_for_pull_request=None, publish_pipeline_metadata=None, require_comments_for_non_team_member_and_non_contributors=None, require_comments_for_non_team_members_only=None, status_badges_are_private=None):
        ...
        self.enforce_no_access_to_secrets_from_forks = enforce_no_access_to_secrets_from_forks
        ...
        self.fork_protection_enabled = fork_protection_enabled
        self.is_comment_required_for_pull_request = is_comment_required_for_pull_request
        self.publish_pipeline_metadata = publish_pipeline_metadata
        self.require_comments_for_non_team_member_and_non_contributors = require_comments_for_non_team_member_and_non_contributors
        self.require_comments_for_non_team_members_only = require_comments_for_non_team_members_only
...
class ProcessParameters(Model):
    ...
    :type data_source_bindings: list of :class:`DataSourceBindingBase <azure.devops.v7_2.microsoft._team_foundation._distributed_task._common._contracts.models.DataSourceBindingBase>`
    :param inputs:
    :type inputs: list of :class:`TaskInputDefinitionBase <azure.devops.v7_2.microsoft._team_foundation._distributed_task._common._contracts.models.TaskInputDefinitionBase>`
    :param source_definitions:
    :type source_definitions: list of :class:`TaskSourceDefinitionBase <azure.devops.v7_2.microsoft._team_foundation._distributed_task._common._contracts.models.TaskSourceDefinitionBase>`
    """
...
class ProjectRetentionSetting(Model):
    ...
    :type purge_artifacts: :class:`RetentionSetting <azure.devops.v7_2.build.models.RetentionSetting>`
    :param purge_pull_request_runs: The rules for pull request pipeline run retention.
    :type purge_pull_request_runs: :class:`RetentionSetting <azure.devops.v7_2.build.models.RetentionSetting>`
    :param purge_runs: The rules for pipeline run retention.
    :type purge_runs: :class:`RetentionSetting <azure.devops.v7_2.build.models.RetentionSetting>`
    :param retain_runs_per_protected_branch: The rules for retaining runs per protected branch.
    :type retain_runs_per_protected_branch: :class:`RetentionSetting <azure.devops.v7_2.build.models.RetentionSetting>`
    """
...
class SourceProviderAttributes(Model):
    ...
    :type supported_triggers: list of :class:`SupportedTrigger <azure.devops.v7_2.build.models.SupportedTrigger>`
    """
...
class SourceRepositories(Model):
    ...
    :type repositories: list of :class:`SourceRepository <azure.devops.v7_2.build.models.SourceRepository>`
...
class TimelineRecord(Model):
    ...
    :type details: :class:`TimelineReference <azure.devops.v7_2.build.models.TimelineReference>`
    ...
    :type identifier: str
    :param issues:
    :type issues: list of :class:`Issue <azure.devops.v7_2.build.models.Issue>`
    ...
    :type log: :class:`BuildLogReference <azure.devops.v7_2.build.models.BuildLogReference>`
    :param name: The name.
    :type name: str
    ...
    :type previous_attempts: list of :class:`TimelineAttempt <azure.devops.v7_2.build.models.TimelineAttempt>`
    ...
    :type task: :class:`TaskReference <azure.devops.v7_2.build.models.TaskReference>`
...
class UpdateProjectRetentionSettingModel(Model):
    ...
    :type artifacts_retention: :class:`UpdateRetentionSettingModel <azure.devops.v7_2.build.models.UpdateRetentionSettingModel>`
    :param pull_request_run_retention:
    :type pull_request_run_retention: :class:`UpdateRetentionSettingModel <azure.devops.v7_2.build.models.UpdateRetentionSettingModel>`
    :param retain_runs_per_protected_branch:
    :type retain_runs_per_protected_branch: :class:`UpdateRetentionSettingModel <azure.devops.v7_2.build.models.UpdateRetentionSettingModel>`
    :param run_retention:
    :type run_retention: :class:`UpdateRetentionSettingModel <azure.devops.v7_2.build.models.UpdateRetentionSettingModel>`
    """
...
class UpdateStageParameters(Model):
    ...
    :param retry_dependencies:
    :type retry_dependencies: bool
    :param state:
    :type state: object
    """
    ...
    _attribute_map = {
        ...
        'retry_dependencies': {'key': 'retryDependencies', 'type': 'bool'},
        'state': {'key': 'state', 'type': 'object'}
    }

    def __init__(self, force_retry_all_jobs=None, retry_dependencies=None, state=None):
        super(UpdateStageParameters, self).__init__()
        self.force_retry_all_jobs = force_retry_all_jobs
        self.retry_dependencies = retry_dependencies
        self.state = state
...
class BuildDefinitionReference(DefinitionReference):
    ...
    :type authored_by: :class:`IdentityRef <azure.devops.v7_2.build.models.IdentityRef>`
    :param draft_of: A reference to the definition that this definition is a draft of, if this is a draft definition.
    :type draft_of: :class:`DefinitionReference <azure.devops.v7_2.build.models.DefinitionReference>`
    :param drafts: The list of drafts associated with this definition, if this is not a draft definition.
    :type drafts: list of :class:`DefinitionReference <azure.devops.v7_2.build.models.DefinitionReference>`
    :param latest_build:
    :type latest_build: :class:`Build <azure.devops.v7_2.build.models.Build>`
    :param latest_completed_build:
    :type latest_completed_build: :class:`Build <azure.devops.v7_2.build.models.Build>`
    :param metrics:
    :type metrics: list of :class:`BuildMetric <azure.devops.v7_2.build.models.BuildMetric>`
...
class BuildOptionDefinition(BuildOptionDefinitionReference):
    ...
    :type groups: list of :class:`BuildOptionGroupDefinition <azure.devops.v7_2.build.models.BuildOptionGroupDefinition>`
    :param inputs: The list of inputs defined for the build option.
    :type inputs: list of :class:`BuildOptionInputDefinition <azure.devops.v7_2.build.models.BuildOptionInputDefinition>`
...
class Timeline(TimelineReference):
    ...
    :type last_changed_on: datetime
    :param records:
    :type records: list of :class:`TimelineRecord <azure.devops.v7_2.build.models.TimelineRecord>`
    """
...
class BuildDefinition(BuildDefinitionReference):
    ...
    :param options:
    :type options: list of :class:`BuildOption <azure.devops.v7_2.build.models.BuildOption>`
    :param process: The build process.
    :type process: :class:`object <azure.devops.v7_2.build.models.object>`
    :param process_parameters: The process parameters for this definition.
    :type process_parameters: :class:`ProcessParameters <azure.devops.v7_2.build.models.ProcessParameters>`
    :param properties:
    :type properties: :class:`object <azure.devops.v7_2.build.models.object>`
    :param repository: The repository.
    :type repository: :class:`BuildRepository <azure.devops.v7_2.build.models.BuildRepository>`
    :param retention_rules:
    :type retention_rules: list of :class:`RetentionPolicy <azure.devops.v7_2.build.models.RetentionPolicy>`
    :param tags:
    :type tags: list of str
    :param triggers:
    :type triggers: list of :class:`object <azure.devops.v7_2.build.models.object>`
    :param variable_groups:
    :type variable_groups: list of :class:`VariableGroup <azure.devops.v7_2.build.models.VariableGroup>`
    :param variables:
    :type variables: dict
    """
...
class BuildDefinition3_2(BuildDefinitionReference3_2):
    ...
    :type badge_enabled: bool
    :param build:
    :type build: list of :class:`BuildDefinitionStep <azure.devops.v7_2.build.models.BuildDefinitionStep>`
    :param build_number_format: The build number format
    :type build_number_format: str
