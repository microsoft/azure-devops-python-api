...
class CategorizedWebApiTeams(Model):
    """
    :param my_teams: Teams that the user is a member of.
    :type my_teams: list of :class:`WebApiTeam <azure.devops.v7_2.core.models.WebApiTeam>`
    :param other_readable_teams: Teams that the user can read but is not member of.
    :type other_readable_teams: list of :class:`WebApiTeam <azure.devops.v7_2.core.models.WebApiTeam>`
    """

    _attribute_map = {
        'my_teams': {'key': 'myTeams', 'type': '[WebApiTeam]'},
        'other_readable_teams': {'key': 'otherReadableTeams', 'type': '[WebApiTeam]'}
    }

    def __init__(self, my_teams=None, other_readable_teams=None):
        super(CategorizedWebApiTeams, self).__init__()
        self.my_teams = my_teams
        self.other_readable_teams = other_readable_teams
...
class IdentityBase(Model):
    ...
    :param descriptor:
    :type descriptor: :class:`str <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.str>`
    ...
    :param member_of:
    :type member_of: list of :class:`str <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.str>`
    :param members:
    :type members: list of :class:`str <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.str>`
    :param meta_type_id:
    :type meta_type_id: int
    :param properties:
    :type properties: :class:`object <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.object>`
    ...
    :type social_descriptor: :class:`str <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.str>`
    :param subject_descriptor: Subject descriptor of a Graph entity.
    :type subject_descriptor: :class:`str <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.str>`
...
class ProjectInfo(Model):
    ...
    :type properties: list of :class:`ProjectProperty <azure.devops.v7_2.core.models.ProjectProperty>`
...
class Proxy(Model):
    """
    :param authorization:
    :type authorization: :class:`ProxyAuthorization <azure.devops.v7_2.core.models.ProxyAuthorization>`
...
class ProxyAuthorization(Model):
    ...
    :type identity: :class:`str <azure.devops.v7_2.core.models.str>`
    :param public_key: Gets or sets the public key used to verify the identity of this proxy. Only specify on hosted.
    :type public_key: :class:`PublicKey <azure.devops.v7_2.core.models.PublicKey>`
    """
...
class TeamMember(Model):
    """
    :param identity:
    :type identity: :class:`IdentityRef <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.IdentityRef>`
    :param is_team_admin:
...
class Process(ProcessReference):
    ...
    :type url: str
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.core.models.ReferenceLinks>`
    :param description:
    :type description: str
    :param id:
    :type id: str
...
class TeamProject(TeamProjectReference):
    ...
    :type default_team: :class:`WebApiTeamRef <azure.devops.v7_2.core.models.WebApiTeamRef>`
    """
...
class TeamProjectCollection(TeamProjectCollectionReference):
    ...
    def __init__(self, avatar_url=None, id=None, name=None, url=None, _links=None, description=None, process_customization_type=None, state=None):
        super(TeamProjectCollection, self).__init__(avatar_url=avatar_url, id=id, name=name, url=url)
        self._links = _links
        self.description = description
...
class WebApiConnectedService(WebApiConnectedServiceRef):
    ...
    :type authenticated_by: :class:`IdentityRef <azure.devops.v7_2.core.models.IdentityRef>`
    ...
    :type project: :class:`TeamProjectReference <azure.devops.v7_2.core.models.TeamProjectReference>`
...
class WebApiConnectedServiceDetails(WebApiConnectedServiceRef):
    ...
    :type connected_service_meta_data: :class:`WebApiConnectedService <azure.devops.v7_2.core.models.WebApiConnectedService>`
...
class WebApiTeam(WebApiTeamRef):
    ...
    :type identity: :class:`Identity <azure.devops.v7_2.core.models.Identity>`
