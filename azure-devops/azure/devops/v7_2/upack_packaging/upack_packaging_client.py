...
class UPackPackagingClient(Client):
    ...
    def add_package(self, metadata, feed_id, package_name, package_version, project=None):
        """AddPackage.
        [Preview API]
        :param :class:`<UPackPackagePushMetadata> <azure.devops.v7_2.upack_packaging.models.UPackPackagePushMetadata>` metadata:
        :param str feed_id:
    ...
    def get_package_metadata(self, feed_id, package_name, package_version, project=None, intent=None):
        ...
        :param str project: Project ID or project name
        :param str intent:
        :rtype: :class:`<UPackPackageMetadata> <azure.devops.v7_2.upack_packaging.models.UPackPackageMetadata>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_package_versions_metadata(self, feed_id, package_name, project=None):
        ...
        :param str package_name:
        :param str project: Project ID or project name
        :rtype: :class:`<UPackLimitedPackageMetadataListResponse> <azure.devops.v7_2.upack_packaging.models.UPackLimitedPackageMetadataListResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
