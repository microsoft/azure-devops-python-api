...
class TaskClient(Client):
    ...
    def create_attachment(self, upload_stream, scope_identifier, hub_name, plan_id, timeline_id, record_id, type, name, **kwargs):
        ...
        :param str type:
        :param str name:
        :rtype: :class:`<TaskAttachment> <azure.devops.v7_2.task.models.TaskAttachment>`
        """
        route_values = {}
        if scope_identifier is not None:
            route_values['scopeIdentifier'] = self._serialize.url('scope_identifier', scope_identifier, 'str')
    ...
    def append_log_content(self, upload_stream, scope_identifier, hub_name, plan_id, log_id, **kwargs):
        ...
        :rtype: :class:`<TaskLog> <azure.devops.v7_2.task.models.TaskLog>`
        """
        route_values = {}
        if scope_identifier is not None:
            route_values['scopeIdentifier'] = self._serialize.url('scope_identifier', scope_identifier, 'str')
    ...
    def create_log(self, log, scope_identifier, hub_name, plan_id):
        ...
        :param :class:`<TaskLog> <azure.devops.v7_2.task.models.TaskLog>` log: An object that contains information about log's path.
        :param str scope_identifier: The project GUID to scope the request
        :param str hub_name: The name of the server hub. Common examples: "build", "rm", "checks"
        :param str plan_id: The ID of the plan.
        :rtype: :class:`<TaskLog> <azure.devops.v7_2.task.models.TaskLog>`
    ...
    def create_oidc_token(self, claims, scope_identifier, hub_name, plan_id, job_id, service_connection_id=None):
        """CreateOidcToken.
        [Preview API]
        :param {str} claims:
        :param str scope_identifier: The project GUID to scope the request
        ...
        :rtype: :class:`<TaskHubOidcToken> <azure.devops.v7_2.task.models.TaskHubOidcToken>`
        """
        route_values = {}
        if scope_identifier is not None:
            route_values['scopeIdentifier'] = self._serialize.url('scope_identifier', scope_identifier, 'str')
    ...
    def update_records(self, records, scope_identifier, hub_name, plan_id, timeline_id):
        ...
        :param :class:`<VssJsonCollectionWrapper> <azure.devops.v7_2.task.models.VssJsonCollectionWrapper>` records: The array of timeline records to be updated.
        :param str scope_identifier: The project GUID to scope the request
        :param str hub_name: The name of the server hub. Common examples: "build", "rm", "checks"
        :param str plan_id: The ID of the plan.
    ...
    def create_timeline(self, timeline, scope_identifier, hub_name, plan_id):
        """CreateTimeline.
        [Preview API]
        :param :class:`<Timeline> <azure.devops.v7_2.task.models.Timeline>` timeline:
        :param str scope_identifier: The project GUID to scope the request
        :param str hub_name: The name of the server hub. Common examples: "build", "rm", "checks"
        :param str plan_id:
        :rtype: :class:`<Timeline> <azure.devops.v7_2.task.models.Timeline>`
        """
        route_values = {}
        if scope_identifier is not None:
            route_values['scopeIdentifier'] = self._serialize.url('scope_identifier', scope_identifier, 'str')
