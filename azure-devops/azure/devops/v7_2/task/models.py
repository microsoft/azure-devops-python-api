...
class PlanEnvironment(Model):
    """
    :param mask:
    :type mask: list of :class:`MaskHint <azure.devops.v7_2.task.models.MaskHint>`
    :param options:
    :type options: dict
    :param variables:
    :type variables: dict
...
class TaskAgentJob(Model):
    ...
    :param steps:
    :type steps: list of :class:`TaskAgentJobStep <azure.devops.v7_2.task.models.TaskAgentJobStep>`
    :param variables:
    :type variables: list of :class:`TaskAgentJobVariable <azure.devops.v7_2.task.models.TaskAgentJobVariable>`
    """
...
class TaskAgentJobStep(Model):
    ...
    :param task:
    :type task: :class:`TaskAgentJobTask <azure.devops.v7_2.task.models.TaskAgentJobTask>`
...
class TaskAttachment(Model):
    """
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.task.models.ReferenceLinks>`
    :param created_on:
...
class TaskOrchestrationPlanReference(Model):
    ...
    :param definition:
    :type definition: :class:`TaskOrchestrationOwner <azure.devops.v7_2.task.models.TaskOrchestrationOwner>`
    :param owner:
    :type owner: :class:`TaskOrchestrationOwner <azure.devops.v7_2.task.models.TaskOrchestrationOwner>`
    :param plan_group:
    :type plan_group: str
    :param plan_id:
    :type plan_id: str
...
class TaskOrchestrationQueuedPlanGroup(Model):
    ...
    :type plan_group: str
    :param plans:
    :type plans: list of :class:`TaskOrchestrationQueuedPlan <azure.devops.v7_2.task.models.TaskOrchestrationQueuedPlan>`
    :param project:
    :type project: :class:`ProjectReference <azure.devops.v7_2.task.models.ProjectReference>`
    :param queue_position:
    :type queue_position: int
    """
...
class TimelineRecord(Model):
    ...
    :type agent_specification: :class:`object <azure.devops.v7_2.task.models.object>`
    ...
    :type details: :class:`TimelineReference <azure.devops.v7_2.task.models.TimelineReference>`
    ...
    :type issues: list of :class:`Issue <azure.devops.v7_2.task.models.Issue>`
    ...
    :type log: :class:`TaskLogReference <azure.devops.v7_2.task.models.TaskLogReference>`
    ...
    :type previous_attempts: list of :class:`TimelineAttempt <azure.devops.v7_2.task.models.TimelineAttempt>`
    ...
    :type task: :class:`TaskReference <azure.devops.v7_2.task.models.TaskReference>`
...
class TaskOrchestrationContainer(TaskOrchestrationItem):
    ...
    :type item_type: object
    :param children:
    :type children: list of :class:`TaskOrchestrationItem <azure.devops.v7_2.task.models.TaskOrchestrationItem>`
    :param continue_on_error:
    :type continue_on_error: bool
    :param data:
    :type data: dict
    ...
    :type parallel: bool
    :param rollback:
    :type rollback: :class:`TaskOrchestrationContainer <azure.devops.v7_2.task.models.TaskOrchestrationContainer>`
    """
...
class TaskOrchestrationPlan(TaskOrchestrationPlanReference):
    ...
    :type version: int
    :param environment:
    :type environment: :class:`PlanEnvironment <azure.devops.v7_2.task.models.PlanEnvironment>`
    :param expanded_yaml:
    :type expanded_yaml: :class:`TaskLogReference <azure.devops.v7_2.task.models.TaskLogReference>`
    :param finish_time:
    :type finish_time: datetime
    :param implementation:
    :type implementation: :class:`TaskOrchestrationContainer <azure.devops.v7_2.task.models.TaskOrchestrationContainer>`
    :param initialization_log:
    :type initialization_log: :class:`TaskLogReference <azure.devops.v7_2.task.models.TaskLogReference>`
    ...
    :type state: object
    :param timeline:
    :type timeline: :class:`TimelineReference <azure.devops.v7_2.task.models.TimelineReference>`
    """
...
class Timeline(TimelineReference):
    ...
    :type last_changed_on: datetime
    :param records:
    :type records: list of :class:`TimelineRecord <azure.devops.v7_2.task.models.TimelineRecord>`
    """
