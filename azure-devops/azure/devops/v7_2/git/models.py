...
class AdvSecEnablementStatus(Model):
    ...
    def __init__(self, changed_by_id=None, changed_on_date=None, enabled=None, enabled_changed_on_date=None, project_id=None, repository_id=None):
...
class Attachment(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.git.models.ReferenceLinks>`
    :param author: The person that uploaded this attachment.
    :type author: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    ...
    :type properties: :class:`object <azure.devops.v7_2.git.models.object>`
...
class BillableCommitterDetail(BillableCommitter):
    ...
    :param display_name: DisplayName of the Pusher.
    :type display_name: str
    :param mail_nick_name: MailNickName of the Pusher.
    :type mail_nick_name: str
    ...
    _attribute_map = {
        ...
        'display_name': {'key': 'displayName', 'type': 'str'},
        'mail_nick_name': {'key': 'mailNickName', 'type': 'str'},
        'project_id': {'key': 'projectId', 'type': 'str'},
    ...
    def __init__(self, repo_id=None, vsid=None, commit_id=None, committer_email=None, commit_time=None, display_name=None, mail_nick_name=None, project_id=None, project_name=None, pushed_time=None, pusher_id=None, push_id=None, repo_name=None, sam_account_name=None):
        super(BillableCommitterDetail, self).__init__(repo_id=repo_id, vsid=vsid)
        self.commit_id = commit_id
        self.committer_email = committer_email
        self.commit_time = commit_time
        self.display_name = display_name
        self.mail_nick_name = mail_nick_name
        self.project_id = project_id
...
class BillablePusher(Model):
    """
    Used by AdvSec to estimate billable pushers for a Host or Project.

    :param project_id: ProjectId that was pushed to.
    :type project_id: str
    :param repo_id: RepositoryId that was pushed to.
    :type repo_id: str
    :param vsid: Visual Studio ID /Team Foundation ID
    :type vsid: str
    """
    ...
    def __init__(self, project_id=None, repo_id=None, vsid=None):
        super(BillablePusher, self).__init__()
        self.project_id = project_id
        self.repo_id = repo_id
        self.vsid = vsid
...
class Change(Model):
    ...
    :type new_content: :class:`ItemContent <azure.devops.v7_2.git.models.ItemContent>`
...
class Comment(Model):
    ...
    :type users_liked: list of :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    """
...
class CommentPosition(Model):
    ...
    :type line: int
    :param offset: The character offset of a thread's position inside of a line. Starts at 1.
    :type offset: int
    """
...
class CommentThread(Model):
    ...
    :type comments: list of :class:`Comment <azure.devops.v7_2.git.models.Comment>`
    ...
    :type thread_context: :class:`CommentThreadContext <azure.devops.v7_2.git.models.CommentThreadContext>`
    """
...
class CommentThreadContext(Model):
    ...
    :type left_file_end: :class:`CommentPosition <azure.devops.v7_2.git.models.CommentPosition>`
    :param left_file_start: Position of first character of the thread's span in left file.
    :type left_file_start: :class:`CommentPosition <azure.devops.v7_2.git.models.CommentPosition>`
    :param right_file_end: Position of last character of the thread's span in right file.
    :type right_file_end: :class:`CommentPosition <azure.devops.v7_2.git.models.CommentPosition>`
    :param right_file_start: Position of first character of the thread's span in right file.
    :type right_file_start: :class:`CommentPosition <azure.devops.v7_2.git.models.CommentPosition>`
    """
...
class CommentTrackingCriteria(Model):
    ...
    :type orig_left_file_end: :class:`CommentPosition <azure.devops.v7_2.git.models.CommentPosition>`
    :param orig_left_file_start: Original position of first character of the thread's span in left file.
    :type orig_left_file_start: :class:`CommentPosition <azure.devops.v7_2.git.models.CommentPosition>`
    :param orig_right_file_end: Original position of last character of the thread's span in right file.
    :type orig_right_file_end: :class:`CommentPosition <azure.devops.v7_2.git.models.CommentPosition>`
    :param orig_right_file_start: Original position of first character of the thread's span in right file.
    :type orig_right_file_start: :class:`CommentPosition <azure.devops.v7_2.git.models.CommentPosition>`
...
class FileDiff(Model):
    ...
    :type line_diff_blocks: list of :class:`LineDiffBlock <azure.devops.v7_2.git.models.LineDiffBlock>`
...
class FileDiffsCriteria(Model):
    ...
    :type file_diff_params: list of :class:`FileDiffParams <azure.devops.v7_2.git.models.FileDiffParams>`
...
class GitAnnotatedTag(Model):
    ...
    :type tagged_by: :class:`GitUserDate <azure.devops.v7_2.git.models.GitUserDate>`
    :param tagged_object: Tagged git object.
    :type tagged_object: :class:`GitObject <azure.devops.v7_2.git.models.GitObject>`
    :param url:
    :type url: str
    """
...
class GitAsyncRefOperation(Model):
    ...
    :type detailed_status: :class:`GitAsyncRefOperationDetail <azure.devops.v7_2.git.models.GitAsyncRefOperationDetail>`
    :param parameters:
    :type parameters: :class:`GitAsyncRefOperationParameters <azure.devops.v7_2.git.models.GitAsyncRefOperationParameters>`
    :param status:
    :type status: object
...
class GitAsyncRefOperationParameters(Model):
    ...
    :type repository: :class:`GitRepository <azure.devops.v7_2.git.models.GitRepository>`
    :param source: Details about the source of the cherry pick or revert operation (e.g. A pull request or a specific commit).
    :type source: :class:`GitAsyncRefOperationSource <azure.devops.v7_2.git.models.GitAsyncRefOperationSource>`
    """
...
class GitAsyncRefOperationSource(Model):
    ...
    :type commit_list: list of :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
...
class GitBranchStats(Model):
    ...
    :type commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
...
class GitCommitChanges(Model):
    ...
    :param changes:
    :type changes: list of :class:`object <azure.devops.v7_2.git.models.object>`
    """
...
class GitCommitRef(Model):
    ...
    :type author: :class:`GitUserDate <azure.devops.v7_2.git.models.GitUserDate>`
    ...
    :type committer: :class:`GitUserDate <azure.devops.v7_2.git.models.GitUserDate>`
    ...
    :type push: :class:`GitPushRef <azure.devops.v7_2.git.models.GitPushRef>`
    ...
    :type statuses: list of :class:`GitStatus <azure.devops.v7_2.git.models.GitStatus>`
    :param url: REST URL for this resource.
    :type url: str
    :param work_items: A list of workitems associated with this commit.
    :type work_items: list of :class:`ResourceRef <azure.devops.v7_2.git.models.ResourceRef>`
    """
    ...
    def __init__(self, _links=None, author=None, change_counts=None, changes=None, comment=None, comment_truncated=None, commit_id=None, committer=None, commit_too_many_changes=None, parents=None, push=None, remote_url=None, statuses=None, url=None, work_items=None):
...
class GitConflict(Model):
    ...
    :type merge_base_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    :param merge_origin:
    :type merge_origin: :class:`GitMergeOriginRef <azure.devops.v7_2.git.models.GitMergeOriginRef>`
    :param merge_source_commit:
    :type merge_source_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    :param merge_target_commit:
    :type merge_target_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    :param resolution_error:
    :type resolution_error: object
    :param resolution_status:
    :type resolution_status: object
    :param resolved_by:
    :type resolved_by: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    :param resolved_date:
...
class GitConflictUpdateResult(Model):
    ...
    :type updated_conflict: :class:`GitConflict <azure.devops.v7_2.git.models.GitConflict>`
...
class GitDeletedRepository(Model):
    ...
    :type created_date: datetime
    :param deleted_by:
    :type deleted_by: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    :param deleted_date:
    ...
    :type name: str
    :param project:
    :type project: :class:`TeamProjectReference <azure.devops.v7_2.git.models.TeamProjectReference>`
    """
...
class GitForkSyncRequest(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.git.models.ReferenceLinks>`
    :param detailed_status:
    :type detailed_status: :class:`GitForkOperationStatusDetail <azure.devops.v7_2.git.models.GitForkOperationStatusDetail>`
    ...
    :type source: :class:`GlobalGitRepositoryKey <azure.devops.v7_2.git.models.GlobalGitRepositoryKey>`
    ...
    :type source_to_target_refs: list of :class:`SourceToTargetRef <azure.devops.v7_2.git.models.SourceToTargetRef>`
    :param status:
    :type status: object
    """
...
class GitImportRequest(Model):
    ...
    :type detailed_status: :class:`GitImportStatusDetail <azure.devops.v7_2.git.models.GitImportStatusDetail>`
    ...
    :type parameters: :class:`GitImportRequestParameters <azure.devops.v7_2.git.models.GitImportRequestParameters>`
...
class GitImportRequestParameters(Model):
    ...
    :type git_source: :class:`GitImportGitSource <azure.devops.v7_2.git.models.GitImportGitSource>`
    ...
    :type tfvc_source: :class:`GitImportTfvcSource <azure.devops.v7_2.git.models.GitImportTfvcSource>`
    """
...
class GitItemRequestData(Model):
    ...
    :type item_descriptors: list of :class:`GitItemDescriptor <azure.devops.v7_2.git.models.GitItemDescriptor>`
...
class GitPolicyConfigurationResponse(Model):
    ...
    :type policy_configurations: list of :class:`PolicyConfiguration <azure.devops.v7_2.git.models.PolicyConfiguration>`
    """
...
class GitPullRequest(Model):
    ...
    :type auto_complete_set_by: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    :param closed_by: The user who closed the pull request.
    :type closed_by: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    ...
    :type commits: list of :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    :param completion_options: Options which affect how the pull request will be merged when it is completed.
    :type completion_options: :class:`GitPullRequestCompletionOptions <azure.devops.v7_2.git.models.GitPullRequestCompletionOptions>`
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    ...
    :type fork_source: :class:`GitForkRef <azure.devops.v7_2.git.models.GitForkRef>`
    ...
    :type labels: list of :class:`WebApiTagDefinition <azure.devops.v7_2.git.models.WebApiTagDefinition>`
    ...
    :type last_merge_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    :param last_merge_source_commit: The commit at the head of the source branch at the time of the last pull request merge.
    :type last_merge_source_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    :param last_merge_target_commit: The commit at the head of the target branch at the time of the last pull request merge.
    :type last_merge_target_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    ...
    :type merge_options: :class:`GitPullRequestMergeOptions <azure.devops.v7_2.git.models.GitPullRequestMergeOptions>`
    ...
    :type reviewers: list of :class:`IdentityRefWithVote <azure.devops.v7_2.git.models.IdentityRefWithVote>`
    ...
    :type work_item_refs: list of :class:`ResourceRef <azure.devops.v7_2.git.models.ResourceRef>`
    """
...
class GitPullRequestCommentThread(CommentThread):
    ...
    :type pull_request_thread_context: :class:`GitPullRequestCommentThreadContext <azure.devops.v7_2.git.models.GitPullRequestCommentThreadContext>`
    """
...
class GitPullRequestCommentThreadContext(Model):
    ...
    :type iteration_context: :class:`CommentIterationContext <azure.devops.v7_2.git.models.CommentIterationContext>`
    ...
    :type tracking_criteria: :class:`CommentTrackingCriteria <azure.devops.v7_2.git.models.CommentTrackingCriteria>`
    """
...
class GitPullRequestIteration(Model):
    ...
    :type change_list: list of :class:`GitPullRequestChange <azure.devops.v7_2.git.models.GitPullRequestChange>`
    ...
    :type common_ref_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    ...
    :type source_ref_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    :param target_ref_commit: The target Git commit of this iteration.
    :type target_ref_commit: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
...
class GitPullRequestIterationChanges(Model):
    ...
    :type change_entries: list of :class:`GitPullRequestChange <azure.devops.v7_2.git.models.GitPullRequestChange>`
...
class GitPullRequestMergeOptions(Model):
    ...
    :param detect_rename_false_positives: If true, renames where there is more than one valid way to map the original file locations to renamed file locations will be treated as false positives and ignored.
...
class GitPullRequestQuery(Model):
    ...
    :type queries: list of :class:`GitPullRequestQueryInput <azure.devops.v7_2.git.models.GitPullRequestQueryInput>`
...
class GitPullRequestSearchCriteria(Model):
    ...
    :param include_links: Whether to include the _links field on the shallow references
    :type include_links: bool
    :param max_time: If specified, filters pull requests that created/closed before this date based on the queryTimeRangeType specified.
    :type max_time: datetime
    :param min_time: If specified, filters pull requests that created/closed after this date based on the queryTimeRangeType specified.
    ...
    :type query_time_range_type: object
    ...
    _attribute_map = {
        ...
        'include_links': {'key': 'includeLinks', 'type': 'bool'},
        'max_time': {'key': 'maxTime', 'type': 'iso-8601'},
        'min_time': {'key': 'minTime', 'type': 'iso-8601'},
        'query_time_range_type': {'key': 'queryTimeRangeType', 'type': 'object'},
        'repository_id': {'key': 'repositoryId', 'type': 'str'},
    ...
    def __init__(self, creator_id=None, include_links=None, max_time=None, min_time=None, query_time_range_type=None, repository_id=None, reviewer_id=None, source_ref_name=None, source_repository_id=None, status=None, target_ref_name=None):
...
class GitPushRef(Model):
    ...
    :param pushed_by:
    :type pushed_by: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    :param push_id:
    :type push_id: int
    :param url:
    :type url: str
...
class GitQueryBranchStatsCriteria(Model):
    """
    :param base_commit:
    :type base_commit: :class:`GitVersionDescriptor <azure.devops.v7_2.git.models.GitVersionDescriptor>`
    :param target_commits:
    :type target_commits: list of :class:`GitVersionDescriptor <azure.devops.v7_2.git.models.GitVersionDescriptor>`
    """
...
class GitQueryCommitsCriteria(Model):
    ...
    :type compare_version: :class:`GitVersionDescriptor <azure.devops.v7_2.git.models.GitVersionDescriptor>`
    ...
    :type item_version: :class:`GitVersionDescriptor <azure.devops.v7_2.git.models.GitVersionDescriptor>`
...
class GitRef(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.git.models.ReferenceLinks>`
    :param creator:
    :type creator: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    :param is_locked:
    :type is_locked: bool
    :param is_locked_by:
    :type is_locked_by: :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    :param name:
    :type name: str
    :param object_id:
    :type object_id: str
...
class GitRepository(Model):
    ...
    :type parent_repository: :class:`GitRepositoryRef <azure.devops.v7_2.git.models.GitRepositoryRef>`
    :param project:
    :type project: :class:`TeamProjectReference <azure.devops.v7_2.git.models.TeamProjectReference>`
    :param remote_url:
    :type remote_url: str
...
class GitRepositoryRef(Model):
    ...
    :type collection: :class:`TeamProjectCollectionReference <azure.devops.v7_2.git.models.TeamProjectCollectionReference>`
    :param id:
    :type id: str
    :param is_fork: True if the repository was created as a fork
    :type is_fork: bool
...
class GitStatus(Model):
    ...
    :type context: :class:`GitStatusContext <azure.devops.v7_2.git.models.GitStatusContext>`
...
class GitTreeDiff(Model):
    ...
    :type diff_entries: list of :class:`GitTreeDiffEntry <azure.devops.v7_2.git.models.GitTreeDiffEntry>`
...
class GitTreeDiffResponse(Model):
    ...
    :param tree_diff:
    :type tree_diff: :class:`GitTreeDiff <azure.devops.v7_2.git.models.GitTreeDiff>`
    """
...
class GitTreeRef(Model):
    ...
    :type tree_entries: list of :class:`GitTreeEntryRef <azure.devops.v7_2.git.models.GitTreeEntryRef>`
...
class IdentityRefWithVote(IdentityRef):
    ...
    :param is_reapprove: Indicates if this approve vote should still be handled even though vote didn't change.
    :type is_reapprove: bool
    ...
    :type voted_for: list of :class:`IdentityRefWithVote <azure.devops.v7_2.git.models.IdentityRefWithVote>`
    """
    ...
    _attribute_map = {
        ...
        'is_reapprove': {'key': 'isReapprove', 'type': 'bool'},
    ...
    def __init__(self, _links=None, descriptor=None, display_name=None, url=None, directory_alias=None, id=None, image_url=None, inactive=None, is_aad_identity=None, is_container=None, is_deleted_in_origin=None, profile_url=None, unique_name=None, has_declined=None, is_flagged=None, is_reapprove=None, is_required=None, reviewer_url=None, vote=None, voted_for=None):
        ...
        self.is_reapprove = is_reapprove
...
class ItemModel(Model):
    ...
    :type content_metadata: :class:`FileContentMetadata <azure.devops.v7_2.git.models.FileContentMetadata>`
    :param is_folder:
    :type is_folder: bool
    :param is_sym_link:
...
class PolicyConfigurationRef(Model):
    ...
    :type type: :class:`PolicyTypeRef <azure.devops.v7_2.microsoft._team_foundation._policy._web_api.models.PolicyTypeRef>`
...
class ShareNotificationContext(Model):
    ...
    :type receivers: list of :class:`IdentityRef <azure.devops.v7_2.git.models.IdentityRef>`
    """
...
class GitCommit(GitCommitRef):
    ...
    def __init__(self, _links=None, author=None, change_counts=None, changes=None, comment=None, comment_truncated=None, commit_id=None, committer=None, commit_too_many_changes=None, parents=None, push=None, remote_url=None, statuses=None, url=None, work_items=None, tree_id=None):
        super(GitCommit, self).__init__(_links=_links, author=author, change_counts=change_counts, changes=changes, comment=comment, comment_truncated=comment_truncated, commit_id=commit_id, committer=committer, commit_too_many_changes=commit_too_many_changes, parents=parents, push=push, remote_url=remote_url, statuses=statuses, url=url, work_items=work_items)
...
class GitItem(ItemModel):
    ...
    :type latest_processed_change: :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
...
class GitMerge(GitMergeParameters):
    ...
    :type detailed_status: :class:`GitMergeOperationStatusDetail <azure.devops.v7_2.git.models.GitMergeOperationStatusDetail>`
...
class GitPush(GitPushRef):
    ...
    :type commits: list of :class:`GitCommitRef <azure.devops.v7_2.git.models.GitCommitRef>`
    :param ref_updates:
    :type ref_updates: list of :class:`GitRefUpdate <azure.devops.v7_2.git.models.GitRefUpdate>`
    :param repository:
    :type repository: :class:`GitRepository <azure.devops.v7_2.git.models.GitRepository>`
    """
...
class PolicyConfiguration(VersionedPolicyConfigurationRef):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.microsoft._team_foundation._policy._web_api.models.ReferenceLinks>`
    :param created_by: A reference to the identity that created the policy.
    :type created_by: :class:`IdentityRef <azure.devops.v7_2.microsoft._team_foundation._policy._web_api.models.IdentityRef>`
