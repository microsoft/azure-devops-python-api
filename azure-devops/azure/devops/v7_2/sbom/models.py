...
class Configuration(Model):
    ...
    :type additional_component_detector_args: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param build_component_path: The folder containing the build components and packages.
    :type build_component_path: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param build_drop_path: The root folder of the drop directory to validate or generate.
    :type build_drop_path: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param build_list_file: Full file name of a list file that contains all files to be validated.
    :type build_list_file: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param catalog_file_path: The path of the signed catalog file used to validate the manifest.json.
    :type catalog_file_path: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param config_file_path: The json file that contains the configuration for the DropValidator.
    :type config_file_path: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    ...
    :type docker_images_to_scan: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    ...
    :type external_document_reference_list_file: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param hash_algorithm: The Hash algorithm to use while verifying the hash value of a file.
    :type hash_algorithm: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param ignore_missing: If set, will not fail validation on the files presented in Manifest but missing on the disk.
    :type ignore_missing: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    ...
    :type manifest_dir_path: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param manifest_info: A list of name and version of the manifest that we are generating.
    :type manifest_info: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    ...
    :type package_name: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param package_version: The version of the package this SBOM represents.
    :type package_version: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param parallelism: The number of parallel threads to use for the workflows.
    :type parallelism: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    ...
    :type root_path_filter: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    ...
    :type telemetry_file_path: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    :param validate_signature: If set, will validate the manifest using the signed catalog file.
    :type validate_signature: :class:`ConfigurationSetting <azure.devops.v7_2.sbom.models.ConfigurationSetting>`
    """
...
class SBOMFile(Model):
    ...
    :type sbom_format_name: :class:`ManifestInfo <azure.devops.v7_2.sbom.models.ManifestInfo>`
    """
...
class SBOMTelemetry(Model):
    ...
    :type parameters: :class:`Configuration <azure.devops.v7_2.sbom.models.Configuration>`
    ...
    :type sbom_formats_used: list of :class:`SBOMFile <azure.devops.v7_2.sbom.models.SBOMFile>`
    ...
    :param task_name: The name of the task that logged SBOM telemetry
    :type task_name: str
    ...
    def __init__(self, bsi_data=None, bsi_source=None, e2_eTask_result=None, parameters=None, result=None, sbom_formats_used=None, switches=None, task_error_message=None, task_name=None, telemetry_id=None, tool_execution_result=None):
...
class SignRequest(Model):
    ...
    :param ebom_id: The EBOM ID for the associated image.
    :type ebom_id: str
    :param file_hash: The file hash of the generated SBOM file.
    :type file_hash: :class:`FileHash <azure.devops.v7_2.sbom.models.FileHash>`
    """

    _attribute_map = {
        'ebom_id': {'key': 'ebomId', 'type': 'str'},
        'file_hash': {'key': 'fileHash', 'type': 'FileHash'}
    }

    def __init__(self, ebom_id=None, file_hash=None):
