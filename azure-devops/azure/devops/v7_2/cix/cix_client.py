...
class CixClient(Client):
    ...
    def create_project_connection(self, create_connection_inputs, project):
        ...
        :param :class:`<CreatePipelineConnectionInputs> <azure.devops.v7_2.cix.models.CreatePipelineConnectionInputs>` create_connection_inputs:
        :param str project:
        :rtype: :class:`<PipelineConnection> <azure.devops.v7_2.cix.models.PipelineConnection>`
        """
        query_parameters = {}
        if project is not None:
    ...
    def create_resources(self, creation_parameters, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<CreatedResources> <azure.devops.v7_2.cix.models.CreatedResources>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
