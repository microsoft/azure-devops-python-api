...
class MavenClient(Client):
    ...
    def update_package_versions(self, batch_request, feed_id, project=None):
        ...
        :param :class:`<MavenPackagesBatchRequest> <azure.devops.v7_2.maven.models.MavenPackagesBatchRequest>` batch_request: Information about the packages to update, the operation to perform, and its associated data.
    ...
    def get_package_version_metadata_from_recycle_bin(self, feed, group_id, artifact_id, version, project=None):
        ...
        :param str version: Version of the package.
        :param str project: Project ID or project name
        :rtype: :class:`<MavenPackageVersionDeletionState> <azure.devops.v7_2.maven.models.MavenPackageVersionDeletionState>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def restore_package_version_from_recycle_bin(self, package_version_details, feed, group_id, artifact_id, version, project=None):
        ...
        :param :class:`<MavenRecycleBinPackageVersionDetails> <azure.devops.v7_2.maven.models.MavenRecycleBinPackageVersionDetails>` package_version_details: Set the 'Deleted' property to false to restore the package.
        :param str feed: Name or ID of the feed.
        :param str group_id: Group ID of the package.
        :param str artifact_id: Artifact ID of the package.
        :param str version: Version of the package.
    ...
    def get_upstreaming_behavior(self, feed, group_id, artifact_id, project=None):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<UpstreamingBehavior> <azure.devops.v7_2.maven.models.UpstreamingBehavior>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def set_upstreaming_behavior(self, feed, group_id, artifact_id, behavior, project=None):
        ...
        :param :class:`<UpstreamingBehavior> <azure.devops.v7_2.maven.models.UpstreamingBehavior>` behavior: The behavior to apply to the package within the scope of the feed
        :param str project: Project ID or project name
        """
        route_values = {}
        if project is not None:
    ...
    def get_package_version(self, feed, group_id, artifact_id, version, project=None, show_deleted=None):
        ...
        :rtype: :class:`<Package> <azure.devops.v7_2.maven.models.Package>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_package_version(self, package_version_details, feed, group_id, artifact_id, version, project=None):
        ...
        :param :class:`<PackageVersionDetails> <azure.devops.v7_2.maven.models.PackageVersionDetails>` package_version_details: Details to be updated.
        :param str feed: Name or ID of the feed.
        :param str group_id: Group ID of the package.
        :param str artifact_id: Artifact ID of the package.
        :param str version: Version of the package.
