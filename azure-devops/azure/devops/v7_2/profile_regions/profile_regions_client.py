...
class ProfileRegionsClient(Client):
    ...
    def get_geo_region(self, ip):
        ...
        :param str ip:
        :rtype: :class:`<GeoRegion> <azure.devops.v7_2.profile_regions.models.GeoRegion>`
        """
        query_parameters = {}
        if ip is not None:
    ...
    def get_regions(self):
        """GetRegions.
        [Preview API]
        :rtype: :class:`<ProfileRegions> <azure.devops.v7_2.profile_regions.models.ProfileRegions>`
        """
        response = self._send(http_method='GET',
