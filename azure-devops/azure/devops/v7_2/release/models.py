...
class ArtifactMetadata(Model):
    ...
    :type instance_reference: :class:`BuildVersion <azure.devops.v7_2.release.models.BuildVersion>`
    """
...
class ArtifactTypeDefinition(Model):
    ...
    :type artifact_trigger_configuration: :class:`ArtifactTriggerConfiguration <azure.devops.v7_2.release.models.ArtifactTriggerConfiguration>`
    ...
    :type input_descriptors: list of :class:`InputDescriptor <azure.devops.v7_2.release.models.InputDescriptor>`
...
class ArtifactVersion(Model):
    ...
    :type default_version: :class:`BuildVersion <azure.devops.v7_2.release.models.BuildVersion>`
    ...
    :type versions: list of :class:`BuildVersion <azure.devops.v7_2.release.models.BuildVersion>`
    """
...
class ArtifactVersionQueryResult(Model):
    ...
    :type artifact_versions: list of :class:`ArtifactVersion <azure.devops.v7_2.release.models.ArtifactVersion>`
    """
...
class AutoTriggerIssue(Model):
    """
    :param issue:
    :type issue: :class:`Issue <azure.devops.v7_2.release.models.Issue>`
    :param issue_source:
    :type issue_source: object
    :param project:
    :type project: :class:`ProjectReference <azure.devops.v7_2.release.models.ProjectReference>`
    :param release_definition_reference:
    :type release_definition_reference: :class:`ReleaseDefinitionShallowReference <azure.devops.v7_2.release.models.ReleaseDefinitionShallowReference>`
...
class BuildVersion(Model):
    ...
    :type source_pull_request_version: :class:`SourcePullRequestVersion <azure.devops.v7_2.release.models.SourcePullRequestVersion>`
...
class Change(Model):
    ...
    :type author: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    ...
    :type pushed_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
...
class Condition(Model):
    ...
    def __init__(self, condition_type=None, name=None, result=None, value=None):
...
class Deployment(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v7_2.release.models.ReferenceLinks>`
    ...
    :type conditions: list of :class:`Condition <azure.devops.v7_2.release.models.Condition>`
    ...
    :type last_modified_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    ...
    :type post_deploy_approvals: list of :class:`ReleaseApproval <azure.devops.v7_2.release.models.ReleaseApproval>`
    :param pre_deploy_approvals: Gets list of PreDeployApprovals.
    :type pre_deploy_approvals: list of :class:`ReleaseApproval <azure.devops.v7_2.release.models.ReleaseApproval>`
    :param project_reference: Gets or sets project reference.
    :type project_reference: :class:`ProjectReference <azure.devops.v7_2.release.models.ProjectReference>`
    ...
    :type release: :class:`ReleaseReference <azure.devops.v7_2.release.models.ReleaseReference>`
    ...
    :type release_definition: :class:`ReleaseDefinitionShallowReference <azure.devops.v7_2.release.models.ReleaseDefinitionShallowReference>`
    ...
    :type release_environment: :class:`ReleaseEnvironmentShallowReference <azure.devops.v7_2.release.models.ReleaseEnvironmentShallowReference>`
    :param requested_by: Gets the identity who requested.
    :type requested_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    :param requested_for: Gets the identity for whom deployment is requested.
    :type requested_for: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
...
class DeploymentAttempt(Model):
    ...
    :type issues: list of :class:`Issue <azure.devops.v7_2.release.models.Issue>`
    :param job:
    :type job: :class:`ReleaseTask <azure.devops.v7_2.release.models.ReleaseTask>`
    ...
    :type post_deployment_gates: :class:`ReleaseGates <azure.devops.v7_2.release.models.ReleaseGates>`
    :param pre_deployment_gates: Pre deployment gates that executed in this deployment.
    :type pre_deployment_gates: :class:`ReleaseGates <azure.devops.v7_2.release.models.ReleaseGates>`
    ...
    :type release_deploy_phases: list of :class:`ReleaseDeployPhase <azure.devops.v7_2.release.models.ReleaseDeployPhase>`
    ...
    :type status: object
    :param tasks:
    :type tasks: list of :class:`ReleaseTask <azure.devops.v7_2.release.models.ReleaseTask>`
    """
...
class DeploymentQueryParameters(Model):
    ...
    :type environments: list of :class:`DefinitionEnvironmentReference <azure.devops.v7_2.release.models.DefinitionEnvironmentReference>`
...
class Folder(Model):
    ...
    :type created_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    ...
    :type last_changed_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
...
class InputValuesQuery(Model):
    ...
    :type input_values: list of :class:`InputValues <azure.devops.v7_2.microsoft._visual_studio._services._web_api.models.InputValues>`
...
class MailMessage(Model):
    ...
    :type cc: :class:`EmailRecipients <azure.devops.v7_2.release.models.EmailRecipients>`
    ...
    :type reply_to: :class:`EmailRecipients <azure.devops.v7_2.release.models.EmailRecipients>`
    ...
    :type to: :class:`EmailRecipients <azure.devops.v7_2.release.models.EmailRecipients>`
    """
...
class ManualIntervention(Model):
    ...
    :type approver: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    ...
    :type release: :class:`ReleaseShallowReference <azure.devops.v7_2.release.models.ReleaseShallowReference>`
...
class Release(Model):
    ...
    :type artifacts: list of :class:`Artifact <azure.devops.v7_2.release.models.Artifact>`
    ...
    :type created_for: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    :param created_on: Gets date on which it got created.
    :type created_on: datetime
    ...
    :type environments: list of :class:`ReleaseEnvironment <azure.devops.v7_2.release.models.ReleaseEnvironment>`
    :param id: Gets the unique identifier of this field.
    :type id: int
    ...
    :type modified_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    :param modified_on: Gets date on which it got modified.
    :type modified_on: datetime
    ...
    :type project_reference: :class:`ProjectReference <azure.devops.v7_2.release.models.ProjectReference>`
    :param properties:
    :type properties: :class:`object <azure.devops.v7_2.release.models.object>`
    ...
    :type variable_groups: list of :class:`VariableGroup <azure.devops.v7_2.release.models.VariableGroup>`
...
class ReleaseApproval(Model):
    ...
    :type approved_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    :param approver: Gets or sets the identity who should approve.
    :type approver: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    ...
    :type history: list of :class:`ReleaseApprovalHistory <azure.devops.v7_2.release.models.ReleaseApprovalHistory>`
    :param id: Gets the unique identifier of this field.
    :type id: int
...
class ReleaseApprovalHistory(Model):
    ...
    :type changed_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
...
class ReleaseCondition(Condition):
    ...
    def __init__(self, condition_type=None, name=None, result=None, value=None):
        super(ReleaseCondition, self).__init__(condition_type=condition_type, name=name, result=result, value=value)


class ReleaseDefinitionApprovals(Model):
    """
    :param approval_options: Gets or sets the approval options.
    :type approval_options: :class:`ApprovalOptions <azure.devops.v7_2.release.models.ApprovalOptions>`
    :param approvals: Gets or sets the approvals.
    :type approvals: list of :class:`ReleaseDefinitionApprovalStep <azure.devops.v7_2.release.models.ReleaseDefinitionApprovalStep>`
    """
...
class ReleaseDefinitionEnvironment(Model):
    ...
    :type current_release: :class:`ReleaseShallowReference <azure.devops.v7_2.release.models.ReleaseShallowReference>`
    :param demands: Gets or sets the demands.
    :type demands: list of :class:`object <azure.devops.v7_2.release.models.object>`
    :param deploy_phases: Gets or sets the deploy phases of environment.
    :type deploy_phases: list of :class:`object <azure.devops.v7_2.release.models.object>`
    :param deploy_step: Gets or sets the deploystep.
    :type deploy_step: :class:`ReleaseDefinitionDeployStep <azure.devops.v7_2.release.models.ReleaseDefinitionDeployStep>`
    :param environment_options: Gets or sets the environment options.
    :type environment_options: :class:`EnvironmentOptions <azure.devops.v7_2.release.models.EnvironmentOptions>`
    :param environment_triggers: Gets or sets the triggers on environment.
    :type environment_triggers: list of :class:`EnvironmentTrigger <azure.devops.v7_2.release.models.EnvironmentTrigger>`
    :param execution_policy: Gets or sets the environment execution policy.
    :type execution_policy: :class:`EnvironmentExecutionPolicy <azure.devops.v7_2.release.models.EnvironmentExecutionPolicy>`
    ...
    :type owner: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    :param post_deploy_approvals: Gets or sets the post deployment approvals.
    :type post_deploy_approvals: :class:`ReleaseDefinitionApprovals <azure.devops.v7_2.release.models.ReleaseDefinitionApprovals>`
    :param post_deployment_gates: Gets or sets the post deployment gates.
    :type post_deployment_gates: :class:`ReleaseDefinitionGatesStep <azure.devops.v7_2.release.models.ReleaseDefinitionGatesStep>`
    :param pre_deploy_approvals: Gets or sets the pre deployment approvals.
    :type pre_deploy_approvals: :class:`ReleaseDefinitionApprovals <azure.devops.v7_2.release.models.ReleaseDefinitionApprovals>`
    :param pre_deployment_gates: Gets or sets the pre deployment gates.
    :type pre_deployment_gates: :class:`ReleaseDefinitionGatesStep <azure.devops.v7_2.release.models.ReleaseDefinitionGatesStep>`
    :param process_parameters: Gets or sets the environment process parameters.
    :type process_parameters: :class:`ProcessParameters <azure.devops.v7_2.release.models.ProcessParameters>`
    ...
    :type retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v7_2.release.models.EnvironmentRetentionPolicy>`
    :param run_options:
    :type run_options: dict
    :param schedules: Gets or sets the schedules
    :type schedules: list of :class:`ReleaseSchedule <azure.devops.v7_2.release.models.ReleaseSchedule>`
...
class ReleaseDefinitionEnvironmentSummary(Model):
    ...
    :type last_releases: list of :class:`ReleaseShallowReference <azure.devops.v7_2.release.models.ReleaseShallowReference>`
...
class ReleaseDefinitionEnvironmentTemplate(Model):
    ...
    :type environment: :class:`ReleaseDefinitionEnvironment <azure.devops.v7_2.release.models.ReleaseDefinitionEnvironment>`
...
class ReleaseDefinitionGate(Model):
    ...
    :type tasks: list of :class:`WorkflowTask <azure.devops.v7_2.release.models.WorkflowTask>`
    """
...
class ReleaseDefinitionGatesStep(Model):
    ...
    :type gates: list of :class:`ReleaseDefinitionGate <azure.devops.v7_2.release.models.ReleaseDefinitionGate>`
    :param gates_options: Gets or sets the gate options.
    :type gates_options: :class:`ReleaseDefinitionGatesOptions <azure.devops.v7_2.release.models.ReleaseDefinitionGatesOptions>`
...
class ReleaseDefinitionSummary(Model):
    ...
    :type environments: list of :class:`ReleaseDefinitionEnvironmentSummary <azure.devops.v7_2.release.models.ReleaseDefinitionEnvironmentSummary>`
    ...
    :type releases: list of :class:`Release <azure.devops.v7_2.release.models.Release>`
    """
...
class ReleaseDeployPhase(Model):
    ...
    :type deployment_jobs: list of :class:`DeploymentJob <azure.devops.v7_2.release.models.DeploymentJob>`
    ...
    :type manual_interventions: list of :class:`ManualIntervention <azure.devops.v7_2.release.models.ManualIntervention>`
...
class ReleaseEnvironment(Model):
    ...
    :type conditions: list of :class:`ReleaseCondition <azure.devops.v7_2.release.models.ReleaseCondition>`
    :param created_on: Gets date on which it got created.
    :type created_on: datetime
    ...
    :type deploy_phases_snapshot: list of :class:`object <azure.devops.v7_2.release.models.object>`
    :param deploy_steps: Gets deploy steps.
    :type deploy_steps: list of :class:`DeploymentAttempt <azure.devops.v7_2.release.models.DeploymentAttempt>`
    ...
    :type post_approvals_snapshot: :class:`ReleaseDefinitionApprovals <azure.devops.v7_2.release.models.ReleaseDefinitionApprovals>`
    ...
    :type post_deployment_gates_snapshot: :class:`ReleaseDefinitionGatesStep <azure.devops.v7_2.release.models.ReleaseDefinitionGatesStep>`
    :param pre_approvals_snapshot: Gets list of pre deploy approvals snapshot.
    :type pre_approvals_snapshot: :class:`ReleaseDefinitionApprovals <azure.devops.v7_2.release.models.ReleaseDefinitionApprovals>`
    ...
    :type pre_deployment_gates_snapshot: :class:`ReleaseDefinitionGatesStep <azure.devops.v7_2.release.models.ReleaseDefinitionGatesStep>`
    ...
    :type release_created_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    ...
    :type workflow_tasks: list of :class:`WorkflowTask <azure.devops.v7_2.release.models.WorkflowTask>`
    """
...
class ReleaseGates(Model):
    ...
    :type ignored_gates: list of :class:`IgnoredGate <azure.devops.v7_2.release.models.IgnoredGate>`
...
class ReleaseSettings(Model):
    ...
    :type compliance_settings: :class:`ComplianceSettings <azure.devops.v7_2.release.models.ComplianceSettings>`
    :param retention_settings: Release retention settings.
    :type retention_settings: :class:`RetentionSettings <azure.devops.v7_2.release.models.RetentionSettings>`
    """
...
class ReleaseStartMetadata(Model):
    ...
    :type artifacts: list of :class:`ArtifactMetadata <azure.devops.v7_2.release.models.ArtifactMetadata>`
    ...
    :type environments_metadata: list of :class:`ReleaseStartEnvironmentMetadata <azure.devops.v7_2.release.models.ReleaseStartEnvironmentMetadata>`
...
class ReleaseTask(Model):
    ...
    :type task: :class:`WorkflowTaskReference <azure.devops.v7_2.release.models.WorkflowTaskReference>`
...
class RetentionSettings(Model):
    ...
    :type default_environment_retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v7_2.release.models.EnvironmentRetentionPolicy>`
    :param maximum_environment_retention_policy: Specifies the maximum environment retention policy.
    :type maximum_environment_retention_policy: :class:`EnvironmentRetentionPolicy <azure.devops.v7_2.release.models.EnvironmentRetentionPolicy>`
    """
...
class VariableGroup(Model):
    ...
    :type provider_data: :class:`VariableGroupProviderData <azure.devops.v7_2.release.models.VariableGroupProviderData>`
    ...
    :type variable_group_project_references: list of :class:`VariableGroupProjectReference <azure.devops.v7_2.release.models.VariableGroupProjectReference>`
...
class ReleaseDefinition(ReleaseDefinitionShallowReference):
    ...
    :type environments: list of :class:`ReleaseDefinitionEnvironment <azure.devops.v7_2.release.models.ReleaseDefinitionEnvironment>`
    :param is_deleted: Whether release definition is deleted.
    :type is_deleted: bool
    :param last_release: Gets the reference of last release.
    :type last_release: :class:`ReleaseReference <azure.devops.v7_2.release.models.ReleaseReference>`
    :param modified_by: Gets or sets the identity who modified.
    :type modified_by: :class:`IdentityRef <azure.devops.v7_2.release.models.IdentityRef>`
    :param modified_on: Gets date on which it got modified.
    :type modified_on: datetime
    :param pipeline_process: Gets or sets pipeline process.
    :type pipeline_process: :class:`PipelineProcess <azure.devops.v7_2.release.models.PipelineProcess>`
    :param properties: Gets or sets properties.
    :type properties: :class:`object <azure.devops.v7_2.release.models.object>`
    :param release_name_format: Gets or sets the release name format.
    :type release_name_format: str
    :param retention_policy:
    :type retention_policy: :class:`RetentionPolicy <azure.devops.v7_2.release.models.RetentionPolicy>`
    :param revision: Gets the revision number.
    :type revision: int
    ...
    :type triggers: list of :class:`object <azure.devops.v7_2.release.models.object>`
