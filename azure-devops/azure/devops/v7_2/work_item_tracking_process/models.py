...
class Control(Model):
    ...
    :type contribution: :class:`WitContribution <azure.devops.v7_2.work_item_tracking.models.WitContribution>`
...
class CreateProcessRuleRequest(Model):
    ...
    :type actions: list of :class:`RuleAction <azure.devops.v7_2.work_item_tracking.models.RuleAction>`
    :param conditions: List of conditions when the rule should be triggered.
    :type conditions: list of :class:`RuleCondition <azure.devops.v7_2.work_item_tracking.models.RuleCondition>`
...
class FieldModel(Model):
    ...
    def __init__(self, description=None, id=None, is_identity=None, is_locked=None, name=None, type=None, url=None):
...
class FieldRuleModel(Model):
    """
    :param actions:
    :type actions: list of :class:`RuleActionModel <azure.devops.v7_2.work_item_tracking.models.RuleActionModel>`
    :param conditions:
    :type conditions: list of :class:`RuleConditionModel <azure.devops.v7_2.work_item_tracking.models.RuleConditionModel>`
    :param friendly_name:
...
class FormLayout(Model):
    ...
    :type extensions: list of :class:`Extension <azure.devops.v7_2.work_item_tracking.models.Extension>`
    :param pages: Top level tabs of the layout.
    :type pages: list of :class:`Page <azure.devops.v7_2.work_item_tracking.models.Page>`
    :param system_controls: Headers controls of the layout.
    :type system_controls: list of :class:`Control <azure.devops.v7_2.work_item_tracking.models.Control>`
    """
...
class Group(Model):
    ...
    :type controls: list of :class:`Control <azure.devops.v7_2.work_item_tracking.models.Control>`
...
class Page(Model):
    ...
    :type sections: list of :class:`Section <azure.devops.v7_2.work_item_tracking.models.Section>`
...
class ProcessBehavior(Model):
    ...
    :param color: Color.
    :type color: str
    :param customization: Indicates the type of customization on this work item. System behaviors are inherited from parent process but not modified. Inherited behaviors are modified behaviors that were inherited from parent process. Custom behaviors are behaviors created by user in current process.
    :type customization: object
    :param description: . Description
    :type description: str
    :param fields: Process Behavior Fields.
    :type fields: list of :class:`ProcessBehaviorField <azure.devops.v7_2.work_item_tracking.models.ProcessBehaviorField>`
    :param inherits: Parent behavior reference.
    :type inherits: :class:`ProcessBehaviorReference <azure.devops.v7_2.work_item_tracking.models.ProcessBehaviorReference>`
...
class ProcessInfo(Model):
    ...
    :type projects: list of :class:`ProjectReference <azure.devops.v7_2.work_item_tracking.models.ProjectReference>`
...
class ProcessModel(Model):
    ...
    :type properties: :class:`ProcessProperties <azure.devops.v7_2.work_item_tracking.models.ProcessProperties>`
    :param reference_name: Reference name of the process
    :type reference_name: str
    :param type_id: The ID of the process
    :type type_id: str
...
class ProcessWorkItemType(Model):
    ...
    :param behaviors:
    :type behaviors: list of :class:`WorkItemTypeBehavior <azure.devops.v7_2.work_item_tracking.models.WorkItemTypeBehavior>`
    :param color: Color hexadecimal code to represent the work item type
    :type color: str
    ...
    :type is_disabled: bool
    :param layout:
    :type layout: :class:`FormLayout <azure.devops.v7_2.work_item_tracking.models.FormLayout>`
    :param name: Name of the work item type
    :type name: str
    :param reference_name: Reference name of work item type
    :type reference_name: str
    :param states:
    :type states: list of :class:`WorkItemStateResultModel <azure.devops.v7_2.work_item_tracking.models.WorkItemStateResultModel>`
...
class ProcessWorkItemTypeField(Model):
    ...
    :type description: str
    :param is_locked: Information about field definition being locked for editing
    :type is_locked: bool
    :param name: Name of the field.
    :type name: str
    :param read_only: If true the field cannot be edited.
    ...
    def __init__(self, allowed_values=None, allow_groups=None, customization=None, default_value=None, description=None, is_locked=None, name=None, read_only=None, reference_name=None, required=None, type=None, url=None):
...
class Section(Model):
    ...
    :type groups: list of :class:`Group <azure.devops.v7_2.work_item_tracking.models.Group>`
    :param id: The id for the layout node.
    :type id: str
    :param overridden: A value indicating whether this layout node has been overridden by a child layout.
    :type overridden: bool
...
class WorkItemBehavior(Model):
    ...
    :type description: str
    :param fields:
    :type fields: list of :class:`WorkItemBehaviorField <azure.devops.v7_2.work_item_tracking.models.WorkItemBehaviorField>`
    :param id:
    :type id: str
    :param inherits:
    :type inherits: :class:`WorkItemBehaviorReference <azure.devops.v7_2.work_item_tracking.models.WorkItemBehaviorReference>`
    :param name:
    :type name: str
    :param overriden:
    :type overriden: bool
...
class WorkItemTypeBehavior(Model):
    ...
    :type behavior: :class:`WorkItemBehaviorReference <azure.devops.v7_2.work_item_tracking.models.WorkItemBehaviorReference>`
