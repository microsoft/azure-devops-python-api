...
class WikiClient(Client):
    ...
    def create_attachment(self, upload_stream, project, wiki_identifier, name, version_descriptor=None, **kwargs):
        ...
        :param :class:`<GitVersionDescriptor> <azure.devops.v7_2.wiki.models.GitVersionDescriptor>` version_descriptor: GitVersionDescriptor for the page. (Optional in case of ProjectWiki).
        :rtype: :class:`<WikiAttachmentResponse> <azure.devops.v7_2.wiki.models.WikiAttachmentResponse>`
        """
        route_values = {}
    ...
    def create_page_move(self, page_move_parameters, project, wiki_identifier, comment=None, version_descriptor=None):
        ...
        :param :class:`<WikiPageMoveParameters> <azure.devops.v7_2.wiki.models.WikiPageMoveParameters>` page_move_parameters: Page more operation parameters.
        :param str project: Project ID or project name
        :param str wiki_identifier: Wiki ID or wiki name.
        :param str comment: Comment that is to be associated with this page move.
        :param :class:`<GitVersionDescriptor> <azure.devops.v7_2.wiki.models.GitVersionDescriptor>` version_descriptor: GitVersionDescriptor for the page. (Optional in case of ProjectWiki).
        :rtype: :class:`<WikiPageMoveResponse> <azure.devops.v7_2.wiki.models.WikiPageMoveResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_or_update_page(self, parameters, project, wiki_identifier, path, version, comment=None, version_descriptor=None):
        ...
        :param :class:`<WikiPageCreateOrUpdateParameters> <azure.devops.v7_2.wiki.models.WikiPageCreateOrUpdateParameters>` parameters: Wiki create or update operation parameters.
        :param str project: Project ID or project name
        :param str wiki_identifier: Wiki ID or wiki name.
        ...
        :param :class:`<GitVersionDescriptor> <azure.devops.v7_2.wiki.models.GitVersionDescriptor>` version_descriptor: GitVersionDescriptor for the page. (Optional in case of ProjectWiki).
        :rtype: :class:`<WikiPageResponse> <azure.devops.v7_2.wiki.models.WikiPageResponse>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_page(self, project, wiki_identifier, path=None, recursion_level=None, version_descriptor=None, include_content=None):
        ...
        :param :class:`<GitVersionDescriptor> <azure.devops.v7_2.wiki.models.GitVersionDescriptor>` version_descriptor: GitVersionDescriptor for the page. Defaults to the default branch (Optional).
    ...
    def update_page_by_id(self, parameters, project, wiki_identifier, id, version, comment=None):
        ...
        :param :class:`<WikiPageCreateOrUpdateParameters> <azure.devops.v7_2.wiki.models.WikiPageCreateOrUpdateParameters>` parameters: Wiki update operation parameters.
        :param str project: Project ID or project name
        :param str wiki_identifier: Wiki ID or wiki name.
        :param int id: Wiki page ID.
        :param String version: Version of the page on which the change is to be made. Mandatory for `Edit` scenario. To be populated in the If-Match header of the request.
    ...
    def get_pages_batch(self, pages_batch_request, project, wiki_identifier, version_descriptor=None):
        ...
        :param :class:`<WikiPagesBatchRequest> <azure.devops.v7_2.wiki.models.WikiPagesBatchRequest>` pages_batch_request: Wiki batch page request.
        :param str project: Project ID or project name
        :param str wiki_identifier: Wiki ID or wiki name.
        :param :class:`<GitVersionDescriptor> <azure.devops.v7_2.wiki.models.GitVersionDescriptor>` version_descriptor: GitVersionDescriptor for the page. (Optional in case of ProjectWiki).
        :rtype: :class:`<[WikiPageDetail]> <azure.devops.v7_2.wiki.models.[WikiPageDetail]>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def create_wiki(self, wiki_create_params, project=None):
        ...
        :param :class:`<WikiCreateParametersV2> <azure.devops.v7_2.wiki.models.WikiCreateParametersV2>` wiki_create_params: Parameters for the wiki creation.
        :param str project: Project ID or project name
        :rtype: :class:`<WikiV2> <azure.devops.v7_2.wiki.models.WikiV2>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def update_wiki(self, update_parameters, wiki_identifier, project=None):
        ...
        :param :class:`<WikiUpdateParameters> <azure.devops.v7_2.wiki.models.WikiUpdateParameters>` update_parameters: Update parameters.
        :param str wiki_identifier: Wiki ID or wiki name.
        :param str project: Project ID or project name
        :rtype: :class:`<WikiV2> <azure.devops.v7_2.wiki.models.WikiV2>`
        """
