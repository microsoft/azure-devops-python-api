...
class DeploymentAttempt(Model):
    ...
    :type post_deployment_gates: :class:`ReleaseGates <release.v4_1.models.ReleaseGates>`
    :param pre_deployment_gates:
    :type pre_deployment_gates: :class:`ReleaseGates <release.v4_1.models.ReleaseGates>`
    :param queued_on:
    :type queued_on: datetime
    :param reason:
    :type reason: object
    :param release_deploy_phases:
    :type release_deploy_phases: list of :class:`ReleaseDeployPhase <release.v4_1.models.ReleaseDeployPhase>`
    :param requested_by:
