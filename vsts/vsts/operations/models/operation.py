...
class Operation(OperationReference):
    ...
    :type _links: :class:`ReferenceLinks <operations.models.ReferenceLinks>`
    ...
    :type result_url: :class:`OperationResultReference <operations.models.OperationResultReference>`
    """
