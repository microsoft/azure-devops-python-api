...
class BuildDefinition(BuildDefinitionReference):
    ...
    :type authored_by: :class:`IdentityRef <vsts_cli_build.models.IdentityRef>`
    :param draft_of: If this is a draft definition, it might have a parent
    :type draft_of: :class:`DefinitionReference <vsts_cli_build.models.DefinitionReference>`
    :param drafts: If this is not a draft definition, it may have drafts of its own
    :type drafts: list of :class:`DefinitionReference <vsts_cli_build.models.DefinitionReference>`
    :param metrics:
    :type metrics: list of :class:`BuildMetric <vsts_cli_build.models.BuildMetric>`
    ...
    :param build_number_format: The vsts_cli_build number format
    ...
    :param latest_build:
    :type latest_build: :class:`Build <vsts_cli_build.models.Build>`
    :param latest_completed_build:
    :type latest_completed_build: :class:`Build <vsts_cli_build.models.Build>`
    :param options:
    :type options: list of :class:`BuildOption <vsts_cli_build.models.BuildOption>`
    :param process: The vsts_cli_build process.
    :type process: :class:`BuildProcess <vsts_cli_build.models.BuildProcess>`
    :param process_parameters: Process Parameters
    :type process_parameters: :class:`ProcessParameters <vsts_cli_build.models.ProcessParameters>`
    :param properties:
    ...
    :type retention_rules: list of :class:`RetentionPolicy <vsts_cli_build.models.RetentionPolicy>`
    :param tags:
    :type tags: list of str
    :param triggers:
    :type triggers: list of :class:`BuildTrigger <vsts_cli_build.models.BuildTrigger>`
    :param variable_groups:
    :type variable_groups: list of :class:`VariableGroup <vsts_cli_build.models.VariableGroup>`
    :param variables:
    :type variables: dict
    """
