...
class BuildOptionDefinition(BuildOptionDefinitionReference):
    ...
    :param groups:
    :type groups: list of :class:`BuildOptionGroupDefinition <vsts_cli_build.models.BuildOptionGroupDefinition>`
    :param inputs:
    :type inputs: list of :class:`BuildOptionInputDefinition <vsts_cli_build.models.BuildOptionInputDefinition>`
    :param name:
    :type name: str
    :param ordinal:
    :type ordinal: int
