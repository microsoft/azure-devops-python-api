...
class BuildSettings(Model):
    ...
    :type default_retention_policy: :class:`RetentionPolicy <vsts_cli_build.models.RetentionPolicy>`
    :param maximum_retention_policy:
    :type maximum_retention_policy: :class:`RetentionPolicy <vsts_cli_build.models.RetentionPolicy>`
    """
