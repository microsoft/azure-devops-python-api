...
class TimelineRecord(Model):
    ...
    :param details:
    :type details: :class:`TimelineReference <vsts_cli_build.models.TimelineReference>`
    :param error_count:
    ...
    :type id: str
    :param issues:
    :type issues: list of :class:`Issue <vsts_cli_build.models.Issue>`
    :param last_modified:
    :type last_modified: datetime
    :param log:
    :type log: :class:`BuildLogReference <vsts_cli_build.models.BuildLogReference>`
    :param name:
    :type name: str
    :param order:
    :type order: int
    ...
    :type state: object
    :param task:
    :type task: :class:`TaskReference <vsts_cli_build.models.TaskReference>`
    :param type:
    :type type: str
    :param url:
    :type url: str
