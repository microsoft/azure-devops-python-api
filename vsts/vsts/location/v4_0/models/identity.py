...
class Identity(Model):
    ...
    :param descriptor:
    :type descriptor: :class:`str <microsoft.-visual-studio.-services.-web-api.models.str>`
    :param id:
    :type id: str
    :param is_active:
    :type is_active: bool
    ...
    :param member_of:
    :type member_of: list of :class:`str <microsoft.-visual-studio.-services.-web-api.models.str>`
    :param members:
    :type members: list of :class:`str <microsoft.-visual-studio.-services.-web-api.models.str>`
    :param meta_type_id:
    :type meta_type_id: int
    :param properties:
    :type properties: :class:`object <microsoft.-visual-studio.-services.-web-api.models.object>`
    ...
    :type subject_descriptor: :class:`str <microsoft.-visual-studio.-services.-web-api.models.str>`
