...
class Identity(Model):
    ...
    :param member_of:
    :type member_of: list of :class:`str <identities.models.str>`
    :param members:
    :type members: list of :class:`str <identities.models.str>`
    :param meta_type_id:
    :type meta_type_id: int
    :param properties:
    :type properties: :class:`object <identities.models.object>`
