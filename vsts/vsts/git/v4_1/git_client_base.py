...
class GitClientBase(VssClient):
    ...
    def get_branch(self, repository_id, name, project=None, base_version_descriptor=None):
        ...
        :param str project: Project ID or project name
        :param :class:`<GitVersionDescriptor> <git.models.GitVersionDescriptor>` base_version_descriptor: Identifies the commit or branch to use as the base.
    ...
    def get_commit_diffs(self, repository_id, project=None, diff_common_commit=None, top=None, skip=None, base_version_descriptor=None, target_version_descriptor=None):
        ...
        :param :class:`<GitBaseVersionDescriptor> <git.models.GitBaseVersionDescriptor>` base_version_descriptor: Base item version. Compared against target item version to find changes in between.
        :param :class:`<GitTargetVersionDescriptor> <git.models.GitTargetVersionDescriptor>` target_version_descriptor: Target item version to use for finding the diffs. Compared against base item version to find changes in between.
    ...
    def create_import_request(self, import_request, project, repository_id):
        ...
        :param :class:`<GitImportRequest> <git.models.GitImportRequest>` import_request: The import request to create.
        :param str project: Project ID or project name
        :param str repository_id: The name or ID of the repository.
    ...
    def update_import_request(self, import_request_to_update, project, repository_id, import_request_id):
        ...
        :param :class:`<GitImportRequest> <git.models.GitImportRequest>` import_request_to_update: The updated version of the import request. Currently, the only change allowed is setting the Status to Queued or Abandoned.
        :param str project: Project ID or project name
        :param str repository_id: The name or ID of the repository.
    ...
    def get_item(self, repository_id, path, project=None, scope_path=None, recursion_level=None, include_content_metadata=None, latest_processed_change=None, download=None, version_descriptor=None):
        ...
        :param VersionControlRecursionType recursion_level: The recursion level of this request. The default is 'none', no recursion.
        ...
        :param :class:`<GitVersionDescriptor> <git.models.GitVersionDescriptor>` version_descriptor: Version descriptor.  Default is null.
    ...
    def update_pull_request_iteration_statuses(self, patch_document, repository_id, pull_request_id, iteration_id, project=None):
        ...
        :param :class:`<[JsonPatchOperation]> <git.models.[JsonPatchOperation]>` patch_document: Operations to apply to the pull request statuses in JSON Patch format.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
        :param int iteration_id: ID of the pull request iteration.
        :param str project: Project ID or project name
    ...
    def create_pull_request_label(self, label, repository_id, pull_request_id, project=None, project_id=None):
        ...
        :param :class:`<WebApiCreateTagRequestData> <git.models.WebApiCreateTagRequestData>` label: Label to assign to the pull request.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
        :param str project: Project ID or project name
    ...
    def get_pull_request_properties(self, repository_id, pull_request_id, project=None):
        ...
        :param int pull_request_id: ID of the pull request.
        :param str project: Project ID or project name
        :rtype: :class:`<object> <git.models.object>`
        """
        route_values = {
            'project': self._serialize.url('project', project, 'str'),
            'repositoryId': self._serialize.url('repository_id', repository_id, 'str'),
    ...
    def update_pull_request_properties(self, patch_document, repository_id, pull_request_id, project=None):
        ...
        :param :class:`<[JsonPatchOperation]> <git.models.[JsonPatchOperation]>` patch_document: Properties to add, replace or remove in JSON Patch format.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
        :param str project: Project ID or project name
        :rtype: :class:`<object> <git.models.object>`
    ...
    def get_pull_request_query(self, queries, repository_id, project=None):
        ...
        :param :class:`<GitPullRequestQuery> <git.models.GitPullRequestQuery>` queries: The list of queries to perform.
        :param str repository_id: ID of the repository.
        :param str project: Project ID or project name
    ...
    def create_pull_request_reviewer(self, reviewer, repository_id, pull_request_id, reviewer_id, project=None):
        ...
        :param :class:`<IdentityRefWithVote> <git.models.IdentityRefWithVote>` reviewer: Reviewer's vote.<br />If the reviewer's ID is included here, it must match the reviewerID parameter.<br />Reviewers can set their own vote with this method.  When adding other reviewers, vote must be set to zero.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
    ...
    def create_comment(self, comment, repository_id, pull_request_id, thread_id, project=None):
        ...
        :param :class:`<Comment> <git.models.Comment>` comment: The comment to create.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
    ...
    def update_comment(self, comment, repository_id, pull_request_id, thread_id, comment_id, project=None):
        ...
        :param :class:`<Comment> <git.models.Comment>` comment: The comment content that should be updated.
        :param str repository_id: The repository ID of the pull request’s target branch.
        :param int pull_request_id: ID of the pull request.
        :param int thread_id: ID of the thread that the desired comment is in.
    ...
    def update_ref(self, new_ref_info, repository_id, filter, project=None, project_id=None):
        ...
        :param :class:`<GitRefUpdate> <git.models.GitRefUpdate>` new_ref_info: The ref update action (lock/unlock) to perform
        :param str repository_id: The name or ID of the repository.
    ...
    def create_favorite(self, favorite, project):
        ...
        :param :class:`<GitRefFavorite> <git.models.GitRefFavorite>` favorite: The ref favorite to create.
        :param str project: Project ID or project name
    ...
    def create_repository(self, git_repository_to_create, project=None, source_ref=None):
        ...
        :param :class:`<GitRepositoryCreateOptions> <git.models.GitRepositoryCreateOptions>` git_repository_to_create: Specify the repo name, team project and/or parent repository
        :param str project: Project ID or project name
    ...
    def update_repository(self, new_repository_info, repository_id, project=None):
        ...
        :param :class:`<GitRepository> <git.models.GitRepository>` new_repository_info: Specify a new repo name or a new default branch of the repository
        :param str repository_id: The name or ID of the repository.
        :param str project: Project ID or project name
        :rtype: :class:`<GitRepository> <git.models.GitRepository>`
        """
    ...
    def create_commit_status(self, git_commit_status_to_create, commit_id, repository_id, project=None):
        ...
        :param :class:`<GitStatus> <git.models.GitStatus>` git_commit_status_to_create: Git commit status object to create.
